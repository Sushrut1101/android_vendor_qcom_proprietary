...
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V1_0_IQTIRADIOINDICATION_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V1_0_IQTIRADIOINDICATION_H
...
struct IQtiRadioIndication : public ::android::hidl::base::V1_0::IBase {
    virtual bool isRemote() const override { return false; }


    virtual ::android::hardware::Return<void> qtiRadioIndication(QtiRadioIndicationType type) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IQtiRadioIndication>> castFrom(const ::android::sp<IQtiRadioIndication>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IQtiRadioIndication>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IQtiRadioIndication>&);
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V1_0_IQTIRADIOINDICATION_H
