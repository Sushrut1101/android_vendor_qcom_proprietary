...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2011, 2018-2019 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#define TIME_V01_IDL_MINOR_VERS 0x08
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define TIME_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define TIME_V01_MAX_MESSAGE_ID 0x0039
/** 
    @} 
  */
...
typedef enum {
  ...
  QMI_TIME_BASE_MFLO_V01 = 11, /**<  Base for MediaFLO time. \n
                   ...
                   reflected on QMI_TIME_BASE_TOD.  */
  QMI_TIME_BASE_5G_V01 = 17, /**<  Base for 5G time. */
  QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_V01 = 18,
...
typedef struct {
	...
	/* Mandatory */
	uint64_t hlos_apps_timetick; /**qtimer timetick value at APSS*/

	/* Mandatory */
	uint64_t sdx_timetick; /**qtimer timetick value at MDM*/

}qmi_time_qtimer_delta_from_hlos_apps_req_msg_v01;

typedef struct {
	/* Mandatory */
	qmi_response_type_v01 resp;           //!< Standard response type.

}qmi_time_qtimer_delta_from_hlos_apps_resp_msg_v01;

typedef struct {
	/* Mandatory */
	uint64_t qtimer_delta;
  /**< qtimer_delta containing qtimer delta for remote and local soc.*/
}qtimer_delta_update_indication_message_msg_v01;
...
#define QMI_TIME_ATS_5G_UPDATE_IND_MSG_V01 0x0038
#define QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_REQ_MSG_V01 0x0039
#define QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_RESP_MSG_V01 0x0039
#define QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_IND_MSG_V01 0x0039
/**
    @}
  */
