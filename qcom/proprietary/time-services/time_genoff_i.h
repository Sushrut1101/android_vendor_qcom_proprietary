/*
 * ----------------------------------------------------------------------------
 *  Copyright (c) 2011, 2014-2020 Qualcomm Technologies, Inc.  All Rights Reserved.
...
#define OFFSET_LOCATION "/data/vendor/time"
#define PERSIST_OFFSET_LOCATION "/mnt/vendor/persist/time"
...
#define MDM 0
#define WLAN 1
#define MDM_LOCAL_REMOTE_QTIMER "/sys/bus/mhi/devices/0306_00.01.00/time"
#define MDM_LOCAL_REMOTE_QTIMER_1 "/sys/bus/mhi/devices/0306_01.01.00/time"
#define MDM_LOCAL_REMOTE_QTIMER_2 "/sys/bus/mhi/devices/0306_02.01.00/time"
#define WLAN_LOCAL_REMOTE_QTIMER "/sys/bus/mhi/devices/1101_00.01.00/time"
#define WLAN_LOCAL_REMOTE_QTIMER_1 "/sys/bus/mhi/devices/1101_01.01.00/time"
#define WLAN_LOCAL_REMOTE_QTIMER_2 "/sys/bus/mhi/devices/1101_02.01.00/time"
