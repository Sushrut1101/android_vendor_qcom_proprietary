...
/* End of list */
	...
	#ifdef SECURE_UI_LISTENER_ENABLED
		#define SEC_UI_LISTENER_INDEX 2 /* value dependent on struct 'qseecom_listener_services' */
	#endif //SEC_UI_LISTENER_INDEX
#else
	#ifdef SECURE_UI_LISTENER_ENABLED
		#define SEC_UI_LISTENER_INDEX 0 /* value dependent on struct 'qseecom_listener_services' */
	#endif //SEC_UI_LISTENER_INDEX
...
#endif
#endif// SECURE_UI_LISTENER_ENABLED
	{
...
{
	int ret = 0;
	int (*service_initialize)(int) = NULL;
