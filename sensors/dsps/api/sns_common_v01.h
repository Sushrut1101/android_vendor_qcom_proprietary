...
#define SNS_COMMON_V01_IDL_MINOR_VERS 0x17
...
/**  Syncronization Proxy Service  */
#define SNS_SYNC_PROXY_SVC_ID_V01 50

/**  Algorithm: QHeart  */
#define SNS_SAM_QHEART_SVC_ID_V01 51

/**  Algorithm: Fast Absolute Motion Detection.  */
#define SNS_SAM_FAST_AMD_SVC_ID_V01 52

/**  Algorithm: Tilt_w detector.  */
#define SNS_SAM_TILT_W_DETECTOR_SVC_ID_V01 53

/**  Algorithm: IOD.  */
#define SNS_SAM_IOD_SVC_ID_V01 54

/**  Algorithm: IOD autocalibration.  */
#define SNS_SAM_IOD_AUTOCAL_SVC_ID_V01 55

/**  QFP(fingerprint) service  */
#define SNS_QFP_SVC_ID_V01 56

/**  Algorithm: Multishake  */
#define SNS_SAM_MULTISHAKE_SVC_ID_V01 57

/**  Algorithm: DPC V2  */
#define SNS_SAM_DPC2_SVC_ID_V01 58

/**  altitude change service  */
#define SNS_INTERNAL_ALTCHG_SVC_ID_V01 59

/**  energy expenditure for wearables service  */
#define SNS_EEW_SVC_ID_V01 60

/**  core activity recognition for wrist service  */
#define SNS_INTERNAL_ARW_ACCEL_SVC_ID_V01 61

/**  Algorithm: Device orientation.  */
#define SNS_SAM_DEV_ORI_SVC_ID_V01 62

/**  Algorithm: Persistent Motion Detector  */
#define SNS_SAM_PMD_SVC_ID_V01 63

/**  Algorithm: Magnetometer Calibration  */
#define SNS_SAM_QMAG_CAL_SVC_ID_V01 64

/**  Algorithm: Gyroscope Calibration  */
#define SNS_SAM_GYRO_CAL_SVC_ID_V01 65

/**  QTI Internal Always ON Test Service  */
#define SNS_SAM_AON_TEST_SVC_ID_V01 66
...
#define SNS_QMI_SVC_ID_50_V01 306
#define SNS_QMI_SVC_ID_51_V01 307
#define SNS_QMI_SVC_ID_52_V01 308
#define SNS_QMI_SVC_ID_53_V01 309
#define SNS_QMI_SVC_ID_54_V01 310
#define SNS_QMI_SVC_ID_55_V01 311
#define SNS_QMI_SVC_ID_56_V01 312
#define SNS_QMI_SVC_ID_57_V01 313
#define SNS_QMI_SVC_ID_58_V01 314
#define SNS_QMI_SVC_ID_59_V01 315
#define SNS_QMI_SVC_ID_60_V01 316
#define SNS_QMI_SVC_ID_61_V01 317
#define SNS_QMI_SVC_ID_62_V01 318
#define SNS_QMI_SVC_ID_63_V01 319
#define SNS_QMI_SVC_ID_64_V01 320
#define SNS_QMI_SVC_ID_65_V01 321
#define SNS_QMI_SVC_ID_66_V01 322
...
/** @addtogroup sns_common_qmi_messages
    @{
  */
/** Request Message; Cancels all requests from a client to any sensor service.
