...
typedef enum {
    ...
    RIL_E_REJECTED_BY_REMOTE = 1001,                /* Rejected by remote */
    RIL_E_NETWORK_NOT_SUPPORTED = 1002,             /* Network not supported */
    RIL_E_HOLD_RESUME_FAILED = 1003,                /* HOLD/RESUME reqeust failed */
    RIL_E_HOLD_RESUME_CANCELED = 1004,              /* HOLD/RESUME reqeust cancelled */
    RIL_E_REINVITE_COLLISION = 1005,                /* Reinvite collision */
    RIL_E_DIAL_MODIFIED_TO_DIAL_VIDEO = 1006,       /* DIAL request modified to VIDEO DIAL */
    RIL_E_SS_MODIFIED_TO_DIAL_VIDEO = 1007,         /* SS request modified to VIDEO DIAL */
    RIL_E_USSD_MODIFIED_TO_DIAL_VIDEO = 1008,       /* USSD request modified to VIDEO DIAL */
    RIL_E_DIAL_VIDEO_MODIFIED_TO_DIAL = 1009,       /* VIDEO DIAL request modified to VIDEO */
    RIL_E_DIAL_VIDEO_MODIFIED_TO_SS = 1010,         /* VIDEO DIAL request modified to SS */
    RIL_E_DIAL_VIDEO_MODIFIED_TO_USSD = 1011,       /* VIDEO DIAL request modified to USSD */
    RIL_E_DIAL_VIDEO_MODIFIED_TO_DIAL_VIDEO = 1012, /* VIDEO DIAL request modified to VIDEO */
} RIL_Errno;
...
typedef enum {
    ...
    CDMA  = 0x04,   // Code Division Multiple Access Radio Access Network
    IWLAN = 0x05,   // IWLAN Radio Access Network
 ...
 * ((const char **)data)[15] Access Network to use for values RIL_RadioAccessNetworks.
 *                           The access network to setup the data call. If the data connection
 *                           cannot be established on the specified access network, the setup
 *                           request must be failed.
 * ((const char **)data)[16] The request reason. Must be
 *                           RIL_RadioDataRequestReasons.NORMAL or
 *                           RIL_RadioDataRequestReasons.HANDOVER.
 * ((const char **)data)[17] If the reason is RIL_RadioDataRequestReasons.HANDOVER,
 ...
 * ((const char **)data)[18] If the reason is RIL_RadioDataRequestReasons.HANDOVER,
 ...
 * "response" is a const RIL_KeepaliveStatus *
 */
#define RIL_UNSOL_EMERGENCY_NUMBERS_LIST 1051
