...
LOCAL_MODULE           := libmfpostdummy_daemon
...
LOCAL_SRC_FILES := ./prebuilt/dummy/mfpost_dummy.cpp
...
LOCAL_MODULE           := libmmcamera_mfproc_postcpp
LOCAL_32_BIT_ONLY      := true
LOCAL_MODULE_TAGS      := optional
...
LOCAL_CFLAGS := $(COMMON_CFLAGS)
LOCAL_SRC_FILES := QCameraMultiFrameProc_Postcpp.cpp

LOCAL_SHARED_LIBRARIES += libdl libcutils liblog
LOCAL_ADDITIONAL_DEPENDENCIES := $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr

LOCAL_SHARED_LIBRARIES += libmfpostdummy_daemon
