...
ifeq ($(call is-board-platform-in-list,msm8994 msm8916 msm8952 msm8996 msm8992 msm8937 msm8953 sdm660 msm8998 apq8098_latv $(TRINKET)),true)
MM_DEBUG := false
endif

ifeq ($(strip $(ARM_VER)),armv7)
LOCAL_PATH := $(JPEG_PATH)/lib/os/armv7
else ifeq ($(strip $(ARM_VER)),armv6)
LOCAL_PATH := $(JPEG_PATH)/lib/os/armv6
else ifeq ($(strip $(ARM_VER)),armv8)
LOCAL_PATH := $(JPEG_PATH)/lib/os/armv8
endif

LOCAL_PATH := $(JPEG_PATH)/lib/os/armv7
LOCAL_MODULE := libmmjpeg-enc-rvct
LOCAL_MODULE_CLASS := STATIC_LIBRARIES
LOCAL_MODULE_TAGS  := optional
LOCAL_SRC_FILES := libmmjpeg-enc-rvct.a
...
libmmjpeg_includes += $(SRC_CAMERA_HAL_DIR)/mm-image-codec/qexif
ifneq ($(TARGET_KERNEL_VERSION),$(filter $(TARGET_KERNEL_VERSION),3.18 4.4 4.9))
libmmjpeg_includes += system/core/libion/include/
libmmjpeg_includes += system/core/libion/kernel-headers/
endif
