...
#define WLFW_V01_MAX_MESSAGE_ID 0x0051
/**
    @}
  */
...
/**  Maximum hang event data size */
#define QMI_WLFW_MAX_HANG_EVT_SIZE_V01 784
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Subscribe option of wlfw_hang_event_ind_msg */
  uint8_t hang_event_ind_msg_valid;  /**< Must be set to true if hang_event_ind_msg is being passed */
  uint8_t hang_event_ind_msg;
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command requests full power */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wlfw_exit_power_save_req_msg_v01;
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command requests full power */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_exit_power_save_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Indication Message; This command tells client to save hang event data */
typedef struct {
  ...
  uint8_t data_valid;  /**< Must be set to true if data is being passed */
  uint32_t data_len;  /**< Must be set to # of elements in data */
  uint8_t data[QMI_WLFW_MAX_HANG_EVT_SIZE_V01];
}wlfw_hang_event_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_WLFW_EXIT_POWER_SAVE_V01
...
//#define REMOVE_QMI_WLFW_HANG_EVENT_IND_V01
...
#define QMI_WLFW_HANG_EVENT_IND_V01 0x0051
/**
    @}
  */
