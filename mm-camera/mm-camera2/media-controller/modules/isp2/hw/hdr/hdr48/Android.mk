#======================================================================
#makefile for libmmcamera2_isp2_hdr48.so form mm-camera2
#======================================================================
...
LOCAL_SRC_FILES        := module_hdr48.c hdr48.c
ifeq ($(OEM_CHROMATIX), true)
LOCAL_C_INCLUDES += $(LOCAL_EXTEN_ISP_INCLUDES)
LOCAL_SRC_FILES += ../../../../../../../../mm-camera-ext/mm-camera2/media-controller/modules/isp2/hdr48_ext.c
