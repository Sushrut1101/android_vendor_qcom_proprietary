...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/wda/api/wireless_data_administrative_service_v01.h#7 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define WDA_V01_IDL_MINOR_VERS 0x18
 ...
 */
  ...
  uint8_t ndp_signature_valid;  /**< Must be set to true if ndp_signature is being passed */
  uint32_t ndp_signature;
  /**<   The default value based on the data aggregation protocol
       is used.
  */
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Request Message; Negotiates various capabilities between TE and modem. */
typedef struct {
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Response Message; Negotiates various capabilities between TE and modem. */
typedef struct {
