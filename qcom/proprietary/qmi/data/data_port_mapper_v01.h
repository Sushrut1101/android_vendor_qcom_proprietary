...
#define DPM_V01_IDL_MINOR_VERS 0x06
...
typedef struct {
  ...
  data_ep_id_type_v01 ep_id;
  /**<   Peripheral endpoint of the data port.
  */
  ...
  /**<   Informs the remote driver about the total Uplink xDCI buffer size
        ...
        peripheral channel/pipe (in Bytes). */
  ...
  /**<   Informs the remote driver about the total Downlink xDCI buffering
       ...
       (In Bytes). dl_fifo_size = n * dl_buf_size. */
...
}data_port_buffer_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Data Port Buffer Info List */
  uint8_t data_port_buffer_info_list_valid;  /**< Must be set to true if data_port_buffer_info_list is being passed */
  uint32_t data_port_buffer_info_list_len;  /**< Must be set to # of elements in data_port_buffer_info_list */
  data_port_buffer_info_type_v01 data_port_buffer_info_list[QMI_DPM_PORT_MAX_NUM_V01];
  /**<   \n
      (Provides buffer fifo parameters for data ports.)
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Is CLAT Feature Supported(Deprecated) */
