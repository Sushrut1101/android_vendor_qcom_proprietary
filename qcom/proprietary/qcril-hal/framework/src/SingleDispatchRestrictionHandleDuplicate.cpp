...
void SingleDispatchRestrictionHandleDuplicate::onMessageCallbackCompletion(
  ...
  auto solicitedMsg = std::static_pointer_cast<SolicitedMessage<QcRilRequestMessageCallbackPayload>>(msg);
  ...
  for (auto const& dup: duplicatedMsg) {
    if(dup != nullptr) {
      ...
      auto item = std::static_pointer_cast<SolicitedMessage<QcRilRequestMessageCallbackPayload>>(dup);
