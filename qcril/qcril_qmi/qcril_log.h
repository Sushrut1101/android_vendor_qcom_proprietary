...
void qcril_log_urf_mask_to_status(int mask, char* const filter_status_str, const size_t filter_status_str_len);
const char* qcril_log_device_state_type_enum_to_str(RIL_DeviceStateType device_state);
