...
static const uint32 msg_bld_masks_gen[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_QDR,
  MSG_BUILD_MASK_MSG_SSID_WDSP,
  MSG_BUILD_MASK_MSG_SSID_GNSS_HLOS,
  MSG_BUILD_MASK_MSG_SSID_SNS_FRAMEWORK,
  MSG_BUILD_MASK_MSG_SSID_SNS_PLATFORM,
  MSG_BUILD_MASK_MSG_SSID_SNS_SENSOR_INT,
  MSG_BUILD_MASK_MSG_SSID_SNS_SENSOR_EXT,
  MSG_BUILD_MASK_MSG_SSID_SSGCCS,
  MSG_BUILD_MASK_MSG_SSID_PERF,
  MSG_BUILD_MASK_MSG_SSID_TSENS,
  MSG_BUILD_MASK_MSG_SSID_ECM,
  MSG_BUILD_MASK_MSG_SSID_TEMPERATURE_MONITOR,
  MSG_BUILD_MASK_MSG_SSID_GPSFFT,
  MSG_BUILD_MASK_MSG_SSID_SSGSCA,
...
static const uint32 msg_bld_masks_wlan[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_WLAN_PLATFORM,
  MSG_BUILD_MASK_MSG_SSID_WLAN_RSSI_MONITOR,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_WPM,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_CSS,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_PPS,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_SCAN_CH_PREDICT,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_MAWC,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_CMC_QMIC,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_HALPHY,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_ENQ,
  MSG_BUILD_MASK_MSG_SSID_WLAN_MODULE_WLM,
};
...
static const uint32 msg_bld_masks_mcs[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_MCS_TRM
};
...
static const uint32 msg_bld_masks_ds[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_DS_TX,
  MSG_BUILD_MASK_MSG_SSID_DS_WLAN,
  MSG_BUILD_MASK_MSG_SSID_DS_IPSEC,
  MSG_BUILD_MASK_MSG_SSID_DS_SSL
};
...
static const uint32 msg_bld_masks_sec[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_SEC_QWES,
};
...
static const uint32 msg_bld_masks_qdsp6[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_CHGPD_CHARGING,
  MSG_BUILD_MASK_MSG_SSID_CHGPD_TYPCPD,
  MSG_BUILD_MASK_MSG_SSID_AUD_OFFL_SVC,
};
...
static const uint32 msg_bld_masks_lte[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_0,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_1,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_2,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_3,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_4,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_5,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_6,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_7,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_8,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_9,
  MSG_BUILD_MASK_MSG_SSID_F_RESERVED_10
};
...
static const uint32 msg_bld_masks_dpm[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_DPM_DM
};

static uint32 msg_rt_masks_dpm[2][sizeof(msg_bld_masks_dpm) /
  sizeof(msg_bld_masks_dpm[0])];

static const uint32 msg_bld_masks_v2x[] =
{
  MSG_BUILD_MASK_MSG_SSID_V2X,
  MSG_BUILD_MASK_MSG_SSID_V2X_ML1,
  MSG_BUILD_MASK_MSG_SSID_V2X_MAC,
  MSG_BUILD_MASK_MSG_SSID_V2X_RLC,
  MSG_BUILD_MASK_MSG_SSID_V2X_PDCP,
  MSG_BUILD_MASK_MSG_SSID_V2X_RRC,
};

static uint32 msg_rt_masks_v2x[2][sizeof(msg_bld_masks_v2x) /
  sizeof(msg_bld_masks_v2x[0])];
...
(uint32*)msg_rt_masks_dpm
    ...
    ,
  {
    ...
    /* FIRST + array count */
    MSG_SSID_V2X+
       sizeof (msg_bld_masks_v2x) / sizeof(msg_bld_masks_v2x[0]) - 1,
    msg_bld_masks_v2x,
    (uint32*)msg_rt_masks_v2x
  }
};
