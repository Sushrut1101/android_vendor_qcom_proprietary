...
/* This file was generated with Tool version 6.14.7
   It was generated on: Thu Jul  5 2018 (Spin 0)
...
static const uint8_t data_port_buffer_info_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(data_port_buffer_info_type_v01, ep_id),
  QMI_IDL_TYPE88(2, 0),
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(data_port_buffer_info_type_v01, ul_fifo_size),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(data_port_buffer_info_type_v01, dl_fifo_size),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(data_port_buffer_info_type_v01, dl_buf_size),
...
static const uint8_t dpm_open_port_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dpm_open_port_req_msg_v01, software_data_port_list) - QMI_IDL_OFFSET16RELATIVE(dpm_open_port_req_msg_v01, software_data_port_list_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dpm_open_port_req_msg_v01, data_port_buffer_info_list) - QMI_IDL_OFFSET16RELATIVE(dpm_open_port_req_msg_v01, data_port_buffer_info_list_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(dpm_open_port_req_msg_v01, data_port_buffer_info_list),
  QMI_DPM_PORT_MAX_NUM_V01,
  QMI_IDL_OFFSET16RELATIVE(dpm_open_port_req_msg_v01, data_port_buffer_info_list) - QMI_IDL_OFFSET16RELATIVE(dpm_open_port_req_msg_v01, data_port_buffer_info_list_len),
  QMI_IDL_TYPE88(0, 4)
};
...
/*
 * dpm_get_supported_capabilities_req_msg is empty
 * static const uint8_t dpm_get_supported_capabilities_req_msg_data_v01[] = {
 * };
 */

static const uint8_t dpm_get_supported_capabilities_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_shim_supported) - QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_shim_supported_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_shim_supported),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_rev_ip_sync_supported) - QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_rev_ip_sync_supported_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_rev_ip_sync_supported),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_clat_supported) - QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_clat_supported_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_clat_supported)
};
...
static const qmi_idl_type_table_entry  dpm_type_table_v01[] = {
  ...
  {sizeof(data_port_buffer_info_type_v01), data_port_buffer_info_type_data_v01},
...
static const qmi_idl_message_table_entry dpm_message_table_v01[] = {
  ...
  {sizeof(dpm_get_supported_capabilities_req_msg_v01), 0},
  {sizeof(dpm_get_supported_capabilities_resp_msg_v01), dpm_get_supported_capabilities_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry dpm_service_command_messages_v01[] = {
  {QMI_DPM_OPEN_PORT_REQ_V01, QMI_IDL_TYPE16(0, 0), 3792},
  {QMI_DPM_CLOSE_PORT_REQ_V01, QMI_IDL_TYPE16(0, 2), 1320},
  {QMI_DPM_GET_SUPPORTED_CAPABILITIES_REQ_V01, QMI_IDL_TYPE16(0, 4), 0}
};
...
static const qmi_idl_service_message_table_entry dpm_service_response_messages_v01[] = {
  ...
  {QMI_DPM_GET_SUPPORTED_CAPABILITIES_RESP_V01, QMI_IDL_TYPE16(0, 5), 19}
};
