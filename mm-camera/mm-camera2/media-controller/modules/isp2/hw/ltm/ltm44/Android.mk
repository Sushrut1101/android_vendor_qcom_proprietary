#======================================================================
#makefile for libmmcamera2_isp2_ltm44.so form mm-camera2
#======================================================================
ifeq ($(call is-vendor-board-platform,QCOM),true)
ifeq ($(call is-board-platform-in-list, apq8084 msm8994 msm8952 msm8937 msm8992 msm8953),true)
...
LOCAL_SRC_FILES        := module_ltm44.c ltm44.c \
                          ../adrc/ltm_algo.c
ifeq ($(OEM_CHROMATIX), true)
LOCAL_SRC_FILES        += ltm44_ext.c
LOCAL_CFLAGS += -DOVERRIDE_FUNC=1
endif
