...
#if (SIM_COUNT >= 2)
static qtimutex::QtiSharedMutex s_pendingRequestsMutex_socket2;
static RequestInfo *s_pendingRequests_socket2          = NULL;
#endif

#if (SIM_COUNT >= 3)
static qtimutex::QtiSharedMutex s_pendingRequestsMutex_socket3;
static RequestInfo *s_pendingRequests_socket3          = NULL;
#endif

#if (SIM_COUNT >= 4)
static qtimutex::QtiSharedMutex s_pendingRequestsMutex_socket4;
