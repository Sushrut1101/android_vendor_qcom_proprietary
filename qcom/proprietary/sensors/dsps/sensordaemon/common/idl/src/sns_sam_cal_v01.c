...
static const uint8_t sns_sam_cal_enable_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_sam_cal_enable_req_msg_v01, phone_mode) - QMI_IDL_OFFSET8(sns_sam_cal_enable_req_msg_v01, phone_mode_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_sam_cal_enable_req_msg_v01, phone_mode)
};
...
static const qmi_idl_message_table_entry sns_sam_cal_message_table_v01[] = {
  {sizeof(sns_sam_cal_enable_req_msg_v01), sns_sam_cal_enable_req_msg_data_v01},
