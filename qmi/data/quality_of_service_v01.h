...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/qos/api/quality_of_service_v01.h#6 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define QOS_V01_IDL_MINOR_VERS 0x11
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Indication Message; Gives the flow and filter information for one or more QoS flows to
    control points that have registered for this event reporting. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Requests the creation of QoS flows. (Deprecated) */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Requests the creation of QoS flows. (Deprecated) */
typedef struct {
  ...
  /**<   List of QoS identifiers for the flows that have
       been negotiated.
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Releases one or more existing QoS flows. */
typedef struct {
  ...
  uint32_t qos_identifier_len;  /**< Must be set to # of elements in qos_identifier */
  uint32_t qos_identifier[QMI_QOS_MAX_QOS_SPECS_V01];
  /**<   List of QoS flows to be released. Index identifying the QoS flow that has
      been negotiated.
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Releases one or more existing QoS flows. */
typedef struct {
...
typedef struct {
  ...
  uint32_t qos_identifier_len;  /**< Must be set to # of elements in qos_identifier */
  uint32_t qos_identifier[QMI_QOS_MAX_QOS_SPECS_V01];
  /**<   List of QoS flows to be suspended. Index identifies the QoS flow that was
      negotiated.
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Resumes one or more suspended QoS flows. */
typedef struct {
  ...
  uint32_t qos_identifier_len;  /**< Must be set to # of elements in qos_identifier */
  uint32_t qos_identifier[QMI_QOS_MAX_QOS_SPECS_V01];
  /**<   List of QoS flows to be resumed. Index identifies the QoS flow that was
      negotiated.
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Resumes one or more suspended QoS flows. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Modifies an existing QoS instance. (Deprecated) */
typedef struct {
  ...
  /**<   Primary QoS modify request. Values: \n
    - 0x01 -- TRUE
  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Modifies an existing QoS instance. (Deprecated) */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Retrieves the QoS parameters that are in effect for the specified
    QoS flow as a result of network negotiation. (Deprecated) */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Retrieves the QoS parameters that are in effect for the specified
    QoS flow as a result of network negotiation. (Deprecated) */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Indication Message; Sends a QoS flow status update to the control point. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Queries whether the device is currently on a network that supports
    QoS. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Queries whether the device is currently on a network that supports
    QoS. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Indication Message; Queries whether the device is currently on a network that supports
    QoS. */
typedef struct {
...
typedef struct {
  ...
  /**<   Data services error value returned by the IOCTL/lower layers. Refer to
     the DS error numbers in \hyperref[80-V6415-1]{80-V6415-1} for the possible
     values returned in this field.
    */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Indication Message; Provides the status of the primary flow operation performed. */
typedef struct {
...
typedef enum {
  ...
  QOS_IP_FAMILY_IPV4_V01 = 0x04, /**<  IPv4 family.  */
  QOS_IP_FAMILY_IPV6_V01 = 0x06, /**<  IPv6 family.  */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Sets the control point's IP preference. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Sets the control point's IP preference. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Performs requested operations on a specified flow. */
typedef struct {
  ...
  /**<   Requested operation bitmask. Values: \n
       - Bit 0 -- Get the Tx queue level \n
       - Bit 1 -- Get HDR RMAC3 information \n
       - Bit 2 -- Get the transmission status \n
       - Bit 3 -- Get the inactivity timer \n
       - Bit 4 -- Set the inactivity timer \n
       Each bit that is set causes the corresponding
  ...
  /**<   The Set Inactivity Timer TLV is required if the requested operation
       bitmask has bit 4 set.
   */
...
typedef struct {
  ...
  uint8_t bit_number;
  /**<   Bit number of the failed operation. */

  int16_t error_value;
  /**<   Error value of the corresponding operation. */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Performs requested operations on a specified flow. */
typedef struct {
  ...
  /**<   A list of error values for the corresponding operations
       sent in the request as a bitmask.
   */
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Retrieves the QoS filter parameters that are in effect for the
    specified QoS flow. (Deprecated.) */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Retrieves the QoS filter parameters that are in effect for the
    specified QoS flow. (Deprecated.) */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Request Message; Binds the requesting control point with the specified subscription. */
typedef struct {
...
/** @addtogroup qos_qmi_messages
    @{
  */
/** Response Message; Binds the requesting control point with the specified subscription. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  uint8_t suppress_report_flow_control_valid;  /**< Must be set to true if suppress_report_flow_control is being passed */
  ...
  */
  ...
  uint8_t suppress_network_status_ind_valid;  /**< Must be set to true if suppress_network_status_ind is being passed */
...
typedef struct {
  ...
  uint16_t filter_id;
  /**<   Filter ID identifying the filter that has match all capability.
  */
}qos_filter_rule_match_all_type_v01;  /* Type */
/**
    @}
  */
...
#define QMI_QOS_IP_FLOW_MASK_3GPP_RES_BER_V01 ((qos_ip_flow_params_mask_v01)0x0000000000000100ull) /**<  3GPP residual bit error rate (BER) \n  */
...
#define QMI_QOS_IP_FLOW_MASK_5G_QCI_V01 ((qos_ip_flow_params_mask_v01)0x0000000000008000ull) /**<  5G QOS class identifier \n  */
#define QMI_QOS_IP_FLOW_MASK_AVG_WINDOW_V01 ((qos_ip_flow_params_mask_v01)0x0000000000010000ull) /**<  Averaging window  */
/** @addtogroup qos_qmi_enums
    @{
  */
typedef enum {
...
typedef enum {
  ...
  QOS_FLOW_LTE_QCI_65_V01 = 65,
  QOS_FLOW_LTE_QCI_66_V01 = 66,
  QOS_FLOW_LTE_QCI_69_V01 = 69,
  QOS_FLOW_LTE_QCI_70_V01 = 70,
...
/** @addtogroup qos_qmi_enums
  ...
  */
typedef enum {
  QOS_FLOW_5G_QCI_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QOS_FLOW_5G_QCI_0_V01 = 0,
  QOS_FLOW_5G_QCI_1_V01 = 1,
  QOS_FLOW_5G_QCI_2_V01 = 2,
  QOS_FLOW_5G_QCI_3_V01 = 3,
  QOS_FLOW_5G_QCI_4_V01 = 4,
  QOS_FLOW_5G_QCI_5_V01 = 5,
  QOS_FLOW_5G_QCI_6_V01 = 6,
  QOS_FLOW_5G_QCI_7_V01 = 7,
  QOS_FLOW_5G_QCI_8_V01 = 8,
  QOS_FLOW_5G_QCI_9_V01 = 9,
  QOS_FLOW_5G_QCI_65_V01 = 65,
  QOS_FLOW_5G_QCI_66_V01 = 66,
  QOS_FLOW_5G_QCI_67_V01 = 67,
  QOS_FLOW_5G_QCI_69_V01 = 69,
  QOS_FLOW_5G_QCI_70_V01 = 70,
  QOS_FLOW_5G_QCI_75_V01 = 75,
  QOS_FLOW_5G_QCI_79_V01 = 79,
  QOS_FLOW_5G_QCI_80_V01 = 80,
  QOS_FLOW_5G_QCI_82_V01 = 82,
  QOS_FLOW_5G_QCI_83_V01 = 83,
  QOS_FLOW_5G_QCI_84_V01 = 84,
  QOS_FLOW_5G_QCI_85_V01 = 85,
  QOS_FLOW_5G_QCI_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qos_flow_5g_qci_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t token_rate;
  /**<   Rate at which tokens are put in the token bucket (bits per second);
       a token must be present in the bucket to send a byte of data.
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Tx 5G QCI */
  uint8_t tx_5g_qci_valid;  /**< Must be set to true if tx_5g_qci is being passed */
  uint32_t tx_5g_qci_len;  /**< Must be set to # of elements in tx_5g_qci */
  qos_flow_5g_qci_enum_v01 tx_5g_qci[QMI_QOS_MAX_QOS_FLOWS_V01];
  /**<   5G Tx QoS Class Identifier (QCI). Valid if flow_valid_params of
       Tx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. The
       elements of this list correspond to the list elements of
       Tx QoS Flow TLV. */

  /* Optional */
  /*  Rx 5G QCI */
  uint8_t rx_5g_qci_valid;  /**< Must be set to true if rx_5g_qci is being passed */
  uint32_t rx_5g_qci_len;  /**< Must be set to # of elements in rx_5g_qci */
  qos_flow_5g_qci_enum_v01 rx_5g_qci[QMI_QOS_MAX_QOS_FLOWS_V01];
  /**<   5G Rx QoS Class Identifier (QCI) Valid if flow_valid_params of
       Rx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. The
       elements of this list correspond to the list elements of
       Rx QoS Flow TLV. */

  /* Optional */
  /*  Tx QoS Averaging Window */
  uint8_t tx_averaging_window_valid;  /**< Must be set to true if tx_averaging_window is being passed */
  uint32_t tx_averaging_window_len;  /**< Must be set to # of elements in tx_averaging_window */
  uint16_t tx_averaging_window[QMI_QOS_MAX_QOS_FLOWS_V01];
  /**<   Represents the duration in ms over which the guaranteed flow bit
       rate (GFBR) and maximum flow bit rate (MFBR) shall be calculated.
       Valid if the flow_valid_params of Tx QoS Flow has a
       QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. The elements of this list
       correspond to the list elements of Tx QoS Flow TLV. */

  /* Optional */
  /*  Rx QoS Averaging Window */
  uint8_t rx_averaging_window_valid;  /**< Must be set to true if rx_averaging_window is being passed */
  uint32_t rx_averaging_window_len;  /**< Must be set to # of elements in rx_averaging_window */
  uint16_t rx_averaging_window[QMI_QOS_MAX_QOS_FLOWS_V01];
  /**<   Represents the duration in ms over which the GFBR and MFBR shall be
       calculated. Valid if the flow_valid_params of Rx QoS Flow TLV has a
       QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. The elements of this list
       correspond to the list elements of Rx QoS Flow TLV. */
...
typedef struct {
  ...
  */
  ...
  /**<   Tx QoS flow parameters error mask. Values: \n
      - QMI_QOS_IP_FLOW_MASK_NONE (0x0000000000000000) --  No parameters \n
      - QMI_QOS_IP_FLOW_MASK_TRF_CLASS (0x0000000000000001) --  Traffic class \n
      - QMI_QOS_IP_FLOW_MASK_DATA_RATE_MIN_MAX (0x0000000000000002) --  Data rate min/max \n
      - QMI_QOS_IP_FLOW_MASK_DATA_RATE_TOK_BUCKET (0x0000000000000004) --  Data rate token bucket \n
 ...
 */
  ...
  /**<   Rx QoS flow parameters error mask. Values: \n
      - QMI_QOS_IP_FLOW_MASK_NONE (0x0000000000000000) --  No parameters \n
      - QMI_QOS_IP_FLOW_MASK_TRF_CLASS (0x0000000000000001) --  Traffic class \n
      - QMI_QOS_IP_FLOW_MASK_DATA_RATE_MIN_MAX (0x0000000000000002) --  Data rate min/max \n
      - QMI_QOS_IP_FLOW_MASK_DATA_RATE_TOK_BUCKET (0x0000000000000004) --  Data rate token bucket \n
 ...
 */
  ...
  /**<   Tx QoS filter parameters error mask. Values: \n
 ...
 */
  ...
  /**<   Rx QoS filter parameters error mask. Values: \n
      - QMI_QOS_FILTER_PARAM_NONE (0x0000000000000000) --  No errors \n
      - QMI_QOS_FILTER_PARAM_IP_VERSION (0x0000000000000001) --  IP version \n
      - QMI_QOS_FILTER_PARAM_IPV4_SRC_ADDR (0x0000000000000002) --  IPv4 source address \n
      - QMI_QOS_FILTER_PARAM_IPV4_DEST_ADDR (0x0000000000000004) --  IPv4 destination address \n
...
typedef enum {
  ...
  QOS_FLOW_REBIND_V01 = 6, /**<  Flow rebind  */
...
typedef struct {
 ...
 Values: \n
      - QOS_FLOW_UE_INITIATED_QOS (0) --  UE-initiated QoS flow
 ...
 */
  ...
  */
  ...
  /*  Tx 5G QCI */
  uint8_t tx_5g_qci_valid;  /**< Must be set to true if tx_5g_qci is being passed */
  qos_flow_5g_qci_enum_v01 tx_5g_qci;
  /**<   5G Tx QoS Class Identifier (QCI). Valid if flow_valid_params of
       Tx QoS Flow Granted TLV has a QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. */

  /* Optional */
  /*  Rx 5G QCI */
  uint8_t rx_5g_qci_valid;  /**< Must be set to true if rx_5g_qci is being passed */
  qos_flow_5g_qci_enum_v01 rx_5g_qci;
  /**<   5G Rx QoS Class Identifier (QCI). Valid if flow_valid_params of
       Rx QoS Flow Granted TLV has a QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. */

  /* Optional */
  /*  Tx QoS Averaging Window */
  uint8_t tx_averaging_window_valid;  /**< Must be set to true if tx_averaging_window is being passed */
  uint16_t tx_averaging_window;
  /**<   Represents the duration in ms over which the guaranteed flow bit
       rate (GFBR) and maximum flow bit rate (MFBR) shall be calculated.
       Valid if flow_valid_params of Tx QoS Flow Granted TLV has
       a QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. */

  /* Optional */
  /*  Rx QoS Averaging Window */
  uint8_t rx_averaging_window_valid;  /**< Must be set to true if rx_averaging_window is being passed */
  uint16_t rx_averaging_window;
  /**<   Represents the duration in ms over which the GFBR and MFBR shall be
       calculated. Valid if flow_valid_params of Rx QoS Flow Granted TLV has
       a QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. */

  /* Optional */
  /*  Tx Filter Match ALL */
  uint8_t tx_filter_match_all_valid;  /**< Must be set to true if tx_filter_match_all is being passed */
  uint32_t tx_filter_match_all_len;  /**< Must be set to # of elements in tx_filter_match_all */
  qos_filter_rule_match_all_type_v01 tx_filter_match_all[QMI_QOS_MAX_QOS_FILTERS_V01];
...
typedef struct {
  ...
  uint32_t tx_averaging_window_len;  /**< Must be set to # of elements in tx_averaging_window */
  uint16_t tx_averaging_window[QMI_QOS_MAX_QOS_FLOWS_V01];
  /**<   Represents the duration in ms over which the GFBR and
       MFBR shall be calculated. Valid if flow_valid_params of
       Tx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. The
       elements of this list correspond to the list elements of
       Tx QoS Flow TLV.  */
  ...
  /**<   Represents the duration in ms over which the GFBR and
       MFBR shall be calculated. Valid if flow_valid_params of
       Rx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. The
       elements of this list correspond to the list elements of
       Rx QoS Flow TLV.     */
 ...
 */
  ...
  */
  ...
  /**<   Data services error value returned by the
       ...
       published in \hyperref[80-V6415-1]{80-V6415-1} for the possible values returned in
       this field.
  */
  ...
  qos_flow_5g_qci_enum_v01 tx_5g_qci;
  /**<   5G Tx QoS Class Identifier (QCI). Valid if flow_valid_params of
       Tx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_5G_QCI bit set). */
  ...
  qos_flow_5g_qci_enum_v01 rx_5g_qci;
  /**<   5G Rx QoS Class Identifier (QCI). Valid if flow_valid_params of
       Rx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. */
  ...
  /**<   Represents the duration in ms over which the GFBR and
       MFBR shall be calculated. Valid if flow_valid_params of
       Tx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.  */
  ...
  /**<   Represents the duration in ms over which the GFBR and
       MFBR shall be calculated. Valid if flow_valid_params of
       Rx QoS Flow TLV has a QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.   */
  ...
  uint32_t tx_filter_match_all_len;  /**< Must be set to # of elements in tx_filter_match_all */
  qos_filter_rule_match_all_type_v01 tx_filter_match_all[QMI_QOS_MAX_QOS_FILTERS_V01];
  /**<   Given filter ids in list is having match all capability.
  */
...
//#define REMOVE_QMI_QOS_SET_EVENT_REPORT_IND_V01
//#define REMOVE_QMI_QOS_STATUS_IND_V01
