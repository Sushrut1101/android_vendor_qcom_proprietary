 ...
 */
public class SimCard implements Comparable<SimCard> {
    ...
    public SimCard(SimCard other) {
        mSimId = other.mSimId;
        mSimSlotIndex = other.mSimSlotIndex;
    ...
    public SimCard(String simId, int simSlotIndex, int subscriptionId, CharSequence carrierName,
    ...
    public SimCard(String simId, CharSequence carrierName,
                   CharSequence displayName, String phoneNumber, String countryCode) {
        this(simId, DEFAULT_SLOT, NO_SUBSCRIPTION_ID, carrierName, displayName, phoneNumber, countryCode);
    }
    ...
    public static SimCard create(SubscriptionInfo info) {
        return new SimCard(info.getIccId(), info.getSimSlotIndex(), info.getSubscriptionId(),
    ...
    @Override
    public int compareTo(@NonNull SimCard simCard) {
        return this.getSimSlotIndex() - simCard.getSimSlotIndex();
    }
}
