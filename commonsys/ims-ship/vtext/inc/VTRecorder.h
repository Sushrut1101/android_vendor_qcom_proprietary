...
#define VT_AVCProfileCBPProfile 0x10000
#define VT_AVCProfileCHPProfile 0x80000
...
class VTRecorder : public VideoCodecBase
{
  ...
  public:
    ...
    virtual ANativeWindow* getRecordingSurface(JNIEnv * env) = 0;
    ...
    virtual QPE_VIDEO_ERROR SetSourceTime(uint8_t useSystemTime) {
      MINIMAL2("SetSourceTime NOT NEEDED to implement %d", useSystemTime);
      return VIDEO_ERROR_OK;
    };
