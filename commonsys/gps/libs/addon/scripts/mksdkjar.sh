...
COMPILED_AIDLS="$DIR/../../../../../../../../out/soong/.intermediates/vendor/qcom/proprietary/commonsys/gps/libs/glue/izat.lib.glue/android_common/gen/aidl/vendor/qcom/proprietary/commonsys/gps/libs/glue/java"
...
if [ ! -e $COMPILED_AIDLS ]
then
    COMPILED_AIDLS="$OUT_JAVA_LIBRARIES/izat.lib.glue_intermediates/aidl/java"
fi
...
# Build class files
mkdir -p $OUT/classes
javac -cp $OUT_JAVA_LIBRARIES/frameworks-core-util-lib_intermediates/classes.jar:$OUT_JAVA_LIBRARIES/framework_intermediates/classes.jar -sourcepath $DIR/../java/:$GLUE_JAVA -d $OUT/classes/ $(find $DIR/../java $COMPILED_AIDLS/ $GLUE_JAVA/com/qti/debugreport/ $GLUE_JAVA/com/qti/wifidbreceiver/  $GLUE_JAVA/com/qti/flp/ $GLUE_JAVA/com/qti/geofence/ $GLUE_JAVA/com/qti/izat/ $GLUE_JAVA/com/qti/wifidbprovider/ $GLUE_JAVA/com/qti/wwandbreceiver/ $GLUE_JAVA/com/qti/wwandbprovider/ -name *.java)
