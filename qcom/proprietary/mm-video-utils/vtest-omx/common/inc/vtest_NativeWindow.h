...
private:
    ...
    //API to convert from UBWC to NV12
    OMX_ERRORTYPE UBWCtoNV12(OMX_U8 *pData, OMX_U8 **bufNV12, VideoResolution *res);
...
private:
    ...
    void* m_hUBWC;
    void* m_pUBWCConfig;
    OMX_U8* m_pTempNV12Buf;
    void* pLibUBWCHandle;
    void* (*pFnUBWCConvertInit)(void);
    void* (*pFnUBWCConvertInitZero)(void *);
    void* (*pFnUBWCConfigInit)(void);
    void* (*pFnUBWCConfigInitZero)(void *);
    VidcStatus (*pFnConvertUBWCToNV12)(void *, void *, uint8 *, uint8 **, VideoResolution*);
    void (*pFnUBWCConvertConfigure)(void *, OMX_U32);
    void (*pFnUBWCConvertDeInit)(void *);
...
static inline OMX_U32 GetGrallocFormat(OMX_U32 nFormat) {
    ...
    switch (nFormat) {
        ...
        case QOMX_COLOR_FORMATYUV420PackedSemiPlanar32mCompressed:
            return HAL_PIXEL_FORMAT_YCbCr_420_SP_VENUS_UBWC;
        default:
            return nFormat;
    }
}
