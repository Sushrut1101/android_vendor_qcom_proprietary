#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_4_IRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_4_IRADIO_H
...
struct IRadio : public ::android::hardware::radio::V1_3::IRadio {
     ...
     * Response callback is IRadioResponse.setInitialAttachApnResponse()
     */
    virtual ::android::hardware::Return<void> setInitialAttachApn_1_4(int32_t serial, const ::android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo) = 0;
     ...
     * Response callback is IRadioResponse.setDataProfileResponse()
     */
    virtual ::android::hardware::Return<void> setDataProfile_1_4(int32_t serial, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::DataProfileInfo>& profiles) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> startNetworkScan_1_4(int32_t serial, const ::android::hardware::radio::V1_2::NetworkScanRequest& request) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getPreferredNetworkTypeBitmap(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setPreferredNetworkTypeBitmap(int32_t serial, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap) = 0;
     ...
     * Response callback is IRadioResponse.setAllowedCarriersResponse()
     */
    virtual ::android::hardware::Return<void> setAllowedCarriers_1_4(int32_t serial, const ::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority& carriers, ::android::hardware::radio::V1_4::SimLockMultiSimPolicy multiSimPolicy) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getAllowedCarriers_1_4(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSignalStrength_1_4(int32_t serial) = 0;
    ...
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_4::IRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_4::IRadio>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_4::IRadio>& o) {
    ...
    os += ::android::hardware::radio::V1_4::IRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_4_IRADIO_H
