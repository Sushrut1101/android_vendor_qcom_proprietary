...
*/
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_1_IQTIRADIORESPONSE_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_1_IQTIRADIORESPONSE_H
...
struct IQtiRadioResponse : public ::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse {
    ...
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>& o) {
    ...
    os += ::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_1_IQTIRADIORESPONSE_H
