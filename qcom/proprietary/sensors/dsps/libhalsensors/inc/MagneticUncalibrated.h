/*============================================================================
  @file MagneticUncalibrated.h

  @brief
  MagneticUncalibrated class definition.

  Copyright (c) 2014,2017 Qualcomm Technologies, Inc.  All Rights Reserved.
  Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
#ifndef ANDROID_MAGNETIC_UNCALIBRATED_SENSOR_H
#define ANDROID_MAGNETIC_UNCALIBRATED_SENSOR_H
...
class MagneticUncalibrated : public SMGRSensor {
public:
	MagneticUncalibrated(int handle);
