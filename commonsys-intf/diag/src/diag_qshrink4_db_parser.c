/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
Copyright (c) 2015-2020 by Qualcomm Technologies, Inc.
All Rights Reserved.
...
int create_diag_qshrink4_db_parser_thread(unsigned int peripheral_mask,unsigned int device_mask)
{
	...
	if (peripheral_mask) {
		...
		periph_info.peripheral_mask = DIAG_CON_MPSS | DIAG_CON_LPASS | DIAG_CON_WCNSS | DIAG_CON_SENSORS | DIAG_CON_WDSP | DIAG_CON_CDSP |
										DIAG_CON_NPU;
