#======================================================================
#makefile for libmmcamera2_isp2_bf_stats47.so form mm-camera2
#======================================================================
ifeq ($(call is-vendor-board-platform,QCOM),true)
ifeq ($(call is-board-platform-in-list, msm8996 msm8952 msm8937 msm8953 sdm660 msm8998 apq8098_latv $(TRINKET)),true)
...
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_gamma
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_down_scaler
...
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_gamma/include47
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_down_scaler/include47
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_stats47/include47
...
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_gamma/include41
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_down_scaler/include41
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_stats47/include41
...
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_gamma/include42
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_down_scaler/include41
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_stats47/include41
...
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_gamma/include47
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_down_scaler/include47
LOCAL_C_INCLUDES += $(LOCAL_MMCAMERA_PATH)/media-controller/modules/isp2/hw/stats/bf_stats/bf_stats47/include48
...
ifeq ($(call is-board-platform-in-list, msm8996 msm8952 msm8937 msm8953),true)
