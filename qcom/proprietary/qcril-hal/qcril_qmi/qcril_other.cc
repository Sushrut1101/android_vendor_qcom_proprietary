...
{
  { NV_AUTO_ANSWER_I,           QCRIL_OTHER_NV_SO( auto_answer ),         (char*)"NV_AUTO_ANSWER_I" },
  { NV_PREF_VOICE_SO_I,         QCRIL_OTHER_NV_SO( pref_voice_so ),       (char*)"NV_PREF_VOICE_SO_I" },
  { NV_ROAM_CNT_I,              QCRIL_OTHER_NV_SO( roam_cnt ),            (char*)"NV_ROAM_CNT_I" },
  { NV_AIR_CNT_I,               QCRIL_OTHER_NV_SO( air_cnt ),             (char*)"NV_AIR_CNT_I" },
  { NV_MIN1_I,                  QCRIL_OTHER_NV_SO( min1 ),                (char*)"NV_MIN1_I" },
  { NV_MIN2_I,                  QCRIL_OTHER_NV_SO( min2 ),                (char*)"NV_MIN2_I" },
  { NV_IMSI_11_12_I,            QCRIL_OTHER_NV_SO( imsi_11_12 ),          (char*)"NV_IMSI_11_12_I" },
  { NV_IMSI_MCC_I,              QCRIL_OTHER_NV_SO( imsi_mcc ),            (char*)"NV_IMSI_MCC_I" },
  { NV_IMSI_T_MCC_I,            QCRIL_OTHER_NV_SO( imsi_t_mcc ),          (char*)"NV_IMSI_T_MCC_I" },
  { NV_IMSI_T_11_12_I,          QCRIL_OTHER_NV_SO( imsi_t_11_12 ),        (char*)"NV_IMSI_T_11_12_I" },
  { NV_IMSI_T_S1_I,             QCRIL_OTHER_NV_SO( imsi_t_s1 ),           (char*)"NV_IMSI_T_S1_I" },
  { NV_IMSI_T_S2_I,             QCRIL_OTHER_NV_SO( imsi_t_s2 ),           (char*)"NV_IMSI_T_S2_I" },
  { NV_IMSI_T_ADDR_NUM_I,       QCRIL_OTHER_NV_SO( imsi_t_addr_num ),     (char*)"NV_IMSI_T_ADDR_NUM_I" },
  { NV_PCDMACH_I,               QCRIL_OTHER_NV_SO( pcdmach ),             (char*)"NV_PCDMACH_I" },
  { NV_SCDMACH_I,               QCRIL_OTHER_NV_SO( scdmach ),             (char*)"NV_SCDMACH_I" },
  { NV_HOME_SID_NID_I,          QCRIL_OTHER_NV_SO( home_sid_nid ),        (char*)"NV_HOME_SID_NID_I" },
  { NV_DIR_NUMBER_I,            QCRIL_OTHER_NV_SO( dir_number ),          (char*)"NV_DIR_NUMBER_I" },
  { NV_SID_NID_I,               QCRIL_OTHER_NV_SO( sid_nid ),             (char*)"NV_SID_NID_I" },
  { NV_MOB_CAI_REV_I,           QCRIL_OTHER_NV_SO( mob_cai_rev ),         (char*)"NV_MOB_CAI_REV_I" },
};

//extern "C" int qcril_log_get_token_id( RIL_Token t );
...
*/
/*=========================================================================*/
static RIL_Errno qcril_other_get_3gpp2_subscription_info
(
...
*/
/*=========================================================================*/
static RIL_Errno qcril_other_preset_min_based_info
(
   nas_3gpp2_min_based_info_type_v01 *min_based_info
)
{
   nas_get_3gpp2_subscription_info_resp_msg_v01 get_config_resp_msg;
   RIL_Errno ret = qcril_other_get_3gpp2_subscription_info(&get_config_resp_msg, DEFAULT_NAM_ID);
   do
   {
...
*/
/*=========================================================================*/
static RIL_Errno qcril_other_preset_true_imsi_info
(
...
*/
/*=========================================================================*/
static RIL_Errno qcril_other_preset_cdma_channel_info
(
      ...
      case NV_AIR_CNT_I:
         {
            ...
            std::shared_ptr<VoiceModemEndPoint> voiceEndPoint =
                ModemEndPointFactory<VoiceModemEndPoint>::getInstance().buildEndPoint();
            if (voiceEndPoint == nullptr) {
                QCRIL_LOG_INFO("ModemEndPoint not ready");
                qcril_other_send_request_reponse(instance_id, params_ptr->t, params_ptr->event_id,
                                       RIL_E_GENERIC_FAILURE, NULL, 0);
                break;
            }
            if (QMI_NO_ERR != voiceEndPoint->sendRawSync(QMI_VOICE_GET_CONFIG_REQ_V02,
                                                        &get_config_req_msg,
                                                        sizeof(get_config_req_msg),
                                                        &get_config_resp_msg,
                                                        sizeof(get_config_resp_msg)))
      ...
      case NV_NAME_NAM_I:          /* retrieved from nam_name*/
         {
            ...
            if (QMI_NO_ERR !=
               qmi_client_nas_send_sync(QMI_NAS_GET_3GPP2_SUBSCRIPTION_INFO_REQ_MSG_V01,
                                          &get_config_req_msg,
                                          sizeof(get_config_req_msg),
                                          &get_config_resp_msg,
                                          sizeof(get_config_resp_msg))
      ...
      case NV_SID_NID_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_HOME_NETWORK_REQ_MSG_V01,
                                           NULL,
                                           0,
                                           &get_config_resp_msg,
                                           sizeof(get_config_resp_msg))
      ...
      case NV_MOB_CAI_REV_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_MOB_CAI_REV_REQ_MSG_V01,
                                           NULL,
                                           0,
                                           &get_config_resp_msg,
                                           sizeof(get_config_resp_msg))
      ...
      case NV_AIR_CNT_I:
         {
            ...
            qmi_client_error = voiceEndPoint->sendRawSync(QMI_VOICE_SET_CONFIG_REQ_V02,
                                                          &set_config_req_msg,
      ...
      case NV_NAME_NAM_I:          /* retrieved from nam_name*/
         {
            ...
            if (NV_MIN1_I == nv_item_id)
            {
               ...
               RIL_Errno ret = qcril_other_preset_min_based_info(&set_config_req_msg.min_based_info);
               if (RIL_E_SUCCESS != ret)
               {
                  qcril_other_send_request_reponse(instance_id, params_ptr->t, params_ptr->event_id,
                                                ret, NULL, 0);
            ...
            else if (NV_IMSI_T_MCC_I == nv_item_id)
            {
               ...
               RIL_Errno ret = qcril_other_preset_true_imsi_info(&set_config_req_msg.true_imsi);
               if (RIL_E_SUCCESS != ret)
               {
                  qcril_other_send_request_reponse(instance_id, params_ptr->t, params_ptr->event_id,
                                                ret, NULL, 0);
            ...
            else if (NV_PCDMACH_I == nv_item_id)
            {
               ...
               RIL_Errno ret = qcril_other_preset_cdma_channel_info(&set_config_req_msg.cdma_channel_info);
               if (RIL_E_SUCCESS != ret)
               {
                  qcril_other_send_request_reponse(instance_id, params_ptr->t, params_ptr->event_id,
                                                ret, NULL, 0);
            ...
            if ( RIL_E_SUCCESS == ril_req_res )
            {
                qmi_client_error = qmi_client_nas_send_sync(QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_REQ_MSG_V01,
                                                              &set_config_req_msg,
                                                              sizeof(set_config_req_msg),
                                                              &set_config_resp_msg,
                                                              sizeof(set_config_resp_msg));
...
#ifndef QMI_RIL_UTF
  std::shared_ptr<rildata::RilRequestGoDormantMessage> msg =
      std::make_shared<rildata::RilRequestGoDormantMessage>(*params_ptr);
  if (msg)
  {
    msg->dispatch();
                                                  ...
                                                  const char *property_value)
{
    ...
    if(property_name && property_value)
    {
        ...
        {
            ret = property_set(property_name,
                               property_value);
...
//===========================================================================
RIL_Errno qmi_ril_set_property_value_to_integer(const char *property_name,
                                                      int property_value)
{
    RIL_Errno res;
