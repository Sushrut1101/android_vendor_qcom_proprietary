...
Description  :This file was generated with Tool version 6.14.7
   It was generated on: Thu Feb 21 2019 (Spin 0)
   From IDL File: ip_multimedia_subsystem_rtp_v01.idl.From IDL File: ip_multimedia_subsystem_rtp_v01.idl
...
static const uint8_t imsrtp_session_configure_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, app_id) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, app_id_valid)),
  0x40,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_configure_req_msg_v01, app_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, enable_lipsync_enhancement) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, enable_lipsync_enhancement_valid)),
  0x41,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_configure_req_msg_v01, enable_lipsync_enhancement),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, video_render_outsync) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, video_render_outsync_valid)),
  0x42,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_configure_req_msg_v01, video_render_outsync)
};
...
static const uint8_t imsrtp_last_audio_play_time_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_last_audio_play_time_req_msg_v01, is_dejitter_delay_ready_update) - QMI_IDL_OFFSET8(imsrtp_last_audio_play_time_req_msg_v01, is_dejitter_delay_ready_update_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_last_audio_play_time_req_msg_v01, is_dejitter_delay_ready_update)
};
...
static const uint8_t imsrtp_update_audio_dejitter_delay_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_update_audio_dejitter_delay_ind_msg_v01, session_id),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsrtp_update_audio_dejitter_delay_ind_msg_v01, update_dejitter_delay),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_update_audio_dejitter_delay_ind_msg_v01, app_id) - QMI_IDL_OFFSET8(imsrtp_update_audio_dejitter_delay_ind_msg_v01, app_id_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_update_audio_dejitter_delay_ind_msg_v01, app_id)
};
...
static const qmi_idl_message_table_entry imsrtp_message_table_v01[] = {
  ...
  {sizeof(imsrtp_update_audio_dejitter_delay_ind_msg_v01), imsrtp_update_audio_dejitter_delay_ind_msg_data_v01},
...
static const qmi_idl_service_message_table_entry imsrtp_service_command_messages_v01[] = {
  ...
  {QMI_IMSRTP_SESSION_CONFIGURE_REQ_V01, QMI_IDL_TYPE16(0, 12), 1998},
  ...
  {QMI_IMS_RTP_LAST_AUDIO_PLAY_TIME_REQ_V01, QMI_IDL_TYPE16(0, 51), 11},
  ...
  {QMI_IMSRTP_UNINITIALIZE_ALL_RTP_SESSION_REQ_V01, QMI_IDL_TYPE16(0, 70), 4},
  {QMI_IMSRTP_SESSION_VIDEO_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 75), 55},
  {QMI_IMSRTP_CONFIGURE_NAT_OVER_RTP_REQ_V01, QMI_IDL_TYPE16(0, 77), 17},
  {QMI_IMSRTP_CONFIGURE_NAT_OVER_RTCP_REQ_V01, QMI_IDL_TYPE16(0, 79), 17},
  {QMI_IMSRTP_SET_HANDOFF_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 82), 18},
...
static const qmi_idl_service_message_table_entry imsrtp_service_response_messages_v01[] = {
  ...
  {QMI_IMSRTP_UNINITIALIZE_ALL_RTP_SESSION_RESP_V01, QMI_IDL_TYPE16(0, 71), 7},
  {QMI_IMSRTP_SESSION_VIDEO_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 76), 7},
  {QMI_IMSRTP_CONFIGURE_NAT_OVER_RTP_RESP_V01, QMI_IDL_TYPE16(0, 78), 7},
  {QMI_IMSRTP_CONFIGURE_NAT_OVER_RTCP_RESP_V01, QMI_IDL_TYPE16(0, 80), 7},
  {QMI_IMSRTP_SET_HANDOFF_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 83), 7},
...
static const qmi_idl_service_message_table_entry imsrtp_service_indication_messages_v01[] = {
  ...
  {QMI_IMSRTP_UNINITIALIZE_ALL_RTP_SESSION_IND_V01, QMI_IDL_TYPE16(0, 72), 15},
  {QMI_IMS_RTP_VIDEO_IDR_GENERATE_IND_V01, QMI_IDL_TYPE16(0, 73), 8},
  {QMI_IMS_RTP_VIDEO_BIT_RATE_ADAPT_IND_V01, QMI_IDL_TYPE16(0, 74), 15},
  {QMI_IMS_RTP_FIRST_PKT_RCVD_IND_V01, QMI_IDL_TYPE16(0, 81), 15},
  {QMI_IMS_RTP_VIDEO_QUALITY_IND_V01, QMI_IDL_TYPE16(0, 68), 26},
  {QMI_IMS_RTP_UPDATE_AUDIO_DEJITTER_DELAY_IND_V01, QMI_IDL_TYPE16(0, 69), 15}
};
