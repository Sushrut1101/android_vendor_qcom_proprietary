...
__attribute__((no_sanitize("cfi"))) static inline void hci_ev_tune_status(uint8_t buff[])
{
...
__attribute__((no_sanitize("cfi"))) static void radio_hci_event_packet(char *evt_buf)
{
    char evt;
...
__attribute__((no_sanitize("cfi"))) int process_event(unsigned char *evt_buf)
{
