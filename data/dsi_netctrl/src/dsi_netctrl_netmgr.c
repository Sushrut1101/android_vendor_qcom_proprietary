...
/*===========================================================================
  ...
  Copyright (c) 2010-2015, 2017, 2019-2020 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
dsi_netmgr_link_map_type dsi_netmgr_link_map_tbl[DSI_MAX_IFACES] =
{
  ...
  { NETMGR_LINK_RMNET_16, 16 },
  { NETMGR_LINK_RMNET_17, 17 },
  { NETMGR_LINK_RMNET_18, 18 },
  { NETMGR_LINK_RMNET_19, 19 },
  { NETMGR_LINK_RMNET_20, 20 },
  { NETMGR_LINK_RMNET_21, 21 },
  { NETMGR_LINK_RMNET_22, 22 },
  { NETMGR_LINK_RMNET_23, 23 },
  { NETMGR_LINK_RMNET_24, 24 },
  { NETMGR_LINK_RMNET_25, 25 },
  { NETMGR_LINK_RMNET_26, 26 },
  { NETMGR_LINK_RMNET_27, 27 },
  { NETMGR_LINK_RMNET_28, 28 },
  { NETMGR_LINK_RMNET_29, 29 },
  { NETMGR_LINK_RMNET_30, 30 },
  { NETMGR_LINK_RMNET_31, 31 },
  { NETMGR_LINK_RMNET_32, 32 },
};
  ...
  do
  {
    ...
    switch(dsi_event)
    {
        ...
        for (i = 0; i < DSI_MAX_DATA_CALLS; i++)
        {
             ...
             )
          {
                     ...
                     (DSI_EVT_NET_IS_CONN == dsi_event))
            {
              ...
              DSI_LOG_ERROR("Dropping %d evt in %d state",dsi_event,st->priv.call_state);
      ...
      case DSI_EVT_NET_NO_NET:
        ...
        {
          DSI_LOG_DEBUG("%s","DSI_EVT_NET_NO_NET : ignoring event as it is for different subs");
          evt_ret = DSI_EVT_INVALID;
          break;
        }
...
)
{
  ...
  do
  {
    ...
    if(NETMGR_READY_RESP != event && NETMGR_USER_CMD != event)
    {
      ...
      {
        DSI_LOG_DEBUG("dsi_process_netmgr_ev posting event [%d][%s]",
