...
#include <vendor/qti/hardware/factory/1.0/types.h>
...
#define BYTE_PTR( var )    ( (uint8_t *) &(var) )
...
typedef struct {
    ...
    uint8_t data[SIZE_512];        /* Variable length payload, test_case nam look at FTM log id for contents */
