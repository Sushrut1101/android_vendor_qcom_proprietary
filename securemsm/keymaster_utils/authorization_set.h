...
class AuthorizationSetBuilder {
  public:
    ...
    AuthorizationSetBuilder& RsaKeyNoSizeNoPubExp();
    AuthorizationSetBuilder& SecureUserId(uint64_t sid);
    AuthorizationSetBuilder& MinSecs(uint32_t minsecs);
    AuthorizationSetBuilder& MaxUse(uint32_t maxuse);
    AuthorizationSetBuilder& EcdsaKey(uint32_t key_size);
    AuthorizationSetBuilder& AesKey(uint32_t key_size);
    AuthorizationSetBuilder& TdesKey(uint32_t key_size);
    AuthorizationSetBuilder& HmacKey(uint32_t key_size);

    AuthorizationSetBuilder& RsaSigningKey(uint32_t key_size, uint64_t public_exponent);
    AuthorizationSetBuilder& RsaWrappingKey(uint32_t key_size, uint64_t public_exponent);
    AuthorizationSetBuilder& RsaSigningKeyNoSizeNoPubExp();
    AuthorizationSetBuilder& RsaEncryptionKey(uint32_t key_size, uint64_t public_exponent);
    AuthorizationSetBuilder& EcdsaSigningKey(uint32_t key_size);
    AuthorizationSetBuilder& AesEncryptionKey(uint32_t key_size);
    AuthorizationSetBuilder& TdesEncryptionKey(uint32_t key_size);

    AuthorizationSetBuilder& SigningKey();
    AuthorizationSetBuilder& WrappingKey();
    AuthorizationSetBuilder& EncryptionKey();
    AuthorizationSetBuilder& NoDigestOrPadding();
    AuthorizationSetBuilder& EcbMode();
    AuthorizationSetBuilder& UseSp();
    ...
    AuthorizationSetBuilder& IncludeUniqueId() {
        return Authorization(TAG_INCLUDE_UNIQUE_ID);
    }
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::RsaKeyNoSizeNoPubExp() {
    Authorization(TAG_ALGORITHM, KM_ALGORITHM_RSA);
    return *this;
}
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::TdesKey(uint32_t key_size) {
    Authorization(TAG_ALGORITHM, KM_ALGORITHM_TripleDES);
    return Authorization(TAG_KEY_SIZE, key_size);
}
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::RsaSigningKeyNoSizeNoPubExp() {
    RsaKeyNoSizeNoPubExp();
    return SigningKey();
}

inline AuthorizationSetBuilder& AuthorizationSetBuilder::RsaWrappingKey(uint32_t key_size,
                                                                       uint64_t public_exponent) {
    RsaKey(key_size, public_exponent);
    return WrappingKey();
}

inline AuthorizationSetBuilder& AuthorizationSetBuilder::SecureUserId(uint64_t sid) {
    return Authorization(TAG_USER_SECURE_ID, sid);
}

inline AuthorizationSetBuilder& AuthorizationSetBuilder::MinSecs(uint32_t minsecs) {
    return Authorization(TAG_MIN_SECONDS_BETWEEN_OPS, minsecs);
}

inline AuthorizationSetBuilder& AuthorizationSetBuilder::MaxUse(uint32_t maxuse) {
    return Authorization(TAG_MAX_USES_PER_BOOT, maxuse);
}
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::TdesEncryptionKey(uint32_t key_size) {
    TdesKey(key_size);
    return EncryptionKey();
}
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::WrappingKey() {
    return Authorization(TAG_PURPOSE, KM_PURPOSE_WRAP);
}
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::UseSp() {
    return Authorization(TAG_USE_SECURE_PROCESSOR);
}
