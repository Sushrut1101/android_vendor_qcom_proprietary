ONSEMI_CAT24C16_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_onsemi_cat24c16_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(ONSEMI_CAT24C16_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= onsemi_cat24c16_eeprom.c
