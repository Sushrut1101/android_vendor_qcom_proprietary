#define LOG_TAG "android.hardware.radio@1.1::RadioIndication"
#undef UNUSED
...
const char* IRadioIndication::descriptor("android.hardware.radio@1.1::IRadioIndication");
...
// static 
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::IRadioIndication>> IRadioIndication::castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>& parent, bool /* emitError */) {
    return parent;
}

// static 
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::IRadioIndication>> IRadioIndication::castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& parent, bool emitError) {
    return ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>(static_cast<::android::hardware::radio::V1_1::IRadioIndication*>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::IRadioIndication>> IRadioIndication::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>(static_cast<::android::hardware::radio::V1_1::IRadioIndication*>(parent.get()));
}
