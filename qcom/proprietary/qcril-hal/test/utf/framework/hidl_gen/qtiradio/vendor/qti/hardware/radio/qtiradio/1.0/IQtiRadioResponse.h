...
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V1_0_IQTIRADIORESPONSE_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V1_0_IQTIRADIORESPONSE_H
...
struct IQtiRadioResponse : public ::android::hidl::base::V1_0::IBase {
    virtual bool isRemote() const override { return false; }


    virtual ::android::hardware::Return<void> getAtrResponse(const QtiRadioResponseInfo& info, const ::android::hardware::hidl_string& atr) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IQtiRadioResponse>> castFrom(const ::android::sp<IQtiRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IQtiRadioResponse>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IQtiRadioResponse>&);
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V1_0_IQTIRADIORESPONSE_H
