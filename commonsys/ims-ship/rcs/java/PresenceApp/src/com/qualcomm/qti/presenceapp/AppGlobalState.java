...
public class AppGlobalState {
  ...
  public static ImsConfig getImsConfig(int phoneId){
        ImsManager imsManager = ImsManager.getInstance(getMainActivityContext(),phoneId);
  ...
  public static ImsManager getImsManager(int phoneId) {
      ImsManager imsManager = ImsManager.getInstance(getMainActivityContext(),phoneId);
      return imsManager;
  }
