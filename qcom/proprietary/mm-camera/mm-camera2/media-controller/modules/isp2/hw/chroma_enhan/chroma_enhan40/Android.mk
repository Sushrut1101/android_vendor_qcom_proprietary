#======================================================================
#makefile for libmmcamera2_isp2_chroma_enhan40.so form mm-camera2
#======================================================================
ifeq ($(call is-vendor-board-platform,QCOM),true)
ifeq ($(call is-board-platform-in-list, apq8084 msm8974 msm8226 msm8994 msm8952 msm8937 msm8916 msm8996 msm8992 msm8953 sdm660 msm8998 apq8098_latv $(TRINKET)),true)
...
else ifeq ($(call is-board-platform-in-list, msm8226 apq8084 msm8916 msm8952 msm8937 msm8992 msm8953),true)
...
else ifeq ($(call is-board-platform-in-list, msm8996 sdm660 msm8998 apq8098_latv $(TRINKET)),true)
...
LOCAL_SRC_FILES        := module_chroma_enhan40.c chroma_enhan40.c \
                          ../adrc/chroma_enhan_algo.c
ifeq ($(OEM_CHROMATIX), true)
LOCAL_C_INCLUDES += $(LOCAL_EXTEN_ISP_INCLUDES)
LOCAL_CFLAGS += -DOVERRIDE_FUNC=1
endif
ifeq ($(CHROMATIX_VERSION), 0310)
    LOCAL_SRC_FILES += 0310/chroma_enhance47_0310.c
else
    LOCAL_SRC_FILES += 0309/chroma_enhance47_0309.c
endif
