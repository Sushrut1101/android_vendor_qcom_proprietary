...
include $(TOPDIR)vendor/qcom/proprietary/common/sdm710/BoardConfigVendor-SDM710-pureAOSP.mk
else
...
QTI_GENSECIMAGE_MSM_IDS := sdm710
QTI_GENSECIMAGE_SIGNED_DEFAULT := sdm710
USES_SEC_POLICY_MULTIPLE_DEFAULT_SIGN := 1
USES_SEC_POLICY_INTEGRITY_CHECK := 1
USE_SOC_HW_VERSION := true
SOC_HW_VERSION := 0x60040100
