...
Return<bool> LocHidlIzatOsNpGlue::setCallback(
        const sp<::vendor::qti::gnss::V1_0::ILocHidlIzatOsNpGlueCallback>& callback){
...
Return<void> LocHidlIzatOsNpGlue::locationChanged(
        const ::vendor::qti::gnss::V1_0::LocHidlIzatLocation& location)
{
    FROM_HIDL_CLIENT();
