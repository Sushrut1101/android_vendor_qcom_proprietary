...
static boolean qcril_qmi_npb_encode_preparation(const pb_field_t fields[], const void *dest_struct);

//===========================================================================
// qcril_qmi_npb_encode_string
//===========================================================================
static bool qcril_qmi_npb_encode_string(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_string(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_byte_string(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_byte_string(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_fixed32(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_fixed64(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_varint(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_svarint(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
    uint64_t* const *vals = (uint64_t * const *)*arg;
...
//===========================================================================
static bool qcril_qmi_npb_encode_repeated_submsg(pb_ostream_t *stream, const pb_field_t *field, void * const *arg)
{
    void** vals = (void **)*arg;
    while (vals && *vals)
    {
