...
#ifndef EGL_QCOM_context_persistent_workload
#define EGL_QCOM_context_persistent_workload 1
#define EGL_CONTEXT_OPENGL_PERSISTENT_WORKLOAD_QCOM 0x32D2
#endif // EGL_QCOM_context_persistent_workload
