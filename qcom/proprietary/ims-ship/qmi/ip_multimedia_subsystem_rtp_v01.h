...
#define IMSRTP_V01_IDL_MINOR_VERS 0x24
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSRTP_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSRTP_V01_MAX_MESSAGE_ID 0x0047
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_enums
  ...
  */
typedef enum {
  IMSRTP_AUDIO_DEJITTER_DELAY_UPDATE_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_RTP_AUDIO_DEJITTER_DELAY_NO_CHANGE_V01 = 0x00, /**<  No change in audio dejitter delay \n  */
  IMS_RTP_AUDIO_DEJITTER_DELAY_INCREASE_V01 = 0x01, /**<  Increase audio dejitter delay \n  */
  IMS_RTP_AUDIO_DEJITTER_DELAY_DECREASE_V01 = 0x02, /**<  Decrease audio dejitter delay \n  */
  IMSRTP_AUDIO_DEJITTER_DELAY_UPDATE_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsrtp_audio_dejitter_delay_update_type_enum_v01;
/**
    @}
  */
...
typedef enum {
  ...
  IMS_RTP_VIDEO_RECORDER_CONFIG_ERROR_V01 = 0x03, /**<  Video Recorder configuration error.  */
  IMS_RTP_VIDEO_PLAYER_CONFIG_ERROR_V01 = 0x04, /**<  Video Player configuration  error.  */
  IMS_RTP_VIDEO_COMMUNICATION_ERROR_V01 = 0x05, /**<  Video channel communication error .  */
  IMS_RTP_VIDEO_NETWORK_ERROR_V01 = 0x06, /**<  network error for a video call.  */
...
/**  Enumeration for handoff status.
 Enumeration for audio dejitter delay update.
...
#define IMS_RTP_HO_THRESHOLD_V01 ((imsrtp_video_quality_reason_code_mask_type_v01)0x04ull) /**<  Handoff Threshold  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Enable dynamic lipsync error enhancement */
  uint8_t enable_lipsync_enhancement_valid;  /**< Must be set to true if enable_lipsync_enhancement is being passed */
  uint8_t enable_lipsync_enhancement;
  /**<   Enables dynamic lipsync enhancement. Values: \n
       - 0 -- Disabled \n
       - 1 -- Enabled
  ...
  */
  ...
  /* Optional */
  /*  Enable rendering of delayed video frames that are out of sync with audio */
  uint8_t video_render_outsync_valid;  /**< Must be set to true if video_render_outsync is being passed */
  uint8_t video_render_outsync;
  /**<   Enables rendering of delayed video frames that are out of sync
       with audio frame.Values: \n
       - TRUE -- Enabled \n
       - FALSE -- Disabled
       If the TLV is not included in the request, the default value
       of TRUE is used.
...
typedef struct {
  ...
  /* Optional */
  /*  Is Dejitter Delay Ready for Update */
  uint8_t is_dejitter_delay_ready_update_valid;  /**< Must be set to true if is_dejitter_delay_ready_update is being passed */
  uint8_t is_dejitter_delay_ready_update;
  /**<   TRUE if audio dejitter buffer is ready to honor audio dejitter delay update indication.
       FALSE if audio dejitter buffer is not ready to honor audio dejitter delay update indication.
       If this field is not present, then default value of false is used. */
...
/** @addtogroup imsrtp_qmi_messages
    @{
  */
/** Indication Message; Reports if audio target delay has to be updated to the client on the modem. */
typedef struct {
  ...
  /* Mandatory */
  /*  Audio target delay updation type during VT call */
  imsrtp_audio_dejitter_delay_update_type_enum_v01 update_dejitter_delay;
  /**<   Update_dejitter_delay. Values: \begin{itemize1}
       \item 0 -- NO CHANGE
       \item 1 -- INCREASE
       \item 2 -- DECREASE
	   \vspace{-12pt}
  ...
  */
  ...
  uint8_t app_id;
  /**<   Unique identifier for the application using the RTP stack. */
}imsrtp_update_audio_dejitter_delay_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Handoff threshold */
  uint8_t ho_threshold_bitrate_valid;  /**< Must be set to true if ho_threshold_bitrate is being passed */
  uint16_t ho_threshold_bitrate;
  /**<   Video Metric threshold for Handoff in kbps. if not set, the value defaults
       to zero. */
...
//#define REMOVE_QMI_IMS_RTP_UPDATE_AUDIO_DEJITTER_DELAY_IND_V01
...
#define QMI_IMS_RTP_UPDATE_AUDIO_DEJITTER_DELAY_IND_V01 0x0047
/**
    @}
  */
