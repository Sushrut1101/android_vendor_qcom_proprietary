...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/voice/src/voice_service_v02.c#51 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Tue Jan 21 2020 (Spin 0)
...
static const uint8_t voice_ip_alert_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ip_alert_info_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ip_alert_info_type_v02, ip_alert_info),
  ((QMI_VOICE_IP_ALERT_INFO_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_IP_ALERT_INFO_MAX_LEN_V02) >> 8),
  QMI_IDL_OFFSET8(voice_ip_alert_info_type_v02, ip_alert_info) - QMI_IDL_OFFSET8(voice_ip_alert_info_type_v02, ip_alert_info_len),
...
static const uint8_t voice_cw_response_type_data_v02[] = {
  QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_cw_response_type_v02, active_status),

  QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_cw_response_type_v02, provision_status),
...
static const uint8_t voice_MT_call_received_verstat_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_MT_call_received_verstat_type_v02, network_supports_unwanted_call),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_MT_call_received_verstat_type_v02, mt_call_verstat_info),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_MT_call_verstat_with_id_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_MT_call_verstat_with_id_type_v02, call_id),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_MT_call_verstat_with_id_type_v02, verstat_info),
  QMI_IDL_TYPE88(0, 94),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_emerg_srv_categ_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_emerg_srv_categ_type_v02, call_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_emerg_srv_categ_type_v02, emerg_srv_categ),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_nw_end_unwanted_call_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_nw_end_unwanted_call_type_v02, call_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_nw_end_unwanted_call_type_v02, is_nw_end_unwanted_call),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_tir_mode_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_tir_mode_type_v02, call_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_tir_mode_type_v02, tir_mode),
...
static const uint8_t voice_indication_register_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, vice_dialog_event) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, vice_dialog_event_valid)),
  0x27,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, vice_dialog_event),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_oprt_mode_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_oprt_mode_events_valid)),
  0x28,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_oprt_mode_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, auto_rejected_incoming_call_end_event) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, auto_rejected_incoming_call_end_event_valid)),
  0x29,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, auto_rejected_incoming_call_end_event),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ip_caller_info_status_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ip_caller_info_status_events_valid)),
  0x2A,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ip_caller_info_status_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_hlap_timer_status_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_hlap_timer_status_events_valid)),
  0x2B,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_hlap_timer_status_events),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_era_glonass_enabled_status_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_era_glonass_enabled_status_events_valid)),
  0x2C,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_era_glonass_enabled_status_events)
};
...
static const uint8_t voice_dial_call_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, rtt_mode) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, rtt_mode_valid)),
  0x23,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, rtt_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, origination_number) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, origination_number_valid)),
  0x24,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, origination_number),
  QMI_VOICE_NUMBER_MAX_V02,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, is_secondary) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, is_secondary_valid)),
  0x25,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, is_secondary),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, is_trn_avail) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, is_trn_avail_valid)),
  0x26,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, is_trn_avail),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_type) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_type_valid)),
  0x27,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, ip_caller_info_content_type),
  QMI_VOICE_IP_CALLER_INFO_CONTENT_TYPE_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_type) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_type_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_valid)),
  0x28,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, ip_caller_info),
  QMI_VOICE_IP_CALLER_INFO_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_failure_mode) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_failure_mode_valid)),
  0x29,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_failure_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_failure_reason) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_failure_reason_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_failure_reason)
};
...
static const uint8_t voice_get_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, rtt_mode) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, rtt_mode_valid)),
  0x28,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, rtt_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, alternate_sip_uri) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, alternate_sip_uri_valid)),
  0x29,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, alternate_sip_uri),
  QMI_VOICE_SIP_URI_MAX_V02
};
...
static const uint8_t voice_all_call_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, rtt_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, rtt_capabilities_info_valid)),
  0x39,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, alternate_sip_uris) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, alternate_sip_uris_valid)),
  0x3A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, alternate_sip_uris),
  QMI_VOICE_ALTERNATE_SIP_URI_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, alternate_sip_uris) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, alternate_sip_uris_len),
  QMI_IDL_TYPE88(0, 46),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_alert_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_alert_info_valid)),
  0x3B,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, ip_alert_info),
  QMI_VOICE_IP_ALERT_INFO_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_alert_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_alert_info_len),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, terminating_num) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, terminating_num_valid)),
  0x3C,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, terminating_num),
  QMI_VOICE_TERMINATING_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, terminating_num) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, terminating_num_len),
  QMI_IDL_TYPE88(0, 42),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, is_secondary) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, is_secondary_valid)),
  0x3D,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, is_secondary),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, mt_call_verstat) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, mt_call_verstat_valid)),
  0x3E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, mt_call_verstat),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, mt_call_verstat) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, mt_call_verstat_len),
  QMI_IDL_TYPE88(0, 95),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, emerg_srv_categ) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, emerg_srv_categ_valid)),
  0x3F,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, emerg_srv_categ),
  QMI_VOICE_EMERG_SRV_CATEG_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, emerg_srv_categ) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, emerg_srv_categ_len),
  QMI_IDL_TYPE88(0, 96),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, is_nw_end_unwanted_call) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, is_nw_end_unwanted_call_valid)),
  0x40,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, is_nw_end_unwanted_call),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, is_nw_end_unwanted_call) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, is_nw_end_unwanted_call_len),
  QMI_IDL_TYPE88(0, 97),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, tir_mode) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, tir_mode_valid)),
  0x41,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, tir_mode),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, tir_mode) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, tir_mode_len),
  QMI_IDL_TYPE88(0, 98)
};
...
static const uint8_t voice_get_all_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, rtt_mode) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, rtt_mode_valid)),
  0x2E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, rtt_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, rtt_capabilities_info_valid)),
  0x2F,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, rtt_capabilities_info),
  QMI_VOICE_RTT_MODE_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, rtt_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, rtt_capabilities_info_len),
  QMI_IDL_TYPE88(0, 63),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris_valid)),
  0x30,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris),
  QMI_VOICE_ALTERNATE_SIP_URI_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris_len),
  QMI_IDL_TYPE88(0, 46)
};
...
static const uint8_t voice_get_call_waiting_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_waiting_resp_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_waiting_resp_msg_v02, sip_error_code_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_waiting_resp_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_waiting_resp_msg_v02, cw_response) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_waiting_resp_msg_v02, cw_response_valid)),
  0x1A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_waiting_resp_msg_v02, cw_response),
  QMI_IDL_TYPE88(0, 73)
};
...
static const uint8_t voice_orig_ussd_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_orig_ussd_req_msg_v02, secondary_number) - QMI_IDL_OFFSET8(voice_orig_ussd_req_msg_v02, secondary_number_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_orig_ussd_req_msg_v02, secondary_number),
  QMI_VOICE_NUMBER_MAX_V02,

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_req_msg_v02, is_secondary) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_req_msg_v02, is_secondary_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_req_msg_v02, is_secondary)
};
...
static const uint8_t voice_orig_ussd_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, sip_error_code_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_resp_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, secondary_number) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, secondary_number_valid)),
  0x19,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_resp_msg_v02, secondary_number),
  QMI_VOICE_NUMBER_MAX_V02,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, is_secondary) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, is_secondary_valid)),
  0x1A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_resp_msg_v02, is_secondary),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, ussd_error_description) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, ussd_error_description_valid)),
  0x1B,
  ...
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_resp_msg_v02, ussd_error_description),
  QMI_VOICE_USS_DATA_MAX_V02
};
...
static const uint8_t voice_ussd_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, sip_error_code_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_ussd_ind_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, ussd_error_description) - QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, ussd_error_description_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_ussd_ind_msg_v02, ussd_error_description),
  QMI_VOICE_USS_DATA_MAX_V02
};
...
static const uint8_t voice_manage_ip_calls_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, rtt_mode) - QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, rtt_mode_valid)),
  0x1A,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, rtt_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, is_secure_call) - QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, is_secure_call_valid)),
  0x1B,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, is_secure_call),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, speech_codec_mask) - QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, speech_codec_mask_valid)),
  0x1C,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, speech_codec_mask),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, priority_speech_codec) - QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, priority_speech_codec_valid)),
  0x1D,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_manage_ip_calls_req_msg_v02, priority_speech_codec)
};
...
static const uint8_t voice_modified_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, rtt_capabilities) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, rtt_capabilities_valid)),
  0x1A,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, rtt_capabilities),
  QMI_IDL_TYPE88(0, 62),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, is_secure_call) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, is_secure_call_valid)),
  0x1B,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, is_secure_call)
};
...
static const uint8_t voice_modify_accept_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, rtt_mode) - QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, rtt_mode_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, rtt_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, is_secure_call) - QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, is_secure_call_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, is_secure_call)
};
...
static const uint8_t voice_avoid_plmn_list_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_avoid_plmn_list_req_msg_v02, list_to_avoid),
  QMI_VOICE_AVOID_PLMN_LIST_MAX_LENGTH_V02,
  QMI_IDL_OFFSET8(voice_avoid_plmn_list_req_msg_v02, list_to_avoid) - QMI_IDL_OFFSET8(voice_avoid_plmn_list_req_msg_v02, list_to_avoid_len),
  QMI_IDL_TYPE88(3, 0)
};

static const uint8_t voice_avoid_plmn_list_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_avoid_plmn_list_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const uint8_t voice_set_ecall_oprt_mode_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_oprt_mode_req_msg_v02, oprt_mode)
};

static const uint8_t voice_set_ecall_oprt_mode_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_ecall_oprt_mode_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t voice_ecall_oprt_mode_ind_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_oprt_mode_ind_msg_v02, oprt_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_oprt_mode_ind_msg_v02, reason)
};

/*
 * voice_get_ecall_oprt_mode_req_msg is empty
 * static const uint8_t voice_get_ecall_oprt_mode_req_msg_data_v02[] = {
 * };
 */

static const uint8_t voice_get_ecall_oprt_mode_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_get_ecall_oprt_mode_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_oprt_mode_resp_msg_v02, oprt_mode) - QMI_IDL_OFFSET8(voice_get_ecall_oprt_mode_resp_msg_v02, oprt_mode_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_oprt_mode_resp_msg_v02, oprt_mode)
};
...
static const uint8_t voice_ims_call_cancel_req_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ims_call_cancel_req_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_ims_call_cancel_req_msg_v02, cancel_type)
};

static const uint8_t voice_ims_call_cancel_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_ims_call_cancel_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  0x03,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ims_call_cancel_resp_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x04,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_ims_call_cancel_resp_msg_v02, cancel_type)
};

static const uint8_t auto_rejected_incoming_call_end_ind_msg_data_v02[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_type),

  0x02,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_end_reason),

  0x03,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, num) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, num_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, num),
  QMI_VOICE_CALLER_ID_MAX_V02,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, num) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, num_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, mt_call_verstat_info) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, mt_call_verstat_info_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, mt_call_verstat_info)
};

static const uint8_t voice_ip_caller_info_status_ind_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ip_caller_info_status_ind_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ip_caller_info_status_ind_msg_v02, caller_info_tx_succeeded) - QMI_IDL_OFFSET8(voice_ip_caller_info_status_ind_msg_v02, caller_info_tx_succeeded_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ip_caller_info_status_ind_msg_v02, caller_info_tx_succeeded)
};

static const uint8_t voice_set_all_call_fwd_sups_req_msg_data_v02[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, voice_service),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, number) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, number_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, number),
  QMI_VOICE_NUMBER_MAX_V02,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, service_class) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, service_class_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, service_class),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, timer_value) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, timer_value_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, timer_value),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, num_type_plan) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, num_type_plan_valid)),
  0x13,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, num_type_plan),
  QMI_IDL_TYPE88(0, 68),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, call_fwd_start_time) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, call_fwd_start_time_valid)),
  0x14,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, call_fwd_start_time),
  QMI_IDL_TYPE88(0, 71),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, call_fwd_end_time) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, call_fwd_end_time_valid)),
  0x15,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, call_fwd_end_time),
  QMI_IDL_TYPE88(0, 71),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, reason) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, reason_valid)),
  0x16,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_req_msg_v02, reason)
};

static const uint8_t voice_set_all_call_fwd_sups_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, failure_cause) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, failure_cause_valid)),
  0x10,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, failure_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, failure_cause_description) - QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, failure_cause_description_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |  QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  QMI_IDL_OFFSET8(voice_set_all_call_fwd_sups_resp_msg_v02, failure_cause_description),
  ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, sip_error_code_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_result) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_result_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_failure_cause) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_failure_cause_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_failure_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_failure_cause_description) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_failure_cause_description_valid)),
  0x15,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |  QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_failure_cause_description),
  ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_retry_duration) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_retry_duration_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_retry_duration),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_sip_error_code_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfu_sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_result) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_result_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_failure_cause) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_failure_cause_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_failure_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_failure_cause_description) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_failure_cause_description_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |  QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_failure_cause_description),
  ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_retry_duration) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_retry_duration_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_retry_duration),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_sip_error_code_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfb_sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_result) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_result_valid)),
  0x1D,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_failure_cause) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_failure_cause_valid)),
  0x1E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_failure_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_failure_cause_description) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_failure_cause_description_valid)),
  0x1F,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |  QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_failure_cause_description),
  ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_retry_duration) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_retry_duration_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_retry_duration),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_sip_error_code_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnry_sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_result) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_result_valid)),
  0x22,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_failure_cause) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_failure_cause_valid)),
  0x23,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_failure_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_failure_cause_description) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_failure_cause_description_valid)),
  0x24,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |  QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_failure_cause_description),
  ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_retry_duration) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_retry_duration_valid)),
  0x25,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_retry_duration),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_sip_error_code_valid)),
  0x26,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cfnrc_sip_error_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, alpha_ident) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, alpha_ident_valid)),
  0x27,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, alpha_ident),
  QMI_IDL_TYPE88(0, 7),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cc_result_type) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cc_result_type_valid)),
  0x28,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cc_result_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, call_id) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, call_id_valid)),
  0x29,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cc_sups_result) - QMI_IDL_OFFSET16RELATIVE(voice_set_all_call_fwd_sups_resp_msg_v02, cc_sups_result_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_set_all_call_fwd_sups_resp_msg_v02, cc_sups_result),
  QMI_IDL_TYPE88(0, 8)
};

static const uint8_t voice_ecall_hlap_timer_status_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t2_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t2_timer_status_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t2_timer_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t5_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t5_timer_status_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t5_timer_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t6_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t6_timer_status_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t6_timer_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t7_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t7_timer_status_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t7_timer_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t9_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t9_timer_status_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t9_timer_status)
};

/*
 * voice_get_ecall_hlap_timer_status_req_msg is empty
 * static const uint8_t voice_get_ecall_hlap_timer_status_req_msg_data_v02[] = {
 * };
 */

static const uint8_t voice_get_ecall_hlap_timer_status_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t2_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t2_timer_status_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t2_timer_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t5_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t5_timer_status_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t5_timer_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t6_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t6_timer_status_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t6_timer_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t7_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t7_timer_status_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t7_timer_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t9_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t9_timer_status_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t9_timer_status)
};

static const uint8_t voice_ecall_era_glonass_enabled_status_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_era_glonass_enabled_status_ind_msg_v02, is_era_glonass_enabled)
};

/*
 * voice_get_ecall_era_glonass_enabled_status_req_msg is empty
 * static const uint8_t voice_get_ecall_era_glonass_enabled_status_req_msg_data_v02[] = {
 * };
 */

static const uint8_t voice_get_ecall_era_glonass_enabled_status_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_get_ecall_era_glonass_enabled_status_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_era_glonass_enabled_status_resp_msg_v02, is_era_glonass_enabled) - QMI_IDL_OFFSET8(voice_get_ecall_era_glonass_enabled_status_resp_msg_v02, is_era_glonass_enabled_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_era_glonass_enabled_status_resp_msg_v02, is_era_glonass_enabled)
};
...
static const qmi_idl_type_table_entry  voice_type_table_v02[] = {
  ...
  {sizeof(voice_ip_alert_info_type_v02), voice_ip_alert_info_type_data_v02},
  ...
  {sizeof(voice_cw_response_type_v02), voice_cw_response_type_data_v02},
  ...
  {sizeof(voice_MT_call_received_verstat_type_v02), voice_MT_call_received_verstat_type_data_v02},
  {sizeof(voice_MT_call_verstat_with_id_type_v02), voice_MT_call_verstat_with_id_type_data_v02},
  {sizeof(voice_emerg_srv_categ_type_v02), voice_emerg_srv_categ_type_data_v02},
  {sizeof(voice_nw_end_unwanted_call_type_v02), voice_nw_end_unwanted_call_type_data_v02},
  {sizeof(voice_tir_mode_type_v02), voice_tir_mode_type_data_v02}
};
...
static const qmi_idl_message_table_entry voice_message_table_v02[] = {
  ...
  {sizeof(voice_avoid_plmn_list_req_msg_v02), voice_avoid_plmn_list_req_msg_data_v02},
  {sizeof(voice_avoid_plmn_list_resp_msg_v02), voice_avoid_plmn_list_resp_msg_data_v02},
  {sizeof(voice_ecall_status_ind_msg_v02), voice_ecall_status_ind_msg_data_v02},
  {sizeof(voice_set_ecall_oprt_mode_req_msg_v02), voice_set_ecall_oprt_mode_req_msg_data_v02},
  {sizeof(voice_set_ecall_oprt_mode_resp_msg_v02), voice_set_ecall_oprt_mode_resp_msg_data_v02},
  {sizeof(voice_ecall_oprt_mode_ind_msg_v02), voice_ecall_oprt_mode_ind_msg_data_v02},
  {sizeof(voice_get_ecall_oprt_mode_req_msg_v02), 0},
  {sizeof(voice_get_ecall_oprt_mode_resp_msg_v02), voice_get_ecall_oprt_mode_resp_msg_data_v02},
  ...
  {sizeof(voice_ims_call_cancel_req_msg_v02), voice_ims_call_cancel_req_msg_data_v02},
  {sizeof(voice_ims_call_cancel_resp_msg_v02), voice_ims_call_cancel_resp_msg_data_v02},
  {sizeof(auto_rejected_incoming_call_end_ind_msg_v02), auto_rejected_incoming_call_end_ind_msg_data_v02},
  {sizeof(voice_ip_caller_info_status_ind_msg_v02), voice_ip_caller_info_status_ind_msg_data_v02},
  {sizeof(voice_set_all_call_fwd_sups_req_msg_v02), voice_set_all_call_fwd_sups_req_msg_data_v02},
  {sizeof(voice_set_all_call_fwd_sups_resp_msg_v02), voice_set_all_call_fwd_sups_resp_msg_data_v02},
  {sizeof(voice_ecall_hlap_timer_status_ind_msg_v02), voice_ecall_hlap_timer_status_ind_msg_data_v02},
  {sizeof(voice_get_ecall_hlap_timer_status_req_msg_v02), 0},
  {sizeof(voice_get_ecall_hlap_timer_status_resp_msg_v02), voice_get_ecall_hlap_timer_status_resp_msg_data_v02},
  {sizeof(voice_ecall_era_glonass_enabled_status_ind_msg_v02), voice_ecall_era_glonass_enabled_status_ind_msg_data_v02},
  {sizeof(voice_get_ecall_era_glonass_enabled_status_req_msg_v02), 0},
  {sizeof(voice_get_ecall_era_glonass_enabled_status_resp_msg_v02), voice_get_ecall_era_glonass_enabled_status_resp_msg_data_v02}
};
...
{&voice_qmi_idl_type_table_object_v02, &common_qmi_idl_type_table_object_v01, &voice_service_common_qmi_idl_type_table_object_v02, &voice_nas_services_common_qmi_idl_type_table_object_v01};
...
static const qmi_idl_service_message_table_entry voice_service_command_messages_v02[] = {
  ...
  {QMI_VOICE_ORIG_USSD_REQ_V02, QMI_IDL_TYPE16(0, 44), 275},
  ...
  {QMI_VOICE_MANAGE_IP_CALLS_REQ_V02, QMI_IDL_TYPE16(0, 80), 224},
  ...
  {QMI_VOICE_GET_SPEECH_CODEC_INFO_REQ_V02, QMI_IDL_TYPE16(0, 128), 4},
  {QMI_VOICE_IMS_CALL_CANCEL_REQ_V02, QMI_IDL_TYPE16(0, 130), 8},
  {QMI_VOICE_AVOID_PLMN_LIST_REQ_V02, QMI_IDL_TYPE16(0, 118), 44},
  {QMI_VOICE_SET_ECALL_OPRT_MODE_REQ_V02, QMI_IDL_TYPE16(0, 121), 7},
  {QMI_VOICE_GET_ECALL_OPRT_MODE_REQ_V02, QMI_IDL_TYPE16(0, 124), 0},
  {QMI_VOICE_SET_ALL_CALL_FWD_SUPS_REQ_V02, QMI_IDL_TYPE16(0, 134), 133},
  {QMI_VOICE_GET_ECALL_HLAP_TIMER_STATUS_REQ_V02, QMI_IDL_TYPE16(0, 137), 0},
  {QMI_VOICE_GET_ECALL_ERA_GLONASS_ENABLED_STATUS_REQ_V02, QMI_IDL_TYPE16(0, 140), 0}
};
...
static const qmi_idl_service_message_table_entry voice_service_response_messages_v02[] = {
  ...
  {QMI_VOICE_GET_CALL_INFO_RESP_V02, QMI_IDL_TYPE16(0, 9), 2961},
  ...
  {QMI_VOICE_GET_ALL_CALL_INFO_RESP_V02, QMI_IDL_TYPE16(0, 26), 21709},
  {QMI_VOICE_MANAGE_CALLS_RESP_V02, QMI_IDL_TYPE16(0, 28), 12},
  {QMI_VOICE_SET_SUPS_SERVICE_RESP_V02, QMI_IDL_TYPE16(0, 31), 744},
  {QMI_VOICE_GET_CALL_WAITING_RESP_V02, QMI_IDL_TYPE16(0, 33), 755},
  ...
  {QMI_VOICE_ORIG_USSD_RESP_V02, QMI_IDL_TYPE16(0, 45), 1744},
  ...
  {QMI_VOICE_GET_SPEECH_CODEC_INFO_RESP_V02, QMI_IDL_TYPE16(0, 129), 32},
  {QMI_VOICE_IMS_CALL_CANCEL_RESP_V02, QMI_IDL_TYPE16(0, 131), 15},
  {QMI_VOICE_AVOID_PLMN_LIST_RESP_V02, QMI_IDL_TYPE16(0, 119), 7},
  {QMI_VOICE_SET_ECALL_OPRT_MODE_RESP_V02, QMI_IDL_TYPE16(0, 122), 7},
  {QMI_VOICE_GET_ECALL_OPRT_MODE_RESP_V02, QMI_IDL_TYPE16(0, 125), 14},
  {QMI_VOICE_SET_ALL_CALL_FWD_SUPS_RESP_V02, QMI_IDL_TYPE16(0, 135), 2872},
  {QMI_VOICE_GET_ECALL_HLAP_TIMER_STATUS_RESP_V02, QMI_IDL_TYPE16(0, 138), 42},
  {QMI_VOICE_GET_ECALL_ERA_GLONASS_ENABLED_STATUS_RESP_V02, QMI_IDL_TYPE16(0, 141), 11}
};
...
static const qmi_idl_service_message_table_entry voice_service_indication_messages_v02[] = {
  ...
  {QMI_VOICE_MODIFIED_IND_V02, QMI_IDL_TYPE16(0, 86), 129},
  {QMI_VOICE_MODIFY_ACCEPT_IND_V02, QMI_IDL_TYPE16(0, 87), 41},
  ...
  {QMI_VOICE_ECALL_STATUS_IND_V02, QMI_IDL_TYPE16(0, 120), 11},
  {QMI_VOICE_CALL_REESTABLISHMENT_STATUS_IND_V02, QMI_IDL_TYPE16(0, 126), 7},
  {QMI_VOICE_VICE_DIALOG_INFO_IND_V02, QMI_IDL_TYPE16(0, 127), 2067},
  {QMI_VOICE_ECALL_OPRT_MODE_IND_V02, QMI_IDL_TYPE16(0, 123), 14},
  {QMI_AUTO_REJECTED_INCOMING_CALL_END_IND_V02, QMI_IDL_TYPE16(0, 132), 106},
  {QMI_VOICE_IP_CALLER_INFO_STATUS_IND_V02, QMI_IDL_TYPE16(0, 133), 8},
  {QMI_VOICE_ECALL_HLAP_TIMER_STATUS_IND_V02, QMI_IDL_TYPE16(0, 136), 35},
  {QMI_VOICE_ECALL_ERA_GLONASS_ENABLED_STATUS_IND_V02, QMI_IDL_TYPE16(0, 139), 4}
};
