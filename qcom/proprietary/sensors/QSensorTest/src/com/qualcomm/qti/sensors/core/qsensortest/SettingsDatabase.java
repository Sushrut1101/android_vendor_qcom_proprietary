...
public class SettingsDatabase extends Object {
  ...
  static public SettingsDatabase getSettings(){
    if(null == SettingsDatabase.settings)
      SettingsDatabase.settings = new SettingsDatabase(QSensorContext.getContext());
    ...
    for(int i = 0; i < 2; i++){
      ...
      if(resultCursor.moveToFirst()){
        sensorSetting = new SensorSetting(
            ...
            TriggerMode.values()[resultCursor.getInt(5)],
            resultCursor.getString(6).contentEquals("true"),
  ...
  private class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    private void populateFragmentTable(SQLiteDatabase db){
      String[][] fragments = new String[][]{
          ...
          new String[]{this.resources.getResourceEntryName(R.string.fragment_name_graph), "0"},
          new String[]{this.resources.getResourceEntryName(R.string.fragment_name_low_lat), "1"}
      };
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      Log.w(QSensorContext.TAG, "Upgrading database from version "
