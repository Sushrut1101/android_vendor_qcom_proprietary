...
{
    // TODO phase 2: make class, add default Move Cnstr and assignment operator
    struct RawLogLine
    {
        ...
        explicit  RawLogLine(missing_log_lines_reason missingLogLinesReason, unsigned numOfMissingLogLines=0) :
            m_strOffset(0),
            m_module(0),
            m_level(0),
            m_isString(0),
