/******************************************************************************
  @file framework/hidl_gen/ims/vendor/qti/hardware/radio/ims/1.1/ImsRadioAll.cpp
  DESCRIPTION
  ---------------------------------------------------------------------------
...
std::string toString(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>& o) {
    std::string os = "[class or subclass of ";
    os += ::vendor::qti::hardware::radio::ims::V1_1::IImsRadio::descriptor;
    os += "]";
    os += o->isRemote() ? "@remote" : "@local";
    return os;
}

const char* IImsRadio::descriptor("vendor.qti.hardware.radio.ims@1.1::IImsRadio");
...
// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>& parent, bool /* emitError */) {
    return parent;
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadio>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio *>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>> mHidlServices;
// static
...
::android::status_t IImsRadio::registerAsService(const std::string &serviceName) {
    ...
    ::vendor::qti::hardware::radio::ims::V1_0::IImsRadio::registerAsService(serviceName);
    return ::android::OK;
}
