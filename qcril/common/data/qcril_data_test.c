...
/*===========================================================================
  ...
  Copyright (c) 2011 - 2012, 2018 Qualcomm Technologies, Inc. All Rights Reserved
...
int qcril_data_test_qos_create_umts_failure2( void* arg )
{
  ...
  asprintf( &call_resp.qos_resp.setup.return_code, "%d", RIL_E_INTERNAL_ERR );
...
int qcril_data_test_qos_getstatus_failure1( void* arg )
{
  ...
  asprintf( &call_resp.qos_resp.get_status.return_code, "%d", RIL_E_INTERNAL_ERR );
