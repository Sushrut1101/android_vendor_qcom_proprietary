...
#define QCRIL_MAX_LOG_MSG_SIZE                1024
...
void qcril_default_request_resp_params_ex( qcril_instance_id_e_type instance_id, RIL_Token t, int request, RIL_Errno err_no,
                                       qcril_request_resp_params_type *param_ptr );
