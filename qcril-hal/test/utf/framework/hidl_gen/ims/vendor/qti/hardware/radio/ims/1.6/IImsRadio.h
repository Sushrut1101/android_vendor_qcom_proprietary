...
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_6_IIMSRADIO_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_6_IIMSRADIO_H

#include <vendor/qti/hardware/radio/ims/1.0/types.h>
#include <vendor/qti/hardware/radio/ims/1.5/IImsRadio.h>
...
struct IImsRadio : public ::vendor::qti::hardware::radio::ims::V1_5::IImsRadio {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.radio.ims@1.6::IImsRadio"
     */
     ...
     *
     */
    virtual ::android::hardware::Return<void> setConfig_1_6(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_6::ConfigInfo& config) = 0;

    /**
     * MessageId..REQUEST_IMS_SET_SERVICE_STATUS
     *
     * @param token Id to match request/response. Response must include same token.
     * @param srvStatusInfo_1_6 New service state requested.
     *
     */
    virtual ::android::hardware::Return<void> setServiceStatus_1_6(int32_t token, const ::android::hardware::hidl_vec<::vendor::qti::hardware::radio::ims::V1_6::ServiceStatusInfo>& srvStatusInfoList) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> suppServiceStatus_1_6(int32_t token, int32_t operationType, ::vendor::qti::hardware::radio::ims::V1_0::FacilityType facilityType, const ::vendor::qti::hardware::radio::ims::V1_0::CbNumListInfo& cbNumListInfo, const ::android::hardware::hidl_string& password) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>& o) {
    ...
    os += ::vendor::qti::hardware::radio::ims::V1_6::IImsRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_6_IIMSRADIO_H
