...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.0.c1/Main/modem_proc/qmimsgs/csvt/api/circuit_switched_video_telephony_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.7 
   It was generated on: Fri Apr 25 2014 (Spin 1)
...
typedef struct {
  ...
  /**<   Instance ID of the underlying Circuit-Switched Data (CSD) call. */

  /* Mandatory */
  /*  Event Type */
  csvt_event_type_enum_v01 event_type;
  /**<   List of CSD call events. Values: \n
       - 0x01 -- Call confirmation \n
       - 0x02 -- Call progress notification \n
       - 0x03 -- Call connect notification \n
       - 0x04 -- Call setup notification \n
       - 0x05 -- Incoming call \n
       - 0x06 -- Call end \n
  ...
  */
  ...
  /**<   Call type. Values: \n
       - 0x01 -- Asynchronous CSVT \n
       - 0x02 -- Synchronous CSVT \n
       - 0x08 -- Videotelephony 
  */
  ...
  /**<   Whether the call is synchronous. Values:  \n
  ...
  /**<   Transparency of the call. Values:  \n
  ...
  */
  ...
  /**<   Network speed (refer to \hyperref[S1]{[S1]} Section 6.7).
  */
  ...
  */
  ...
  /**<   Subsequent call modification. Values: \n
       - 0x00 -- Modification is not allowed \n
       - 0x01 -- Modification is allowed
  */
  ...
  /**<   Call end cause (refer to \hyperref[S2]{[S2]}).
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Network data rate (refer to \hyperref[S1]{[S1]} Section 6.7). \n
  ...
  */
  ...
  /**<   Air interface data rate (refer to \hyperref[S1]{[S1]} Section 6.7). \n
       Default value is 64 kbps.
  */
  ...
  */
  ...
  uint8_t cug_index;
  /**<   CUG index (refer to \hyperref[S1]{[S1]} Section 7.10). \n
       Default value is 0.
  */
  ...
  /**<   Whether to suppress preferred CUG. Values: \n
  ...
  */
  ...
  /**<   Whether to suppress outgoing access. Values: \n
...
typedef struct {
  ...
  */
  ...
  /**<   Whether to confirm the call. Values: \n
  ...
  */
  ...
  /**<   Reject value call control cause as defined 
       in \hyperref[S2]{[S2]} Table 10.5.123.
  */
...
typedef struct {
  ...
  */
  ...
  /*  Answer Call */
  uint8_t answer_call;
  /**<   Whether to answer the call. Values: \n
       - 0x00 -- Reject the call \n
...
typedef struct {
  ...
  */
  ...
  /**<   Whether to accept the request. Values: \n
...
typedef struct {
  ...
  /**<   Direction to enable the compression. Values: \n
...
typedef struct {
  ...
  /**<   Instance IDs of the active calls.
  */
...
typedef struct {
  ...
  uint8_t call_active;
  /**<   Whether the call is active. Values: \n
...
/** @addtogroup csvt_qmi_messages
    @{
  */
/** Request Message; Associates the requesting control point to the requested subscription. */
typedef struct {

  /* Mandatory */
  /*  Bind Subscription */
  csvt_bind_subscription_enum_v01 bind_subs;
  /**<   Subscription to bind. Values: \n
...
/** @addtogroup csvt_qmi_messages
    @{
  */
/** Response Message; Associates the requesting control point to the requested subscription. */
typedef struct {
...
/** @addtogroup csvt_qmi_messages
    @{
  */
/** Response Message; Queries the control point's bound subscription. */
typedef struct {
