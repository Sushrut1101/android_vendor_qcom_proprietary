...
public class SensorCalUtils {
    ...
    public static String calibrateSensor(Sensor sensor, int testType) {
        ...
        try {
            ISensorsCalibrate iSensorsCalibrate = ISensorsCalibrate.getService(true);
            return iSensorsCalibrate.SensorsCal(sensor.getType(), (byte) testType);
        } catch (Exception e) {
    ...
    public static String calibrateSensorByReflect(Sensor sensor, int testType) {
