...
#define LOG_TAG "vendor.qti.hardware.radio.ims@1.5::ImsRadioIndication"
...
const char* IImsRadioIndication::descriptor("vendor.qti.hardware.radio.ims@1.5::IImsRadioIndication");
...
// no default implementation for: ::android::hardware::Return<void> IImsRadioIndication::onUssdMessageFailed(::vendor::qti::hardware::radio::ims::V1_5::UssdModeType type, const ::vendor::qti::hardware::radio::ims::V1_0::SipErrorInfo& errorDetails)
...
::android::hardware::Return<void> IImsRadioIndication::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioIndication *>(parent.get()));
}
