...
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.0::QtiRadioResponse"
...
const char* IQtiRadioResponse::descriptor("vendor.qti.hardware.radio.qtiradio@2.0::IQtiRadioResponse");
...
// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>& parent, bool /* emitError */) {
    return parent;
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadioResponse>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse*>(parent.get()));
}
