...
Copyright (c) 2002-2009,2014-2015,2018 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
RETURN VALUE
  A pointer to the next item on the queue if the queue is not NULL. If the end of the queue is reached,
