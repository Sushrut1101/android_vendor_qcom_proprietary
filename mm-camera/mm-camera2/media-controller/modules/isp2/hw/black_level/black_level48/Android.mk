#======================================================================
#makefile for libmmcamera2_isp2_black_level48.so form mm-camera2
#======================================================================
...
LOCAL_SRC_FILES        := module_black_level48.c \
                          black_level48.c
LOCAL_MODULE           := libmmcamera_isp_black_level48
ifeq ($(OEM_CHROMATIX), true)
LOCAL_C_INCLUDES += $(LOCAL_EXTEN_ISP_INCLUDES)
LOCAL_SRC_FILES += ../../../../../../../../mm-camera-ext/mm-camera2/media-controller/modules/isp2/black_level48_ext.c
