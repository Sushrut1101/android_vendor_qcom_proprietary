 ...
 .sensor_native_pattern_info =
 {
  /* Res 0 */
  {
   .block_pattern = {
    ...
    .pix_coords =
    {
     {2, 14, PDAF_RIGHT_PIXEL,},
     {10, 2, PDAF_RIGHT_PIXEL,},
     {18, 14, PDAF_RIGHT_PIXEL,},
     {26, 2, PDAF_RIGHT_PIXEL,},
     {2, 30, PDAF_RIGHT_PIXEL,},
     {10, 18, PDAF_RIGHT_PIXEL,},
     {18, 30, PDAF_RIGHT_PIXEL,},
     {26, 18, PDAF_RIGHT_PIXEL,},
     {2, 10, PDAF_LEFT_PIXEL,},
     {10, 6, PDAF_LEFT_PIXEL,},
     {18, 10, PDAF_LEFT_PIXEL,},
     {26, 6, PDAF_LEFT_PIXEL,},
     {2, 26, PDAF_LEFT_PIXEL,},
     {10, 22, PDAF_LEFT_PIXEL,},
     {18, 26, PDAF_LEFT_PIXEL,},
     {26, 22, PDAF_LEFT_PIXEL,},
    },
   },
