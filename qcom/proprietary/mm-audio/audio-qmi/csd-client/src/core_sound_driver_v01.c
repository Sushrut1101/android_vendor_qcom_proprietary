...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2011-2014, 2017, 2019 Qualcomm Technologies, Inc.
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.


  $Header: //components/rel/qmimsgs.apss.tn/3.7/csd/src/core_sound_driver_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.6
   It was generated on: Tue Aug  4 2015 (Spin 1)
...
static const uint8_t qmi_csd_vm_ioctl_set_hdvoice_mode_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_vm_ioctl_set_hdvoice_mode_v01, cmd_token),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_vm_ioctl_set_hdvoice_mode_v01, mode),
...
static const uint8_t qmi_csd_device_info_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_device_info_v01, dev_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_device_info_v01, sample_rate),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_device_info_v01, bits_per_sample),
...
static const uint8_t qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_req_msg_v01, handle),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_req_msg_v01, qmi_csd_vm_ioctl_set_hdvoice_mode_payload),
  QMI_IDL_TYPE88(0, 51)
};

static const uint8_t qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, handle) - QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, handle_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, handle),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, cmd_token) - QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, cmd_token_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, cmd_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, qmi_csd_status_code) - QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, qmi_csd_status_code_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01, qmi_csd_status_code)
};
...
static const uint8_t qmi_csd_common_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, cmd_token) - QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, cmd_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, cmd_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, qmi_csd_status_code) - QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, qmi_csd_status_code_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_common_resp_msg_v01, qmi_csd_status_code)
};

static const uint8_t qmi_csd_voice_config_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_config_req_msg_v01, cmd_token),

  0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(qmi_csd_voice_config_req_msg_v01, session_id),
  SESSION_NAME_MAX_LEN_V01,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_config_req_msg_v01, tx_device_info) - QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_config_req_msg_v01, tx_device_info_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qmi_csd_voice_config_req_msg_v01, tx_device_info),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_config_req_msg_v01, rx_device_info) - QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_config_req_msg_v01, rx_device_info_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qmi_csd_voice_config_req_msg_v01, rx_device_info),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_config_req_msg_v01, ec_ref_device_info) - QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_config_req_msg_v01, ec_ref_device_info_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qmi_csd_voice_config_req_msg_v01, ec_ref_device_info),
  QMI_IDL_TYPE88(0, 64)
};

static const uint8_t qmi_csd_voice_start_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_start_req_msg_v01, cmd_token),

  0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(qmi_csd_voice_start_req_msg_v01, session_id),
  SESSION_NAME_MAX_LEN_V01,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_start_req_msg_v01, tx_device_info) - QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_start_req_msg_v01, tx_device_info_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qmi_csd_voice_start_req_msg_v01, tx_device_info),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_start_req_msg_v01, rx_device_info) - QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_start_req_msg_v01, rx_device_info_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qmi_csd_voice_start_req_msg_v01, rx_device_info),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_start_req_msg_v01, ec_ref_device_info) - QMI_IDL_OFFSET16RELATIVE(qmi_csd_voice_start_req_msg_v01, ec_ref_device_info_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(qmi_csd_voice_start_req_msg_v01, ec_ref_device_info),
  QMI_IDL_TYPE88(0, 64)
};

static const uint8_t qmi_csd_voice_end_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_end_req_msg_v01, cmd_token)
};

static const uint8_t qmi_csd_voice_device_switch_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_device_switch_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_voice_device_switch_req_msg_v01, tx_device_info),
  QMI_IDL_TYPE88(0, 64),

  0x03,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_voice_device_switch_req_msg_v01, rx_device_info),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_voice_device_switch_req_msg_v01, ec_ref_device_info) - QMI_IDL_OFFSET8(qmi_csd_voice_device_switch_req_msg_v01, ec_ref_device_info_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_voice_device_switch_req_msg_v01, ec_ref_device_info),
  QMI_IDL_TYPE88(0, 64)
};

static const uint8_t qmi_csd_afe_loopback_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_afe_loopback_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_afe_loopback_req_msg_v01, enable),

  0x03,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_afe_loopback_req_msg_v01, tx_device_info),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x04,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_afe_loopback_req_msg_v01, rx_device_info),
  QMI_IDL_TYPE88(0, 64)
};

static const uint8_t qmi_csd_voice_volume_control_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_volume_control_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_volume_control_req_msg_v01, volume_index),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_volume_control_req_msg_v01, ramp_duration_in_ms)
};

static const uint8_t qmi_csd_voice_mute_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_mute_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_mute_req_msg_v01, mode),

  0x03,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_mute_req_msg_v01, enable),

  0x04,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_mute_req_msg_v01, direction),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x05,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_mute_req_msg_v01, ramp_duration_in_ms)
};

static const uint8_t qmi_csd_dtmf_generation_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, direction),

  0x03,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, dtmf_duration_in_ms),

  0x04,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, high_frequency),

  0x05,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, low_frequency),

  0x06,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, gain),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, mix_mode) - QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, mix_mode_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, mix_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, device_info) - QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, device_info_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_csd_dtmf_generation_req_msg_v01, device_info),
  QMI_IDL_TYPE88(0, 64)
};

static const uint8_t qmi_csd_voice_dtmf_generation_ended_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_generation_ended_ind_msg_v01, direction)
};

static const uint8_t qmi_csd_voice_dtmf_detection_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_detection_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_detection_req_msg_v01, direction),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_detection_req_msg_v01, enable)
};

static const uint8_t qmi_csd_voice_dtmf_detected_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_detected_ind_msg_v01, direction),

  0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_detected_ind_msg_v01, low_freq),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_dtmf_detected_ind_msg_v01, high_freq)
};

static const uint8_t qmi_csd_set_voice_feature_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, cmd_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, hdvoice_mode) - QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, hdvoice_mode_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, hdvoice_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, slowtalk_mode) - QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, slowtalk_mode_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, slowtalk_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, voice_tty_mode) - QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, voice_tty_mode_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_set_voice_feature_req_msg_v01, voice_tty_mode)
};

static const uint8_t qmi_csd_voice_record_start_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, cmd_token),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, rx_tap_point),

  0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, tx_tap_point),

  0x04,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, device_id) - QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, device_id_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_record_start_req_msg_v01, device_id)
};

static const uint8_t qmi_csd_voice_record_end_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_record_end_req_msg_v01, cmd_token)
};

static const uint8_t qmi_csd_voice_playback_start_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_playback_start_req_msg_v01, cmd_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_csd_voice_playback_start_req_msg_v01, device_id) - QMI_IDL_OFFSET8(qmi_csd_voice_playback_start_req_msg_v01, device_id_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_playback_start_req_msg_v01, device_id)
};

static const uint8_t qmi_csd_voice_playback_end_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_csd_voice_playback_end_req_msg_v01, cmd_token)
};
...
static const qmi_idl_type_table_entry  csd_type_table_v01[] = {
  ...
  {sizeof(qmi_csd_vm_ioctl_set_hdvoice_mode_v01), qmi_csd_vm_ioctl_set_hdvoice_mode_data_v01},
  ...
  {sizeof(qmi_csd_device_info_v01), qmi_csd_device_info_data_v01}
};
...
static const qmi_idl_message_table_entry csd_message_table_v01[] = {
  ...
  {sizeof(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_req_msg_v01), qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_req_msg_data_v01},
  {sizeof(qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01), qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_data_v01},
  ...
  {sizeof(qmi_csd_common_resp_msg_v01), qmi_csd_common_resp_msg_data_v01},
  {sizeof(qmi_csd_voice_config_req_msg_v01), qmi_csd_voice_config_req_msg_data_v01},
  {sizeof(qmi_csd_voice_start_req_msg_v01), qmi_csd_voice_start_req_msg_data_v01},
  {sizeof(qmi_csd_voice_end_req_msg_v01), qmi_csd_voice_end_req_msg_data_v01},
  {sizeof(qmi_csd_voice_device_switch_req_msg_v01), qmi_csd_voice_device_switch_req_msg_data_v01},
  {sizeof(qmi_csd_afe_loopback_req_msg_v01), qmi_csd_afe_loopback_req_msg_data_v01},
  {sizeof(qmi_csd_voice_volume_control_req_msg_v01), qmi_csd_voice_volume_control_req_msg_data_v01},
  {sizeof(qmi_csd_voice_mute_req_msg_v01), qmi_csd_voice_mute_req_msg_data_v01},
  {sizeof(qmi_csd_dtmf_generation_req_msg_v01), qmi_csd_dtmf_generation_req_msg_data_v01},
  {sizeof(qmi_csd_voice_dtmf_generation_ended_ind_msg_v01), qmi_csd_voice_dtmf_generation_ended_ind_msg_data_v01},
  {sizeof(qmi_csd_voice_dtmf_detection_req_msg_v01), qmi_csd_voice_dtmf_detection_req_msg_data_v01},
  {sizeof(qmi_csd_voice_dtmf_detected_ind_msg_v01), qmi_csd_voice_dtmf_detected_ind_msg_data_v01},
  {sizeof(qmi_csd_set_voice_feature_req_msg_v01), qmi_csd_set_voice_feature_req_msg_data_v01},
  {sizeof(qmi_csd_voice_record_start_req_msg_v01), qmi_csd_voice_record_start_req_msg_data_v01},
  {sizeof(qmi_csd_voice_record_end_req_msg_v01), qmi_csd_voice_record_end_req_msg_data_v01},
  {sizeof(qmi_csd_voice_playback_start_req_msg_v01), qmi_csd_voice_playback_start_req_msg_data_v01},
  {sizeof(qmi_csd_voice_playback_end_req_msg_v01), qmi_csd_voice_playback_end_req_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry csd_service_command_messages_v01[] = {
  ...
  {QMI_CSD_IOCTL_DEV_CMD_DISABLE_REQ_V01, QMI_IDL_TYPE16(0, 22), 47},
  {QMI_CSD_IOCTL_DEV_CMD_AFE_LOOPBACK_REQ_V01, QMI_IDL_TYPE16(0, 24), 21},
  {QMI_CSD_IOCTL_DEV_CMD_ANC_CONTROL_REQ_V01, QMI_IDL_TYPE16(0, 28), 15},
  {QMI_CSD_IOCTL_DEV_CMD_COMPANDING_CONTROL_REQ_V01, QMI_IDL_TYPE16(0, 32), 18},
  {QMI_CSD_IOCTL_DEV_CMD_GET_MAX_DEVICE_NUMS_REQ_V01, QMI_IDL_TYPE16(0, 34), 7},
  {QMI_CSD_IOCTL_DEV_CMD_GET_DEV_CAPS_REQ_V01, QMI_IDL_TYPE16(0, 36), 7},
  {QMI_CSD_IOCTL_DEV_CMD_DTMF_CONTROL_REQ_V01, QMI_IDL_TYPE16(0, 38), 1050},
  {QMI_CSD_IOCTL_DEV_CMD_SIDETONE_CONTROL_REQ_V01, QMI_IDL_TYPE16(0, 40), 22},
  {QMI_CSD_IOCTL_DEV_CMD_CONFIGURE_REQ_V01, QMI_IDL_TYPE16(0, 42), 35},
  {QMI_CSD_IOCTL_VC_CMD_SET_DEVICE_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 44), 37},
  {QMI_CSD_IOCTL_VC_CMD_ENABLE_REQ_V01, QMI_IDL_TYPE16(0, 46), 14},
  {QMI_CSD_IOCTL_VC_CMD_DISABLE_REQ_V01, QMI_IDL_TYPE16(0, 48), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_INDEX_REQ_V01, QMI_IDL_TYPE16(0, 50), 18},
  {QMI_CSD_IOCTL_VC_CMD_SET_MUTE_REQ_V01, QMI_IDL_TYPE16(0, 56), 27},
  {QMI_CSD_IOCTL_VC_CMD_SET_TX_DTMF_DETECTION_REQ_V01, QMI_IDL_TYPE16(0, 58), 18},
  {QMI_CSD_IOCTL_VC_CMD_SET_UI_PROPERTY_REQ_V01, QMI_IDL_TYPE16(0, 61), 2072},
  {QMI_CSD_IOCTL_VC_CMD_GET_UI_PROPERTY_REQ_V01, QMI_IDL_TYPE16(0, 63), 29},
  {QMI_CSD_IOCTL_VS_CMD_SET_MEDIA_TYPE_REQ_V01, QMI_IDL_TYPE16(0, 68), 22},
  {QMI_CSD_IOCTL_VS_CMD_SET_MUTE_REQ_V01, QMI_IDL_TYPE16(0, 70), 27},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENCODER_DTX_MODE_REQ_V01, QMI_IDL_TYPE16(0, 72), 18},
  {QMI_CSD_IOCTL_VS_CMD_SET_DEC_TIMEWARP_REQ_V01, QMI_IDL_TYPE16(0, 74), 24},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_MINMAX_RATE_REQ_V01, QMI_IDL_TYPE16(0, 76), 22},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_RATE_MODULATION_REQ_V01, QMI_IDL_TYPE16(0, 78), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_QCELP13K_SET_RATE_REQ_V01, QMI_IDL_TYPE16(0, 80), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVNB_SET_RATE_REQ_V01, QMI_IDL_TYPE16(0, 82), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVWB_SET_RATE_REQ_V01, QMI_IDL_TYPE16(0, 84), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMR_SET_ENC_RATE_REQ_V01, QMI_IDL_TYPE16(0, 86), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMRWB_SET_ENC_RATE_REQ_V01, QMI_IDL_TYPE16(0, 88), 18},
  {QMI_CSD_IOCTL_VS_CMD_SET_DTMF_GENERATION_REQ_V01, QMI_IDL_TYPE16(0, 90), 26},
  {QMI_CSD_IOCTL_VS_CMD_SET_RX_DTMF_DETECTION_REQ_V01, QMI_IDL_TYPE16(0, 93), 18},
  {QMI_CSD_IOCTL_VS_CMD_SET_UI_PROPERTY_REQ_V01, QMI_IDL_TYPE16(0, 96), 2072},
  {QMI_CSD_IOCTL_VS_CMD_GET_UI_PROPERTY_REQ_V01, QMI_IDL_TYPE16(0, 98), 29},
  {QMI_CSD_IOCTL_VS_CMD_START_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 100), 42},
  {QMI_CSD_IOCTL_VS_CMD_STOP_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 102), 14},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_STREAM_REQ_V01, QMI_IDL_TYPE16(0, 111), 18},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_STREAM_REQ_V01, QMI_IDL_TYPE16(0, 113), 18},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_CONTEXT_REQ_V01, QMI_IDL_TYPE16(0, 115), 18},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_CONTEXT_REQ_V01, QMI_IDL_TYPE16(0, 117), 18},
  {QMI_CSD_IOCTL_VM_CMD_START_VOICE_REQ_V01, QMI_IDL_TYPE16(0, 119), 14},
  {QMI_CSD_IOCTL_VM_CMD_STOP_VOICE_REQ_V01, QMI_IDL_TYPE16(0, 125), 14},
  {QMI_CSD_IOCTL_VM_CMD_SET_NETWORK_REQ_V01, QMI_IDL_TYPE16(0, 127), 18},
  {QMI_CSD_IOCTL_VM_CMD_SET_VOICE_TIMING_REQ_V01, QMI_IDL_TYPE16(0, 129), 22},
  {QMI_CSD_IOCTL_VM_CMD_SET_TTY_MODE_REQ_V01, QMI_IDL_TYPE16(0, 131), 18},
  {QMI_CSD_IOCTL_VM_CMD_SET_WIDEVOICE_REQ_V01, QMI_IDL_TYPE16(0, 135), 18},
  {QMI_CSD_OPEN_AUDIO_STREAM_REQ_V01, QMI_IDL_TYPE16(0, 137), 31},
  {QMI_CSD_OPEN_AUDIO_CONTEXT_REQ_V01, QMI_IDL_TYPE16(0, 139), 19},
  {QMI_CSD_AS_CMD_START_SESSION_REQ_V01, QMI_IDL_TYPE16(0, 141), 22},
  {QMI_CSD_AS_CMD_STOP_SESSION_REQ_V01, QMI_IDL_TYPE16(0, 143), 7},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_REQ_V01, QMI_IDL_TYPE16(0, 145), 7},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_TX_REQ_V01, QMI_IDL_TYPE16(0, 147), 7},
  {QMI_CSD_AS_CMD_GET_VOL_LEVELS_REQ_V01, QMI_IDL_TYPE16(0, 149), 7},
  {QMI_CSD_AS_CMD_GET_DSP_CLK_REQ_V01, QMI_IDL_TYPE16(0, 151), 7},
  {QMI_CSD_AS_CMD_GET_RENDERED_TIME_REQ_V01, QMI_IDL_TYPE16(0, 153), 7},
  {QMI_CSD_AS_CMD_GET_SESSION_ID_REQ_V01, QMI_IDL_TYPE16(0, 155), 7},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_PCM_REQ_V01, QMI_IDL_TYPE16(0, 157), 40},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_ADPCM_REQ_V01, QMI_IDL_TYPE16(0, 159), 35},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_MIDI_REQ_V01, QMI_IDL_TYPE16(0, 161), 14},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV9_REQ_V01, QMI_IDL_TYPE16(0, 163), 56},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV10_REQ_V01, QMI_IDL_TYPE16(0, 165), 62},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AAC_REQ_V01, QMI_IDL_TYPE16(0, 167), 37},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_G711_REQ_V01, QMI_IDL_TYPE16(0, 169), 14},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_FLAC_REQ_V01, QMI_IDL_TYPE16(0, 171), 47},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_VORBIS_REQ_V01, QMI_IDL_TYPE16(0, 173), 56},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AMRWBPLUS_REQ_V01, QMI_IDL_TYPE16(0, 175), 42},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_PCM_REQ_V01, QMI_IDL_TYPE16(0, 177), 40},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AAC_REQ_V01, QMI_IDL_TYPE16(0, 179), 42},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_G711_REQ_V01, QMI_IDL_TYPE16(0, 181), 14},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRNB_REQ_V01, QMI_IDL_TYPE16(0, 183), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRWB_REQ_V01, QMI_IDL_TYPE16(0, 185), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_QCELP13K_REQ_V01, QMI_IDL_TYPE16(0, 187), 33},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRC_REQ_V01, QMI_IDL_TYPE16(0, 189), 33},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCB_REQ_V01, QMI_IDL_TYPE16(0, 191), 35},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCWB_REQ_V01, QMI_IDL_TYPE16(0, 193), 35},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_SBC_REQ_V01, QMI_IDL_TYPE16(0, 195), 49},
  {QMI_CSD_AS_CMD_SET_STREAM_EOS_REQ_V01, QMI_IDL_TYPE16(0, 197), 7},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MASTER_GAIN_REQ_V01, QMI_IDL_TYPE16(0, 199), 12},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_STEREO_GAIN_REQ_V01, QMI_IDL_TYPE16(0, 201), 17},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_REQ_V01, QMI_IDL_TYPE16(0, 203), 59},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MUTE_REQ_V01, QMI_IDL_TYPE16(0, 205), 14},
  {QMI_CSD_AS_CMD_CONFIG_PP_EQ_ENABLE_REQ_V01, QMI_IDL_TYPE16(0, 207), 251},
  {QMI_CSD_AS_CMD_CONFIG_PP_QCPR_REQ_V01, QMI_IDL_TYPE16(0, 209), 18},
  {QMI_CSD_AS_CMD_CONFIG_PP_SPA_REQ_V01, QMI_IDL_TYPE16(0, 211), 18},
  {QMI_CSD_AS_CMD_CONFIG_PP_TSM_REQ_V01, QMI_IDL_TYPE16(0, 213), 12},
  {QMI_CSD_AS_CMD_GET_SPA_DATA_REQ_V01, QMI_IDL_TYPE16(0, 215), 7},
  {QMI_CSD_AS_CMD_SET_DUAL_MONO_REMAP_REQ_V01, QMI_IDL_TYPE16(0, 217), 14},
  {QMI_CSD_AS_CMD_ADJUST_SESSION_CLOCK_REQ_V01, QMI_IDL_TYPE16(0, 219), 21},
  {QMI_CSD_AS_CMD_SET_AAC_SBR_PS_REQ_V01, QMI_IDL_TYPE16(0, 221), 14},
  {QMI_CSD_AS_CMD_DTMF_CTL_REQ_V01, QMI_IDL_TYPE16(0, 223), 27},
  {QMI_CSD_AS_CMD_SET_STREAM_INFO_REQ_V01, QMI_IDL_TYPE16(0, 225), 14},
  {QMI_CSD_AS_CMD_GET_RENDERED_BYTE_OFFSET_REQ_V01, QMI_IDL_TYPE16(0, 227), 7},
  {QMI_CSD_AS_CMD_GET_MIDI_SEQUENCE_ID_REQ_V01, QMI_IDL_TYPE16(0, 229), 7},
  {QMI_CSD_AS_CMD_ENCODER_BIT_RATE_UPDATE_REQ_V01, QMI_IDL_TYPE16(0, 231), 21},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_WMAV10_REQ_V01, QMI_IDL_TYPE16(0, 233), 14},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_EAC3_REQ_V01, QMI_IDL_TYPE16(0, 235), 56},
  {QMI_CSD_AC_CMD_AS_ATTACH_REQ_V01, QMI_IDL_TYPE16(0, 240), 43},
  {QMI_CSD_AC_CMD_AS_DETACH_REQ_V01, QMI_IDL_TYPE16(0, 242), 43},
  {QMI_CSD_AC_CMD_SET_DEVICE_REQ_V01, QMI_IDL_TYPE16(0, 244), 21},
  {QMI_CSD_AC_CMD_ENABLE_REQ_V01, QMI_IDL_TYPE16(0, 246), 7},
  {QMI_CSD_AC_CMD_DISABLE_REQ_V01, QMI_IDL_TYPE16(0, 248), 7},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MASTER_GAIN_REQ_V01, QMI_IDL_TYPE16(0, 250), 12},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_STEREO_GAIN_REQ_V01, QMI_IDL_TYPE16(0, 252), 17},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_REQ_V01, QMI_IDL_TYPE16(0, 254), 59},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MUTE_REQ_V01, QMI_IDL_TYPE16(0, 256), 14},
  {QMI_CSD_AC_CMD_CONFIG_PP_EQ_ENABLE_REQ_V01, QMI_IDL_TYPE16(0, 258), 251},
  {QMI_CSD_AC_CMD_CONFIG_PP_QCPR_REQ_V01, QMI_IDL_TYPE16(0, 260), 18},
  {QMI_CSD_AC_CMD_CONFIG_PP_SPA_REQ_V01, QMI_IDL_TYPE16(0, 262), 18},
  {QMI_CSD_AC_CMD_GET_SPA_DATA_REQ_V01, QMI_IDL_TYPE16(0, 264), 7},
  {QMI_CSD_AC_CMD_CONFIG_MULTI_CHANNEL_REQ_V01, QMI_IDL_TYPE16(0, 266), 47},
  {QMI_CSD_IOCTL_DEV_CMD_CONNECT_DEVICE_REQ_V01, QMI_IDL_TYPE16(0, 26), 19},
  {QMI_CSD_IOCTL_VC_CMD_SET_NUMBER_OF_VOLUME_STEPS_REQ_V01, QMI_IDL_TYPE16(0, 52), 18},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_STEP_REQ_V01, QMI_IDL_TYPE16(0, 54), 20},
  {QMI_CSD_IOCTL_VS_CMD_START_PLAYBACK_REQ_V01, QMI_IDL_TYPE16(0, 104), 21},
  {QMI_CSD_IOCTL_VS_CMD_STOP_PLAYBACK_REQ_V01, QMI_IDL_TYPE16(0, 106), 14},
  {QMI_CSD_IOCTL_VM_CMD_STANDBY_VOICE_REQ_V01, QMI_IDL_TYPE16(0, 123), 14},
  {QMI_CSD_IOCTL_DEV_CMD_AANC_CONTROL_REQ_V01, QMI_IDL_TYPE16(0, 30), 35},
  {QMI_CSD_IOCTL_VM_CMD_PAUSE_VOICE_REQ_V01, QMI_IDL_TYPE16(0, 121), 14},
  {QMI_CSD_IOCTL_DEV_CMD_RESTART_REQ_V01, QMI_IDL_TYPE16(0, 20), 22},
  {QMI_CSD_IOCTL_VC_CMD_SET_CAL_FEATURE_ID_REQ_V01, QMI_IDL_TYPE16(0, 66), 22},
  {QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_REQ_V01, QMI_IDL_TYPE16(0, 133), 18},
  {QMI_CSD_VOICE_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 270), 310},
  {QMI_CSD_VOICE_START_REQ_V01, QMI_IDL_TYPE16(0, 271), 310},
  {QMI_CSD_VOICE_END_REQ_V01, QMI_IDL_TYPE16(0, 272), 7},
  {QMI_CSD_VOICE_DEVICE_SWITCH_REQ_V01, QMI_IDL_TYPE16(0, 273), 52},
  {QMI_CSD_AFE_LOOPBACK_REQ_V01, QMI_IDL_TYPE16(0, 274), 41},
  {QMI_CSD_VOICE_VOLUME_CONTROL_REQ_V01, QMI_IDL_TYPE16(0, 275), 17},
  {QMI_CSD_VOICE_MUTE_REQ_V01, QMI_IDL_TYPE16(0, 276), 30},
  {QMI_CSD_DTMF_GENERATION_REQ_V01, QMI_IDL_TYPE16(0, 277), 62},
  {QMI_CSD_VOICE_DTMF_DETECTION_REQ_V01, QMI_IDL_TYPE16(0, 279), 18},
  {QMI_CSD_SET_VOICE_FEATURE_REQ_V01, QMI_IDL_TYPE16(0, 281), 28},
  {QMI_CSD_VOICE_RECORD_START_REQ_V01, QMI_IDL_TYPE16(0, 282), 35},
  {QMI_CSD_VOICE_RECORD_END_REQ_V01, QMI_IDL_TYPE16(0, 283), 7},
  {QMI_CSD_VOICE_PLAYBACK_START_REQ_V01, QMI_IDL_TYPE16(0, 284), 14},
  {QMI_CSD_VOICE_PLAYBACK_END_REQ_V01, QMI_IDL_TYPE16(0, 285), 7}
};
...
static const qmi_idl_service_message_table_entry csd_service_response_messages_v01[] = {
  ...
  {QMI_CSD_IOCTL_DEV_CMD_DISABLE_RESP_V01, QMI_IDL_TYPE16(0, 23), 14},
  {QMI_CSD_IOCTL_DEV_CMD_AFE_LOOPBACK_RESP_V01, QMI_IDL_TYPE16(0, 25), 14},
  {QMI_CSD_IOCTL_DEV_CMD_ANC_CONTROL_RESP_V01, QMI_IDL_TYPE16(0, 29), 14},
  {QMI_CSD_IOCTL_DEV_CMD_COMPANDING_CONTROL_RESP_V01, QMI_IDL_TYPE16(0, 33), 14},
  {QMI_CSD_IOCTL_DEV_CMD_GET_MAX_DEVICE_NUMS_RESP_V01, QMI_IDL_TYPE16(0, 35), 21},
  {QMI_CSD_IOCTL_DEV_CMD_GET_DEV_CAPS_RESP_V01, QMI_IDL_TYPE16(0, 37), 3095},
  {QMI_CSD_IOCTL_DEV_CMD_DTMF_CONTROL_RESP_V01, QMI_IDL_TYPE16(0, 39), 14},
  {QMI_CSD_IOCTL_DEV_CMD_SIDETONE_CONTROL_RESP_V01, QMI_IDL_TYPE16(0, 41), 14},
  {QMI_CSD_IOCTL_DEV_CMD_CONFIGURE_RESP_V01, QMI_IDL_TYPE16(0, 43), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_DEVICE_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 45), 28},
  {QMI_CSD_IOCTL_VC_CMD_ENABLE_RESP_V01, QMI_IDL_TYPE16(0, 47), 28},
  {QMI_CSD_IOCTL_VC_CMD_DISABLE_RESP_V01, QMI_IDL_TYPE16(0, 49), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_INDEX_RESP_V01, QMI_IDL_TYPE16(0, 51), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_MUTE_RESP_V01, QMI_IDL_TYPE16(0, 57), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_TX_DTMF_DETECTION_RESP_V01, QMI_IDL_TYPE16(0, 59), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_UI_PROPERTY_RESP_V01, QMI_IDL_TYPE16(0, 62), 28},
  {QMI_CSD_IOCTL_VC_CMD_GET_UI_PROPERTY_RESP_V01, QMI_IDL_TYPE16(0, 64), 2093},
  {QMI_CSD_IOCTL_VS_CMD_SET_MEDIA_TYPE_RESP_V01, QMI_IDL_TYPE16(0, 69), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_MUTE_RESP_V01, QMI_IDL_TYPE16(0, 71), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENCODER_DTX_MODE_RESP_V01, QMI_IDL_TYPE16(0, 73), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_DEC_TIMEWARP_RESP_V01, QMI_IDL_TYPE16(0, 75), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_MINMAX_RATE_RESP_V01, QMI_IDL_TYPE16(0, 77), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_RATE_MODULATION_RESP_V01, QMI_IDL_TYPE16(0, 79), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_QCELP13K_SET_RATE_RESP_V01, QMI_IDL_TYPE16(0, 81), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVNB_SET_RATE_RESP_V01, QMI_IDL_TYPE16(0, 83), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVWB_SET_RATE_RESP_V01, QMI_IDL_TYPE16(0, 85), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMR_SET_ENC_RATE_RESP_V01, QMI_IDL_TYPE16(0, 87), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMRWB_SET_ENC_RATE_RESP_V01, QMI_IDL_TYPE16(0, 89), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_DTMF_GENERATION_RESP_V01, QMI_IDL_TYPE16(0, 91), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_RX_DTMF_DETECTION_RESP_V01, QMI_IDL_TYPE16(0, 94), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_UI_PROPERTY_RESP_V01, QMI_IDL_TYPE16(0, 97), 28},
  {QMI_CSD_IOCTL_VS_CMD_GET_UI_PROPERTY_RESP_V01, QMI_IDL_TYPE16(0, 99), 2093},
  {QMI_CSD_IOCTL_VS_CMD_START_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 101), 28},
  {QMI_CSD_IOCTL_VS_CMD_STOP_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 103), 28},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_STREAM_RESP_V01, QMI_IDL_TYPE16(0, 112), 28},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_STREAM_RESP_V01, QMI_IDL_TYPE16(0, 114), 28},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_CONTEXT_RESP_V01, QMI_IDL_TYPE16(0, 116), 28},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_CONTEXT_RESP_V01, QMI_IDL_TYPE16(0, 118), 28},
  {QMI_CSD_IOCTL_VM_CMD_START_VOICE_RESP_V01, QMI_IDL_TYPE16(0, 120), 28},
  {QMI_CSD_IOCTL_VM_CMD_STOP_VOICE_RESP_V01, QMI_IDL_TYPE16(0, 126), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_NETWORK_RESP_V01, QMI_IDL_TYPE16(0, 128), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_VOICE_TIMING_RESP_V01, QMI_IDL_TYPE16(0, 130), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_TTY_MODE_RESP_V01, QMI_IDL_TYPE16(0, 132), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_WIDEVOICE_RESP_V01, QMI_IDL_TYPE16(0, 136), 28},
  {QMI_CSD_OPEN_AUDIO_STREAM_RESP_V01, QMI_IDL_TYPE16(0, 138), 21},
  {QMI_CSD_OPEN_AUDIO_CONTEXT_RESP_V01, QMI_IDL_TYPE16(0, 140), 21},
  {QMI_CSD_AS_CMD_START_SESSION_RESP_V01, QMI_IDL_TYPE16(0, 142), 21},
  {QMI_CSD_AS_CMD_STOP_SESSION_RESP_V01, QMI_IDL_TYPE16(0, 144), 21},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_RESP_V01, QMI_IDL_TYPE16(0, 146), 21},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_TX_RESP_V01, QMI_IDL_TYPE16(0, 148), 21},
  {QMI_CSD_AS_CMD_GET_VOL_LEVELS_RESP_V01, QMI_IDL_TYPE16(0, 150), 28},
  {QMI_CSD_AS_CMD_GET_DSP_CLK_RESP_V01, QMI_IDL_TYPE16(0, 152), 36},
  {QMI_CSD_AS_CMD_GET_RENDERED_TIME_RESP_V01, QMI_IDL_TYPE16(0, 154), 36},
  {QMI_CSD_AS_CMD_GET_SESSION_ID_RESP_V01, QMI_IDL_TYPE16(0, 156), 28},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_PCM_RESP_V01, QMI_IDL_TYPE16(0, 158), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_ADPCM_RESP_V01, QMI_IDL_TYPE16(0, 160), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_MIDI_RESP_V01, QMI_IDL_TYPE16(0, 162), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV9_RESP_V01, QMI_IDL_TYPE16(0, 164), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV10_RESP_V01, QMI_IDL_TYPE16(0, 166), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AAC_RESP_V01, QMI_IDL_TYPE16(0, 168), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_G711_RESP_V01, QMI_IDL_TYPE16(0, 170), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_FLAC_RESP_V01, QMI_IDL_TYPE16(0, 172), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_VORBIS_RESP_V01, QMI_IDL_TYPE16(0, 174), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AMRWBPLUS_RESP_V01, QMI_IDL_TYPE16(0, 176), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_PCM_RESP_V01, QMI_IDL_TYPE16(0, 178), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AAC_RESP_V01, QMI_IDL_TYPE16(0, 180), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_G711_RESP_V01, QMI_IDL_TYPE16(0, 182), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRNB_RESP_V01, QMI_IDL_TYPE16(0, 184), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRWB_RESP_V01, QMI_IDL_TYPE16(0, 186), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_QCELP13K_RESP_V01, QMI_IDL_TYPE16(0, 188), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRC_RESP_V01, QMI_IDL_TYPE16(0, 190), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCB_RESP_V01, QMI_IDL_TYPE16(0, 192), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCWB_RESP_V01, QMI_IDL_TYPE16(0, 194), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_SBC_RESP_V01, QMI_IDL_TYPE16(0, 196), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_EOS_RESP_V01, QMI_IDL_TYPE16(0, 198), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MASTER_GAIN_RESP_V01, QMI_IDL_TYPE16(0, 200), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_STEREO_GAIN_RESP_V01, QMI_IDL_TYPE16(0, 202), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_RESP_V01, QMI_IDL_TYPE16(0, 204), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MUTE_RESP_V01, QMI_IDL_TYPE16(0, 206), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_EQ_ENABLE_RESP_V01, QMI_IDL_TYPE16(0, 208), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_QCPR_RESP_V01, QMI_IDL_TYPE16(0, 210), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_SPA_RESP_V01, QMI_IDL_TYPE16(0, 212), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_TSM_RESP_V01, QMI_IDL_TYPE16(0, 214), 21},
  {QMI_CSD_AS_CMD_GET_SPA_DATA_RESP_V01, QMI_IDL_TYPE16(0, 216), 21},
  {QMI_CSD_AS_CMD_SET_DUAL_MONO_REMAP_RESP_V01, QMI_IDL_TYPE16(0, 218), 21},
  {QMI_CSD_AS_CMD_ADJUST_SESSION_CLOCK_RESP_V01, QMI_IDL_TYPE16(0, 220), 35},
  {QMI_CSD_AS_CMD_SET_AAC_SBR_PS_RESP_V01, QMI_IDL_TYPE16(0, 222), 21},
  {QMI_CSD_AS_CMD_DTMF_CTL_RESP_V01, QMI_IDL_TYPE16(0, 224), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_INFO_RESP_V01, QMI_IDL_TYPE16(0, 226), 21},
  {QMI_CSD_AS_CMD_GET_RENDERED_BYTE_OFFSET_RESP_V01, QMI_IDL_TYPE16(0, 228), 32},
  {QMI_CSD_AS_CMD_GET_MIDI_SEQUENCE_ID_RESP_V01, QMI_IDL_TYPE16(0, 230), 25},
  {QMI_CSD_AS_CMD_ENCODER_BIT_RATE_UPDATE_RESP_V01, QMI_IDL_TYPE16(0, 232), 21},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_WMAV10_RESP_V01, QMI_IDL_TYPE16(0, 234), 21},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_EAC3_RESP_V01, QMI_IDL_TYPE16(0, 236), 21},
  {QMI_CSD_AC_CMD_AS_ATTACH_RESP_V01, QMI_IDL_TYPE16(0, 241), 21},
  {QMI_CSD_AC_CMD_AS_DETACH_RESP_V01, QMI_IDL_TYPE16(0, 243), 21},
  {QMI_CSD_AC_CMD_SET_DEVICE_RESP_V01, QMI_IDL_TYPE16(0, 245), 21},
  {QMI_CSD_AC_CMD_ENABLE_RESP_V01, QMI_IDL_TYPE16(0, 247), 21},
  {QMI_CSD_AC_CMD_DISABLE_RESP_V01, QMI_IDL_TYPE16(0, 249), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MASTER_GAIN_RESP_V01, QMI_IDL_TYPE16(0, 251), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_STEREO_GAIN_RESP_V01, QMI_IDL_TYPE16(0, 253), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_RESP_V01, QMI_IDL_TYPE16(0, 255), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MUTE_RESP_V01, QMI_IDL_TYPE16(0, 257), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_EQ_ENABLE_RESP_V01, QMI_IDL_TYPE16(0, 259), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_QCPR_RESP_V01, QMI_IDL_TYPE16(0, 261), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_SPA_RESP_V01, QMI_IDL_TYPE16(0, 263), 21},
  {QMI_CSD_AC_CMD_GET_SPA_DATA_RESP_V01, QMI_IDL_TYPE16(0, 265), 21},
  {QMI_CSD_AC_CMD_CONFIG_MULTI_CHANNEL_RESP_V01, QMI_IDL_TYPE16(0, 267), 21},
  {QMI_CSD_IOCTL_DEV_CMD_CONNECT_DEVICE_RESP_V01, QMI_IDL_TYPE16(0, 27), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_NUMBER_OF_VOLUME_STEPS_RESP_V01, QMI_IDL_TYPE16(0, 53), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_STEP_RESP_V01, QMI_IDL_TYPE16(0, 55), 28},
  {QMI_CSD_IOCTL_VS_CMD_START_PLAYBACK_RESP_V01, QMI_IDL_TYPE16(0, 105), 28},
  {QMI_CSD_IOCTL_VS_CMD_STOP_PLAYBACK_RESP_V01, QMI_IDL_TYPE16(0, 107), 28},
  {QMI_CSD_IOCTL_VM_CMD_STANDBY_VOICE_RESP_V01, QMI_IDL_TYPE16(0, 124), 28},
  {QMI_CSD_IOCTL_DEV_CMD_AANC_CONTROL_RESP_V01, QMI_IDL_TYPE16(0, 31), 14},
  {QMI_CSD_IOCTL_VM_CMD_PAUSE_VOICE_RESP_V01, QMI_IDL_TYPE16(0, 122), 28},
  {QMI_CSD_IOCTL_DEV_CMD_RESTART_RESP_V01, QMI_IDL_TYPE16(0, 21), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_CAL_FEATURE_ID_RESP_V01, QMI_IDL_TYPE16(0, 67), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_RESP_V01, QMI_IDL_TYPE16(0, 134), 28},
  {QMI_CSD_VOICE_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_START_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_END_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_DEVICE_SWITCH_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_AFE_LOOPBACK_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_VOLUME_CONTROL_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_MUTE_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_DTMF_GENERATION_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_DTMF_DETECTION_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_SET_VOICE_FEATURE_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_RECORD_START_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_RECORD_END_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_PLAYBACK_START_RESP_V01, QMI_IDL_TYPE16(0, 269), 21},
  {QMI_CSD_VOICE_PLAYBACK_END_RESP_V01, QMI_IDL_TYPE16(0, 269), 21}
};

static const qmi_idl_service_message_table_entry csd_service_indication_messages_v01[] = {
  {QMI_CSD_IOCTL_VC_TX_DTMF_DETECTED_IND_V01, QMI_IDL_TYPE16(0, 60), 17},
  {QMI_CSD_IOCTL_VC_STATE_IND_V01, QMI_IDL_TYPE16(0, 65), 14},
  {QMI_CSD_IOCTL_VS_DTMF_GENERATION_ENDED_IND_V01, QMI_IDL_TYPE16(0, 92), 19},
  {QMI_CSD_IOCTL_VS_RX_DTMF_DETECTED_IND_V01, QMI_IDL_TYPE16(0, 95), 17},
  {QMI_CSD_IOCTL_VS_STATE_IND_V01, QMI_IDL_TYPE16(0, 108), 14},
  {QMI_CSD_IOCTL_VS_ENC_BUFFER_IND_V01, QMI_IDL_TYPE16(0, 109), 7},
  {QMI_CSD_IOCTL_VS_DEC_BUFFER_IND_V01, QMI_IDL_TYPE16(0, 110), 7},
  {QMI_CSD_AS_EVT_EOS_IND_V01, QMI_IDL_TYPE16(0, 237), 7},
  {QMI_CSD_AS_EVT_SPA_BUF_READY_IND_V01, QMI_IDL_TYPE16(0, 239), 4108},
  {QMI_CSD_AS_EVT_SR_CM_CHANGE_IND_V01, QMI_IDL_TYPE16(0, 238), 30},
  {QMI_CSD_AC_EVT_SPA_BUF_READY_IND_V01, QMI_IDL_TYPE16(0, 268), 4108},
  {QMI_CSD_VOICE_DTMF_GENERATION_ENDED_IND_V01, QMI_IDL_TYPE16(0, 278), 7},
  {QMI_CSD_VOICE_DTMF_DETECTED_IND_V01, QMI_IDL_TYPE16(0, 280), 17}
};
