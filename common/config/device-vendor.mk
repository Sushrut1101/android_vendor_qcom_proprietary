...
ifeq ($(filter $(TARGET_PRODUCT), sdm845 sdm710),$(TARGET_PRODUCT))
ifeq ($(TARGET_USES_AOSP),true)
BUILD_SDM845_PUREAOSP := true
endif
endif

ifeq ($(filter $(TARGET_PRODUCT), kona lito bengal),$(TARGET_PRODUCT))
$(call inherit-product, vendor/qcom/proprietary/common/config/cfi.mk)
endif
...
PRODUCT_LIST += $(TRINKET)_32
PRODUCT_LIST += kona
PRODUCT_LIST += lito
PRODUCT_LIST += bengal
PRODUCT_LIST += lahaina
PRODUCT_LIST += sdmshrike_au
...
PLAYREADY_SUPPORTED_LIST := qcs605
PLAYREADY_SUPPORTED_LIST += msm8998
...
CNE += libwqe
CNE += libxml
CNE += ATT_profiles.xml
CNE += VZW_profiles.xml
CNE += ROW_profiles.xml
...
CNE += vendor.qti.hardware.data.dynamicdds@1.0
CNE += vendor.qti.ims.rcsconfig@1.0
CNE += vendor.qti.latency@2.0
...
CNE += vendor.qti.hardware.data.dynamicdds-V1.0-java
CNE += vendor.qti.ims.rcsconfig-V1.0-java
CNE += vendor.qti.latency-V2.0-java
CNE += vendor.qti.latency@2.0
...
#IWLAN
IWLAN += IWlanService
IWLAN += vendor.qti.hardware.data.iwlan-V1.0-java
...
DATA += libdsutils
DATA += libnetmgr
DATA += libnetmgr_common
DATA += libnetmgr_rmnet_ext
DATA += libnetmgr_nr_fusion
DATA += libqcrildatactl
DATA += libqcmaputils
DATA += netmgrd
...
DISPLAY += vendor.display.config@1.1
DISPLAY += vendor.display.config@1.2
DISPLAY += vendor.display.config@1.3
DISPLAY += vendor.display.config@1.4
DISPLAY += vendor.display.config@1.5
DISPLAY += vendor.display.config@1.6
...
# Add libvirtdiag on automotive hypervisor build
ifeq ($(ENABLE_HYP),true)
DIAG += libvirtdiag
endif
...
GPS += vendor.qti.gnss@2.0-impl
GPS += vendor.qti.gnss@2.0-service
LOC_HIDL_VERSION = 2.0
endif

ifneq (,$(filter $(LOC_HIDL_2_1_TARGET_LIST),$(TARGET_BOARD_PLATFORM)))
GPS += vendor.qti.gnss@2.1-impl
GPS += vendor.qti.gnss@2.1-service
LOC_HIDL_VERSION = 2.1
endif

ifneq (,$(filter $(LOC_HIDL_3_0_TARGET_LIST),$(TARGET_BOARD_PLATFORM)))
GPS += vendor.qti.gnss@3.0-impl
GPS += vendor.qti.gnss@3.0-service
...
#TS_FORWARD dummy touch
TS_FORWARD := ts_forward
...
IMS_RCS += com.qualcomm.qti.imscmservice@2.0
IMS_RCS += com.qualcomm.qti.imscmservice-V2.0-java
IMS_RCS += com.qualcomm.qti.imscmservice-V2.0-java.xml
IMS_RCS += com.qualcomm.qti.uceservice@2.0
IMS_RCS += com.qualcomm.qti.uceservice-V2.0-java.xml
IMS_RCS += com.qualcomm.qti.uceservice-V2.0-java
IMS_RCS += com.qualcomm.qti.uceservice@2.1
IMS_RCS += com.qualcomm.qti.uceservice-V2.1-java
IMS_RCS += com.qualcomm.qti.uceservice-V2.1-java.xml
IMS_RCS += com.qualcomm.qti.imscmservice@2.1
IMS_RCS += com.qualcomm.qti.imscmservice-V2.1-java
IMS_RCS += com.qualcomm.qti.imscmservice-V2.1-java.xml
IMS_RCS += vendor.qti.ims.callinfo@1.0
IMS_RCS += vendor.qti.ims.callinfo-V1.0-java
...
MM_AUDIO += MTP_Lagoon_Bluetooth_cal.acdb
MM_AUDIO += MTP_Lagoon_General_cal.acdb
MM_AUDIO += MTP_Lagoon_Global_cal.acdb
MM_AUDIO += MTP_Lagoon_Handset_cal.acdb
MM_AUDIO += MTP_Lagoon_Hdmi_cal.acdb
MM_AUDIO += MTP_Lagoon_Headset_cal.acdb
MM_AUDIO += MTP_Lagoon_Speaker_cal.acdb
MM_AUDIO += MTP_Lagoon_workspaceFile.qwsp
MM_AUDIO += QRD_Lagoon_Bluetooth_cal.acdb
MM_AUDIO += QRD_Lagoon_General_cal.acdb
MM_AUDIO += QRD_Lagoon_Global_cal.acdb
MM_AUDIO += QRD_Lagoon_Handset_cal.acdb
MM_AUDIO += QRD_Lagoon_Hdmi_cal.acdb
MM_AUDIO += QRD_Lagoon_Headset_cal.acdb
MM_AUDIO += QRD_Lagoon_Speaker_cal.acdb
MM_AUDIO += QRD_Lagoon_workspaceFile.qwsp
MM_AUDIO += IDP_Bluetooth_cal.acdb
MM_AUDIO += IDP_Codec_cal.acdb
MM_AUDIO += IDP_General_cal.acdb
MM_AUDIO += IDP_Global_cal.acdb
MM_AUDIO += IDP_Handset_cal.acdb
MM_AUDIO += IDP_Hdmi_cal.acdb
MM_AUDIO += IDP_Headset_cal.acdb
MM_AUDIO += IDP_Speaker_cal.acdb
MM_AUDIO += IDP_workspaceFile.qwsp
MM_AUDIO += IDP_WCD9340_Bluetooth_cal.acdb
MM_AUDIO += IDP_WCD9340_Codec_cal.acdb
MM_AUDIO += IDP_WCD9340_General_cal.acdb
MM_AUDIO += IDP_WCD9340_Global_cal.acdb
MM_AUDIO += IDP_WCD9340_Handset_cal.acdb
MM_AUDIO += IDP_WCD9340_Hdmi_cal.acdb
MM_AUDIO += IDP_WCD9340_Headset_cal.acdb
MM_AUDIO += IDP_WCD9340_Speaker_cal.acdb
MM_AUDIO += IDP_WCD9340_workspaceFile.qwsp
MM_AUDIO += IDP_WCD9335_Bluetooth_cal.acdb
MM_AUDIO += IDP_WCD9335_General_cal.acdb
MM_AUDIO += IDP_WCD9335_Global_cal.acdb
MM_AUDIO += IDP_WCD9335_Handset_cal.acdb
MM_AUDIO += IDP_WCD9335_Hdmi_cal.acdb
MM_AUDIO += IDP_WCD9335_Headset_cal.acdb
MM_AUDIO += IDP_WCD9335_Speaker_cal.acdb
MM_AUDIO += IDP_WCD9335_workspaceFile.qwsp
MM_AUDIO += IDP_WCD937X_Bluetooth_cal.acdb
MM_AUDIO += IDP_WCD937X_General_cal.acdb
MM_AUDIO += IDP_WCD937X_Global_cal.acdb
MM_AUDIO += IDP_WCD937X_Handset_cal.acdb
MM_AUDIO += IDP_WCD937X_Hdmi_cal.acdb
MM_AUDIO += IDP_WCD937X_Headset_cal.acdb
MM_AUDIO += IDP_WCD937X_Speaker_cal.acdb
MM_AUDIO += IDP_WCD937X_workspaceFile.qwsp
...
MM_AUDIO += ftm_test_config_qrd
MM_AUDIO += ftm_test_config_sm6150-tavil-snd-card
MM_AUDIO += ftm_test_config_trinket-tasha-snd-card
MM_AUDIO += ftm_test_config_kona-qrd-snd-card
MM_AUDIO += ftm_test_config_lito-qrd-snd-card
MM_AUDIO += ftm_test_config_atoll-wcd937x-snd-card
MM_AUDIO += ftm_test_config_atoll-qrd-snd-card
MM_AUDIO += ftm_test_config_sm6150-wcd9375qrd-snd-card
MM_AUDIO += ftm_test_config_sm6150-tavil-snd-card
MM_AUDIO += ftm_test_config_bengal-qrd-snd-card
MM_AUDIO += ftm_test_config_lito-lagoonmtp-snd-card
...
MM_CAMERA += cpp_firmware_v1_12_1.fw
MM_CAMERA += libflash_pmic
MM_CAMERA += libflash_gpio
...
MM_CAMERA += libchromatix_imx519_4k
MM_CAMERA += libchromatix_imx519_4k_video
MM_CAMERA += libchromatix_imx519_fullsize_preview
MM_CAMERA += libchromatix_imx519_fullsize_preview_60
MM_CAMERA += libchromatix_imx519_fullsize_video
MM_CAMERA += libchromatix_imx519_fullsize_video_60
MM_CAMERA += libchromatix_imx519_3A_hfr_120
MM_CAMERA += libchromatix_imx519_3A_hfr_240
MM_CAMERA += libchromatix_imx519_3A_hfr_480
MM_CAMERA += libchromatix_imx519_default_preview_3a
MM_CAMERA += libchromatix_imx519_default_video_3a
MM_CAMERA += libchromatix_imx519_3A_snapshot_raw_hdr
MM_CAMERA += libchromatix_imx519_3A_snapshot_raw_hdr_60
MM_CAMERA += libchromatix_imx519_common
MM_CAMERA += libchromatix_imx519_cpp_hfr_120
MM_CAMERA += libchromatix_imx519_cpp_hfr_240
MM_CAMERA += libchromatix_imx519_cpp_hfr_480
MM_CAMERA += libchromatix_imx519_cpp_liveshot
MM_CAMERA += libchromatix_imx519_cpp_preview
MM_CAMERA += libchromatix_imx519_cpp_snapshot
MM_CAMERA += libchromatix_imx519_cpp_snapshot_raw_hdr
MM_CAMERA += libchromatix_imx519_cpp_video
MM_CAMERA += libchromatix_imx519_hfr_120
MM_CAMERA += libchromatix_imx519_hfr_240
MM_CAMERA += libchromatix_imx519_hfr_480
MM_CAMERA += libchromatix_imx519_preview
MM_CAMERA += libchromatix_imx519_snapshot
MM_CAMERA += libchromatix_imx519_snapshot_raw_hdr
MM_CAMERA += libchromatix_imx519_default_video
MM_CAMERA += libchromatix_imx519_video_4k
MM_CAMERA += libchromatix_imx519_postproc
MM_CAMERA += libchromatix_s5k5e9yu05_mono_common
MM_CAMERA += libchromatix_s5k5e9yu05_mono_zsl_video
MM_CAMERA += libchromatix_s5k5e9yu05_mono_default_video
MM_CAMERA += libchromatix_s5k5e9yu05_mono_zsl_preview
MM_CAMERA += libchromatix_s5k5e9yu05_mono_hfr_60
MM_CAMERA += libchromatix_s5k5e9yu05_mono_hfr_120
MM_CAMERA += libchromatix_s5k5e9yu05_mono_default_preview
MM_CAMERA += libchromatix_s5k5e9yu05_mono_postproc
MM_CAMERA += libchromatix_s5k5e9yu05_mono_preview_isp
MM_CAMERA += libchromatix_s5k5e9yu05_mono_hfr_60_isp
MM_CAMERA += libchromatix_s5k5e9yu05_mono_hfr_120_isp
MM_CAMERA += libchromatix_s5k5e9yu05_mono_default_video_isp
MM_CAMERA += libchromatix_s5k5e9yu05_mono_snapshot_isp
MM_CAMERA += libchromatix_s5k5e9yu05_mono_cpp_hfr_120
MM_CAMERA += libchromatix_s5k5e9yu05_mono_cpp_video
MM_CAMERA += libchromatix_s5k5e9yu05_mono_cpp_snapshot
MM_CAMERA += libchromatix_s5k5e9yu05_mono_cpp_preview
MM_CAMERA += libchromatix_s5k5e9yu05_mono_cpp_hfr_60
MM_CAMERA += libchromatix_s5k5e9yu05_mono_cpp_liveshot
...
MM_CAMERA += libmmcamera_imx519
MM_CAMERA += libmmcamera_sunny_gt24p64b_imx519_eeprom
MM_CAMERA += libmmcamera_s5k5e9yu05
...
ifneq ($(TARGET_HAS_LOW_RAM), true)
MM_CAMERA += libmmcamera_sat_test_lib
endif
...
MM_CAMERA += PIPCamera
ifneq ($(strip $(TARGET_KERNEL_VERSION)), 3.18)
...
MM_CAMERA += imx519_chromatix.xml
MM_CAMERA += s5k5e9yu05_mono_chromatix.xml
...
#Automotive camera(AIS)
ifeq ($(TARGET_BOARD_AUTO),true)
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/ais/product.mk)
endif
...
MM_CAMERA += com.qti.camx.chiiqutils
MM_CAMERA += com.qti.chi.override
MM_CAMERA += com.qti.eisv2
MM_CAMERA += com.qti.eisv3
MM_CAMERA += com.qti.hvx.addconstant
MM_CAMERA += com.qti.hvx.binning
MM_CAMERA += com.qti.node.depth
MM_CAMERA += com.qti.node.dummyrtb
MM_CAMERA += com.qti.node.dummysat
MM_CAMERA += com.qti.node.eisv2
MM_CAMERA += com.qti.node.eisv3
MM_CAMERA += com.qti.node.gpu
MM_CAMERA += com.qti.node.memcpy
MM_CAMERA += com.qti.node.remosaic
MM_CAMERA += com.qti.node.stich
MM_CAMERA += com.qti.node.swregistration
MM_CAMERA += com.qti.sensor.imx318
MM_CAMERA += com.qti.sensor.max7366_eyetrack
MM_CAMERA += com.qti.sensor.imx334
MM_CAMERA += com.qti.sensor.imx577
MM_CAMERA += com.qti.sensor.imx362
MM_CAMERA += com.qti.sensor.ov12a10
MM_CAMERA += com.qti.sensor.max7366_6dof
MM_CAMERA += com.qti.sensor.ov13880
MM_CAMERA += com.qti.sensor.ov8856
MM_CAMERA += com.qti.sensor.ov7251
MM_CAMERA += com.qti.sensor.ov13855
MM_CAMERA += com.qti.sensor.imx386
MM_CAMERA += com.qti.sensor.imx519
MM_CAMERA += com.qti.sensor.s5k2l7
MM_CAMERA += com.qti.sensor.max7366_ov6211
MM_CAMERA += com.qti.sensor.max7366_ov9282
MM_CAMERA += com.qti.eeprom.truly_cmb433
MM_CAMERA += com.qti.sensormodule.liteon_ov7251.bin
MM_CAMERA += com.qti.sensormodule.liteon_max7366_6dof.bin
MM_CAMERA += com.qti.sensormodule.liteon_max7366_eyetrack.bin
MM_CAMERA += com.qti.sensormodule.altek_imx577.bin
MM_CAMERA += com.qti.sensormodule.altek1_imx577.bin
MM_CAMERA += com.qti.sensormodule.altek2_imx577.bin
...
MM_CAMERA += com.qti.sensormodule.ofilm_imx376.bin
MM_CAMERA += com.qti.sensormodule.ofilm_ov12a10.bin
MM_CAMERA += com.qti.sensormodule.ofilm_ov12a10_front.bin
MM_CAMERA += com.qti.sensormodule.ofilm_ov13855.bin
MM_CAMERA += com.qti.sensormodule.ofilm_ov13880.bin
MM_CAMERA += com.qti.sensormodule.pmd_irs1645.bin
MM_CAMERA += com.qti.sensormodule.semco_imx258.bin
MM_CAMERA += com.qti.sensormodule.semco_imx386.bin
MM_CAMERA += com.qti.sensormodule.sony_imx334.bin
MM_CAMERA += com.qti.sensormodule.sunny_s5k2l7.bin
MM_CAMERA += com.qti.sensormodule.truly_ov8856.bin
MM_CAMERA += com.qti.sensormodule.sunny_imx519.bin
MM_CAMERA += com.qti.tuned.default.bin
MM_CAMERA += com.qti.tuned.default_full_iq.bin
MM_CAMERA += com.qti.tuned.semco_imx258.bin
MM_CAMERA += com.qti.tuned.liteon_imx318.bin
MM_CAMERA += com.qti.tuned.liteon_imx362.bin
MM_CAMERA += com.qti.tuned.ofilm_ov12a10.bin
MM_CAMERA += com.qti.tuned.ofilm_ov13880.bin
MM_CAMERA += com.qti.tuned.ofilm_ov13855.bin
MM_CAMERA += com.qti.tuned.semco_imx386.bin
MM_CAMERA += com.qti.tuned.sunny_s5k2l7.bin
MM_CAMERA += com.qti.tuned.altek_imx577.bin
MM_CAMERA += com.qti.tuned.altek1_imx577.bin
MM_CAMERA += com.qti.tuned.liteon_max7366_ov9282.bin
MM_CAMERA += com.qti.tuned.liteon_ov7251.bin
MM_CAMERA += com.qti.tuned.sunny_imx519.bin
...
MM_CAMERA += com.qti.stats.awbwrapper
MM_CAMERA += com.qti.stats.pdlib
MM_CAMERA += com.qti.stats.pdlibsony
MM_CAMERA += com.qti.stats.pdlibwrapper
...
MM_RTP += libmmrtpencoder_proprietary
MM_RTP += libmmrtpdecoder_proprietary
...
# Add libhyp_video_fe on automotive hypervisor build
ifeq ($(ENABLE_HYP),true)
MM_VIDEO += libhyp_video_fe
MM_VIDEO += hyp_dvr_mux_be
MM_VIDEO += hyp_dvr_hidl_client
MM_VIDEO += vendor.qti.dvr@1.0
MM_VIDEO += vendor.qti.dvr@1.0-service
MM_VIDEO += vendor.qti.dvr@1.0-service.rc
endif
...
PERF += workloadclassifier
PERF += libqti_workloadclassifiermodel
...
PERF += vendor.qti.hardware.perf@2.0
PERF += vendor.qti.hardware.perf@2.0-service.rc
PERF += vendor.qti.hardware.perf@2.0-impl
PERF += vendor.qti.hardware.perf@2.0-service
...
PERF += libadaptlaunch
PERF += AppClassifierFeature.xml
PERF += libappclassifier
PERF += GameOptimizationFeature.xml
PERF += libgameoptfeature
PERF += GamePerfEngineFeature.xml
PERF += libGamePerfEnginefeature
...
QCRIL += vendor.qti.hardware.radio.ims@1.2
QCRIL += vendor.qti.hardware.radio.ims@1.3
QCRIL += vendor.qti.hardware.radio.ims@1.4
...
QCRIL += vendor.qti.hardware.radio.qtiradio@2.0
QCRIL += vendor.qti.hardware.radio.qtiradio@2.1
QCRIL += vendor.qti.hardware.radio.qtiradio@2.2
...
QCRIL += vendor.qti.hardware.radio.uim_remote_client@1.1
QCRIL += vendor.qti.hardware.radio.uim_remote_client@1.2
QCRIL += vendor.qti.hardware.radio.uim_remote_server@1.0
QCRIL += vendor.qti.hardware.radio.internal.deviceinfo@1.0
...
QVR += libqvr_dsp_driver_skel_v65
QVR += libtracker_6dof_skel
QVR += libtracker_6dof_skel_v65
QVR += libtracker_6dof_skel_v82_v66
QVR += libtracker_6dof_skel_v82_v65
QVR += libtracker_6dof_skel_v83_v66
QVR += libqvrservice
...
SECUREMSM += android.hardware.keymaster@4.0-strongbox-service-qti
SECUREMSM += android.hardware.keymaster@4.0-strongbox-service-qti.rc
endif
...
SECUREMSM += vendor.qti.hardware.qseecom@1.0
SECUREMSM += vendor.qti.hardware.qseecom@1.0.vendor
SECUREMSM += vendor.qti.hardware.qseecom@1.0-impl
SECUREMSM += vendor.qti.hardware.qseecom@1.0-service
SECUREMSM += vendor.qti.hardware.qseecom@1.0-service.rc
SECUREMSM += libQSEEComAPI_system
SECUREMSM += qseecom_sample_client_system
...
ifneq ($(TARGET_HAS_LOW_RAM),true)
SECUREMSM += vendor.qti.hardware.soter@1.0
SECUREMSM += vendor.qti.hardware.soter-V1.0-java
SECUREMSM += vendor.qti.hardware.soter@1.0_vendor
SECUREMSM += vendor.qti.hardware.soter@1.0-client
SECUREMSM += vendor.qti.hardware.soter@1.0-provision
SECUREMSM += vendor.qti.hardware.soter@1.0-impl
SECUREMSM += vendor.qti.hardware.soter@1.0-service
SECUREMSM += vendor.qti.hardware.soter@1.0-service.rc
endif #TARGET_HAS_LOW_RAM

ifeq ($(strip $(TARGET_USES_GPQESE)),true)
SECUREMSM += android.hardware.secure_element@1.0-impl
SECUREMSM += vendor.qti.secure_element@1.0-service
SECUREMSM += vendor.qti.secure_element@1.0-service.rc
endif
...
ifneq ($(TARGET_HAS_LOW_RAM),true)
SECUREMSM += vendor.qti.hardware.cryptfshw@1.0
SECUREMSM += vendor.qti.hardware.cryptfshw@1.0.vendor
SECUREMSM += vendor.qti.hardware.cryptfshw@1.0-service-qti
SECUREMSM += vendor.qti.hardware.cryptfshw@1.0-service-qti.rc
endif #TARGET_HAS_LOW_RAM
SECUREMSM += aostlmd
...
SECUREMSM += qseecomd
ifeq ($(TARGET_BOARD_AUTO), true)
SECUREMSM += prdrm_gtest
endif
ifeq ($(call is-board-platform-in-list,$(PLAYREADY_SUPPORTED_LIST)),true)
SECUREMSM += prdrm_gtest
endif
SECUREMSM += qti_gatekeeper_tests
SECUREMSM += qti_keymaster_tests
...
SECUREMSM += smcinvoke_vendor_client
SECUREMSM += seemp
SECUREMSM += SeempAPI
SECUREMSM += seemp_cli
...
SECUREMSM += libcryptfshwhidl
SECUREMSM += libcryptfshw_hidl_headers
SECUREMSM += libcryptfshwcommon
endif #TARGET_HAS_LOW_RAM
endif #ENABLE_HYP
...
ifeq ($(ENABLE_CAR_POWER_MANAGER), true)
VEHICLE_NETWORKS += car_power_daemon
endif
...
WFD += libwfdmmservice
WFD += libwfdmmservice_proprietary
WFD += libwfduibcinterface
WFD += libwfduibcinterface_proprietary
WFD += libwfduibcsrcinterface
WFD += libwfduibcsrcinterface_proprietary
WFD += libwfduibcsrc
WFD += libwfduibcsrc_proprietary
WFD += libOmxMux
WFD += libOmxMux_proprietary
WFD += libwfdcommonutils
WFD += libwfdcommonutils_proprietary
WFD += libwfdhdcpcp
WFD += libwfdhdcpservice_proprietary
WFD += wfdvndservice
WFD += wfdvndservice.rc
WFD += wfdhdcphalservice
WFD += android.hardware.drm@1.1-service.wfdhdcp.rc
WFD += libwfdlinkstub
WFD += libwfdmmsrc
WFD += libwfdmmsrc_proprietary
WFD += libwfdmmutils
WFD += libwfdnative
WFD += libwfdsm
WFD += libwfdsm_proprietary
WFD += libwfdclient
WFD += libwfdservice
WFD += libwfdrtsp
WFD += libwfdrtsp_proprietary
...
WFD += vendor.qti.hardware.sigma_miracast@1.0
WFD += vendor.qti.hardware.sigma_miracast@1.0-halimpl
WFD += vendor.qti.hardware.sigma_miracast@1.0-impl
WFD += libmiracast
WFD += libmiracastsystem
WFD += sigma_miracasthalservice
WFD += com.qualcomm.qti.sigma_miracast@1.0-service.rc
WFD += libwfdhaldsmanager
WFD += libwfdmodulehdcpsession
WFD += libwfdavenhancements
WFD += libwfdcodecv4l2
WFD += libwfdcodecv4l2_proprietary
WFD += wfdservice.rc
WFD += com.qualcomm.qti.wifidisplayhal@1.0-service.rc
WFD += libwfdconfigutils
WFD += libwfdconfigutils_proprietary
WFD += libwfdsessionmodule
WFD += vendor.qti.hardware.wifidisplaysession@1.0-halimpl
WFD += vendor.qti.hardware.wifidisplaysession@1.0
WFD += vendor.qti.hardware.wifidisplaysession@1.0_system
WFD += vendor.qti.hardware.wifidisplaysession@1.0_vendor
WFD += vendor.qti.hardware.wifidisplaysession@1.0-impl
WFD += libwfdsourcesm_proprietary
WFD += libwfdsourcesession_proprietary
WFD += libwfdmminterface_proprietary
WFD += libwfdmmsrc_system
...
SNAPDRAGON_SDK_DISPLAY += libsd_sdk_display.qti
...
# NNHAL Stack Components
NNHAL = android.hardware.neuralnetworks@1.2-service-qti
NNHAL += android.hardware.neuralnetworks@1.2-service-qti.rc
NNHAL += libhexagon_nn_skel
NNHAL += libhexagon_nn_skel.so
NNHAL += libhexagon_nn_stub
NNHAL += unnhal-acc-common
NNHAL += unnhal-acc-adreno
NNHAL += unnhal-acc-hvx
...
GPS_DBG += libLocModemEmulator
GPS_DBG += LocModemEmulatorCli
GPS_DBG += OptInAppOverlay
...
MM_AUDIO_DBG += mm-adec-omxMpegh-test
...
WFD_DBG += libwfduibcsink_proprietary
WFD_DBG += libwfduibcsinkinterface
WFD_DBG += libwfduibcsinkinterface_proprietary
...
PRODUCT_PACKAGES_DEBUG += $(DISPLAY_DEBUG)
...
VNDK_LIBS += com.qualcomm.qti.uceservice@2.1.vendor
VNDK_LIBS += vendor.qti.hardware.tui_comm@1.0.vendor
VNDK_LIBS += vendor.qti.voiceprint@1.0.vendor
VNDK_LIBS += vendor.qti.hardware.radio.atcmdfwd@1.0.vendor
...
VNDK_LIBS += com.qualcomm.qti.dpm.api@1.0.vendor
VNDK_LIBS += vendor.qti.ims.rcsconfig@1.0.vendor
VNDK_LIBS += vendor.qti.latency@2.0.vendor
ifneq ($(TARGET_HAS_LOW_RAM),true)
VNDK_LIBS += vendor.qti.hardware.soter@1.0.vendor
endif #TARGET_HAS_LOW_RAM
VNDK_LIBS += $(patsubst vendor.qti.gnss%,vendor.qti.gnss%.vendor,$(LOCHIDL))
VNDK_LIBS += $(patsubst vendor.qti.hardware.radio%,vendor.qti.hardware.radio%.vendor,$(QCRIL))
VNDK_LIBS += vendor.qti.hardware.perf@1.0.vendor
VNDK_LIBS += vendor.qti.hardware.perf@2.0.vendor
VNDK_LIBS += vendor.qti.hardware.scve.panorama@1.0.vendor
VNDK_LIBS += vendor.qti.hardware.scve.objecttracker@1.0.vendor
VNDK_LIBS += vendor.qti.hardware.cvp@1.0.vendor
...
## TODO android.hidl.base@1.0 is deprecated and its depedency
## need to be removed in next Android Version. Compiling this
## module to satisfy current dependents.
