...
#define LOG_TAG "vendor.qti.hardware.radio.ims@1.4::ImsRadioResponse"
...
const char* IImsRadioResponse::descriptor("vendor.qti.hardware.radio.ims@1.4::IImsRadioResponse");
...
// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>> IImsRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>& parent, bool /* emitError */) {
    return parent;
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>> IImsRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioResponse>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>(static_cast<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>> IImsRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadioResponse>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>(static_cast<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>> IImsRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadioResponse>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>(static_cast<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>> IImsRadioResponse::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>(static_cast<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse *>(parent.get()));
}
