...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue Oct  4 2016 (Spin 0)
...
static const uint8_t sns_reg_group_search_req_msg_data_v02[] = {
  0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_reg_group_search_req_msg_v02, data),
  ((SNS_REG_MAX_GROUP_BYTE_COUNT_V02) & 0xFF), ((SNS_REG_MAX_GROUP_BYTE_COUNT_V02) >> 8),
  QMI_IDL_OFFSET8(sns_reg_group_search_req_msg_v02, data) - QMI_IDL_OFFSET8(sns_reg_group_search_req_msg_v02, data_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(sns_reg_group_search_req_msg_v02, group_id_start) - QMI_IDL_OFFSET16RELATIVE(sns_reg_group_search_req_msg_v02, group_id_start_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(sns_reg_group_search_req_msg_v02, group_id_start),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(sns_reg_group_search_req_msg_v02, group_id_end) - QMI_IDL_OFFSET16RELATIVE(sns_reg_group_search_req_msg_v02, group_id_end_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(sns_reg_group_search_req_msg_v02, group_id_end),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(sns_reg_group_search_req_msg_v02, search_position) - QMI_IDL_OFFSET16RELATIVE(sns_reg_group_search_req_msg_v02, search_position_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(sns_reg_group_search_req_msg_v02, search_position)
};

static const uint8_t sns_reg_group_search_resp_msg_data_v02[] = {
  2,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, group_id) - QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, group_id_valid)),
  0x10,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, group_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, data) - QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, data_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, data),
  ((SNS_REG_MAX_GROUP_BYTE_COUNT_V02) & 0xFF), ((SNS_REG_MAX_GROUP_BYTE_COUNT_V02) >> 8),
  QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, data) - QMI_IDL_OFFSET8(sns_reg_group_search_resp_msg_v02, data_len)
};
...
static const qmi_idl_message_table_entry SNS_REG2_SVC_message_table_v02[] = {
  ...
  {sizeof(sns_reg_group_search_req_msg_v02), sns_reg_group_search_req_msg_data_v02},
  {sizeof(sns_reg_group_search_resp_msg_v02), sns_reg_group_search_resp_msg_data_v02}
};
...
static const qmi_idl_service_message_table_entry SNS_REG2_SVC_service_command_messages_v02[] = {
  ...
  {SNS_REG_GROUP_SEARCH_REQ_V02, QMI_IDL_TYPE16(0, 8), 275}
};
...
static const qmi_idl_service_message_table_entry SNS_REG2_SVC_service_response_messages_v02[] = {
  ...
  {SNS_REG_GROUP_SEARCH_RESP_V02, QMI_IDL_TYPE16(0, 9), 271}
};
