...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.HE.1.0.c1/Main/modem_proc/qmimsgs/uimrmt/src/user_identity_module_remote_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t uim_remote_event_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, error_cause) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, error_cause_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, error_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, transport) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, transport_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, transport),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, usage) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, usage_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, usage),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, apdu_timeout) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, apdu_timeout_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, apdu_timeout),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, disable_all_polling) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, disable_all_polling_valid)),
  0x16,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, disable_all_polling),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, poll_interval) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, poll_interval_valid)),
  0x17,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, poll_interval),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, encryption) - QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, encryption_valid)),
  0x18,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_remote_event_req_msg_v01, encryption)
};
...
static const uint8_t uim_remote_apdu_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_apdu_ind_msg_v01, encrypted_command_apdu) - QMI_IDL_OFFSET16RELATIVE(uim_remote_apdu_ind_msg_v01, encrypted_command_apdu_valid)),
  0x10,
  ...
  QMI_IDL_OFFSET16ARRAY(uim_remote_apdu_ind_msg_v01, encrypted_command_apdu),
  ((QMI_UIM_REMOTE_MAX_ENC_COMMAND_APDU_LEN_V01) & 0xFF), ((QMI_UIM_REMOTE_MAX_ENC_COMMAND_APDU_LEN_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_remote_apdu_ind_msg_v01, encrypted_command_apdu) - QMI_IDL_OFFSET16RELATIVE(uim_remote_apdu_ind_msg_v01, encrypted_command_apdu_len)
};
...
static const qmi_idl_service_message_table_entry uim_remote_service_command_messages_v01[] = {
  ...
  {QMI_UIM_REMOTE_EVENT_REQ_V01, QMI_IDL_TYPE16(0, 2), 97},
...
static const qmi_idl_service_message_table_entry uim_remote_service_indication_messages_v01[] = {
  {QMI_UIM_REMOTE_APDU_IND_V01, QMI_IDL_TYPE16(0, 6), 685},
