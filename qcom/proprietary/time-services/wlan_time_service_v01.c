...
static const uint8_t qmi_wlan_get_qtimer_delta_from_apps_req_data_v01[] = {
  0x01,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_wlan_get_qtimer_delta_from_apps_req_v01, apps_timetick),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_wlan_get_qtimer_delta_from_apps_req_v01, wlan_timetick)
};

static const uint8_t qmi_wlan_get_qtimer_delta_from_apps_resp_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_wlan_get_qtimer_delta_from_apps_resp_v01, resp),
  0, 1
};

/*
Empty structures
static const uint8_t qmi_wlan_get_qtimer_delta_from_apps_ind_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_wlan_get_qtimer_delta_from_apps_ind_v01, __placeholder)
};

static const uint8_t qmi_wlan_get_rtc_from_apps_ind_data_v01[] = {
  0x01,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_wlan_get_rtc_from_apps_ind_v01, __placeholder)
};
*/

static const uint8_t time_turn_on_or_off_ind_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(time_turn_on_or_off_ind_req_msg_v01, msg_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(time_turn_on_or_off_ind_req_msg_v01, opr)
};

static const uint8_t time_turn_on_or_off_ind_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(time_turn_on_or_off_ind_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry wlan_time_message_table_v01[] = {
  ...
  {sizeof(qmi_wlan_get_qtimer_delta_from_apps_req_v01), qmi_wlan_get_qtimer_delta_from_apps_req_data_v01},
  {sizeof(qmi_wlan_get_qtimer_delta_from_apps_resp_v01), qmi_wlan_get_qtimer_delta_from_apps_resp_data_v01},
  {sizeof(qmi_wlan_get_qtimer_delta_from_apps_ind_v01), 0},
  {sizeof(qmi_wlan_get_rtc_from_apps_ind_v01), 0},
  {sizeof(time_turn_on_or_off_ind_req_msg_v01), time_turn_on_or_off_ind_req_msg_data_v01},
  {sizeof(time_turn_on_or_off_ind_resp_msg_v01), time_turn_on_or_off_ind_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry wlan_time_service_command_messages_v01[] = {
  ...
  {QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_REQ_V01, QMI_IDL_TYPE16(0, 11), 22},
  {QMI_WLAN_TIME_TURN_ON_OR_OFF_IND_REQ_MSG_V01, QMI_IDL_TYPE16(0, 15), 14}
};
...
static const qmi_idl_service_message_table_entry wlan_time_service_response_messages_v01[] = {
  ...
  {QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_RESP_V01, QMI_IDL_TYPE16(0, 12), 7},
  {QMI_WLAN_TIME_TURN_ON_OR_OFF_IND_RESP_MSG_V01, QMI_IDL_TYPE16(0, 16), 7}
};
...
static const qmi_idl_service_message_table_entry wlan_time_service_indication_messages_v01[] = {
  ...
  {QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_IND_V01, QMI_IDL_TYPE16(0, 13), 0},
  {QMI_WLAN_GET_RTC_FROM_APPS_IND_V01, QMI_IDL_TYPE16(0, 14), 0}
};
