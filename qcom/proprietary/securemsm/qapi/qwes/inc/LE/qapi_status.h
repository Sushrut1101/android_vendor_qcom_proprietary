...
#define __QAPI_ERROR(__mod_id__, __err__) \
    (0 - (__QAPI_ERR_ENCAP_MOD_ID(__mod_id__) + (__err__)))

/** @name QAPI Modules
 * The following definitions represent the IDs for the various modules of
 * the QAPI.
 *
 * Note that if OEMs wish to added their own module IDs, it is recommended
 * to start at 100 to avoid possible conflicts with updates to the QAPI
 * that add additional modules.
 * @{ */
...
/** @name Common QAPI Status Codes
 * @xreflabel{hdr:QAPIStatust}
 * The following definitions represent the status codes common to all of
 * the QAPI modules.
 */
#define QAPI_OK ((qapi_Status_t)(0)) /**< Success                   */
#define QAPI_ERROR \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 1))) /**< General error             */
#define QAPI_ERR_INVALID_PARAM \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 2))) /**< Invalid parameter         */
#define QAPI_ERR_NO_MEMORY \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 3))) /**< Memory allocation error   */
#define QAPI_ERR_NO_RESOURCE \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 4))) /**< Resource allocation error */
#define QAPI_ERR_BUSY \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 6))) /**< Opertion busy             */
#define QAPI_ERR_NO_ENTRY \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 7))) /**< Entry not found           */
#define QAPI_ERR_NOT_SUPPORTED \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 8))) /**< Feature not supported     */
#define QAPI_ERR_TIMEOUT \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 9))) /**< Operation timed out       */
#define QAPI_ERR_BOUNDS \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 10))) /**< Out of bounds             */
#define QAPI_ERR_BAD_PAYLOAD \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 11))) /**< Bad Payload               */
#define QAPI_ERR_EXISTS \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 12))) /**< Entry already exists      */
#define QAPI_ERR_NOT_INITIALIZED \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 13))) /**< Unintialized              */
#define QAPI_ERR_INVALID_STATE \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 13))) /**< Invalid state             */
#define QAPI_ERR_API_DEPRACATED                                              \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 14))) /**< Qapi function is \
                                                          deprecated*/
/** @} */                                              /* end_namegroup */
