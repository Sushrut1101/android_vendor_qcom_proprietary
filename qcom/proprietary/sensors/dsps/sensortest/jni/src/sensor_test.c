...
Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_runNativeSensorTest__IIIZZ
...
JNIEXPORT jint JNICALL
Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_runNativeSensorTest__III
  (JNIEnv *ENV, jclass class, jint sensorID, jint dataType, jint testType)
{
  return Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_runNativeSensorTest__IIIZZ(
      ENV, class, sensorID, dataType, testType, true, true );
}

JNIEXPORT jint JNICALL
Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_getNativeRawDataMode
  (JNIEnv *ENV, jclass class)
{
   int error = 0;
   uint8_t *data = NULL, data_len;
   int result = 0;
...
JNIEXPORT jint JNICALL
Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_setNativeRawDataMode
...
static const JNINativeMethod gMethods[] = {
   { "runNativeSensorTest",
     "(III)I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_runNativeSensorTest__III
   },
   { "runNativeSensorTest",
     "(IIIZZ)I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_runNativeSensorTest__IIIZZ
   },
   { "setNativeRawDataMode",
     "(Z)I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_setNativeRawDataMode
   },
   { "getNativeRawDataMode",
     "()I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorTest_getNativeRawDataMode
   }
};
...
registerMethods(JNIEnv* env)
{
   static const char* const kClassName =
      "com/qualcomm/qti/sensors/core/sensortest/SensorTest";
   jclass class;
