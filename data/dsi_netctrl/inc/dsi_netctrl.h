...
typedef enum
{
  DSI_BEARER_IP_TYPE_INVALID = -1,
  DSI_BEARER_IP_TYPE_V4,
  DSI_BEARER_IP_TYPE_V6,
  DSI_BEARER_IP_TYPE_V4_V6,
  DSI_BEARER_IP_TYPE_MAX
} dsi_wds_bearer_ip_type_t;

typedef struct
{
  char                     ipv4_addr[IPV4_ADDR_LEN];
  char                     ipv6_addr[IPV6_ADDR_LEN];
  dsi_wds_bearer_ip_type_t bearer_ip_type;
} dsi_wds_handoff_ctxt_t;
...
typedef enum
{
  DSI_APN_TYPE_INVALID = -1,
  DSI_APN_TYPE_UNSPECIFIED,
  DSI_APN_TYPE_INTERNET,
  DSI_APN_TYPE_IMS,
  DSI_APN_TYPE_VSIM,
  DSI_APN_TYPE_MMS,
  DSI_APN_TYPE_DUN,
  ...
  DSI_APN_TYPE_CBS,
  DSI_APN_TYPE_IA,
  DSI_APN_TYPE_EMERGENCY,
  DSI_APN_TYPE_MAX
} dsi_wds_apn_type_t;

typedef uint64_t dsi_wds_apn_type_mask_t;
#define DSI_APN_TYPE_MASK_UNSPECIFIED (WDS_APN_TYPE_MASK_UNSPECIFIED_V01)
#define DSI_APN_TYPE_MASK_DEFAULT     (WDS_APN_TYPE_MASK_DEFAULT_V01)
#define DSI_APN_TYPE_MASK_IMS         (WDS_APN_TYPE_MASK_IMS_V01)
#define DSI_APN_TYPE_MASK_MMS         (WDS_APN_TYPE_MASK_MMS_V01)
#define DSI_APN_TYPE_MASK_DUN         (WDS_APN_TYPE_MASK_DUN_V01)
#define DSI_APN_TYPE_MASK_SUPL        (WDS_APN_TYPE_MASK_SUPL_V01)
#define DSI_APN_TYPE_MASK_HIPRI       (WDS_APN_TYPE_MASK_HIPRI_V01)
#define DSI_APN_TYPE_MASK_FOTA        (WDS_APN_TYPE_MASK_FOTA_V01)
#define DSI_APN_TYPE_MASK_CBS         (WDS_APN_TYPE_MASK_CBS_V01)
#define DSI_APN_TYPE_MASK_IA          (WDS_APN_TYPE_MASK_IA_V01)
#define DSI_APN_TYPE_MASK_EMERGENCY   (WDS_APN_TYPE_MASK_EMERGENCY_V01)
