...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.apss.tn/3.7/csd/api/core_sound_driver_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define CSD_V01_IDL_MINOR_VERS 0x0C
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define CSD_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define CSD_V01_MAX_MESSAGE_ID 0x00B8
/**
    @}
  */
...
/**  Set the default device topologies obtained from the ACDB.
     The client uses this feature ID value to set the default topology
     that was obtained from the ACDB for the voice call.  */
#define QMI_CSD_VC_FID_TOPOLOGY_DEFAULT_V01 0

/**  Set the topology to None.
     The client uses this feature ID value to set the topology
     for the voice call to None.  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Queries the CSD version number. */
typedef struct {
...
/** @addtogroup csd_qmi_messages
    @{
   */
/** Response Message; Indicates the asynchronous spectrum-analyzed buffer production
...
typedef struct {
   ...
   uint32_t cmd_token;
   /**<   Identifier to track the command. */
 ...
 }qmi_csd_common_resp_msg_v01;  /* Message */

typedef struct _qmi_csd_voice_cmd_resp_msg_v01
 {
     union
     {
         qmi_csd_common_resp_msg_v01 qmi_csd_voice_resp;

     }u;
 }qmi_csd_voice_cmd_resp_msg;


/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Initializes the CSD before the CSD can provide any functionality. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Detaches the client from the CSD. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Instructs the CSD to return the device control handle. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Dynamically restarts the device at a new sampling rate without bring down the clocks. */
typedef struct {
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Response Message; Dynamically restarts the device at a new sampling rate without bring down the clocks. */
typedef struct {
...
typedef struct {
  ...
  uint32_t module_id;
  /**<   ID of the module to be configured. Refer to \hyperref[80-N4404-1]{80-N4404-1}
         for information on module IDs. */

  uint32_t param_id;
  /**<   ID of the parameter to be configured. Refer to \hyperref[80-N4404-1]{80-N4404-1}
  ...
  /**<   Actual data for the module ID and parameter ID. Refer to
         \hyperref[80-N4404-1]{80-N4404-1} for information on the payload for different
...
typedef struct {
  ...
  uint32_t feature_id;
  /**<   Feature ID value that is set for a
       specific feature. */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Sets the specific calibration feature ID. */
typedef struct {
  ...
  /**<   Set the calibration feature ID payload. */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Response Message; Sets the specific calibration feature ID. */
typedef struct {
...
/** @addtogroup csd_qmi_aggregates
    @{
  */
/**  Payload structure for CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE.
 */
typedef struct {
  ...
  /**<   Mode type:\n
         - 0 -- Disable HD Voice \n
         - 1 -- Enable HD Voice */
}qmi_csd_vm_ioctl_set_hdvoice_mode_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Sets the HD Voice mode on the voice manager.   */
typedef struct {
  ...
  /* Mandatory */
  /*  HD Voice Mode Type */
  qmi_csd_vm_ioctl_set_hdvoice_mode_v01 qmi_csd_vm_ioctl_set_hdvoice_mode_payload;
}qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Response Message; Sets the HD Voice mode on the voice manager.   */
typedef struct {
  ...
  qmi_csd_status_v01 qmi_csd_status_code;
  /**<   GUID for the CSD status.*/
}qmi_csd_ioctl_vm_cmd_set_hdvoice_mode_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Windows Media Audio 9 tag field. Specifies the unique ID of the codec
         ...
         - QMI_CSD_AS_WMA_TAG_ STANDARD (0x161) -- Standard \n
         - QMI_CSD_AS_WMA_TAG_ PROFESSIONAL (0x162) -- Professional \n
         - QMI_CSD_AS_WMA_TAG_ LOSSLESS (0x163) -- Lossless
    */
...
typedef struct {
  ...
  /**<   Specifies whether METADAT_BLOCK_ STREAMINFO is parsed
        successfully. When bStrmInfoPresent is set to:\n
        - 1 -- METADAT_BLOCK_ STREAMINFO is successfully parsed.\n
...
/** Request Message; Enables, configures, or disables Qconcert
           Plus Reverb (QCPR) for the audio
           stream. */
typedef struct {
...
typedef struct {
  ...
  /**<   For detailed SPA data buffer format, refer to \hyperref[80-N4404-1]{80-N4404-1}. */
...
typedef struct {
  ...
  uint32_t sample_rate;
  /**<   Tx sampling rate in Hz.         */

  uint32_t bits_per_sample;
  /**<   Bits per sample.     */
}qmi_csd_device_info_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Configures an audio device and prepares the associated audio module. */
typedef struct {
  ...
  /* Mandatory */
  /*  Voice Session ID */
  char session_id[SESSION_NAME_MAX_LEN_V01 + 1];
  /**<   Voice session ID. */

  /* Optional */
  /*  Tx Device Info */
  uint8_t tx_device_info_valid;  /**< Must be set to true if tx_device_info is being passed */
  qmi_csd_device_info_v01 tx_device_info;
  /**<   \vspace{4pt} \n Audio Tx device information. */

  /* Optional */
  /*  Rx Device Info */
  uint8_t rx_device_info_valid;  /**< Must be set to true if rx_device_info is being passed */
  qmi_csd_device_info_v01 rx_device_info;
  /**<   \vspace{4pt} \n Audio Rx device information. */

  /* Optional */
  /*  Echo Cancellation Reference Device */
  uint8_t ec_ref_device_info_valid;  /**< Must be set to true if ec_ref_device_info is being passed */
  qmi_csd_device_info_v01 ec_ref_device_info;
  /**<   \vspace{4pt} \n Echo cancellation reference device information. */
}qmi_csd_voice_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Starts a voice call with the provided audio device. */
typedef struct {
  ...
  qmi_csd_device_info_v01 ec_ref_device_info;
  /**<   Echo cancellation reference device information. */
}qmi_csd_voice_start_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Ends a voice call and tears down the associated audio device. */
typedef struct {
  ...
  uint32_t cmd_token;
  /**<   Identifier to track the command. */
}qmi_csd_voice_end_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Perform a device switch */
typedef struct {
  ...
  qmi_csd_device_info_v01 ec_ref_device_info;
  /**<   Echo cancellation reference device information. */
}qmi_csd_voice_device_switch_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Enables or disables loopback from the AFE to route Tx data to Rx. */
typedef struct {
  ...
  qmi_csd_device_info_v01 rx_device_info;
  /**<   Audio Rx device information. */
}qmi_csd_afe_loopback_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Configures system volume for voice calls. */
typedef struct {
  ...
  /**<   Index representing the volume of the sound device. */
  ...
  /**<   Ramp duration. \n
         Value: 0 to 5000 ms */
}qmi_csd_voice_volume_control_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_MUTE_MODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_VOICE_MUTE_MODE_STREAM_V01 = 0x00, /**<  Stream mute  */
  CSD_VOICE_MUTE_MODE_DEVICE_V01 = 0x01, /**<  Device mute  */
  CSD_VOICE_MUTE_MODE_STREAM_DEVICE_V01 = 0x02, /**<  Stream and device mute  */
  QMI_CSD_VOICE_MUTE_MODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_mute_mode_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_MUTE_DIRECTION_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_VOICE_MUTE_DIR_TX_V01 = 0x00, /**<  Tx mute  */
  CSD_VOICE_MUTE_DIR_RX_V01 = 0x01, /**<  Rx mute  */
  CSD_VOICE_MUTE_DIR_TX_RX_V01 = 0x02, /**<  Tx and Rx mute  */
  QMI_CSD_VOICE_MUTE_DIRECTION_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_mute_direction_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Mutes or unmutes the audio for a voice call. */
typedef struct {

  /* Mandatory */
  /*  Transaction Identifier */
  uint32_t cmd_token;
  /**<   Identifier to track command. */

  /* Mandatory */
  /*  Mute Mode */
  qmi_csd_voice_mute_mode_v01 mode;
  /**<   Mute modes. \n
 Values: \n
      - CSD_VOICE_MUTE_MODE_STREAM (0x00) --  Stream mute
      - CSD_VOICE_MUTE_MODE_DEVICE (0x01) --  Device mute
      - CSD_VOICE_MUTE_MODE_STREAM_DEVICE (0x02) --  Stream and device mute
 */
  ...
  /* Mandatory */
  /*  Mute Path Direction  */
  qmi_csd_voice_mute_direction_v01 direction;
  /**<   Mute path direction. \n
 Values:
      - CSD_VOICE_MUTE_DIR_TX (0x00) --  Tx mute
      - CSD_VOICE_MUTE_DIR_RX (0x01) --  Rx mute
      - CSD_VOICE_MUTE_DIR_TX_RX (0x02) --  Tx and Rx mute
 */
  ...
  /**<   Ramp duration. \n
         Value: 0 to 5000 ms */
}qmi_csd_voice_mute_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_DTMF_GENERATION_DIRECTION_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_DTMF_GENERATION_DIR_TX_V01 = 0x00, /**<  Tx DTMF generation  */
  CSD_DTMF_GENERATION_DIR_RX_V01 = 0x01, /**<  Rx DTMF generation  */
  QMI_CSD_DTMF_GENERATION_DIRECTION_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_dtmf_generation_direction_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_DTMF_MIX_MODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_DTMF_MIX_WITH_SPEECH_DISABLE_V01 = 0x00, /**<  Generated DTMF replaces speech.  */
  CSD_DTMF_MIX_WITH_SPEECH_ENABLE_V01 = 0x01, /**<  Generated DTMF mixes speech (default)  */
  QMI_CSD_DTMF_MIX_MODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_dtmf_mix_mode_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Generates a DTMF tone. */
typedef struct {
  ...
  /* Mandatory */
  /*  Direction */
  qmi_csd_dtmf_generation_direction_v01 direction;
  /**<   DTMF generation detection. \n
 Values: \n
      - CSD_DTMF_GENERATION_DIR_TX (0x00) --  Tx DTMF generation
      - CSD_DTMF_GENERATION_DIR_RX (0x01) --  Rx DTMF generation
 */
  ...
  /* Mandatory */
  /*  High Frequency of the DTMF Tone */
  uint16_t high_frequency;
  /**<   High frequency of the DTMF tone. \n
         Values: 0, 100 to 4000 Hz.*/

  /* Mandatory */
  /*  Low Frequency of the DTMF Tone */
  uint16_t low_frequency;
  /**<   Low frequency of the DTMF tone. \n
         Values: 0, 100 to 4000 Hz.*/

  /* Mandatory */
  /*  Gain of the DTMF Tone */
  uint16_t gain;
  /**<   DTMF tone gain. Possible value: Linear value in Q13 format. \n
         Because the level of tone generation is fixed at 0 dBFS, this
         value must be set to a negative gain.
    */

  /* Optional */
  /*  Mix Mode */
  uint8_t mix_mode_valid;  /**< Must be set to true if mix_mode is being passed */
  qmi_csd_dtmf_mix_mode_v01 mix_mode;
  /**<   This field is only applicable for Tx tone generation.\n
 Values: \n
      - CSD_DTMF_MIX_WITH_SPEECH_DISABLE (0x00) --  Generated DTMF replaces speech.
      - CSD_DTMF_MIX_WITH_SPEECH_ENABLE (0x01) --  Generated DTMF mixes speech (default)
 */

  /* Optional */
  /*  Device Info */
  uint8_t device_info_valid;  /**< Must be set to true if device_info is being passed */
  qmi_csd_device_info_v01 device_info;
  /**<   Audio device information. */
}qmi_csd_dtmf_generation_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Indication Message; Indicates that the generation of the DTMF tone has ended. */
typedef struct {
 ...
 Values: \n
      ...
      - CSD_DTMF_GENERATION_DIR_RX (0x01) --  Rx DTMF generation
 */
}qmi_csd_voice_dtmf_generation_ended_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_DTMF_DETECTION_DIR_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_VOICE_DTMF_DETECTION_TX_ONLY_V01 = 0x00, /**<  Tx only  */
  CSD_VOICE_DTMF_DETECTION_RX_ONLY_V01 = 0x01, /**<  Rx only  */
  CSD_VOICE_DTMF_DETECTION_TX_RX_V01 = 0x02, /**<  Tx and Rx  */
  QMI_CSD_VOICE_DTMF_DETECTION_DIR_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_dtmf_detection_dir_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Enables DTMF detection during a voice call. */
typedef struct {
  ...
  /* Mandatory */
  /*  Direction */
  qmi_csd_voice_dtmf_detection_dir_v01 direction;
  /**<   DTMF detection direction. \n
 Values: \n
      - CSD_VOICE_DTMF_DETECTION_TX_ONLY (0x00) --  Tx only
      - CSD_VOICE_DTMF_DETECTION_RX_ONLY (0x01) --  Rx only
      - CSD_VOICE_DTMF_DETECTION_TX_RX (0x02) --  Tx and Rx
 */
  ...
  /**<   Enable flag. Values: \n
          ...
          - 0x01 -- Enable
    */
}qmi_csd_voice_dtmf_detection_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_DTMF_DETECTED_DIRECTION_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_VOICE_TX_DTMF_DETECTED_V01 = 0x00, /**<  DTMF detected on Tx  */
  CSD_VOICE_RX_DTMF_DETECTED_V01 = 0x01, /**<  DTMF detected on Rx  */
  QMI_CSD_VOICE_DTMF_DETECTED_DIRECTION_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_dtmf_detected_direction_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Indication Message; Indicates that a DTMF tone is detected during a voice call. */
typedef struct {

  /* Mandatory */
  /*  Direction */
  qmi_csd_voice_dtmf_detected_direction_v01 direction;
  /**<   DTMF detected direction. \n
 Values: \n
      - CSD_VOICE_TX_DTMF_DETECTED (0x00) --  DTMF detected on Tx
      - CSD_VOICE_RX_DTMF_DETECTED (0x01) --  DTMF detected on Rx
 */

  /* Mandatory */
  /*  Detected Low DTMF Frequency  */
  uint16_t low_freq;
  /**<   Detected low DTMF frequency. \n
         Value: 100 to 4000 Hz.*/

  /* Mandatory */
  /*  High DTMF Frequency Detection */
  uint16_t high_freq;
  /**<   Detected hight DTMF frequency. \n
         Value: 100 to 4000 Hz.*/
}qmi_csd_voice_dtmf_detected_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_FEATURE_HDVOICE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_HDVOICE_OFF_V01 = 0x00, /**<  Disable HDVoice. This setting can be applied both before
       a voice call starts and in the middle of a voice call.
   */
  CSD_HDVOICE_ON_V01 = 0x01, /**<  Enable HDVoice. This setting can be applied both before
       a voice call starts and in the middle of a voice call.
   */
  CSD_HDVOICE_ON_WIDEVOICE2_OFF_V01 = 0x02, /**<  Enable HDVoice and force widevoice2 to be disabled. This
       setting can be applied only before a voice call starts.
   */
  CSD_HDVOICE_ON_BEAMR_OFF_V01 = 0x03, /**<  Enable HDVoice and force BeAMR to be disabled. This setting
       can be applied only before a voice call starts.
   */
  QMI_CSD_VOICE_FEATURE_HDVOICE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_feature_hdvoice_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_FEATURE_SLOWTALK_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_SLOWTALK_OFF_V01 = 0x00, /**<  Disable slow talk  */
  CSD_SLOWTALK_ON_V01 = 0x01, /**<  Enable slow talk  */
  QMI_CSD_VOICE_FEATURE_SLOWTALK_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_feature_slowtalk_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_FEATURE_TTY_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_TTY_OFF_V01 = 0x00, /**<  Disable TTY  */
  CSD_TTY_HCO_V01 = 0x01, /**<  Enable TTY in Hearing Carry-Over (HCO) mode  */
  CSD_TTY_VCO_V01 = 0x02, /**<  Enable TTY in Voice Carry-Over (VCO) mode  */
  CSD_TTY_FULL_V01 = 0x03, /**<  Enable TTY in full mode  */
  QMI_CSD_VOICE_FEATURE_TTY_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_feature_tty_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Enables voice features. */
typedef struct {
  ...
  /* Optional */
  /*  HDVoice Feature Mode */
  uint8_t hdvoice_mode_valid;  /**< Must be set to true if hdvoice_mode is being passed */
  qmi_csd_voice_feature_hdvoice_v01 hdvoice_mode;
  /**<   HDVoice feature mode: \n
 Values: \n
      - CSD_HDVOICE_OFF (0x00) --  Disable HDVoice. This setting can be applied both before
       a voice call starts and in the middle of a voice call.

      - CSD_HDVOICE_ON (0x01) --  Enable HDVoice. This setting can be applied both before
       a voice call starts and in the middle of a voice call.

      - CSD_HDVOICE_ON_WIDEVOICE2_OFF (0x02) --  Enable HDVoice and force widevoice2 to be disabled. This
       setting can be applied only before a voice call starts.

      - CSD_HDVOICE_ON_BEAMR_OFF (0x03) --  Enable HDVoice and force BeAMR to be disabled. This setting
       can be applied only before a voice call starts.

 */

  /* Optional */
  /*  Slowtalk Feature Mode */
  uint8_t slowtalk_mode_valid;  /**< Must be set to true if slowtalk_mode is being passed */
  qmi_csd_voice_feature_slowtalk_v01 slowtalk_mode;
  /**<   Slowtalk feature mode. \n
 Values: \n
      - CSD_SLOWTALK_OFF (0x00) --  Disable slow talk
      - CSD_SLOWTALK_ON (0x01) --  Enable slow talk
 */

  /* Optional */
  /*  TTY Feature Mode */
  uint8_t voice_tty_mode_valid;  /**< Must be set to true if voice_tty_mode is being passed */
  qmi_csd_voice_feature_tty_v01 voice_tty_mode;
  /**<   TTY feature mode: \n
 Values: \n
      - CSD_TTY_OFF (0x00) --  Disable TTY
      - CSD_TTY_HCO (0x01) --  Enable TTY in Hearing Carry-Over (HCO) mode
      - CSD_TTY_VCO (0x02) --  Enable TTY in Voice Carry-Over (VCO) mode
      - CSD_TTY_FULL (0x03) --  Enable TTY in full mode
 */
}qmi_csd_set_voice_feature_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_RECORD_TAP_POINT_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_VOICE_RECORD_TAP_POINT_NONE_V01 = 0x00, /**<  Do not record  */
  CSD_VOICE_RECORD_TAP_POINT_END_OF_STREAM_V01 = 0x01, /**<  Record at the end of the stream  */
  QMI_CSD_VOICE_RECORD_TAP_POINT_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_record_tap_point_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_enums
  ...
  */
typedef enum {
  QMI_CSD_VOICE_RECORD_MODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CSD_VOICE_RECORD_MODE_TX_RX_STEREO_V01 = 0x00, /**<  Select Tx on the left channel and Rx on the right channel  */
  CSD_VOICE_RECORD_MODE_TX_RX_MIXING_V01 = 0x01, /**<  Select mixed Tx and Rx paths  */
  QMI_CSD_VOICE_RECORD_MODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_csd_voice_record_mode_v01;
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Starts recording during a voice call. */
typedef struct {
  ...
  /* Mandatory */
  /*  Rx Tap Point */
  qmi_csd_voice_record_tap_point_v01 rx_tap_point;
  /**<   Rx tap point for recording. \n
 Values: \n
      - CSD_VOICE_RECORD_TAP_POINT_NONE (0x00) --  Do not record
      - CSD_VOICE_RECORD_TAP_POINT_END_OF_STREAM (0x01) --  Record at the end of the stream
 */

  /* Mandatory */
  /*  Tx Tap Point */
  qmi_csd_voice_record_tap_point_v01 tx_tap_point;
  /**<   Tx tap point. \n
 Values: \n
      - CSD_VOICE_RECORD_TAP_POINT_NONE (0x00) --  Do not record
      - CSD_VOICE_RECORD_TAP_POINT_END_OF_STREAM (0x01) --  Record at the end of the stream
 */
  ...
  /* Mandatory */
  /*  Record Mode */
  qmi_csd_voice_record_mode_v01 mode;
  /**<   Record mode. \n
 Values: \n
      - CSD_VOICE_RECORD_MODE_TX_RX_STEREO (0x00) --  Select Tx on the left channel and Rx on the right channel
      - CSD_VOICE_RECORD_MODE_TX_RX_MIXING (0x01) --  Select mixed Tx and Rx paths
 */

  /* Optional */
  /*  Device ID */
  uint8_t device_id_valid;  /**< Must be set to true if device_id is being passed */
  uint32_t device_id;
  /**<   Conversation data is available on the recording device ID.
         Data is routed to the AFE port of the device ID indicated.
         A default recording device is used if this field is not supplied. */
}qmi_csd_voice_record_start_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Ends recording in a voice call. */
typedef struct {
  ...
  uint32_t cmd_token;
  /**<   Identifier to track the command. */
}qmi_csd_voice_record_end_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Starts a playback session during a voice call. */
typedef struct {
  ...
  uint32_t device_id;
  /**<   Audio received at the device ID is delivered to the Tx voice call
          path. A default playback device is used if this field is not supplied. */
}qmi_csd_voice_playback_start_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Ends playback in a voice call. */
typedef struct {
  ...
  uint32_t cmd_token;
  /**<   Identifier to track the command. */
}qmi_csd_voice_playback_end_req_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */
//#define REMOVE_QMI_CSD_AC_CMD_AS_ATTACH_V01
//#define REMOVE_QMI_CSD_AC_CMD_AS_DETACH_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_MULTI_CHANNEL_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_EQ_ENABLE_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_QCPR_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_SPA_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_VOL_MASTER_GAIN_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_VOL_MUTE_V01
//#define REMOVE_QMI_CSD_AC_CMD_CONFIG_PP_VOL_STEREO_GAIN_V01
//#define REMOVE_QMI_CSD_AC_CMD_DISABLE_V01
//#define REMOVE_QMI_CSD_AC_CMD_ENABLE_V01
//#define REMOVE_QMI_CSD_AC_CMD_GET_SPA_DATA_V01
//#define REMOVE_QMI_CSD_AC_CMD_SET_DEVICE_V01
//#define REMOVE_QMI_CSD_AC_EVT_SPA_BUF_READY_IND_V01
//#define REMOVE_QMI_CSD_AFE_LOOPBACK_V01
//#define REMOVE_QMI_CSD_AS_CMD_ADJUST_SESSION_CLOCK_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_EAC3_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_WMAV10_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_EQ_ENABLE_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_QCPR_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_SPA_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_TSM_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_VOL_MASTER_GAIN_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_VOL_MUTE_V01
//#define REMOVE_QMI_CSD_AS_CMD_CONFIG_PP_VOL_STEREO_GAIN_V01
//#define REMOVE_QMI_CSD_AS_CMD_DTMF_CTL_V01
//#define REMOVE_QMI_CSD_AS_CMD_ENCODER_BIT_RATE_UPDATE_V01
//#define REMOVE_QMI_CSD_AS_CMD_FLUSH_STREAM_V01
//#define REMOVE_QMI_CSD_AS_CMD_FLUSH_STREAM_TX_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_DSP_CLK_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_MIDI_SEQUENCE_ID_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_RENDERED_BYTE_OFFSET_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_RENDERED_TIME_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_SESSION_ID_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_SPA_DATA_V01
//#define REMOVE_QMI_CSD_AS_CMD_GET_VOL_LEVELS_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_AAC_SBR_PS_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_DUAL_MONO_REMAP_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_EOS_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AAC_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_ADPCM_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AMRWBPLUS_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_FLAC_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_G711_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_MIDI_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_PCM_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_VORBIS_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV10_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV9_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AAC_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRNB_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRWB_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRC_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCB_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCWB_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_G711_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_PCM_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_QCELP13K_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_SBC_V01
//#define REMOVE_QMI_CSD_AS_CMD_SET_STREAM_INFO_V01
//#define REMOVE_QMI_CSD_AS_CMD_START_SESSION_V01
//#define REMOVE_QMI_CSD_AS_CMD_STOP_SESSION_V01
//#define REMOVE_QMI_CSD_AS_EVT_EOS_IND_V01
//#define REMOVE_QMI_CSD_AS_EVT_SPA_BUF_READY_IND_V01
//#define REMOVE_QMI_CSD_AS_EVT_SR_CM_CHANGE_IND_V01
//#define REMOVE_QMI_CSD_CLOSE_V01
//#define REMOVE_QMI_CSD_DEINIT_V01
//#define REMOVE_QMI_CSD_DTMF_GENERATION_V01
//#define REMOVE_QMI_CSD_INIT_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_AANC_CONTROL_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_AFE_LOOPBACK_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_ANC_CONTROL_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_COMPANDING_CONTROL_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_CONFIGURE_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_CONNECT_DEVICE_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_DISABLE_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_DTMF_CONTROL_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_ENABLE_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_GET_DEV_CAPS_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_GET_MAX_DEVICE_NUMS_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_RESTART_V01
//#define REMOVE_QMI_CSD_IOCTL_DEV_CMD_SIDETONE_CONTROL_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_DISABLE_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_ENABLE_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_GET_UI_PROPERTY_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_CAL_FEATURE_ID_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_DEVICE_CONFIG_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_MUTE_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_NUMBER_OF_VOLUME_STEPS_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_INDEX_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_STEP_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_TX_DTMF_DETECTION_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_CMD_SET_UI_PROPERTY_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_STATE_IND_V01
//#define REMOVE_QMI_CSD_IOCTL_VC_TX_DTMF_DETECTED_IND_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_ATTACH_CONTEXT_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_ATTACH_STREAM_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_DETACH_CONTEXT_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_DETACH_STREAM_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_PAUSE_VOICE_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_SET_NETWORK_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_SET_TTY_MODE_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_SET_VOICE_TIMING_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_SET_WIDEVOICE_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_STANDBY_VOICE_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_START_VOICE_V01
//#define REMOVE_QMI_CSD_IOCTL_VM_CMD_STOP_VOICE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_GET_UI_PROPERTY_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_DEC_TIMEWARP_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_DTMF_GENERATION_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_ENCODER_DTX_MODE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_ENC_MINMAX_RATE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_ENC_RATE_MODULATION_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_MEDIA_TYPE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_MUTE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_RX_DTMF_DETECTION_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_SET_UI_PROPERTY_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_START_PLAYBACK_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_START_RECORD_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_STOP_PLAYBACK_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_STOP_RECORD_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_VOC_4GVNB_SET_RATE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_VOC_4GVWB_SET_RATE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_VOC_AMRWB_SET_ENC_RATE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_VOC_AMR_SET_ENC_RATE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_CMD_VOC_QCELP13K_SET_RATE_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_DEC_BUFFER_IND_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_DTMF_GENERATION_ENDED_IND_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_ENC_BUFFER_IND_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_RX_DTMF_DETECTED_IND_V01
//#define REMOVE_QMI_CSD_IOCTL_VS_STATE_IND_V01
//#define REMOVE_QMI_CSD_OPEN_AUDIO_CONTEXT_V01
//#define REMOVE_QMI_CSD_OPEN_AUDIO_STREAM_V01
//#define REMOVE_QMI_CSD_OPEN_DEVICE_CONTROL_V01
//#define REMOVE_QMI_CSD_OPEN_FULL_CONTROL_VOICE_STREAM_V01
//#define REMOVE_QMI_CSD_OPEN_PASSIVE_CONTROL_VOICE_STREAM_V01
//#define REMOVE_QMI_CSD_OPEN_VOICE_CONTEXT_V01
//#define REMOVE_QMI_CSD_OPEN_VOICE_MANAGER_V01
//#define REMOVE_QMI_CSD_QUERY_DRIVER_VERSION_V01
//#define REMOVE_QMI_CSD_SET_VOICE_FEATURE_V01
//#define REMOVE_QMI_CSD_VOICE_CONFIG_V01
//#define REMOVE_QMI_CSD_VOICE_DEVICE_SWITCH_V01
//#define REMOVE_QMI_CSD_VOICE_DTMF_DETECTED_IND_V01
//#define REMOVE_QMI_CSD_VOICE_DTMF_DETECTION_V01
//#define REMOVE_QMI_CSD_VOICE_DTMF_GENERATION_ENDED_IND_V01
//#define REMOVE_QMI_CSD_VOICE_END_V01
//#define REMOVE_QMI_CSD_VOICE_MUTE_V01
//#define REMOVE_QMI_CSD_VOICE_PLAYBACK_END_V01
//#define REMOVE_QMI_CSD_VOICE_PLAYBACK_START_V01
//#define REMOVE_QMI_CSD_VOICE_RECORD_END_V01
//#define REMOVE_QMI_CSD_VOICE_RECORD_START_V01
//#define REMOVE_QMI_CSD_VOICE_START_V01
//#define REMOVE_QMI_CSD_VOICE_VOLUME_CONTROL_V01
...
#define QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_REQ_V01 0x00A8
#define QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_RESP_V01 0x00A8
#define QMI_CSD_VOICE_CONFIG_REQ_V01 0x00A9
#define QMI_CSD_VOICE_CONFIG_RESP_V01 0x00A9
#define QMI_CSD_VOICE_START_REQ_V01 0x00AA
#define QMI_CSD_VOICE_START_RESP_V01 0x00AA
#define QMI_CSD_VOICE_END_REQ_V01 0x00AB
#define QMI_CSD_VOICE_END_RESP_V01 0x00AB
#define QMI_CSD_VOICE_DEVICE_SWITCH_REQ_V01 0x00AC
#define QMI_CSD_VOICE_DEVICE_SWITCH_RESP_V01 0x00AC
#define QMI_CSD_AFE_LOOPBACK_REQ_V01 0x00AD
#define QMI_CSD_AFE_LOOPBACK_RESP_V01 0x00AD
#define QMI_CSD_VOICE_VOLUME_CONTROL_REQ_V01 0x00AE
#define QMI_CSD_VOICE_VOLUME_CONTROL_RESP_V01 0x00AE
#define QMI_CSD_VOICE_MUTE_REQ_V01 0x00AF
#define QMI_CSD_VOICE_MUTE_RESP_V01 0x00AF
#define QMI_CSD_DTMF_GENERATION_REQ_V01 0x00B0
#define QMI_CSD_DTMF_GENERATION_RESP_V01 0x00B0
#define QMI_CSD_VOICE_DTMF_GENERATION_ENDED_IND_V01 0x00B1
#define QMI_CSD_VOICE_DTMF_DETECTION_REQ_V01 0x00B2
#define QMI_CSD_VOICE_DTMF_DETECTION_RESP_V01 0x00B2
#define QMI_CSD_VOICE_DTMF_DETECTED_IND_V01 0x00B3
#define QMI_CSD_SET_VOICE_FEATURE_REQ_V01 0x00B4
#define QMI_CSD_SET_VOICE_FEATURE_RESP_V01 0x00B4
#define QMI_CSD_VOICE_RECORD_START_REQ_V01 0x00B5
#define QMI_CSD_VOICE_RECORD_START_RESP_V01 0x00B5
#define QMI_CSD_VOICE_RECORD_END_REQ_V01 0x00B6
#define QMI_CSD_VOICE_RECORD_END_RESP_V01 0x00B6
#define QMI_CSD_VOICE_PLAYBACK_START_REQ_V01 0x00B7
#define QMI_CSD_VOICE_PLAYBACK_START_RESP_V01 0x00B7
#define QMI_CSD_VOICE_PLAYBACK_END_REQ_V01 0x00B8
#define QMI_CSD_VOICE_PLAYBACK_END_RESP_V01 0x00B8
/**
    @}
  */
