    ...
    public static boolean handleVendorMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_VENDOR_START_SECCAM_USECASE: {
                Bundle in_bundle = msg.getData();
                long result = in_bundle.getLong("result");
                Log.d(LOG_TAG, "handleVendorMessage(MSG_VENDOR_START_SECCAM_USECASE) - result: " + result);
                ret = true;
                break;
            }
            case MSG_VENDOR_STOP_SECCAM_USECASE: {
                Bundle in_bundle = msg.getData();
                long result = in_bundle.getLong("result");
                Log.d(LOG_TAG, "handleVendorMessage(MSG_VENDOR_STOP_SECCAM_USECASE) - result: " + result);
                ret = true;
                break;
            }
            default:
