...
#define IMSS_V01_IDL_MINOR_VERS 0x54
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSS_V01_MAX_MESSAGE_ID 0x00A2
/**
    @}
  */
...
#define IMS_SETTINGS_RCS_DEVICE_STRING_LEN_MAX_V01 31
/**
    @}
  */
...
typedef enum {
  ...
  IMS_SETTINGS_MSG_VALUE_NOT_SUPPORTED_V01 = 6, /**<  Value not supported  */
...
typedef enum {
  ...
  IMS_SETTINGS_CALL_MODE_PREFERRED_IMS_V01 = 5, 
...
typedef enum {
  ...
  IMS_SETTINGS_MSG_DUPLICATE_SEGMENT_ERR_V01 = 0x01, /**<  Failure if seq_num already exists in modem for a particular sent ref_num in request then modem will   discard all pervious stored segments. HLOS needs to resend the segments starting from first segment.  */
  IMS_SETTINGS_MSG_INCORRECT_SEQ_NUM_ERR_V01 = 0x02, /**<  Failure if there is mismatch between seq_num and seg_count then this error shall be returned in response. For example, seg_count = 10 and seq_num received = 0 or greater than 10 then returns this error.  */
...
/** @addtogroup imss_qmi_enums
  ...
  */
typedef enum {
  IMS_SETTINGS_DISCARD_FAILURE_CODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_SETTINGS_DISCARD_FAILURE_NONE_V01 = 0, /**<   None  */
  IMS_SETTINGS_DISCARD_FAILURE_MTU_EXCEEDED_V01 = 1, /**<   Maximum transfer unit  */
  IMS_SETTINGS_DISCARD_FAILURE_BW_EXCEEDED_V01 = 2, /**<   Bandwidth  */
  IMS_SETTINGS_DISCARD_FAILURE_CODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}ims_settings_discard_failure_code_v01;
/**
    @}
  */
...
/**  Enumeration for all the IMS Settings service specific Response 
 ...
 QVP RTP SDP bandwidth specific to the codec option.
  ...
  IMS Default Bearer Policy.
 
 Specifies information about the type of line 
 
 DIGITS Feature Enabled
   */
typedef uint64_t IMS_PDN_HO_ROAMING_DISABLED_MASK_v01;
#define IMS_HO_DISABLED_NONE_V01 ((IMS_PDN_HO_ROAMING_DISABLED_MASK_v01)0x0000ull) 
#define IMS_HO_DISABLED_ALL_V01 ((IMS_PDN_HO_ROAMING_DISABLED_MASK_v01)0x0001ull) 
#define IMS_HO_DISABLED_BETWEEN_LTE_AND_IWLAN_V01 ((IMS_PDN_HO_ROAMING_DISABLED_MASK_v01)0x0002ull) 
#define IMS_HO_DISABLED_BETWEEN_NR_AND_IWLAN_V01 ((IMS_PDN_HO_ROAMING_DISABLED_MASK_v01)0x0004ull) 
#define IMS_HO_DISABLED_BETWEEN_3G_AND_IWLAN_V01 ((IMS_PDN_HO_ROAMING_DISABLED_MASK_v01)0x0008ull) 
#define IMS_HO_DISABLED_BETWEEN_2G_AND_IWLAN_V01 ((IMS_PDN_HO_ROAMING_DISABLED_MASK_v01)0x0010ull) 
...
#define IMS_SETTINGS_OMADM_SERVICES_VOLTE_RESTRICT_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x20ull) /**<  VoLTE service restrict  */
#define IMS_SETTINGS_OMADM_SERVICES_VT_RESTRICT_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x40ull) /**<  VT service restrict  */
#define IMS_SETTINGS_OMADM_SERVICES_VOLTE_RESTRICT_ROAMING_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x80ull) /**<  VoLTE service restrict roaming  */
#define IMS_SETTINGS_OMADM_SERVICES_VT_RESTRICT_ROAMING_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x100ull) /**<  VT service restrict roaming  */
#define IMS_SETTINGS_OMADM_SERVICES_VOWIFI_RESTRICT_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x200ull) /**<  VoWiFi service restrict  */
#define IMS_SETTINGS_OMADM_SERVICES_VTWIFI_RESTRICT_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x400ull) /**<  VTWiFi service restrict  */
/**  Bitmask values for AMR NB values.
  */
typedef uint64_t ims_settings_amr_nb_codec_mode_type_mask_v01;
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_0_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x0ull) /**<  AMR 4.75 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_1_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x1ull) /**<  AMR 5.15 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_2_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x2ull) /**<  AMR 5.90 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_3_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x4ull) /**<  AMR 6.17 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_4_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x8ull) /**<  AMR 7.40 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_5_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x10ull) /**<  AMR 7.95 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_6_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x20ull) /**<  AMR 10.20 kpbs.  */
#define IMS_SETTINGS_AMR_NB_CODEC_MODE_7_BIT_MASK_V01 ((ims_settings_amr_nb_codec_mode_type_mask_v01)0x40ull) /**<  AMR 12.20 kpbs.  */
/**  Bitmask values for AMR WB values.
  */
typedef uint64_t ims_settings_amr_wb_codec_mode_type_mask_v01;
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_8_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x0ull) /**<  AMR-WB 6.60 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_9_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x1ull) /**<  AMR-WB 8.85 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_10_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x2ull) /**<  AMR-WB 12.65 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_11_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x4ull) /**<  AMR-WB 14.25 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_12_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x8ull) /**<  AMR-WB 15.85 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_13_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x10ull) /**<  AMR-WB 18.25 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_14_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x20ull) /**<  AMR-WB 19.85 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_15_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x40ull) /**<  AMR-WB 23.05 kbps.  */
#define IMS_SETTINGS_AMR_WB_CODEC_MODE_16_BIT_MASK_V01 ((ims_settings_amr_wb_codec_mode_type_mask_v01)0x80ull) /**<  AMR-WB 23.85 kbps.  */
...
typedef struct {
  ...
  uint8_t is_gzipped;
  /**<   TRUE if this content is gzipped; otherwise FALSE.
  */

  uint8_t ref_num;
  /**<   This cookie is a module of 256 numbers which remains the same for all the segments 
       composing the original long content split into "seg_count" segments.
  */

  uint8_t seq_num;
  /**<   Starts with 1, increments by 1, the last seq\_num is the same as the total 
      segments composing the content of seg\_count. If same seq\_num and ref\_num 
      are received again, it is treated as an error condition and all saved segments
      are discarded.
  */
 ...
 */
  ...
  /* Optional */
  /*  IMS Emergency LTE Threshold1 */
  uint8_t iIMSHOEmerLTEQualTH1_valid;  /**< Must be set to true if iIMSHOEmerLTEQualTH1 is being passed */
  int32_t iIMSHOEmerLTEQualTH1;
  /**<   Defines the LTE Threshold 1 for EPDN. 
         Handover scenario is LTE to Wi-Fi. Used for In-call mode for voice only. \n
		 Default value: -117 db
	*/

  /* Optional */
  /*  IMS Emergency LTE Threshold2 */
  uint8_t iIMSHOEmerLTEQualTH2_valid;  /**< Must be set to true if iIMSHOEmerLTEQualTH2 is being passed */
  int32_t iIMSHOEmerLTEQualTH2;
  /**<   Defines LTE Threshold 2. Handover scenario is Wi-Fi to LTE. 
         Used for In-call mode for voice only. \n
		 Default value: -115 db
	*/

  /* Optional */
  /*  IMS Emergency LTE Threshold3  */
  uint8_t iIMSHOEmerLTEQualTH3_valid;  /**< Must be set to true if iIMSHOEmerLTEQualTH3 is being passed */
  int32_t iIMSHOEmerLTEQualTH3;
  /**<   Defines LTE Threshold 3. Handover scenario is Wi-Fi to LTE and LTE to Wi-Fi.
         Used for In-call mode for voice only. \n
		 Default value: -110 db
	*/

  /* Optional */
  /*  Handover Roaming disabled mask on IMS PDN */
  uint8_t ims_pdn_ho_roaming_disabled_mask_valid;  /**< Must be set to true if ims_pdn_ho_roaming_disabled_mask is being passed */
  IMS_PDN_HO_ROAMING_DISABLED_MASK_v01 ims_pdn_ho_roaming_disabled_mask;
  /**<   Handover Roaming disabled mask on IMS PDN
	   Default value is IMS_HO_DISABLED_NONE \n
    */
...
typedef struct {
  ...
  /**<   \n Array of RAT and APN extended information parameters. */
 ...
 */
  ...
  uint8_t wlan_to_3gpp_idle_mode_hys_timer_valid;  /**< Must be set to true if wlan_to_3gpp_idle_mode_hys_timer is being passed */
  uint32_t wlan_to_3gpp_idle_mode_hys_timer;
  /**<   QMI Get response for the Hysteresis timer duration (in seconds), during which 
		 movement of voice services from WLAN to a 3GPP RAT is blocked. \n 
         This timer is started in Cellular Preferred mode if IMS PDN moved from
         a UTRAN/GERAN RAT to WLAN during Idle mode because of a UTRAN/GERAN RAT loss. 
	*/
  ...
  uint32_t wlan_to_3gpp2_idle_mode_hys_timer;
  /**<   QMI Get response for the Hysteresis timer duration (in seconds), during which 
		 movement of voice services from WLAN to a 3GPP2 RAT is blocked. \n 
         This timer is started in Cellular Preferred mode if IMS PDN moved from
         an eHRPD/eVDO RAT to WLAN during Idle mode because of an eHRPD/eVDO RAT loss. 
	*/
  ...
  uint32_t wlan_to_1x_idle_mode_hys_timer;
  /**<   QMI Get response for the Hysteresis timer duration (in seconds), during which 
         movement of voice services from WLAN to a 1X RAT is blocked. \n 
         This timer is started in Cellular Preferred mode if IMS PDN is brought
         up on WLAN during Idle mode because of a 1X RAT loss.
	*/
  ...
  uint32_t wlan_to_lte_voip_cell_pref_timer;
  /**<   QMI Get response for the Hysteresis timer duration (in seconds), during which 
	     movement of voice services from WLAN to an LTE RAT during a VOIP call is blocked. \n 
         This timer is started in Cellular Preferred mode if IMS PDN moved from
         an LTE RAT to WLAN during a VOIP call because of an LTE RAT loss. 
	*/
  ...
  uint32_t wlan_to_lte_vt_cell_pref_timer;
  /**<   QMI Get response for the Hysteresis timer duration (in seconds), during which 
	     movement of video services from WLAN to an LTE RAT during a video call is blocked. \n 
         This timer is started in Cellular Preferred mode if IMS PDN moved from
         an LTE RAT to WLAN during a video call because of an LTE RAT loss. 
	*/
  ...
  uint32_t wwan_to_wlan_all_mode_hysteresis_timer;
  /**<   This timer is started when IMS hands over or moves from Wi-Fi to any
         cellular RAT (LTE, eHRPD, and so on.) to avoid returning to Wi-Fi 
	     immediately, thereby avoiding PDN ping-pongs. It is started during
  ...
  uint8_t iIMSHOEmerLTEQualTH2_valid;  /**< Must be set to true if iIMSHOEmerLTEQualTH2 is being passed */
  int32_t iIMSHOEmerLTEQualTH2;
  /**<   Defines LTE Threshold 2. Handover scenario: Wi-Fi to LTE. 
         Used for In-call mode for voice only. \n
		 Default value: -115 db
	*/
...
typedef struct {
  ...
  /**<   IMS handover hysteresis timer for WLAN to WWAN, in seconds.
	     This timer is started if the LTE to WLAN Idle mode handover
	     occurs because of an LTE RAT loss. When in Cellular Preferred mode,
	     a WLAN to LTE handover only occurs after LTE is available for this
	     period of time. If this value is not present, a default value of 120 s
	     is used.
	*/
...
typedef struct {
  ...
  /* Optional */
  /*  RCS Device Name */
  uint8_t friendly_device_name_valid;  /**< Must be set to true if friendly_device_name is being passed */
  char friendly_device_name[IMS_SETTINGS_RCS_DEVICE_STRING_LEN_MAX_V01 + 1];
  /**<   RCS friendly device name. If not set, the default is MyDevice.
    */

  /* Optional */
  /*  RCS Profile */
  uint8_t rcs_profile_valid;  /**< Must be set to true if rcs_profile is being passed */
  char rcs_profile[IMS_SETTINGS_RCS_STRING_LEN_MAX_V01 + 1];
  /**<   Terminal RCS profile. If not set, the default is UP1.0.
    */

  /* Optional */
  /*  Chat Bot Version Supported by Client */
  uint8_t bot_version_valid;  /**< Must be set to true if bot_version is being passed */
  char bot_version[IMS_SETTINGS_RCS_STRING_LEN_MAX_V01 + 1];
  /**<   Chat bot version supported by the client.
...
typedef struct {
  ...
  /**<   Indicates which URI to use in header.
        Values: \n
        -0 -- URI from header field is not used
        -1 -- URI from header field is used
    */

  /* Optional */
  /*  IMS Application Reliable Response */
  uint8_t reliable_response_enabled_valid;  /**< Must be set to true if reliable_response_enabled is being passed */
  uint8_t reliable_response_enabled;
  /**<   Indicates whether reliable response is enabled.
        Values: \n
        -TRUE -- Enabled \n
        -FALSE -- Disabled (default)
    */
  ...
  /* Optional */
  /*  QoS Reservation Timer  */
  uint8_t qos_reservation_timer_valid;  /**< Must be set to true if qos_reservation_timer is being passed */
  uint32_t qos_reservation_timer;
  /**<   Duration of the QoS reservation timer, in milliseconds.
         If not set, the default is 10000.
    */

  /* Optional */
  /*  QoS Reservation Timer EPS only Attach  */
  uint8_t qos_reservation_timer_eps_only_attach_valid;  /**< Must be set to true if qos_reservation_timer_eps_only_attach is being passed */
  uint32_t qos_reservation_timer_eps_only_attach;
  /**<   Duration of the QoS reservation timer for EPS attach only, in milliseconds.
         If not set, the default is 10000.
    */
...
typedef struct {
  ...
  /**<     
		The AMR modeset used for SDP Answer when an open offer is selected. Valid range is [0-0xFF].
        If not set, the default value is 149 (0x95 for modeset 0,2,4,7; based on specification)
        Value interpretation is amr_modesetans | bitmask for AMR modeset (starts from bit 0 to 
        bit 7: each bit represents one modeset from modeset 0 to modeset 7). The default value is 0
		for the IR 92 default configuration. The maximum value to enable all AMR voice modesets is 
		255, which is 0xFF.
    */
  ...
  /**<     
		The AMR-WB modeset used for SDP Answer when open offer is selected. Valid Range is [0-0x1FF].
        If not set, the default value is 0. Value interpretation is amrwb_modesetans | bitmask 
        for AMR WB modeset (starts from bit 0 to bit 8: each bit represents one modeset from 
        modeset 0 to modeset 8). The default value is 0	for the IR 92 default configuration. 
		The maximum value to enable all AMR voice modesets is 255, which is 0xFF.
   */
...
typedef struct {
  ...
  /* Optional */
  /*  Emergency QoS Reservation Timer */
  uint8_t e911_qos_reservation_timer_valid;  /**< Must be set to true if e911_qos_reservation_timer is being passed */
  uint32_t e911_qos_reservation_timer;
  /**<   
        Emergency QoS reservation timer, in milliseconds.
        If not set, the default is 10000.
    */
...
typedef struct {
  ...
  /**<   Configures the phone context policy for the operator. Range is 0-255.
		 Values:  \n
         - 1 - Home-local number \n
         - 2 - Geo-local number \n
         - 0,3-255 - Not assigned \n
         Default value = 1 is derived from NV.
    */
...
typedef struct {
  ...
  uint8_t sms_enabled;
  /**<   Enable/disable SMS over the IP network indication.
         Values: \n
        - TRUE -- Enable  \n
        - FALSE -- Disable (default)
    */
  ...
  /* Optional */
  /*  Call Mode Preference Roaming Service Status (Deprecated) */
  ...
  /* Optional */
  /*  Call Mode Roam Preference */
  uint8_t call_mode_roam_preference_valid;  /**< Must be set to true if call_mode_roam_preference is being passed */
  ims_settings_call_mode_option_enum_v01 call_mode_roam_preference;
  /**<   When Wi-Fi is enabled, a call mode roam preference is selected for calls
         as cellular preferred or Wi-Fi preferred. If not set, the default is the 
         operator preference in the MBN.
    */

  /* Optional */
  /*  Carrier Config */
  uint8_t carrier_config_enabled_valid;  /**< Must be set to true if carrier_config_enabled is being passed */
  uint8_t carrier_config_enabled;
  /**<   Enable/disable carrier config.
         Values: \n
        - TRUE (1) -- Enable  \n
        - FALSE (0) -- Disable (default)
    */
  ...
  /* Optional */
  /*  Call Mode Preference */
  uint8_t call_mode_preference_ext_valid;  /**< Must be set to true if call_mode_preference_ext is being passed */
  ims_settings_call_mode_option_enum_v01 call_mode_preference_ext;
  /**<   When Wi-Fi is enabled, a call mode preference can be selected for calls
         as cellular preferred or Wi-Fi preferred.
         If not set, the default is operator specific.
    */
  ...
  /* Optional */
  /*  Call Mode Roam Preference */
  uint8_t call_mode_roam_preference_ext_valid;  /**< Must be set to true if call_mode_roam_preference_ext is being passed */
  ims_settings_call_mode_option_enum_v01 call_mode_roam_preference_ext;
  /**<   When Wi-Fi is enabled, a call mode roam preference is selected for calls
         as cellular preferred or Wi-Fi preferred. If not set, the default is the 
         operator preference in the MBN.
    */
...
typedef struct {
  ...
  ims_settings_call_mode_option_enum_v01 call_mode_roam_preference;
  /**<   When Wi-Fi is enabled, a call mode roam preference is selected for calls
         as cellular preferred or Wi-Fi preferred. If not set, the default is 
         the operator preference in the MBN.
    */
...
typedef struct {
  ...
  /* Optional */
  /*  Call Mode Preference Roaming Serivce Status (Deprecated) */
  uint8_t call_mode_pref_roam_enabled_valid;  /**< Must be set to true if call_mode_pref_roam_enabled is being passed */
  uint8_t call_mode_pref_roam_enabled;
...
typedef struct {
  ...
  /* Optional */
  /*  Send RTT Message Consumed Data Length */
  uint8_t rtt_consumed_data_len_valid;  /**< Must be set to true if rtt_consumed_data_len is being passed */
  uint32_t rtt_consumed_data_len;
  /**<   Total RTT consumed data.
    */

  /* Optional */
  /*  Send Time to Unblock RTT Message */
  uint8_t time_to_unblock_valid;  /**< Must be set to true if time_to_unblock is being passed */
  uint32_t time_to_unblock;
  /**<   Time to unblock. If not set, the default value is 0 (unblocked).
    */

  /* Optional */
  /*  RTT Message Discard Data Failure Code */
  uint8_t discard_failure_code_valid;  /**< Must be set to true if discard_failure_code is being passed */
  ims_settings_discard_failure_code_v01 discard_failure_code;
  /**<   Failure code for discarding the RTT data. If not set, the default value is
         IMS_SETTINGS_DISCARD_FAILURE_NONE.
    */
...
typedef struct {
  ...
  /**<   Out-of-band procedures HLOS uses to determine whether TMO digits is enabled, disabled, or 
       pending. Values: \n
       - Disabled = 0 \n
	   - Enabled = 1  \n
	   - Pending = 2
  */
  ...
  uint8_t no_of_lines;
  /**<   Determines the number of virtual lines included in the IMS registration. */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Sent from HLOS to notify IMS of an IMS/RCS configuration update from 
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Sent from HLOS to notify IMS of an IMS/RCS configuration update from 
             the entitlement server. */
typedef struct {
  ...
  /**<   Segment status error code is returned when the qmi_response_type error type 
         is QC_QMI_RESPONSE_FAILURE.
       		*/
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Indication Message; Indicates to HLOS the status of all the received segments for RCS/IMS 
             configuration. */
typedef struct {

  /* Mandatory */
  /*  Update HLOS with Received Segment Status Ref No */
  uint8_t ref_num;
  /**<   Reference number of the carrier configuration.
    */

  /* Mandatory */
  /*  Update HLOS with Received Segment Status */
  ims_settings_carrier_config_status_v01 config_status;
  /**<   Status of the configuration content.
    		*/
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Sets the precondition dynamic configuration parameters for the 
             requesting control point. */
typedef struct {
  ...
  /**<   Indicates whether precondition is enabled overall.
        Values: \n
        - 0 -- Disabled	 \n
        - 1 -- Enabled (default)
    */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Sets the precondition dynamic configuration parameters for the 
             requesting control point. */
typedef struct {
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Retrieves the precondition dynamic configuration parameters. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Retrieves the precondition dynamic configuration parameters. */
typedef struct {
...
typedef struct {
  ...
  /**<   SMS over IP/IMS usage policy with respect to voice enabled or disabled 
         from domain selection.
        Values: \n
        - 0 -- Use SMSoIP only if voice over PS is available and only on the IP-CAN 
          that is used for the transport of SIP signaling associated with voice over PS. 
          For example, E-UTRAN and/or EPC-integrated WLAN. (default) \n
        - 1 -- Use SMSoIP only if voice over PS is available and on any IP-CAN. For example,
          E-UTRAN, EPC-integrated WLAN, UTRAN, and/or GERAN. \n
        - 2 -- Use SMSoIP irrespective of whether voice over PS is available and on any IP-CAN. 
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Resets the MSIM-related user settings.  */
typedef struct {

  /* Optional */
  /*  Auto-Reject Flag for MT Call  */
  uint8_t auto_reject_call_enabled_valid;  /**< Must be set to true if auto_reject_call_enabled is being passed */
  uint8_t auto_reject_call_enabled;
  /**<   If this flag/user setting is enabled by the user on one sub, IMS sends a 
         missed call notification to that sub upon receiving an MT call. If this 
         TLV is not included in the request, a value of FALSE (disabled) is used. 
	*/
}ims_settings_set_concurrency_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Resets the MSIM-related user settings.  */
typedef struct {
  ...
  /**<   Contains the following data members: \n
       ...
       - qmi_error_type  -- Error code. Possible error code values are described 
                            ...
                            definition.
    */
}ims_settings_set_concurrency_config_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_IMS_SETTINGS_SET_CONCURRENCY_CONFIG_V01 
...
#define QMI_IMS_SETTINGS_SET_CONCURRENCY_CONFIG_REQ_V01 0x00A2
#define QMI_IMS_SETTINGS_SET_CONCURRENCY_CONFIG_RSP_V01 0x00A2
/**
    @}
  */
