...
#define MAX_MODEM_BW_LEVEL  (5)
#define QMI_MODEM_SKIN "modem_skin"
#define MAX_MODEM_SKIN_LEVEL  (3)
#define QMI_WLAN_BW "wlan_bw"
#define MAX_WLAN_BW_LEVEL  (1)
...
static struct qmi_dev_info modem_devs[] = {
	...
	{
		.dev_name = QMI_WLAN_BW,
		.debug_name = WLAN_BW_DEV_NAME,
	},
};
...
/*===========================================================================
FUNCTION wlan_bw_request

Action function to throttle wlan bandwidth.

ARGUMENTS
	level - 0-1 throttling level for wlan bandwidth
...
int wlan_bw_request(int level)
{
	...
	/* WLAN bw level: 0 - No action
	 *		1 - Mitigation level 1
	 */
	ret = generic_qmi_request(level, MAX_WLAN_BW_LEVEL,
				  &modem_clnt, QMI_WLAN_BW,
				  WLAN_BW_DEV_NAME);
