...
#ifndef __MODULE_SCALER44_H__
#define __MODULE_SCALER44_H__
 ...
 *  @mutex: Mutex lock for scaler44 private data structure
 ...
 *  @enable: scaler44 module enable/disable flag
...
typedef struct {
  ...
  uint32_t                       crop_factor_applied;
  uint32_t                       crop_factor_calculate_crop;
