...
LOCAL_SRC_FILES += qcril_qmi/services/qmi_ims_vt_v01.c
...
LOCAL_SRC_FILES += common/uim/SecureElement.cc
LOCAL_SRC_FILES += common/uim/RadioConfig.cc
...
LOCAL_SRC_FILES += common/data/qcril_data_connectionservice.cc
...
LOCAL_INIT_RC := qcril_qmi/vendor.rild.rc
else
LOCAL_INIT_RC := qcril_qmi/vendor.rild.legacy.rc
endif
endif
