...
public class GpsNetInitiatedHandler {
    ...
    public void handleNiNotification(GpsNiNotification notif, boolean esEnabled)
    {
    ...
    private synchronized void handleNiInEs(GpsNiNotification notif) {
        ...
        */
        if (notif.niType != GPS_NI_TYPE_UMTS_CTRL_PLANE &&
                (notif.niType == GPS_NI_TYPE_EMERGENCY_SUPL) != isUEInEmergencyMode) {
    ...
    private synchronized void setNiNotification(GpsNiNotification notif) {
        ...
        mBuilder.setSmallIcon(com.android.internal.R.drawable.stat_sys_gps_on);
        mBuilder.setContentTitle(title);
        mBuilder.setContentText(message);
        mBuilder.setDefaults(Notification.DEFAULT_SOUND);
        mBuilder.setOngoing(true);
        mBuilder.setAutoCancel(true);
        mBuilder.setTicker(getNotifTicker(notif, mContext));
        ...
        notificationManager.notify(notif.notificationId, mBuilder.build());
    }
