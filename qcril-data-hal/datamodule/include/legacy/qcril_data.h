/******************************************************************************
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2009-2010, 2013-2015, 2017-2019 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
typedef enum
{
  ...
  QCRIL_DATA_RIL_RADIO_TECH_IWLAN   = QCRIL_DATA_CONVERT_RIL_RADIOTECH(RADIO_TECH_IWLAN),
...
/*!
  @brief
  Maps qcril_data_ril_radio_tech_t to RIL_RadioAccessNetworks

  @return
  RIL_RadioAccessNetworks value corresponding to the qcril_data_ril_radio_tech_t
*/
/*===========================================================================*/
RIL_RadioAccessNetworks
qcril_data_get_access_network_from_radio_tech
(
...
/*===========================================================================
  ...
  FUNCTION:  qcril_data_is_threshold_based_reporting_supported
...
/*!
    ...
    @returns
    TRUE : if Threshold based reporting is supported
    FALSE : Otherwise
*/
/*=========================================================================*/
...
/**
 * @brief      Toggle Link quality reporting
 *
...
/**
 * @brief      Set Link quality reporting criteria
 *
 * @param[in]  criteria the new criteria
 *
 * @return     0 if succ, -1 if failed
 */
...
void deallocate_cid( const qcril_instance_id_e_type instance_id,
                     const RIL_Token token );
