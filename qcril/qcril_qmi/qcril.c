...
static qcril_dispatch_table_entry_type qcril_event_table[] =
{
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_INTERNAL_UIM_SAP_REQ, qcril_uim_sap_process_request ) },
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_UIM_LPA_QMI_COMMAND_CALLBACK, qcril_uim_lpa_process_qmi_callback ) },
    /* QCRIL_EVT_UIM_HTTP_QMI_TRANSACTION_COMPLETED_CALLBACK */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_UIM_HTTP_QMI_TRANSACTION_COMPLETED_CALLBACK, qcril_uim_http_process_transaction_completed_qmi_callback ) },

  /* QCRIL_EVT_UIM_HTTP_QMI_INDICATION_CALLBACK */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_UIM_HTTP_QMI_INDICATION_CALLBACK, qcril_uim_http_process_qmi_indication ) },
...
#if defined RIL_REQUEST_SIM_QUERY_ATR
  /* 141 - RIL_REQUEST_SIM_QUERY_ATR */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_SIM_QUERY_ATR, qcril_uim_request_get_atr ) },
#endif /* RIL_REQUEST_SIM_QUERY_ATR */
  ...
  /* 140 - RIL_REQUEST_SET_SIM_CARD_POWER */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_SET_SIM_CARD_POWER, qcril_uim_request_uicc_power ) },
  ...
  /* QCRIL_EVT_HOOK_UICC_POWER_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_UICC_POWER_REQ, qcril_uim_request_uicc_power ) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_ENTER_DEPERSONALIZATION_REQ, qcril_uim_request_enter_perso_key ) },

  /* QCRIL_EVT_HOOK_SLOT_GET_CARD_STATE_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SLOT_GET_CARD_STATE_REQ, qcril_uim_request_get_sim_status ) },

  /* QCRIL_EVT_HOOK_SLOT_GET_ATR_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SLOT_GET_ATR_REQ, qcril_uim_request_get_atr ) },

  /* QCRIL_EVT_HOOK_SLOT_SEND_APDU_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SLOT_SEND_APDU_REQ, qcril_uim_request_send_apdu ) },

  /* QCRIL_EVT_HOOK_SWITCH_SLOT_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SWITCH_SLOT_REQ, qcril_uim_request_switch_slot ) },

  /* QCRIL_EVT_HOOK_GET_PHYSICAL_SLOT_MAPPING_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_PHYSICAL_SLOT_MAPPING_REQ, qcril_uim_request_get_physical_slot_mapping ) },

  /* QCRIL_EVT_HOOK_SLOT_CARD_POWER_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SLOT_CARD_POWER_REQ, qcril_uim_request_uicc_power ) },

  /* QCRIL_EVT_HOOK_SLOT_SET_APDU_BEHAVIOR_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SLOT_SET_APDU_BEHAVIOR_REQ, qcril_uim_request_set_apdu_behavior ) },

  /* QCRIL_EVT_HOOK_SLOT_GET_SLOT_STATUS_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_SLOTS_STATUS_REQ, qcril_uim_request_get_slots_status ) },

  /* QCRIL_EVT_HOOK_GET_TERMINAL_CAPABILITY_LPA_TLV_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_TERMINAL_CAPABILITY_LPA_TLV_REQ, qcril_uim_request_get_terminal_capability ) },

  /* QCRIL_EVT_HOOK_SET_TERMINAL_CAPABILITY_LPA_TLV_REQ */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SET_TERMINAL_CAPABILITY_LPA_TLV_REQ, qcril_uim_request_set_terminal_capability ) },
  ...
  /* QCRIL_EVT_QMI_PROV_ACTIVATE_FOLLOW_UP */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_PROV_ACTIVATE_FOLLOW_UP, qcril_qmi_prov_subs_activate_followup ) },

  /*QCRIL_EVT_QMI_PROV_DEACTIVATE_FOLLOW_UP */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_PROV_DEACTIVATE_FOLLOW_UP, qcril_qmi_prov_subs_deactivate_followup ) },
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_INIT, qcril_mbn_hw_update_init_hdlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_DISABLED_INIT */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_DISABLED_INIT, qcril_mbn_hw_update_disabled_init_hdlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_GET_SELECTED_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_GET_SELECTED_CONFIG, qcril_mbn_hw_query_selected_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_DEACTIVATE_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_DEACTIVATE_CONFIG, qcril_mbn_hw_deactivate_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_DELETE_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_DELETE_CONFIG, qcril_mbn_hw_delete_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_LOAD_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_LOAD_CONFIG, qcril_mbn_hw_load_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_SELECT_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_SELECT_CONFIG, qcril_mbn_hw_select_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_HW_ACTIVATE_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_HW_ACTIVATE_CONFIG, qcril_mbn_hw_activate_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_DISALBLE_MODEM_UPDATE */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_DISALBLE_MODEM_UPDATE , qcril_mbn_sw_disable_modem_update_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_INIT */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_VERIFY_MBN_SW_INIT, qcril_mbn_sw_update_init_helper) },

  /* QCRIL_EVT_REQUEST_MBN_SW_INIT */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_INIT, qcril_mbn_sw_update_init_hdlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_GET_SELECTED_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_GET_SELECTED_CONFIG, qcril_mbn_sw_query_selected_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_GET_CONFIG_INFO */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_GET_CONFIG_INFO, qcril_mbn_sw_get_config_info_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_DEACTIVATE_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_DEACTIVATE_CONFIG, qcril_mbn_sw_deactivate_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_DELETE_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_DELETE_CONFIG, qcril_mbn_sw_delete_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_LOAD_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_LOAD_CONFIG, qcril_mbn_sw_load_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_SELECT_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_SELECT_CONFIG, qcril_mbn_sw_select_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_ACTIVATE_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_ACTIVATE_CONFIG, qcril_mbn_sw_activate_config_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_CLEANUP_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_CLEANUP_CONFIG, qcril_mbn_sw_cleanup_config_hndlr) },

  /* QCRIL_EVT_QMI_RIL_PDC_DELETE_ALL */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_RIL_PDC_DELETE_ALL, qcril_mbn_pdc_delete_all_sw_configs) },

  /* QCRIL_EVT_REQUEST_MBN_SW_COUNT_PENDING_CONFIGS */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_COUNT_PENDING_CONFIGS, qcril_mbn_sw_count_pending_configs_hndlr) },

  /* QCRIL_EVT_REQUEST_MBN_SW_QUERY_PENDING_CONFIG */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_REQUEST_MBN_SW_QUERY_PENDING_CONFIG, qcril_mbn_pdc_query_pending_sw_config) },

  /* QCRIL_EVT_QMI_NAS_BAR_FAKE_GCELL */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_NAS_BAR_FAKE_GCELL, qcril_qmi_nas_bar_fake_gcell ) },
  ...
  {  QCRIL_REG_ALL_STATES(QCRIL_EVT_DATA_ASYNC_CALLBACK, qcril_data_async_hdlr) },
  {  QCRIL_REG_ALL_STATES(QCRIL_EVT_DATA_SET_RAT_PREF_CALLBACK, qcril_data_set_rat_pref_hdlr) },

#ifdef FEATURE_DATA_LQE
  /* QCRIL_EVT_DATA_LQE_CALLBACK */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_DATA_LQE_EVENT_CALLBACK, qcril_data_lqe_event_hdlr ) },
#endif
  ...
  /* - QCRIL_EVT_HOOK_GET_DATA_CALL_PROFILE*/
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_DATA_CALL_PROFILE, qcril_data_request_omh_profile_info ) },
...
#ifdef FEATURE_DATA_LQE
  /* 132 - RIL_REQUEST_START_LCE */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_START_LCE, qcril_data_lqe_start ) },

  /* 133 - RIL_REQUEST_STOP_LCE */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_STOP_LCE, qcril_data_lqe_stop ) },

  /* 134 - RIL_REQUEST_PULL_LCEDATA */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_PULL_LCEDATA, qcril_data_lqe_get_info ) },
#endif
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_RIL_MODEM_RESTART_CHECK_IF_SSR_EXCL_SERVICE_UP,
                                                 qcril_qmi_check_if_ssr_excluded_service_is_up) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_RIL_SSR_EXCL_SERVICE_DOWN, qcril_qmi_handle_event_ssr_excluded_service_down) },
  /* -------------------*
   *        EVENTS      *
   * -------------------*/
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_VOICE_AM_LCH_COMPLETE, qcril_qmi_voice_am_lch_complete_handler ) },
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_IMSS_HANDLE_INDICATIONS, qcril_qmi_imss_unsol_ind_cb_helper ) },
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_PDC_HANDLE_INDICATIONS, qcril_qmi_pdc_unsol_ind_cb_hndlr ) },
#ifdef QMI_RIL_UTF
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_DSD_HANDLE_INDICATIONS, qcril_qmi_dsd_unsolicited_indication_cb_helper ) },
#endif
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_DMS_HANDLE_ASYNC_CB, qcril_qmi_dms_async_cb_helper ) },
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_DATA_DDS_STATUS_FOLLOW_UP, qcril_qmi_nas_data_event_dds_status_follow_up ) },
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_DATA_NEW_DDS_INFO, qcril_qmi_nas_data_event_new_dds_info ) },

  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_LTE_HANDLE_COMM_CALLBACKS, qcril_qmi_lte_direct_disc_command_cb_helper ) },
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_QMI_LTE_HANDLE_INDICATIONS, qcril_qmi_lte_direct_disc_unsol_ind_cb_helper ) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_EMBMS_SEND_INTERESTED_TMGI_LIST, qcril_data_embms_send_interested_list ) },
#endif
#endif
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_CSG_ID,    qcril_qmi_nas_get_csg_id_handler ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_RAT_RAC,    qcril_qmi_nas_get_rat_rac_handler ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_SUB_PROVISION_PREFERENCE_REQ, qcril_qmi_prov_get_sub_prov_pref_req_handler )},
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SET_SUB_PROVISION_PREFERENCE_REQ, qcril_qmi_prov_set_sub_prov_pref_req_handler ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_SIM_ICCID_REQ, qcril_qmi_prov_get_sim_iccid_req_handler ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_MAX_DATA_ALLOWED_REQ, qcril_qmi_nas_get_max_data_handler ) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_CANCEL_QUERY_AVAILABLE_NETWORKS, qcril_qmi_nas_cancel_query_available_networks ) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_SET_LTE_BAND_PREF, qcril_qmi_nas_set_lte_band_pref ) },

  /* 135 - RIL_REQUEST_GET_ACTIVITY_INFO */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_GET_ACTIVITY_INFO, qcril_qmi_nas_dms_get_activity_info ) },

  /* 142 - RIL_REQUEST_START_NETWORK_SCAN */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_START_NETWORK_SCAN, qcril_qmi_nas_start_advanced_scan ) },

  /* 143 - RIL_REQUEST_STOP_NETWORK_SCAN */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_STOP_NETWORK_SCAN, qcril_qmi_nas_cancel_query_available_networks ) },
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_CM_CARD_STATUS_CHANGE_IND, qcril_qmi_nas_event_card_status_change_ind) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_SEND_DEVICE_STATE, qcril_qmi_nas_request_send_device_state ) },

  /* 139 - RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER
     Introduced in RIL Version 15 */
  { QCRIL_REG_ALL_ACTIVE_STATES( RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER, qcril_qmi_nas_request_set_unsol_response_filter ) },
  ...
  /* 0x8000a - QCRIL_EVT_HOOK_SET_ATEL_UI_STATUS */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SET_ATEL_UI_STATUS, qcril_qmi_nas_oem_hook_set_atel_ui_status_to_modem ) },
  ...
  /* 0x80033 - QCRIL_EVT_HOOK_SET_LOCAL_CALL_HOLD_v01 */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_SET_LOCAL_CALL_HOLD_v01, qcril_qmi_voice_request_set_local_call_hold ) },
  ...
  /* QCRIL_EVT_HOOK_CANCEL_QUERY_AVAILABLE_NETWORK */
  { QCRIL_REG_ALL_ACTIVE_STATES(QCRIL_EVT_HOOK_CANCEL_QUERY_AVAILABLE_NETWORK, qcril_qmi_nas_cancel_query_available_networks) },
 ...
 /* QCRIL_EVT_HOOK_GET_PREFERRED_NETWORK_ACQ_ORDER*/
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_RIL_PDC_LIST_CONFIGURATION, qcril_qmi_pdc_list_configuration_event_hdlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_RIL_PDC_DEACTIVATE_CONFIGURATION, qcril_qmi_pdc_deactivate_configuration) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_PROV_FM_START_STATUS, qcril_qmi_nas_prov_fm_start_status_hndlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_PROV_FM_APPLY_STATUS, qcril_qmi_nas_prov_fm_apply_status_hndlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_PROV_ACTIVATE_SUB_STATUS, qcril_qmi_nas_prov_activate_sub_status_hndlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_PROV_DEACTIVATE_SUB_STATUS, qcril_qmi_nas_prov_deactivate_sub_status_hndlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_PROV_STATUS_CHANGED, qcril_qmi_nas_prov_status_hndlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_RIL_REQUEST_MANUAL_PROVISIONING, qcril_qmi_prov_manual_provisioning_hndlr) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_PROV_UPDATE_ICCID, qcril_qmi_prov_update_iccid_hndlr) },
#ifndef QMI_RIL_UTF
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_QMI_RIL_PDC_PARSE_DIFF_RESULT, qcril_qmi_pdc_parse_diff_result) },
#endif
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_OEM_MSG_GBA_INIT, qcril_uim_oem_request_gba_init ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_OEM_MSG_GET_IMPI, qcril_uim_oem_request_get_impi ) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_SET_GEO_LOC, qcril_qmi_imsa_set_geo_loc ) },
  ...
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_SET_IMS_CONFIG, qcril_qmi_imss_request_set_ims_config ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_IMS_CONFIG, qcril_qmi_imss_request_get_ims_config ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_EXPLICIT_CALL_TRANSFER, qcril_qmi_voice_request_explicit_call_transfer ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_VOWIFI_CALL_QUALITY, qcril_qmi_imsa_request_get_vowifi_call_quality ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_SET_VOLTE_PREF, qcril_qmi_imss_request_set_volte_preference ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_VOLTE_PREF, qcril_qmi_imss_request_get_volte_preference ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_HANDOVER_CONFIG, qcril_qmi_imss_request_get_handover_config ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_SET_HANDOVER_CONFIG, qcril_qmi_imss_request_set_handover_config ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_IMS_SUB_CONFIG, qcril_qmi_imsa_request_get_ims_sub_config ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_SEND_RTT_MSG, qcril_qmi_imss_request_send_rtt_msg ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_CANCEL_MODIFY_CALL, qcril_qmi_voice_request_cancel_modify_call ) },

  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_UIM_RMT_QMI_SRVC_UP, qcril_uim_remote_client_int) },

  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_UIM_HTTP_QMI_HTTP_SRVC_UP, qcril_uim_http_client_int) },

  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_RADIO_CONFIG_SOCKET_REQ_SET_CONFIG, qcril_qmi_radio_config_dispatch_set_request ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_RADIO_CONFIG_SOCKET_REQ_GET_CONFIG, qcril_qmi_radio_config_dispatch_get_request ) },

  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_VOPS_INFO, qcril_qmi_nas_vops_info_get_request ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_IMS_SOCKET_REQ_GET_SSAC_INFO, qcril_qmi_nas_ssac_info_get_request ) },

  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_INITIALIZE, qcril_qmi_lte_direct_disc_initialize ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_GET_DEVICE_CAPABILITY, qcril_qmi_lte_direct_disc_get_device_capability ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_TERMINATE, qcril_qmi_lte_direct_disc_terminate ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_GET_SERVICE_STATUS, qcril_qmi_lte_direct_disc_get_service_status ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_PUBLISH, qcril_qmi_lte_direct_disc_publish ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_CANCEL_PUBLISH, qcril_qmi_lte_direct_disc_cancel_publish ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_SUBSCRIBE, qcril_qmi_lte_direct_disc_subscribe ) },
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_LTE_DIRECT_DISC_REQ_CANCEL_SUBSCRIBE, qcril_qmi_lte_direct_disc_cancel_subscribe ) },
  ...
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_PBM_GET_PB_CAPACITY, qcril_qmi_pbm_get_pb_capacity_hndlr ) },

  /* QCRIL_EVT_PBM_ASYNC_CALLBACK */
  { QCRIL_REG_ALL_STATES( QCRIL_EVT_PBM_ASYNC_CALLBACK,  qcril_qmi_pbm_async_cb_helper_hndlr ) },
  ...
  /* QCRIL_EVT_HOOK_GET_ADN_RECORD */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_GET_ADN_RECORD, qcril_qmi_pbm_get_adn_record_hndlr ) },

  /* QCRIL_EVT_HOOK_UPDATE_ADN_RECORD */
  { QCRIL_REG_ALL_ACTIVE_STATES( QCRIL_EVT_HOOK_UPDATE_ADN_RECORD, qcril_qmi_pbm_update_adn_record_hndlr ) },
...
extern void qcril_qmi_qti_radio_service_init();
...
static IxErrnoType qcril_execute_event(qcril_request_params_type *params_ptr,
                                int *is_dedicated_thread);
...
void qcril_get_baseband_name(char *prop_str)
{
    ...
    if (prop_str)
    {
        ...
        if (!strcmp("mdm", prop_str)  ||
            !strcmp("mdm2", prop_str) ||
            !strcmp("sdx", prop_str) )
        {
...
int qmi_ril_is_feature_supported(int feature)
{
  ...
  switch ( feature )
  {
    ...
    case QMI_RIL_FEATURE_PCI:
      if ( QMI_RIL_FTR_BASEBAND_UNKNOWN ==  qmi_ril_baseband_ftr_info)
      {
        *prop_str = 0;
        ...
        if ( strcmp(prop_str, "apq") == 0 || strcmp(prop_str, "sda") == 0 )
        {
        ...
        else if ( strcmp(prop_str, "msm") == 0 || strcmp(prop_str, "sdm") )
        {
    ...
    case QMI_RIL_FEATURE_8996:
#ifdef FEATURE_QCRIL_8996
      res = TRUE;
#else
      res = FALSE;
#endif
    ...
    case QMI_RIL_FEATURE_8952:
#ifdef FEATURE_QCRIL_8952
      res = TRUE;
#else
      res = FALSE;
#endif
    ...
    case QMI_RIL_FEATURE_8937:
#ifdef FEATURE_QCRIL_8937
      res = TRUE;
#else
      res = FALSE;
#endif
    ...
    case QMI_RIL_FEATURE_8953:
#ifdef FEATURE_QCRIL_8953
      res = TRUE;
#else
      res = FALSE;
#endif
    ...
    case QMI_RIL_FEATURE_8998:
#ifdef FEATURE_QCRIL_8998
      res = TRUE;
#else
      res = FALSE;
#endif
    ...
    case QMI_RIL_FEATURE_SDM:
#ifdef FEATURE_QCRIL_SDM
      res = TRUE;
#else
      res = FALSE;
#endif
    ...
    case QMI_RIL_FEATURE_RIL_CONTROLLED_PROVISIONING:

    /* RIL controlled provisioning is supported
     * only if QCRIL_CONTROLLED_SUBSCRIPTION_PROVISIONING
     * is defined */
#ifdef QCRIL_CONTROLLED_SUBSCRIPTION_PROVISIONING
    ...
    case QMI_RIL_FEATURE_FLEX_MAP:
#ifdef FEATURE_FLEX_MAP
      res = TRUE;
#else
      res = FALSE;
#endif
...
)
{
  ...
  do
  {
    ...
    while (msg_idx < (unsigned int)msg_len)
    {
      for (bytes_per_line_idx = 0, buf_idx = 0; (buf_idx + 2 < sizeof(buf)) &&
          (bytes_per_line_idx < QCRIL_PRINT_MAX_BYTES_PER_LINE) && (msg_idx < (unsigned)msg_len);
  ...
  char label[ 512 ];
       ...
       (param_ptr->instance_id < QCRIL_MAX_INSTANCE_ID))
    {
          ...
          switch ( param_ptr->request_id )
          {
            ...
            case QCRIL_EVT_HOOK_SLOT_GET_CARD_STATE_REQ:
            case QCRIL_EVT_HOOK_SLOT_GET_ATR_REQ:
            case QCRIL_EVT_HOOK_SLOT_SEND_APDU_REQ:
            case QCRIL_EVT_HOOK_SWITCH_SLOT_REQ:
            case QCRIL_EVT_HOOK_GET_PHYSICAL_SLOT_MAPPING_REQ:
            case QCRIL_EVT_HOOK_SLOT_CARD_POWER_REQ:
            case QCRIL_EVT_HOOK_SLOT_SET_APDU_BEHAVIOR_REQ:
            case QCRIL_EVT_HOOK_GET_TERMINAL_CAPABILITY_LPA_TLV_REQ:
            case QCRIL_EVT_HOOK_SET_TERMINAL_CAPABILITY_LPA_TLV_REQ:
                                              ...
                                              qcril_request_resp_params_type *param_ptr_ref )
{
  ...
  int                                       invalid_token_execution = FALSE;
  ...
  do
  {
    ...
    {
        if ( !(flow_decision_flag & FLOWCONTROL_ONREQUEST_FLOWCONTROL_REJECTED_OVERFLOW ))
        {
            invalid_token_execution = TRUE;
        }
  ...
  QCRIL_LOG_DEBUG("invalid_token_execution - %d", invalid_token_execution) ;
  if (token && !qcril_is_internal_token(token) && !invalid_token_execution)
  {
...
)
{
  ...
  do
  {
    ...
    switch ( unsol_event )
    {
      ...
      case QCRIL_EVT_HOOK_EMBMS_UNSOL_GET_INTERESTED_TMGI_LIST:
        is_qmi_idl_tunelling = TRUE;
        service_id           = QMI_RIL_OEM_HOOK_QMI_TUNNELING_SERVICE_EMBMS;
    ...
    { // legacy stream
      ...
      if ( NULL != payload )
      {
        ...
        QCRIL_LOG_DEBUG("qcril_qmi_print_hex");
...
)
{
  ...
  if(params_ptr != NULL && (params_ptr->instance_id < QCRIL_MAX_INSTANCE_ID) )
  {
    ...
    if(params_ptr->event_id != (int) RIL_REQUEST_IMS_SEND_SMS ){
    ...
    switch ( cur_status )
    {
      ...
      case QMI_RIL_GEN_OPERATIONAL_STATUS_UNBIND:
        switch (params_ptr->event_id)
          ...
          // For RIL_REQUEST_SET_RADIO_CAPABILITY, handler will take care of returning error
          ...
          case QCRIL_EVT_QMI_IMSA_HANDLE_INDICATIONS:
          case QCRIL_EVT_QMI_IMSA_HANDLE_COMM_CALLBACKS:
          case QCRIL_EVT_QMI_IMSS_HANDLE_INDICATIONS:
    ...
    if (qmi_ril_is_feature_supported(QMI_RIL_FEATURE_EMBMS))
    {
      switch (message_id )
      {
         ...
         case  QMI_EMBMS_GET_INTERESTED_TMGI_LIST_RESP_V01:
             *request_id =  QCRIL_EVT_HOOK_EMBMS_SEND_INTERESTED_TMGI_LIST;
...
RIL_Errno qmi_ril_parse_oem_hook_header ( unsigned char *data, qmi_ril_oem_hook_request_details_type *outcome )
{
  ...
  do
  {
    ...
    switch ( cmd_id )
    {
      ...
      case QCRIL_EVT_HOOK_SET_LTE_TUNE_AWAY:
      // ADN record requests
      case QCRIL_EVT_HOOK_GET_ADN_RECORD:
      case QCRIL_EVT_HOOK_UPDATE_ADN_RECORD:
        outcome_data.is_oem_hook    = TRUE;
        outcome_data.hook_req       = cmd_id;
        break;

      default:
        QCRIL_LOG_WARN( "Received un-handled/oem command id = %lu", cmd_id );
        outcome_data.is_oem_hook    = TRUE;
        outcome_data.hook_req       = cmd_id;
        break;
    }
...
)
{
  ...
  do
  {
          ...
          if (qcril_request_check_if_suppressed(param.event_id, &event_handler))
          {
              if (!event_handler)
              {
                  QCRIL_LOG_ERROR("Internal error..request %d is supressed but doesnt have an event handler associated", param.event_id);
          ...
          if ( ( param.event_id == RIL_REQUEST_DIAL ) || ( param.event_id == RIL_REQUEST_SETUP_DATA_CALL ) )
          {
            ...
            QCRIL_LOG_CF_PKT_RIL_REQ2( param.instance_id, label );
                      ...
                      ( param.event_id == RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER ) ||
                      ( param.event_id == RIL_REQUEST_SET_MUTE ) ) && ( param.data != NULL ) )
          {
            ...
            if (param.event_id == RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER)
            {
              char unsol_resp_filter_status[ qcril_log_urf_filter_status_str_size ];
              qcril_log_urf_mask_to_status(in_data_val, unsol_resp_filter_status, sizeof(unsol_resp_filter_status));
              QCRIL_SNPRINTF( label, sizeof(label), "%s - %s, Token id %d",
                              qcril_log_lookup_event_name( param.event_id ),
                              unsol_resp_filter_status,
                              log_projected_token );
            }
            else
            {
          ...
          else if (param.event_id == RIL_REQUEST_SEND_DEVICE_STATE)
          {
            in_data_ptr = ( int * ) param.data;
            if ( in_data_ptr != NULL )
            {
              QCRIL_SNPRINTF( label, sizeof(label), "%s - %s - %d, Token id %d",
                              qcril_log_lookup_event_name( param.event_id ),
                              qcril_log_device_state_type_enum_to_str(in_data_ptr[0]),
                              in_data_ptr[1],
                              log_projected_token );
              QCRIL_LOG_CF_PKT_RIL_REQ( param.instance_id, label );
            }
          ...
          QCRIL_LOG_DEBUG( "pre-exec token id %d, a-r-id %d, audit %d, nrender %d", log_projected_token,
                                                                                    param.event_id,
                                                                                    (int)audit_result,
                                                                                    (int)no_render );
...
void * qmi_ril_fw_dedicated_request_exec_thread(void * param)
{
    ...
    if ( NULL != exec_params )
    {
      ...
      if ( RIL_E_SUCCESS != audit_result )
      {
        ...
        /* For internal events*/
        if( exec_params->event_id > QCRIL_EVT_BASE )
        {
          QCRIL_LOG_INFO("Internal event in the dedicated thread returned failure. Processing..");
          if ( exec_params->event_id > QCRIL_EVT_IMS_SOCKET_REQ_BASE && exec_params->event_id < QCRIL_EVT_IMS_SOCKET_REQ_MAX )
          {
          ...
          else if ( exec_params->event_id > QCRIL_EVT_HOOK_BASE && exec_params->event_id < QCRIL_EVT_HOOK_MAX )
          {
            resp.rild_sock_oem_req = TRUE;
            qcril_send_request_response( &resp );
          }
...
)
{
  ...
  if ( E_SUCCESS != err_no )
  {
    ...
    {
      imsRadioSendMessage(params.t, ims_MsgType_RESPONSE, qcril_qmi_ims_map_event_to_request(params.event_id), qcril_qmi_ims_map_ril_error_to_ims_error(err_no), NULL, 0);
    }
...
)
{
  ...
  do
  {
    ...
    if ( qcril_hash_table_lookup( (uint32) params_ptr->event_id, &entry_ptr ) != E_SUCCESS || NULL == entry_ptr )
    {
    ...
    if ( dedicated_thrd_req_lookup_val == params_ptr->event_id )
    {
      ...
      param_copy_approach = qmi_ril_fw_create_android_live_params_copy( params_ptr->event_id,
                                                                        params_ptr->data,
                                                                        params_ptr->datalen,
...
{
    uint32 hash_index = qcril_hash( event_id, QCRIL_HT_ENTRIES_MAX, 0 );

    QCRIL_LOG_INFO("event_id = %d\n", event_id);
    QCRIL_LOG_INFO("hash_index = %d\n", hash_index);
    ...
    while (temp_entry_ptr != NULL)
    {
        if (temp_entry_ptr->event_id == event_id)
        {
            break;
        }
        temp_entry_ptr = temp_entry_ptr->next_ptr;
    ...
    if (temp_entry_ptr != NULL)
    {
        temp_entry_ptr->handler = handler;
    }
}
...
#define QCRIL_LEGACY_PROPERTY__MIGRATION_COMPLETE "persist.vendor.radio.prop_migration_complete"
#define QCRIL_QMI_VOICE_CLIR_OLD                  "persist.radio.clir"
#define QMI_RIL_MULTI_SIM_STACK_ID_OLD            "persist.radio.msim.stackid_"
#define QCRIL_MBN_ACTIVATION_STATUS_PROP_NAME_OLD "persist.radio.stack_id"

/*===========================================================================

  FUNCTION:  qcril_migrate_properties

===========================================================================*/
/*!
    @brief
    Migrate the old properties to new vendor properties.

    @return
    None.
*/
/*=========================================================================*/
void qcril_migrate_properties(void)
{
  boolean is_prop_migration_completed = FALSE;
  char old_property_name[PROPERTY_NAME_MAX];
  char old_property_value[PROPERTY_VALUE_MAX];
  char new_property_name[PROPERTY_NAME_MAX];
  size_t property_value_len = 0;
  qcril_instance_id_e_type instance_id = qmi_ril_get_process_instance_id();

  QCRIL_SNPRINTF(new_property_name, sizeof(new_property_name), "%s%d",
      QCRIL_LEGACY_PROPERTY__MIGRATION_COMPLETE, instance_id);
  qmi_ril_get_property_value_from_boolean(new_property_name, &is_prop_migration_completed, FALSE);
  QCRIL_LOG_INFO("is_prop_migration_completed = %d\n", is_prop_migration_completed);

  if (!is_prop_migration_completed)
  {
    // clir
    QCRIL_SNPRINTF(old_property_name, sizeof(old_property_name), "%s%d",
        QCRIL_QMI_VOICE_CLIR_OLD, instance_id);
    qmi_ril_get_property_value_from_string(old_property_name, old_property_value, "");
    property_value_len = strlen(old_property_value);
    if (property_value_len > 0)
    {
      QCRIL_SNPRINTF(new_property_name, sizeof(new_property_name), "%s%d",
          QCRIL_QMI_VOICE_CLIR, instance_id);
      qmi_ril_set_property_value_to_string(new_property_name, old_property_value);
      QCRIL_LOG_INFO("copied %s to %s (value %s)", old_property_name, new_property_name,
          old_property_value);
    }

    // stack id
    QCRIL_SNPRINTF(old_property_name, sizeof(old_property_name), "%s%d",
        QMI_RIL_MULTI_SIM_STACK_ID_OLD, instance_id);
    qmi_ril_get_property_value_from_string(old_property_name, old_property_value, "");
    property_value_len = strlen(old_property_value);
    if (property_value_len > 0)
    {
      QCRIL_SNPRINTF(new_property_name, sizeof(new_property_name), "%s%d",
          QMI_RIL_MULTI_SIM_STACK_ID, instance_id);
      qmi_ril_set_property_value_to_string(new_property_name, old_property_value);
      QCRIL_LOG_INFO("copied %s to %s (value %s)", old_property_name, new_property_name,
          old_property_value);
    }
    ...
    // stack id
    QCRIL_SNPRINTF(old_property_name, sizeof(old_property_name), "%s_%d",
        QCRIL_MBN_ACTIVATION_STATUS_PROP_NAME_OLD, instance_id);
    qmi_ril_get_property_value_from_string(old_property_name, old_property_value, "");
    property_value_len = strlen(old_property_value);
    if (property_value_len > 0)
    {
      QCRIL_SNPRINTF(new_property_name, sizeof(new_property_name), "%s_%d",
          QCRIL_MBN_ACTIVATION_STATUS_PROP_NAME, instance_id);
      qmi_ril_set_property_value_to_string(new_property_name, old_property_value);
      QCRIL_LOG_INFO("copied %s to %s (value %s)", old_property_name, new_property_name,
          old_property_value);
    }
    ...
    QCRIL_SNPRINTF(new_property_name, sizeof(new_property_name), "%s%d",
        QCRIL_LEGACY_PROPERTY__MIGRATION_COMPLETE, instance_id);
    qmi_ril_set_property_value_to_integer(new_property_name, 1);
  }
}
...
void qcril_init()
{
  ...
  /* Migrate old property values to new vendor property */
  qcril_migrate_properties();
...
RIL_Errno qmi_ril_core_init(void)
{
  ...
  do
  {
    ...
    qcril_qmi_qti_radio_service_init();
#endif
    ...
    if ( origin->nof_extra_holders_and_caps_and_dynamics & QMI_RIL_FW_ANDROID_REQUEST_HNDL_CAPS_ALLOW_SINGLE_ONLY )
    {
           ...
           ( is_unbind_cleanup && ( origin->nof_extra_holders_and_caps_and_dynamics & QMI_RIL_FW_ANDROID_REQUEST_HNDL_CAPS_UNBIND_DROP_OFF )))
      {
        if ( !(origin->holders.local_holder.param_info_and_len & QMI_RIL_FW_ANDROID_REQUEST_INFO_SLOT_AVAILABLE) )
        {
          ...
          QCRIL_LOG_DEBUG("abandon  token id %d, a-r-id %d", cur_token_id, android_request_id );
          ...
          QCRIL_LOG_INFO("token_under_execution %d, cur_token %d",  token_id_under_execution, cur_token_id);
           ...
           ( is_unbind_cleanup && ( origin->nof_extra_holders_and_caps_and_dynamics & QMI_RIL_FW_ANDROID_REQUEST_HNDL_CAPS_UNBIND_DROP_OFF )))
      {
        ...
        for ( idx = QMI_RIL_ZERO; idx < nof_cap; idx++ )
        {
          if ( !(iter->param_info_and_len & QMI_RIL_FW_ANDROID_REQUEST_INFO_SLOT_AVAILABLE) )
          {
            ...
            int32_t token_id_under_execution = qcril_log_get_token_id(origin->token_under_execution);
...
void qmi_ril_abandon_all_oem_hook_requests( RIL_Errno cause )
{
  ...
  while ( E_SUCCESS == qcril_reqlist_get_entry_from_request_range( QCRIL_DEFAULT_INSTANCE_ID,
                                                                    QCRIL_EVT_HOOK_BASE,
                                                                    QCRIL_EVT_HOOK_MAX,
                                                                    &request_info) )
  {
                                               ...
                                               IxErrnoType* error)
{
  ...
  switch ( android_request_id )
  {
   ...
   case RIL_REQUEST_SET_INITIAL_ATTACH_APN:
    ...
    case RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER: // fallthrough
    ...
    case RIL_REQUEST_SEND_DEVICE_STATE:
      if ( NULL != android_request_data && android_request_data_len > QMI_RIL_ZERO )
      {
        ...
        * ((const int*)data)[1] Specifies the state. See RIL_DeviceStateType for the definition
        *                       of each type.
        */
