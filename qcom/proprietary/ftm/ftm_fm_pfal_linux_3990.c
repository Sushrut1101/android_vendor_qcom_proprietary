...
char *FM_LIBRARY_NAME = "ftm_fm_lib.so";
...
typedef struct {
    int (*hal_init)(const fm_vendor_callbacks_t *p_cb);
...
===========================================================================*/
__attribute__((no_sanitize("cfi"))) fm_cmd_status_type EnableFM
(
