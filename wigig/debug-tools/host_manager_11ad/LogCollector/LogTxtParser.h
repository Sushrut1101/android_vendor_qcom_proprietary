...
namespace log_collector
{
    ...
    {
    public:
        LogTxtParser() :str_sz(0), m_modulesInfo(nullptr), m_newLineRequired(true), m_prevModule(-1){};
    ...
    private:
        ...
        std::vector<char> m_stringsConversionBuffer;
        bool ReadStringsConversionFile(const char* fileName, size_t& outRealSize, size_t extra);
