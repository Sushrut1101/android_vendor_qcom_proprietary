...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/wms/api/wireless_messaging_service_v01.h#12 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define WMS_V01_IDL_MINOR_VERS 0x23
...
#define WMS_BC_WARNING_AREA_COORDINATE_LENGTH_MAX_V01 1400
/**
    @}
  */
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Resets the WMS service state variables of the requesting control
             point. */
typedef struct {
...
typedef struct {
  ...
  uint8_t report_ll_err_codes_valid;  /**< Must be set to true if report_ll_err_codes is being passed */
  uint8_t report_ll_err_codes;
  /**<   Report additional error codes from
         lower layers. Values: \n
         - 0x00 -- Disable \n
         - 0x01 -- Enable 
    */
...
/** @addtogroup wms_qmi_enums
  ...
  */
typedef enum {
  WMS_BC_RAT_INFO_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  ...
  WMS_BC_RAT_INFO_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wms_bc_rat_info_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t bc_sms_rat_info_valid;  /**< Must be set to true if bc_sms_rat_info is being passed */
  wms_bc_rat_info_enum_v01 bc_sms_rat_info;
  /**<   Broadcast SMS RAT information. Values: \n
      - WMS_BC_RAT_GSM_RADIO_ACCESS (0x00) --  Broadcast SMS received over GSM \n 
      - WMS_BC_RAT_WCDMA_RADIO_ACCESS (0x01) --  Broadcast SMS received over WCDMA \n 
      - WMS_BC_RAT_LTE_RADIO_ACCESS (0x02) --  Broadcast SMS received over LTE \n 
      - WMS_BC_RAT_CDMA_RADIO_ACCESS (0x03) --  Broadcast SMS received over CDMA \n 
      - WMS_BC_RAT_NR5G_RADIO_ACCESS (0x04) --  Broadcast SMS received over NR5G \n
 */

  /* Optional */
  /*  IMS SMS Verstat Status Information */
  uint8_t verstat_status_info_valid;  /**< Must be set to true if verstat_status_info is being passed */
  mt_ims_verstat_enum_v02 verstat_status_info;
  /**<   SMS Verstat Status Information. Values: \n
 ...
 */
  ...
  /* Optional */
  /*  Broadcast SMS Warning Area Coordinate Information */
  uint8_t warning_area_valid;  /**< Must be set to true if warning_area is being passed */
  uint32_t warning_area_len;  /**< Must be set to # of elements in warning_area */
  uint8_t warning_area[WMS_BC_WARNING_AREA_COORDINATE_LENGTH_MAX_V01];
...
/** @addtogroup wms_qmi_enums
  ...
  */
typedef enum {
  WMS_LINK_CONTROL_MODE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WMS_LINK_CONTROL_DISABLED_V01 = 0x00, 
  WMS_LINK_CONTROL_ENABLED_ONE_V01 = 0x01, 
  WMS_LINK_CONTROL_ENABLE_ALL_V01 = 0x02, 
  WMS_LINK_CONTROL_MODE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wms_link_control_mode_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Indicates whether to keep the link control enabled, until the option is
		 ...
		 This TLV is deprecated from minor version 33. Optional TLV "link_control_mode"
		 should be used instead.
    */

  /* Optional */
  /*  Link Control Mode Information** */
  uint8_t link_control_mode_valid;  /**< Must be set to true if link_control_mode is being passed */
  wms_link_control_mode_enum_v01 link_control_mode;
  /**<   Indicates the link control mode to be used, until the option is
         modified by the client. Values: \n
		 - 0x00 -- Disable link control \n 
         - 0x01 -- Enable link control once so that the lower layer keeps the
                   link up for a specified time until the next MO SMS is requested
                   or the timer expires \n
         - 0x02 -- Always enable link control \n
         Note: This TLV is valid only if the Link Control TLV is specified 
         and is set to a valid timer value.
    */

  /* Optional */
  /*  SMS command Mode Information** */
  uint8_t sms_is_command_tpdu_valid;  /**< Must be set to true if sms_is_command_tpdu is being passed */
  uint8_t sms_is_command_tpdu;
  /**<   Indicates whether to keep sms_command_tpdu to be used, until the option is
         enabled by the client. Values: \n
     - 0x00 -- Regular SMS of TUDU type SUBMIT \n
     - 0x01 -- SMS TPDU type is command \n
     Note: This TLV is valid only if the SMS TPDU command TLV is specified
         and is set to 1.
    */
...
typedef struct {
  ...
  /**<   GW RP cause per 
         \hyperref[STD-24011]{3GPP TS 24.011} Section 8.2.5.4;
  ...
  /**<   GW TP cause per 
         \hyperref[STD-23040]{3GPP TS 23.040} Section 9.2.3.22; see Table
...
typedef enum {
  ...
  WMS_MESSAGE_BLOCKED_DUE_TO_VOICE_OR_DATA_CALL_V01 = 0x01, 
...
/** @addtogroup wms_qmi_enums
  ...
  */
typedef enum {
  WMS_REJECT_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_OTA_REJECT_V01 = 0x01, 
  WMS_REJECT_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wms_reject_type_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  wms_reject_type_enum_v01 reject_type;
  /**<   Lower layer reject type. Values: \n
         - 0x01 -- NAS OTA Reject (\hyperref[STD-24008]{3GPP TS 24.008})
    */

  uint8_t reject_value;
  /**<   Reject cause value.
    */
}wms_reject_cause_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   WMS cause code per 
         \hyperref[STD-NS00050]{3GPP2 N.S0005-0} Section 6.5.2.125; see
 ...
 */
  ...
  /* Optional */
  /*  Lower Layer Reject Cause Information */
  uint8_t rej_cause_info_valid;  /**< Must be set to true if rej_cause_info is being passed */
  wms_reject_cause_type_v01 rej_cause_info;
  /**<   \n
         (Indicates the reject type and the error code for lower layer failures)
    */

  /* Optional */
  /*  IMS reject cause Information** */
  uint8_t sms_ims_rej_cause_info_valid;  /**< Must be set to true if sms_ims_rej_cause_info is being passed */
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the message protocol currently in use for the WMS client. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the currently configured action performed upon WMS
...
typedef struct {
  ...
  */
  ...
  /**<   WMS transport layer status conveying the CDMA cause code per 
       \hyperref[STD-CS0015A]{3GPP2 C.S0015-A} Section 3.4.3.6; 
       see Table @latexonly \ref{tbl:WMSCauseCodes} @endlatexonly for more 
       information.
  */
...
typedef struct {
  ...
  /**<   Starting point of the range of CBM message identifiers; 
       message IDs are defined in 
       \hyperref[STD-23041]{3GPP TS 23.041} Section 9.4.1.2.2 for GSM and
       \hyperref[STD-23041]{3GPP TS 23.041} Section 9.4.4.2.2 for UMTS.
  */

  uint16_t to_service_id;
  /**<   Ending point of the range of CBM message identifiers; 
       message IDs are defined in 
       \hyperref[STD-23041]{3GPP TS 23.041} Section 9.4.1.2.2 for GSM and
       \hyperref[STD-23041]{3GPP TS 23.041} Section 9.4.4.2.2 for UMTS.
  */
...
typedef struct {
  ...
  /**<   Service category assignments, as defined in 
       \hyperref[STD-CR1001D]{3GPP2 C.R1001-D} Section 9.3; 
       see Table @latexonly \ref{tbl:ServiceCategories}
       @endlatexonly for more information.
  */

  wms_language_enum_v01 language;
  /**<   Language indicator value assignments, as defined in
       \hyperref[STD-CR1001D]{3GPP2 C.R1001-D} Section 9.2.
       Values: \n 
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the GW domain preference. (Deprecated) */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef struct {
  ...
  /**<   WMS cause code per 
       \hyperref[STD-NS00050]{3GPP2 N.S0005-0} Section 6.5.2.125; see 
       Table @latexonly \ref{tbl:WMSCauseCodes} @endlatexonly for more information.
  */
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Gets the message waiting information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  SIM Ready Information Events */
  uint8_t reg_sim_ready_info_events_valid;  /**< Must be set to true if reg_sim_ready_info_events is being passed */
  uint8_t reg_sim_ready_info_events;
  /**<   Values: \n
       - 0x00 -- Disable (default)\n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  SMSC Address Change Events */
  uint8_t reg_smsc_addr_info_events_valid;  /**< Must be set to true if reg_smsc_addr_info_events is being passed */
  uint8_t reg_smsc_addr_info_events;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable (default)
  */
  ...
  /* Optional */
  /*  Memory full indication Events */
  uint8_t mem_full_ind_events_valid;  /**< Must be set to true if mem_full_ind_events is being passed */
  uint8_t mem_full_ind_events;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable (default)
  */
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Gets the transport layer information.  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Gets the transport network registration information.  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Gets the registration state for different
             QMI_WMS indications for the requesting control point. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  SIM Ready Information Events */
  uint8_t reg_sim_ready_events_valid;  /**< Must be set to true if reg_sim_ready_events is being passed */
  uint8_t reg_sim_ready_events;
  /**<   Values: \n 
       - 0x00 -- Disable \n 
       - 0x01 -- Enable
  */
...
typedef struct {
  ...
  /**<   Destination address as defined in 
       \hyperref[STD-23040]{3GPP TS 23.040} Section 9.2.3.8.
  */
  ...
  /**<   Protocol Identifier Data (PID) per 
       \hyperref[STD-23040]{3GPP TS 23.040} Section 9.2.3.9; see
  ...
  */
  ...
  uint8_t dcs;
  /**<   SMS data coding scheme as defined in 
       \hyperref[STD-23038]{3GPP TS 23.038} Section 4.
  */
  ...
  uint8_t validity;
  /**<   Relative validity period as defined in 
       \hyperref[STD-23040]{3GPP TS 23.040} Section 9.2.3.12.1.
  */
...
typedef struct {
  ...
  wms_pid_enum_v01 pid;
  /**<   Protocol Identifier Data (PID) per 
         \hyperref[STD-23040]{3GPP TS 23.040} Section 9.2.3.9; see Table 
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the domain preference configuration.
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the retry period. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the retry interval. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the CDMA dedicated channel autodisconnect timer. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the client-set memory status for new SMS messages. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries whether the client has set itself as the primary client of 
             QMI_WMS. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Queries the specific subscription to which the control point is bound. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef struct {
  ...
  /**<   Send status. Values: \n
    ...
    -QMI_ERR_CAUSE_CODE -- SMS cause code: For CDMA, refer to 
                           \hyperref[STD-NS00050]{3GPP2 N.S0005-0}
                           Section 6.5.2.125; 
                           for GW, refer to \hyperref[STD-27005]{3GPP TS 27.005}
                           Section 3.2.5 \n
  ...
  wms_tl_cause_code_enum_v01 cause_code;
  /**<   WMS cause code 
         per \hyperref[STD-NS00050]{3GPP2 N.S0005-0} Section 6.5.2.125; see
         Table @latexonly \ref{tbl:WMSCauseCodes} @endlatexonly for more
         information.
    */
...
typedef struct {
  ...
  /**<   Send status. Values: \n
    ...
    -QMI_ERR_CAUSE_CODE -- SMS cause code: For CDMA, refer to 
                           ...
                           Section 6.5.2.125; 
                           for GW, refer to 
                           \hyperref[STD-27005]{3GPP TS 27.005}
                           Section 3.2.5 \n
    -QMI_ERR_MESSAGE_DELIVERY_ FAILURE -- Message could not be delivered \n
    -QMI_ERR_NO_MEMORY -- Device could not allocate memory to
                          formulate a response  
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Request Message; Gets the service ready status. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef enum {
  ...
  WMS_SERVICE_READY_STATUS_3GPP_LIMITED_V01 = 0x04, 
  WMS_SERVICE_READY_STATUS_3GPP2_LIMITED_V01 = 0x05, 
  WMS_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2_LIMITED_V01 = 0x06, 
  WMS_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2_V01 = 0x07, 
  WMS_SERVICE_READY_STATUS_3GPP_AND_3GPP2_LIMITED_V01 = 0x08, 
...
typedef uint64_t wms_sim_ready_status_mask_v01;
#define WMS_SIM_READY_3GPP_V01 ((wms_sim_ready_status_mask_v01)0x01ull) /**<  3GPP service is ready \n  */
#define WMS_SIM_READY_3GPP2_V01 ((wms_sim_ready_status_mask_v01)0x02ull) /**<  3GPP2 service is ready  */
/** @addtogroup wms_qmi_messages
    @{
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the service is ready to handle 3GPP/3GPP2 SMS requests.
       Values: \n
       - 0x00 -- SMS service is not ready \n 
       - 0x01 -- 3GPP SMS Full service is ready \n 
       - 0x02 -- 3GPP2 SMS Full service is ready \n 
       - 0x03 -- Both 3GPP SMS Full and 3GPP2 SMS Full services are ready \n
       - 0x04 -- 3GPP SMS Limited service is ready \n
       - 0x05 -- 3GPP2 SMS Limited service is ready \n
       - 0x06 -- Both 3GPP SMS Limited and 3GPP2 SMS Limited services are ready \n
       - 0x07 -- 3GPP SMS Limited and 3GPP2 SMS Full services are ready \n
       - 0x08 -- 3GPP SMS Full and 3GPP2 SMS Limited services are ready \n
       Note: All other values are reserved and should be ignored by clients.
  */

  /* Optional */
  /*  SIM Ready Events Registration Information */
  uint8_t sim_ready_registered_ind_valid;  /**< Must be set to true if sim_ready_registered_ind is being passed */
  uint8_t sim_ready_registered_ind;
  /**<   Indicates whether SIM ready events are registered. Values: \n
       - 0x00 -- SIM ready events are not registered \n
       - 0x01 -- SIM ready events are registered
  */

  /* Optional */
  /*  SIM Ready Status Information */
  uint8_t sim_ready_status_valid;  /**< Must be set to true if sim_ready_status is being passed */
  wms_sim_ready_status_mask_v01 sim_ready_status;
  /**<   Bitmask indicating whether the service is ready to handle 3GPP/3GPP2 
       SIM-related SMS requests. \n
       If a value of 0 is returned, the service is not ready. \n
       If a value of 3 is returned, both 3GPP and 3GPP2 SIM-related requests 
       can be processed.

       \vspace{6pt}
       Any combination of the following may be returned: \n
       - Bit 0 (0x01) -- WMS_SIM_READY_ 3GPP -- 3GPP service is ready \n
       - Bit 1 (0x02) -- WMS_SIM_READY_ 3GPP2 -- 3GPP2 service is ready \n
...
typedef enum {
  ...
  TRANSPORT_MWI_MESSAGE_TYPE_VOICEMAIL_V01 = 0x00, /**<  Voicemail \n  */
  TRANSPORT_MWI_MESSAGE_TYPE_VIDEOMAIL_V01 = 0x01, /**<  Videomail \n  */
  TRANSPORT_MWI_MESSAGE_TYPE_FAX_V01 = 0x02, /**<  Fax \n  */
  TRANSPORT_MWI_MESSAGE_TYPE_PAGER_V01 = 0x03, /**<  Pager \n  */
  TRANSPORT_MWI_MESSAGE_TYPE_MULTIMEDIA_V01 = 0x04, /**<  Multimedia \n  */
  TRANSPORT_MWI_MESSAGE_TYPE_TEXT_V01 = 0x05, /**<  Text  */
...
typedef struct {
  ...
  /**<   Message type. Values: \n 
      - TRANSPORT_MWI_MESSAGE_TYPE_VOICEMAIL (0x00) --  Voicemail \n 
      - TRANSPORT_MWI_MESSAGE_TYPE_VIDEOMAIL (0x01) --  Videomail \n 
      - TRANSPORT_MWI_MESSAGE_TYPE_FAX (0x02) --  Fax \n 
      - TRANSPORT_MWI_MESSAGE_TYPE_PAGER (0x03) --  Pager \n 
      - TRANSPORT_MWI_MESSAGE_TYPE_MULTIMEDIA (0x04) --  Multimedia \n 
      - TRANSPORT_MWI_MESSAGE_TYPE_TEXT (0x05) --  Text 
 */
...
typedef enum {
  ...
  WMS_UNKNOWN_PRIORITY_V01 = 0x00, /**<  Unknown \n  */
  WMS_LOW_PRIORITY_V01 = 0x01, /**<  Low \n  */
  WMS_NORMAL_PRIORITY_V01 = 0x02, /**<  Normal \n  */
  WMS_URGENT_PRIORITY_V01 = 0x03, /**<  Urgent  */
 ...
 */
  ...
  /**<   Priority. Values: \n 
      - WMS_UNKNOWN_PRIORITY (0x00) --  Unknown \n 
      - WMS_LOW_PRIORITY (0x01) --  Low \n 
      - WMS_NORMAL_PRIORITY (0x02) --  Normal \n 
      - WMS_URGENT_PRIORITY (0x03) --  Urgent 
 */
...
/** @addtogroup wms_qmi_messages
    @{
  */
/** Indication Message; Indicates changes in the message waiting information. */
typedef struct {
...
//#define REMOVE_QMI_WMS_ASYNC_RAW_SEND_V01 
//#define REMOVE_QMI_WMS_ASYNC_RAW_SEND_IND_V01 
//#define REMOVE_QMI_WMS_ASYNC_SEND_ACK_V01 
//#define REMOVE_QMI_WMS_ASYNC_SEND_ACK_IND_V01 
//#define REMOVE_QMI_WMS_ASYNC_SEND_FROM_MEM_STORE_V01 
//#define REMOVE_QMI_WMS_ASYNC_SEND_FROM_MEM_STORE_IND_V01 
//#define REMOVE_QMI_WMS_BIND_SUBSCRIPTION_V01 
//#define REMOVE_QMI_WMS_BROADCAST_CONFIG_IND_V01 
//#define REMOVE_QMI_WMS_CALL_STATUS_IND_V01 
//#define REMOVE_QMI_WMS_DELETE_V01 
//#define REMOVE_QMI_WMS_EVENT_REPORT_IND_V01 
//#define REMOVE_QMI_WMS_GET_BROADCAST_CONFIG_V01 
//#define REMOVE_QMI_WMS_GET_DC_DISCONNECT_TIMER_V01 
//#define REMOVE_QMI_WMS_GET_DOMAIN_PREF_V01 
//#define REMOVE_QMI_WMS_GET_DOMAIN_PREF_CONFIG_V01 
//#define REMOVE_QMI_WMS_GET_INDICATION_REGISTER_V01 
//#define REMOVE_QMI_WMS_GET_MEMORY_STATUS_V01 
//#define REMOVE_QMI_WMS_GET_MESSAGE_PROTOCOL_V01 
//#define REMOVE_QMI_WMS_GET_MESSAGE_WAITING_V01 
//#define REMOVE_QMI_WMS_GET_PRIMARY_CLIENT_V01 
//#define REMOVE_QMI_WMS_GET_RETRY_INTERVAL_V01 
//#define REMOVE_QMI_WMS_GET_RETRY_PERIOD_V01 
//#define REMOVE_QMI_WMS_GET_ROUTES_V01 
//#define REMOVE_QMI_WMS_GET_SERVICE_READY_STATUS_V01 
//#define REMOVE_QMI_WMS_GET_SMSC_ADDRESS_V01 
//#define REMOVE_QMI_WMS_GET_SMS_PARAMETERS_V01 
//#define REMOVE_QMI_WMS_GET_STORE_MAX_SIZE_V01 
//#define REMOVE_QMI_WMS_GET_SUBSCRIPTION_BINDING_V01 
//#define REMOVE_QMI_WMS_GET_SUPPORTED_FIELDS_V01 
//#define REMOVE_QMI_WMS_GET_SUPPORTED_MSGS_V01 
//#define REMOVE_QMI_WMS_GET_TRANSPORT_LAYER_INFO_V01 
//#define REMOVE_QMI_WMS_GET_TRANSPORT_NW_REG_INFO_V01 
//#define REMOVE_QMI_WMS_INDICATION_REGISTER_V01 
//#define REMOVE_QMI_WMS_LIST_MESSAGES_V01 
//#define REMOVE_QMI_WMS_MEMORY_FULL_IND_V01 
//#define REMOVE_QMI_WMS_MESSAGE_WAITING_IND_V01 
//#define REMOVE_QMI_WMS_MODIFY_TAG_V01 
//#define REMOVE_QMI_WMS_RAW_READ_V01 
//#define REMOVE_QMI_WMS_RAW_SEND_V01 
//#define REMOVE_QMI_WMS_RAW_WRITE_V01 
//#define REMOVE_QMI_WMS_RESET_V01 
//#define REMOVE_QMI_WMS_SEND_ACK_V01 
//#define REMOVE_QMI_WMS_SEND_FROM_MEM_STORE_V01 
//#define REMOVE_QMI_WMS_SERVICE_READY_IND_V01 
//#define REMOVE_QMI_WMS_SET_BROADCAST_ACTIVATION_V01 
//#define REMOVE_QMI_WMS_SET_BROADCAST_CONFIG_V01 
//#define REMOVE_QMI_WMS_SET_DC_DISCONNECT_TIMER_V01 
//#define REMOVE_QMI_WMS_SET_DOMAIN_PREF_V01 
//#define REMOVE_QMI_WMS_SET_DOMAIN_PREF_CONFIG_V01 
//#define REMOVE_QMI_WMS_SET_EVENT_REPORT_V01 
//#define REMOVE_QMI_WMS_SET_MEMORY_STATUS_V01 
//#define REMOVE_QMI_WMS_SET_MESSAGE_WAITING_V01 
//#define REMOVE_QMI_WMS_SET_PRIMARY_CLIENT_V01 
//#define REMOVE_QMI_WMS_SET_RETRY_INTERVAL_V01 
//#define REMOVE_QMI_WMS_SET_RETRY_PERIOD_V01 
//#define REMOVE_QMI_WMS_SET_ROUTES_V01 
//#define REMOVE_QMI_WMS_SET_SMSC_ADDRESS_V01 
//#define REMOVE_QMI_WMS_SET_SMS_PARAMETERS_V01 
//#define REMOVE_QMI_WMS_SMSC_ADDRESS_IND_V01 
//#define REMOVE_QMI_WMS_TRANSPORT_LAYER_INFO_IND_V01 
//#define REMOVE_QMI_WMS_TRANSPORT_LAYER_MWI_IND_V01 
//#define REMOVE_QMI_WMS_TRANSPORT_NW_REG_INFO_IND_V01 
