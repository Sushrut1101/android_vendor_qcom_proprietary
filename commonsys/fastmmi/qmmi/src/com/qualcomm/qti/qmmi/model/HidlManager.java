...
import vendor.qti.hardware.factory.V1_1.IFactory;
...
public final class HidlManager {
    ...
    private HidlManager() {
        LogUtils.logi("init");
        try {
            iFactory = IFactory.getService(true);
        } catch (Exception e) {
    ...
    public vendor.qti.hardware.factory.V1_1.FactoryResult delegate(String cmd, String value) {
        LogUtils.logi("delegate: cmd: " + cmd + ", value: " + value);
        if (iFactory != null) {
            vendor.qti.hardware.factory.V1_1.FactoryResult result = null;
            try {
