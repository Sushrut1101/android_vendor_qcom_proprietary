...
typedef enum
{
    ...
    QCRIL_QMI_RADIO_CONFIG_CLIENT_PROVISIONING_ENABLE_RTT = 90,
    QCRIL_QMI_RADIO_CONFIG_RCS_SMS_APP = 91,
    QCRIL_QMI_RADIO_CONFIG_RCS_VVM_APP = 92,
    QCRIL_QMI_RADIO_CONFIG_WIFI_CALL_ROAMING_PREFERENCE = 93,
    QCRIL_QMI_RADIO_CONFIG_SET_CONCURRENCY_CONFIG = 94,
...
typedef struct
{
  void *data;
  size_t data_len;
}qcril_qmi_radio_config_resp_data_type;
