...
void qcril_qmi_ims_init_msg_meta()
{
    ...
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_SEND_SMS, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_SEND_SMS" });
    ...
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_UNSOL_VOICE_INFO, ims_MsgType_UNSOL_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_UNSOL_VOICE_INFO"});
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_UNSOL_INCOMING_SMS, ims_MsgType_UNSOL_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_UNSOL_INCOMING_SMS"});
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_UNSOL_SMS_STATUS_REPORT, ims_MsgType_UNSOL_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_UNSOL_SMS_STATUS_REPORT"});
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_UNSOL_AUTO_CALL_REJECTION_IND, ims_MsgType_UNSOL_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_UNSOL_AUTO_CALL_REJECTION_IND"});
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_UNSOL_MULTI_IDENTITY_REGISTRATION_STATUS, ims_MsgType_UNSOL_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_UNSOL_MULTI_IDENTITY_REGISTRATION_STATUS"});
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_UNSOL_MULTI_IDENTITY_PENDING_INFO, ims_MsgType_UNSOL_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_UNSOL_MULTI_IDENTITY_PENDING_INFO"});
#endif
}
//===========================================================================
