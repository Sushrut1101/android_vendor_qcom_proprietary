/*============================================================================
   ...
   Copyright (c) 2012-2015, 2018-2019  Qualcomm Technologies, Inc.  All Rights Reserved.
...
#include "jpegdma_app_util_mmap.h"
 ...
 *==========================================================================*/
void *do_mmap (long size __unused, int *p_pmem_fd,
