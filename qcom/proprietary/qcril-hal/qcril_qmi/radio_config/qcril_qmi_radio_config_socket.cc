...
#include "qcrili.h"
#define TAG "Radio_Config_Socket"
...
{
    QCRIL_LOG_FUNC_ENTRY();
    qcril_qmi_radio_config_socket_agent::get_instance()->init();
    QCRIL_LOG_FUNC_ENTRY("...Created Radio Config thread on SUB %d", qmi_ril_get_process_instance_id());
    QCRIL_LOG_FUNC_RETURN();
}
