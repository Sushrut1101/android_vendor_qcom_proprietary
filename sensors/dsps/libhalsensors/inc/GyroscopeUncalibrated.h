/*============================================================================
  @file GyroscopeUncalibrated.h

  @brief
  GyroscopeUncalibrated class definition.

  Copyright (c) 2014,2017 Qualcomm Technologies, Inc.  All Rights Reserved.
  Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
#ifndef ANDROID_GYROSCOPE_UNCALIBRATED_SENSOR_H
#define ANDROID_GYROSCOPE_UNCALIBRATED_SENSOR_H

#include "SMGRSensor.h"

/*============================================================================
 * Class GyroscopeUncalibrated
=============================================================================*/

class GyroscopeUncalibrated : public SMGRSensor {
public:
	GyroscopeUncalibrated(int handle);
