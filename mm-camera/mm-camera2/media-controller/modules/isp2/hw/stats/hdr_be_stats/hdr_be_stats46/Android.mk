#======================================================================
#makefile for libmmcamera2_isp2_hdr_be_stats46.so form mm-camera2
#======================================================================
...
LOCAL_SRC_FILES        := module_hdr_be_stats46.c hdr_be_stats46.c
ifeq ($(call is-board-platform-in-list,sdm660 msm8998 apq8098_latv $(TRINKET)),true)
LOCAL_SRC_FILES += include48/hdr_be_stats_ext48.c
else
LOCAL_SRC_FILES += hdr_be_stats_ext46.c
endif
