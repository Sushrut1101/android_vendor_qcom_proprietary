...
#  Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  @file framework/hidl_gen/uim/vendor/qti/hardware/radio/uim/1.0/IUimResponse.h
  DESCRIPTION
  ---------------------------------------------------------------------------
******************************************************************************/
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_UIM_V1_0_IUIMRESPONSE_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_UIM_V1_0_IUIMRESPONSE_H
...
struct IUimResponse : public ::android::hidl::base::V1_0::IBase {
    virtual bool isRemote() const override { return false; }


    virtual ::android::hardware::Return<void> UimRemoteSimlockResponse(int32_t token, UimRemoteSimlockResponseType response, UimRemoteSimlockOperationType simlockOp, const ::android::hardware::hidl_vec<uint8_t>& simlockRspData, const UimRemoteSimlockVersion& version, const UimRemoteSimlockStatus& status) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IUimResponse>> castFrom(const ::android::sp<IUimResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IUimResponse>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IUimResponse>&);
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_UIM_V1_0_IUIMRESPONSE_H
