...
public:
    ...
    sp<ILinkLatencyService> requestService(const ::vendor::qti::data::factory::V1_0::IFactory::StatusCode
                                                  expected_result) {
...
TEST_F(LatencyHidlTestBase, TestCreateLinkLatencyService) {
    sp<ILinkLatencyService> service =
        requestService(::vendor::qti::data::factory::V1_0::IFactory::StatusCode::OK);
...
public:
    virtual void SetUp() override {
        setUpFactory();
        linkLatencyService = requestService(::vendor::qti::data::factory::V1_0::IFactory::StatusCode::OK);
        linkLatencyService2 = requestService(::vendor::qti::data::factory::V1_0::IFactory::StatusCode::OK);
    }
