...
typedef struct qmi_util_requester_private_info
{
    ...
    qmi_client_os_params        os_params[QMI_UTIL_SVC_NOF_SVC];
...
int qmi_util_get_modem_port()
{
    return QMI_CLIENT_INSTANCE_ANY;
}
...
int qmi_util_common_init(qmi_util_service_message_handler resp_handler, qmi_util_service_message_handler ind_handler)
    ...
    int rs = 1;
    int time_out = 4;
    int qmi_port = qmi_util_get_modem_port();
    ...
    if (!requester_info.is_initialized)
        ...
        do
            {
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_VOICE],
                                                   qmi_port,
                                                   qmi_util_unsolicited_voice_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_VOICE],
                                                   time_out,
           ...
           //     break;
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_NAS],
                                                   qmi_port,
                                                   qmi_util_unsolicited_nas_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_NAS],
                                                   time_out,
           ...
           //     break;
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_DMS],
                                                   qmi_port,
                                                   qmi_util_unsolicited_dms_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_DMS],
                                                   time_out,
           ...
           //     break;
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_WDS],
                                                   qmi_port,
                                                   qmi_util_unsolicited_wds_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_WDS],
                                                   time_out,
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_UIM],
                                                   qmi_port,
                                                   qmi_util_unsolicited_uim_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_UIM],
                                                   time_out,
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_PB],
                                                   qmi_port,
                                                   qmi_util_unsolicited_pb_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_PB],
                                                   time_out,
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_WMS],
                                                   qmi_port,
                                                   qmi_util_unsolicited_wms_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_WMS],
                                                   time_out,
            ...
            client_err = qmi_client_init_instance( requester_info.service_objects[QMI_UTIL_SVC_RF_SAR],
                                                   qmi_port,
                                                   qmi_util_unsolicited_rf_sar_ind_handler,
                                                   NULL,
                                                   &requester_info.os_params[QMI_UTIL_SVC_RF_SAR],
                                                   time_out,
