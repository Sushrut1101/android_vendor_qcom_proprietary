...
public:
    ...
    // copy constructor
    IzatRequest (IzatRequest & rhs)
    : mProvider(rhs.getProvider()),
      mNumUpdates(rhs.getNumUpdates()),
      mSuggestedResponseTimeForFirstFix(rhs.getTimeForFirstFix ()),
      mTimeIntervalBetweenFixes(rhs.getInterval()),
      mSmallestDistanceBetweenFixes(rhs.getDistance()),
      mSuggestedHorizontalAccuracy(rhs.getHorizontalAccuracy()),
      mSuggestedAltitudeAccuracy(rhs.getAltitudeAccuracy()),
      mSuggestedBearingAccuracy(rhs.getBearingAccuracy()) {}
