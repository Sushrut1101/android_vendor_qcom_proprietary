 ...
 */
#ifndef VENDOR_QTI_GNSS_V3_0_LOCHIDLGNSS_H
#define VENDOR_QTI_GNSS_V3_0_LOCHIDLGNSS_H
...
struct LocHidlGnss : public ILocHidlGnss {
    ...
    // Methods from ::vendor::qti::gnss::V3_0::ILocHidlGnss follow.
    Return<sp<V3_0::ILocHidlIzatConfig>> getExtensionLocHidlIzatConfig() override;
...
private:
    ...
    sp<V3_0::ILocHidlIzatConfig> mIzatConfig = nullptr;
};
...
#endif  // VENDOR_QTI_GNSS_V3_0_LOCHIDLGNSS_H
