...
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.gnss-V1.0-java
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.gnss-V1.1-java
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.gnss-V1.2-java
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.gnss-V2.0-java
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.gnss-V2.1-java
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.gnss-V3.0-java
