...
SensingCommandDispatcher::SensingCommandDispatcher()
{
    ...
    RegisterOpCodeHandler("read_stats", std::unique_ptr<IJsonHandler>(new SensingReadStatsHandler()));
    RegisterOpCodeHandler("clear_data", std::unique_ptr<IJsonHandler>(new SensingClearDataHandler()));
    RegisterOpCodeHandler("set_read_timeout", std::unique_ptr<IJsonHandler>(new SensingSetReadTimeoutHandler()));
    RegisterOpCodeHandler("cancel_read", std::unique_ptr<IJsonHandler>(new SensingCancelReadHandler()));
