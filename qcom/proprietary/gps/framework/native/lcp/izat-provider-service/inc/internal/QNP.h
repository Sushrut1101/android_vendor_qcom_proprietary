...
public:
    ...
    void reportError(const IZatLocationError *locError, const ILocationProvider *providerSrc = NULL);
...
private:
    ...
    IZatLocationError mWifiLocError;
    IZatLocationError mWwanLocError;
    IZatLocationError mZppLocError;
    ...
    static uint32_t mMinTimeBeweenTrackingFixInMsec;
    ...
    static unsigned int mMaxZppReportableHepe;
    ...
    static int64 mTimeForSavedPositionToBeValidInMinutes;

    static int mGtpApMode;

    static unsigned int mQuickFixAccuracyMinInMeters;
    ...
    static int mMinTimeToReportStatsCollectedInSec;
