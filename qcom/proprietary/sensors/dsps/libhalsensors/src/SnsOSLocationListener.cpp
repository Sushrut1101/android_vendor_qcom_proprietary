...
/*============================================================================
  FUNCTION: onNmeaChanged
============================================================================*/
void SnsOSLocationListener::onNmeaChanged (const IzatNmea * nmea){
    UNREFERENCED_PARAMETER(nmea);
    HAL_LOG_INFO("%s: Nmea changed!", __FUNCTION__);
}

/*============================================================================
  FUNCTION: listensTo
============================================================================*/
IzatListenerMask SnsOSLocationListener::listensTo () const {
