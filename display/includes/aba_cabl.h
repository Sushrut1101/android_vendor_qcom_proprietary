...
typedef struct
{
   ...
   // maximum backlight level designated by OEM (default is 255)
...
/* CablProcessingInfoType
  Defines CABL processing information
*/
typedef union
{
  struct
  {
    // 1st 64-bit data
    unsigned int  uFrameCount     : 12;
    unsigned int  uDistortionRate : 10;
    unsigned int  uMinRatio       : 12;
    unsigned int  uMaxRatio       : 12;
    unsigned int  uAlsValue       : 16;
    unsigned int  uReserved1      : 1;
    unsigned int  uState          : 1;
    // 2nd 64-bit data
    unsigned int  uLuxPoint       : 12;
    unsigned int  uFilterStep     : 7;
    unsigned int  uTargetBL       : 12;
    unsigned int  uFilteredBL     : 12;
    unsigned int  uCutOffPt       : 10;
    unsigned int  uLutType        : 2;
    unsigned int  uReserved2      : 9;
  } u;
