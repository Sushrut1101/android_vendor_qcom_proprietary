...
private:
    ...
    bool mSchedBoostNestingSupported;
    const int min_kernel_major_version_with_sched_boost_nesting_support = 14;
...
public:
    ...
    bool isSchedBoostNestingSupported() {
        return mSchedBoostNestingSupported;
    }
};
