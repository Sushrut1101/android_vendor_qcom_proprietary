...
/*shdr_aec_tuning_type*/
  ...
  {   {64.0f, 0.550f, 1.50f, 0.85f, 4, 220,{0.0f}},
      {48.0f, 0.570f, 1.50f, 0.85f, 4, 220,{0.0f}},
      {32.0f, 0.595f, 1.50f, 0.85f, 4, 220,{0.0f}},
      {24.0f, 0.615f, 1.50f, 0.85f, 4, 200,{0.0f}},
      {16.0f, 0.650f, 1.50f, 0.85f, 4, 200,{0.0f}},
      {12.0f, 0.670f, 1.30f, 0.90f, 4, 200,{0.0f}},
      { 8.0f, 0.710f, 1.20f, 0.90f, 4, 200,{0.0f}},
      { 4.0f, 0.790f, 1.20f, 0.90f, 4, 200,{0.0f}},
  },
  /*lux_index, k, exp_ratio_up_limit, exp_ratio_low_light, reserved[5] */
  {   {122,1.000f,64.0f,4.0f,{0.0f}},
      {168,1.000f,64.0f,4.0f,{0.0f}},
      {192,1.000f,64.0f,4.0f,{0.0f}},
      {215,1.000f,64.0f,4.0f,{0.0f}},
      {239,1.000f,64.0f,4.0f,{0.0f}},
      {262,1.000f,64.0f,4.0f,{0.0f}},
  },
  {0.0f}, /* reserved */
  },
