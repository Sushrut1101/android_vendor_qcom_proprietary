...
ifeq ($(filter $(TARGET_PRODUCT), kona lito bengal lahaina),$(TARGET_PRODUCT))
...
ifneq (, $(filter $(PRODUCT_LIST), $(target_base_product)))
  ...
  ifeq ($(TARGET_ARCH),arm64)
    QSSI_PREBUILT_BOARD_PLATFORM_DIR := qssi
  else
    QSSI_PREBUILT_BOARD_PLATFORM_DIR := qssi$(TARGET_BOARD_SUFFIX)
  endif
  ...
  $(call inherit-product-if-exists, $(QC_PROP_ROOT)/prebuilt_grease/target/product/$(QSSI_PREBUILT_BOARD_PLATFORM_DIR)/prebuilt.mk)
  $(call inherit-product-if-exists, $(QC_PROP_ROOT)/prebuilt_HY11/target/product/$(QSSI_PREBUILT_BOARD_PLATFORM_DIR)/prebuilt.mk)
  $(call inherit-product-if-exists, $(QC_PROP_ROOT)/prebuilt_HY22/target/product/$(QSSI_PREBUILT_BOARD_PLATFORM_DIR)/prebuilt.mk)
...
NNHAL += libprotobuf-cpp-full-rtti
