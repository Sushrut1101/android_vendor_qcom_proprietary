...
static const JNINativeMethod gMethods[] = {
  { "performUserCal",
    "(BB)I",
    (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorUserCal_performUserCal
  }
};
...
registerMethods(JNIEnv* env)
{
  static const char* const kClassName =
      "com/qualcomm/qti/sensors/core/sensortest/SensorUserCal";
  jclass class;
...
JNIEXPORT jint
JNICALL Java_com_qualcomm_qti_sensors_core_sensortest_SensorUserCal_performUserCal
...
Java_com_qualcomm_qti_sensors_core_sensortest_SensorUserCal_reqSensorCal
