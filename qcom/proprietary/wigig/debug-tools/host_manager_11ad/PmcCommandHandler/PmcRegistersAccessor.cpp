...
const std::map<std::string, std::map<BasebandRevision, PmcRegisterInfo>> PmcRegistersAccessor::s_pmcRegisterMap
{
     ...
     {"MAC_RGF.PMC.GENERAL.MAC_MAC_RGF_PMC_GENERAL_0.ucode_event_en", {{BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88607c ,26 , 26}}}},
     {"MAC_RGF.PMC.GENERAL.MAC_MAC_RGF_PMC_GENERAL_0.idle_sm_en", {{BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88607c ,27 , 27}}}},
     {"MAC_RGF.PMC.GENERAL.MAC_MAC_RGF_PMC_GENERAL_0.fw_udef_en", {{BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88607c ,28 , 28}}}},
     {"MAC_RGF.PMC.GENERAL.MAC_MAC_RGF_PMC_GENERAL_0.ucpu_udef_en", {{BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88607c ,29, 29}}}},
     ...
     {"DMA_RGF.DESCQ.<0>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x8812dc ,6, 6}}}},
     {"DMA_RGF.DESCQ.<1>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88134c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<2>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x8813bc ,6, 6}}}},
     {"DMA_RGF.DESCQ.<3>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88142c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<4>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88149c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<5>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88150c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<6>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88157c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<7>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x8815ec ,6, 6}}}},
     {"DMA_RGF.DESCQ.<8>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88165c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<9>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x8816cc ,6, 6}}}},
     {"DMA_RGF.DESCQ.<10>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x88173c ,6, 6}}}},
     {"DMA_RGF.DESCQ.<11>.IS.IS.is_pmc_dma", {{ BasebandRevision::BB_REV_UNKNOWN, PmcRegisterInfo{0x8817ac ,6, 6}}}},
...
PmcRegisterInfo PmcRegistersAccessor::GetPmcRegisterInfo(const std::string& registerName, const BasebandRevision deviceType) const
{
    ...
    auto unknownRevisionIterator = revisionToRegInfoMap.find(BasebandRevision::BB_REV_UNKNOWN);
...
{
    BasebandRevision revision = PmcSequence::GetDeviceRevision(deviceName);
