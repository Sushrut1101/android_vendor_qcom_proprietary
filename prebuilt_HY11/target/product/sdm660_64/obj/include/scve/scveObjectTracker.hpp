...
/// @param pResultSize
///    Represents number of valid entries in the 'pResult' array (this array is
///    the same one passed into the Async function). This value equals to
///    the number of objects that were tracked.
...
class SCVE_API ObjectTracker
{
   public:
      ...
      //------------------------------------------------------------------------------
      /// @brief
      ///    Deprecated old RegisterObject_Async function. Though this function is
      ///    still supported for backwards compatibility, it is recommended to use
      ///    the newer RegisterObject_Async function.
      ///
      /// @deprecated Old version, still supported for backwards compatibility.
      //------------------------------------------------------------------------------
      ...
      ///    Co-ordinates of the ROI rectangle that represents the object to be
      ///    tracked.
      /// @param bBufferBlocked
      ///    Indicates whether the buffer is held by the tracker until the callback
      ///    is sent or not. If set to zero, when the function returns the user is
      ///    free reuse the buffer in which the image data was present. When set to
      ///    zero, this function will have higher latency compared to when this is
      ///    set to non-zero.
      /// @param pTaskUserData
      ...
      //------------------------------------------------------------------------------
      /// @brief
      ///    Deprecated old RegisterObjectByPoint_Async function. Though this function
      ///    is still supported for backwards compatibility, it is recommended to use
      ///    the newer RegisterObjectByPoint_Async function.
      ///
      /// @deprecated Old version, still supported for backwards compatibility.
      //------------------------------------------------------------------------------
      ...
      //------------------------------------------------------------------------------
      /// @brief
      ///    Deprecated old TrackObjects_Async function. Though this function
      ///    is still supported for backwards compatibility, it is recommended to use
      ///    the newer TrackObjects_Async function.
      ///
      /// @deprecated Old version, still supported for backwards compatibility.
      //------------------------------------------------------------------------------
      ...
      //------------------------------------------------------------------------------
      /// @brief
      ///    Deprecated old TrackObjectsExt_Async function. Though this function
      ///    is still supported for backwards compatibility, it is recommended to use
      ///    the newer TrackObjectsExt_Async function.
      ///
      /// @deprecated Old version, still supported for backwards compatibility.
      //------------------------------------------------------------------------------
