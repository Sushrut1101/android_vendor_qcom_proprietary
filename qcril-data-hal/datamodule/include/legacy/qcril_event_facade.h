...
QCRIL_DECLARE_LEGACY_EVENT(RIL_REQUEST_SET_CARRIER_INFO_IMSI_ENCRYPTION, NULL, &QCRIL_GRP_ANDROID_RIL_REQ, QMI_RIL_ALLOWED_IN_ALL_STATES);
...
void activate_embms_request_msg
(
  qcril_request_params_type const *request
);

void deactivate_embms_request_msg
(
  qcril_request_params_type const *request
);

void activate_deactivate_embms_request_msg
(
  qcril_request_params_type const *request
);

void embms_get_available_tmgi_msg
(
  qcril_request_params_type const *request
);

void embms_get_active_tmgi_msg
(
  qcril_request_params_type const *request
);

void embms_content_desc_update_msg
(
  qcril_request_params_type const *request
);


void embms_send_interested_list
(
  qcril_request_params_type const *request
);
...
/*===========================================================================
  ...
  FUNCTION:  qcril_data_lce_report_ind

===========================================================================*/
/*!
    @brief
    Notify uplink and downlink capacity
...
/* ------------------------------------------------------------------------*/
#if defined(QCRIL_DATA_MODULE_DEV) || defined(QMI_RIL_UTF)
