...
#define NM_MDMPRXY_MAXDEVSTR          66
#define NM_MDMPRXY_MAXCMDSTR          256
#define NM_MDMPRXY_MAXRULES           2
#define NM_MDMPRXY_MAXOUTRULES        66
...
typedef ipsec_tunnel_info_t vpn_skip_tunnel_info;
...
struct route_prov_iptables
{
  ...
  const struct nm_mdmprxy_cmd *masquerade_skip_rule_list;
  ...
  int                         masquerade_skip_rule_list_len;
};
...
@arg bufflen - length of buff in bytes
@arg formatstr - format string; you know, the thing with the %s and %d
@arg in_addr - address of IMS PDN
...
/*===========================================================================
  FUNCTION  nm_mdmprxy_static_rule masquerade_formatter
===========================================================================*/
/*!
@brief
...
@arg link_name  - Interface name
@arg tech_type  - Local breakout or S2B
@arg saddr4 - IPv4 address of IMS
