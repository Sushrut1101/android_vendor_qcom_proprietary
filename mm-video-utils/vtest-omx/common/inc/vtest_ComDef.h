...
struct PreferredOmxIndexType {
    OMX_U32	IndexParamAndroidVideoTemporalLayers    :1;
    OMX_U32 IndexConfigAndroidVideoTemporalLayers   :1;
    OMX_U32 reserved                                :30;
};
...
enum ExtraDataType {
    ...
    TimeStampExtraData,
    EncMBIStatSSExtraData,     /* MBI mode 1 */
    EncMBIStatT2TExtraData,    /* MBI mode 2 */
    EncMBIStatFRCExtraData,    /* MBI mode 3 */
};
...
struct CodecConfigType {
    ...
    //======== MetaBufferType
    MetadataBufferType eMetaBufferType;            // No Config File Key needed
    ...
    ///======= PreferredOmxIndexType
    struct PreferredOmxIndexType preferredOmxIndex;    // Config File Key: PreferredOmxIndex
...
static ConfigEnum g_pColorFormat[] =
{
    ...
    { (OMX_STRING)"VENUS_RGBA",        QOMX_COLOR_Format32bitRGBA8888 },
    { (OMX_STRING)"VENUS_RGBA_UBWC",   QOMX_COLOR_Format32bitRGBA8888Compressed},
    { 0, 0 }
};
