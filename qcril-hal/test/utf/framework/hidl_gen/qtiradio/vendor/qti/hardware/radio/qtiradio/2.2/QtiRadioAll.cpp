...
*/
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.2::QtiRadio"
...
const char* IQtiRadio::descriptor("vendor.qti.hardware.radio.qtiradio@2.2::IQtiRadio");
...
// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>& parent, bool /* emitError */) {
    return parent;
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio*>(parent.get()));
}

// static
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio*>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>> mHidlServices;
...
::android::status_t IQtiRadio::registerAsService(const std::string &serviceName) {
    ...
    ::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio::registerAsService(serviceName);
    return ::android::OK;
}
