...
public:
    virtual Return<int32_t> setAlarm(int64_t time) override;
    virtual Return<int64_t> getAlarm() override;
    virtual Return<int32_t> cancelAlarm() override;
    virtual Return<int64_t> getRtcTime() override;
};
