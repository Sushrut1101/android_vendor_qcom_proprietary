...
public class WfdEnums {
    ...
    public static final String ACTION_WIFI_DISPLAY_ENABLED =
        "qualcomm.intent.action.WIFI_DISPLAY_ENABLED";

    public static final String ACTION_WIFI_DISPLAY_DISABLED =
        "qualcomm.intent.action.WIFI_DISPLAY_DISABLED";

    public static final String ACTION_WIFI_DISPLAY_RESOLUTION =
        "qualcomm.intent.action.WIFI_DISPLAY_RESOLUTION";

    public static final String ACTION_WIFI_DISPLAY_BITRATE =
        "qualcomm.intent.action.WIFI_DISPLAY_BITRATE";

    public static final String ACTION_WIFI_DISPLAY_VIDEO_CODEC_RESOLUTION =
         "qualcomm.intent.action.WIFI_DISPLAY_VIDEO_CODEC_RESOLUTION";

    public static final String ACTION_WIFI_DISPLAY_RTP_TRANSPORT =
        "qualcomm.intent.action.WIFI_DISPLAY_RTP_TRANSPORT";

    public static final String ACTION_WIFI_DISPLAY_TCP_PLAYBACK_CONTROL =
        "qualcomm.intent.action.WIFI_DISPLAY_TCP_PLAYBACK_CONTROL";

    public static final String ACTION_WIFI_DISPLAY_PLAYBACK_MODE =
        "qualcomm.intent.action.WIFI_DISPLAY_PLAYBACK_MODE";

    public static final String ACTION_WIFI_DISPLAY_SINGLE_STREAM_CTRL =
        "qualcomm.intent.action.WIFI_DISPLAY_SINGLE_STREAM_CTRL";
    ...
    public static final String SURFACE_PROP_KEY = "wfd_surface_prop";
    ...
    public static final int     H264_CEA_3840x2160p24       = BIT17;
    public static final int     H264_CEA_3840x2160p25       = BIT18;
    public static final int     H264_CEA_3840x2160p30       = BIT19;
    public static final int     H264_CEA_3840x2160p50       = BIT20;
    public static final int     H264_CEA_3840x2160p60       = BIT21;
    public static final int     H264_CEA_4096x2160p24       = BIT22;
    public static final int     H264_CEA_4096x2160p25       = BIT23;
    public static final int     H264_CEA_4096x2160p30       = BIT24;
    public static final int     H264_CEA_4096x2160p50       = BIT25;
    public static final int     H264_CEA_4096x2160p60       = BIT26;
    ...
    public static final boolean isCeaResolution(int resolution) {
        switch(resolution) {
            ...
            break;
            case H264_CEA_3840x2160p24:{
                setResParams(3840, 2160, 24);
            }
            break;

            case H264_CEA_3840x2160p25:{
                setResParams(3840,2160, 25);
            }
            break;
            case H264_CEA_3840x2160p30:{
                setResParams(3840, 2160, 30);
            }
            break;
            case H264_CEA_3840x2160p50:{
                setResParams(3840, 2160, 50);
            }
            break;
            case H264_CEA_3840x2160p60:{
                setResParams(3840, 2160, 60);
            }
            break;
            case H264_CEA_4096x2160p24:{
                setResParams(4096, 2160, 24);
            }
            break;
            case H264_CEA_4096x2160p25:{
                setResParams(4096, 2160, 25);
            }
            break;
            case H264_CEA_4096x2160p30:{
                setResParams(4096, 2160, 30);
            }
            break;
            case H264_CEA_4096x2160p50:{
                setResParams(4096, 2160, 50);
            }
            break;
            case H264_CEA_4096x2160p60:{
                setResParams(4096, 2160, 60);
            }
            break;
            default:
                return false;
    ...
    public static final int     H264_VESA_2560x1440p30      = BIT30;
    public static final int     H264_VESA_2560x1440p60      = BIT31;
    ...
    public static final boolean isVesaResolution(int resolution) {
        switch(resolution) {
            ...
            break;
            case H264_VESA_2560x1440p30: {
                setResParams(2560, 1440, 30);
            }

            case H264_VESA_2560x1440p60: {
                setResParams(2560, 1440, 60);
            }
            //Higher Vesa Res Not supported
            default:
                return false;
        }
        return true;
    ...
    public static enum H264Profile {
        WFD_VIDEO_H264_CONSTRAINED_BASELINE,
        WFD_VIDEO_H264_RESTRICTED_HIGH,
        WFD_VIDEO_H264_RESTRICTED_HIGH2,
        WFD_VIDEO_H264_BASELINE,
        WFD_VIDEO_H264_MAIN,
        WFD_VIDEO_H264_HIGH
    }

    public static enum H265Profile {
        WFD_VIDEO_H265_MAIN
    }

    public static enum VideoCodecLevel {
        WFD_VIDEO_CODEC_LEVEL_3_1,
        WFD_VIDEO_CODEC_LEVEL_3_2,
        WFD_VIDEO_CODEC_LEVEL_4,
        WFD_VIDEO_CODEC_LEVEL_4_1,
        WFD_VIDEO_CODEC_LEVEL_4_2,
        WFD_VIDEO_CODEC_LEVEL_5,
        WFD_VIDEO_CODEC_LEVEL_5_1,
        WFD_VIDEO_CODEC_LEVEL_5_2
    }
    ...
    public enum RuntimecmdType {
        UNKNOWN(-1),
        ENABLE_BITRATE_ADAPT(0),
        DISABLE_BITRATE_ADAPT(1),
        HANDLE_STANDBY(2),
        ENABLE_STREAMING_FEATURE(3),
        DISABLE_STREAMING_FEATURE(4),
        DISABLE_AUDIO(5),
        ENABLE_AUDIO(6),
        DISABLE_VIDEO(7),
        ENABLE_VIDEO(8);
    ...
    public static enum HIDDataType {
        HID_REPORT, HID_REPORT_DESCRIPTOR, HID_INVALID_DATA
    }
