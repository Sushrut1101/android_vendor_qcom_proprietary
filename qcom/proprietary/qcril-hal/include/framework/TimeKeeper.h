...
public:
    ...
    static constexpr millisec INVALID_MESSAGE_EXPIRY_TIMEOUT{-1};
...
private:
    ...
    using Lock = qtimutex::QtiSharedMutex;
    ...
    bool exit;
    qtimutex::QtiSharedMutex looper_mutex;
    std::condition_variable_any looper_cv;
