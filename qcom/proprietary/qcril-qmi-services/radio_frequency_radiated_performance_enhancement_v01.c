...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.HE.1.0.c1/Main/modem_proc/qmimsgs/rfrpe/src/radio_frequency_radiated_performance_enhancement_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const qmi_idl_message_table_entry rfrpe_message_table_v01[] = {
  ...
  {sizeof(rfrpe_get_rfm_scenarios_req_v01), 0},
  {sizeof(rfrpe_get_rfm_scenarios_resp_v01), rfrpe_get_rfm_scenarios_resp_data_v01},
  {sizeof(rfrpe_get_provisioned_table_revision_req_v01), 0},
...
static const qmi_idl_service_message_table_entry rfrpe_service_command_messages_v01[] = {
  {QMI_RFRPE_GET_SUPPORTED_MSGS_REQ_V01, QMI_IDL_TYPE16(1, 0), 0},
  {QMI_RFRPE_GET_SUPPORTED_FIELDS_REQ_V01, QMI_IDL_TYPE16(1, 2), 5},
  {QMI_RFRPE_SET_RFM_SCENARIO_REQ_V01, QMI_IDL_TYPE16(0, 0), 132},
  {QMI_RFRPE_GET_RFM_SCENARIO_REQ_V01, QMI_IDL_TYPE16(0, 2), 0},
  {QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_REQ_V01, QMI_IDL_TYPE16(0, 4), 0}
};

static const qmi_idl_service_message_table_entry rfrpe_service_response_messages_v01[] = {
  {QMI_RFRPE_GET_SUPPORTED_MSGS_RESP_V01, QMI_IDL_TYPE16(1, 1), 8204},
  {QMI_RFRPE_GET_SUPPORTED_FIELDS_RESP_V01, QMI_IDL_TYPE16(1, 3), 115},
  {QMI_RFRPE_SET_RFM_SCENARIO_RESP_V01, QMI_IDL_TYPE16(0, 1), 7},
  {QMI_RFRPE_GET_RFM_SCENARIO_RESP_V01, QMI_IDL_TYPE16(0, 3), 139},
  {QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_RESP_V01, QMI_IDL_TYPE16(0, 5), 146}
};
