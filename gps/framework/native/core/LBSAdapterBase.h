...
virtual bool reportFdclInfoEvent(FdclInfo& fdclInfo, uint8_t status, UlpLocation& location);

virtual bool requestCellCSDataEvent();
virtual bool reportCellCSInfoEvent(CellCSInfo& cellCSInfo, uint8_t status);
