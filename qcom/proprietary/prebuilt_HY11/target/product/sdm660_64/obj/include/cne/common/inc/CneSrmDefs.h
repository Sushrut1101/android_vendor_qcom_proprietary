...
/*=============================================================================
               Copyright (c) 2009-2017,2019 Qualcomm Technologies, Inc.
               All Rights Reserved.
...
enum SrmEvent {
  ...
  SRM_SLM_ADAPTER_REQUEST_UPDATE_RAT_INFO,
  SRM_SLS_EVENT,
  SRM_SLA_EVENT
};
...
typedef struct _CneSlaRatioInfo {
  float primaryRatio;
  ...
  _CneSlaRatioInfo(): primaryRatio(0.500), secondaryRatio(0.500)
  {
...
typedef struct _CneSlsInterfaceInfo {
  char iface[CNE_MAX_IFACE_NAME_LEN];

  _CneSlsInterfaceInfo() {
    bzero(iface, CNE_MAX_IFACE_NAME_LEN);
  }
