...
typedef void (*qap_module_callback_t)(qap_module_handle_t module_handle,
                              void* priv_data,
                              qap_module_callback_event_t event_id,
                              int size,
                              void* data);

typedef void (*qap_log_func_t)(qap_log_level_t level, const char *msg);
...
/**************************************/
/*
 * Set the callback function for message logging.
 * Input:
...
/*
 * Set the level for default log handler in lib.
 * Input:
 *     lib_handle - Library Handle
...
/*
 * Process command for input buffer synchronous.
 * Input:
 *     module_handle - module handle
...
int qap_module_process_sync(qap_module_handle_t module_handle,
                            qap_audio_buffer_t *input_buffer,
                            qap_audio_buffer_t *output_buffer);
 ...
 *     cb - module callback function pointer
 *     priv_data - callback context
 * Output:
 *     qap_status_t - returns success or failure.
 */
