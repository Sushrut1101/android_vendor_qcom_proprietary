...
*/
	...
	*/
	listen_status_enum verifyUserRecording(
	...
	*/
	listen_status_enum checkUserRecording(
	...
	*/
    ...
    listen_status_enum  checkRecordingsQuality(
		listen_language_model_type	*pLanguageModel,
		listen_epd_params			*pEpdParameter,
	...
	*		kKeywordNotFound - When keywordId not exist in the model
	*/
	listen_status_enum tuneUserDefinedKeywordModelThreshold(
	...
	*		kNoSignal - When user recording is non-speech
	*/
	listen_status_enum getUserDefinedKeywordSize(
		listen_model_type			*pUserDefinedKeyword,
		keywordId_t					keywordId,
		userId_t					userId,
		listen_epd_params			*pEpdParameter,
	...
	*/
	listen_status_enum createUserDefinedKeywordModel(
		listen_model_type		   *pUserDefinedKeyword,
		keywordId_t					keywordId,
		userId_t					userId,
		listen_epd_params			*pEpdParameter,
	...
	*
	*/
	listen_status_enum getStrippedUserKeywordModelSize(
	...
	*
	*/
	listen_status_enum stripUserKeywordModel(
		listen_model_type			*pModel,
	...
	*		kSMVersionUnsupported - When pKeywordModel is not 2.0 model
	*/
	listen_status_enum getUserKeywordModelSize(
		listen_model_type			*pKeywordModel,
		keywordId_t					keywordId, // add for SVA 2.0
	...
	*/
	listen_status_enum createUserKeywordModel(
		listen_model_type			*pKeywordModel,
		keywordId_t					keywordId, // add for SVA 2.0
		userId_t					userId,	// add for SVA 2.0
		listen_epd_params			*pEpdParameter,
...
// to allocate memory for pResultModel when deleteFromModel() called.
	...
	*/
	listen_status_enum getSizeAfterDeleting(
...
// less than or equal to size of input SoundModel.
	...
	*		kUserUDKPairNotRemoved - When <keywordId, userId> pair to delete is UDK
	*/
	listen_status_enum deleteFromModel(
		listen_model_type			*pInputModel,
		keywordId_t					keywordId, // add for SVA 2.0
		userId_t					userId,	// add for SVA 2.0
	...
	*		kMaxUsersExceeded,
	*/
	listen_status_enum getMergedModelSize(
		uint16_t					numModels,
	...
	*/
	listen_status_enum mergeModels(
		uint16_t					numModels,
		listen_model_type			*pModels[],
	...
	*/
	...
	listen_status_enum parseDetectionEventData(
		listen_model_type			*pUserKeywordModel,
...
//
	...
	*/
	listen_status_enum querySoundModel(
	...
	*/
	listen_status_enum getSoundModelHeader(
		listen_model_type			*pSoundModel,
	...
	*		kBadParam - When any input pointer is NULL
	*/
	listen_status_enum releaseSoundModelHeader(
		listen_sound_model_header	*pListenSoundModelHeader);
	...
	*		kSMVersionUnsupported - When pSoundModel is not 2.0 model
	*/
	listen_status_enum getKeywordPhrases(
		listen_model_type			*pSoundModel,
	...
	*		kSMVersionUnsupported - When pSoundModel is not 2.0 model
	*/
	listen_status_enum getUserNames(
		listen_model_type			*pSoundModel,
		uint16_t						*numUsers,
		userId_t						*users);
	...
	*		kSMVersionUnsupported - When pKeywordModel is not 2.0 model
	*/
        listen_status_enum findKeywordEndPosition(
				listen_model_type			*pKeywordModel,
				keywordId_t					keywordId,
				listen_user_recording		*pUserRecording,
