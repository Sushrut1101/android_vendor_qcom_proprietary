...
typedef struct command_line_options {
    ...
    char gpsConfPath[LOC_MAX_PARAM_STRING]; // Path to config file
    ...
    int routeToNmeaPort; // Send NMEA strings to NMEA port
    int deleteAll;
    int engineTypeMask; // EngineTypeMask to perform delete on
