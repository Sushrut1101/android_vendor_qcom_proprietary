...
public class ListenerHandler extends Handler
{
    ...
    private static String TAG = "Presence_UI2: ListenerHandler";
    Context mContext;
    ...
    private final short PRESENCE_IMS_UNPUBLISH_MSG_SENT = 11;
   ...
   public ListenerHandler(Context context, Looper looper) {
    ...
    public IPresenceListener presListener = new IPresenceListener.Stub() {
        ...
        public void sipResponseReceived(PresSipResponse pSipResponse)
                ...
                case PresCmdId.UCE_PRES_CMD_PUBLISHMYCAP: {
                    ...
                    if (pSipResponse.getSipResponseCode() == 999) {
                        ...
                        if (AppGlobalState.getCdService() != null) {
                            ...
                            Log.d(TAG,"ATT_MODE :errorSipHandle:"+errorSipHandle);
                        ...
                        if (AppGlobalState.getCdService() != null) {
                            ...
                            Log.d(TAG,"VZW_MODE :errorSipHandle:"+errorSipHandle);
            ...
            else if ((pSipResponse.getSipResponseCode() == 200) && (pSipResponse.getCmdId().getCmdId() == PresCmdId.UCE_PRES_CMD_GETCONTACTLISTCAP))
            {
                for (int i = 0; i < AppGlobalState.listCapPollingRequestinfo
                            .size(); i++) {
                        if (pSipResponse.getRequestId() == AppGlobalState.listCapPollingRequestinfo
        ...
        public void serviceUnAvailable(StatusCode statusCode) throws RemoteException {
            ...
            Log.d(TAG, "ListenerHandler : ServiceUnAvailable : statusCode "+statusCode.getStatusCode());
        ...
        public void serviceAvailable(StatusCode statusCode) throws RemoteException {
            ...
            Log.d(TAG, "ListenerHandler : ServiceAvailable : statusCode "+statusCode.getStatusCode());
        ...
        public void publishTriggering(final PresPublishTriggerType publishTrigger) throws RemoteException {
            ...
            Log.d(TAG, "ListenerHandler : before posting to UI tread");
            MainActivity.mainActivityObject.runOnUiThread(show_UI);
            Log.d(TAG, "ListenerHandler : after posting to UI tread");

            Message updateUiMesg = uiThreadHandler.obtainMessage(
                    PRESENCE_IMS_UNSOL_PUBLISH_TRIGGER, publishTrigger);
            uiThreadHandler.sendMessage(updateUiMesg);

            Log.d(TAG, "ListenerHandler : after calling ui update");
        }
        ...
        public void listCapInfoReceived(PresRlmiInfo pRlmiInfo, PresResInfo[] pResInfo)
            ...
            if(pRlmiInfo != null)
            {
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getListName "+pRlmiInfo.getListName());
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.isFullState "+pRlmiInfo.isFullState());
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getUri "+pRlmiInfo.getUri());
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getVersion "+pRlmiInfo.getVersion());
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getRequestID "+pRlmiInfo.getRequestId());
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getPresSubscriptionState "+pRlmiInfo.getPresSubscriptionState().getPresSubscriptionStateValue());
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getSubscriptionExpireTime "+pRlmiInfo.getSubscriptionExpireTime());
                ...
                Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pRlmiInfo.getSubscriptionTerminatedReason "+pRlmiInfo.getSubscriptionTerminatedReason());
            ...
            if(pResInfo != null)
            {
                ...
                {
                    Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getDisplayName() "+pResInfo[i].getDisplayName());
                    Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getResUri() "+pResInfo[i].getResUri());
                    Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo.getInstanceInfo().getPresentityUri() "+pResInfo[i].getInstanceInfo().getPresentityUri());
                    Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getResId() "+pResInfo[i].getInstanceInfo().getResId());
                    Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getsReason() "+pResInfo[i].getInstanceInfo().getReason());
                    Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getResInstanceState() "+pResInfo[i].getInstanceInfo().getResInstanceState());
                    if(pResInfo[i].getInstanceInfo() != null && pResInfo[i].getInstanceInfo().getTupleInfo() != null)
                    {
                        Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getTupleInfo().length "+pResInfo[i].getInstanceInfo().getTupleInfo().length);
                        for(int j = 0; j < pResInfo[i].getInstanceInfo().getTupleInfo().length; j++ )
                        {
                            Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getTupleInfo()[j].getFeatureTag "+pResInfo[i].getInstanceInfo().getTupleInfo()[j].getFeatureTag());
                            Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getTupleInfo()[j].getsContactURI "+pResInfo[i].getInstanceInfo().getTupleInfo()[j].getContactUri());
                            Log.d(TAG, "ListenerHandler : ListCapInfoReceived : pResInfo[i].getInstanceInfo().getTupleInfo()[j].getsTimestamp "+pResInfo[i].getInstanceInfo().getTupleInfo()[j].getTimestamp());
                        }
                    }
                }
            }
        ...
        public void getVersionCb(String pVersion) throws RemoteException {
            ...
            Log.d(TAG, "ListenerHandler : GetVersion : pVersion "+pVersion);
        }
        ...
        public void capInfoReceived(String pPresentityURI, PresTupleInfo[] pTupleInfo)
            ...
            {
                Log.d(TAG, "ListenerHandler : CapInfoReceived : pPresentityURI "+pPresentityURI);
            }
            if(pTupleInfo != null)
            {
                for(int i = 0; i < pTupleInfo.length; i++)
                {
                    Log.d(TAG, "ListenerHandler : CapInfoReceived : pTupleInfo[i].getFeatureTag() "+pTupleInfo[i].getFeatureTag());
                    Log.d(TAG, "ListenerHandler : CapInfoReceived : pTupleInfo[i].getsContactURI() "+pTupleInfo[i].getContactUri());
                    Log.d(TAG, "ListenerHandler : CapInfoReceived : pTupleInfo[i].getsTimestamp() "+pTupleInfo[i].getTimestamp());
                }
            }
        ...
        public void unpublishMessageSent() throws RemoteException {
            Log.d(TAG, "ListenerHandler : unpublishMessageSent");
            Message updateUiMesg = uiThreadHandler
                    .obtainMessage(
                            PRESENCE_IMS_UNPUBLISH_MSG_SENT,
                            "UN-PUBLISH SENT");
            uiThreadHandler.sendMessage(updateUiMesg);
      }
        ...
        public void cmdStatus(PresCmdStatus pCmdStatus) throws RemoteException {
            ...
            Log.d(TAG, "ListenerHandler : CMDStatus : pCmdStatus.getRequestID() "+pCmdStatus.getRequestId());
            Log.d(TAG, "ListenerHandler : CMDStatus : pCmdStatus.getUserData() "+pCmdStatus.getUserData());
            ...
            for(int i = 0; i < AppGlobalState.requestinfo.size(); i++)
            {
                if(pCmdStatus.getUserData() == AppGlobalState.requestinfo.get(i).userData)
                {
                    ...
                    Log.d(TAG, "ListenerHandler : CMDStatus : AppGlobalState.requestinfo.get(i).requestID "+
            ...
            for(int i = 0; i < AppGlobalState.listCapPollingRequestinfo.size(); i++)
            {
                if(pCmdStatus.getUserData() == AppGlobalState.listCapPollingRequestinfo.get(i).userData)
                {
                    ...
                    Log.d(TAG, "ListenerHandler : CMDStatus : AppGlobalState.listCapPollingRequestinfo.get(i).requestID "+
                            AppGlobalState.listCapPollingRequestinfo.get(i).requestID);
                    break;
                }
            }

            Log.d(TAG, "ListenerHandler : CMDStatus : pCmdStatus.getCmdId().toString() "+pCmdStatus.getCmdId().getCmdId());
            Log.d(TAG, "ListenerHandler : CMDStatus : pCmdStatus.getStatus().toString() "+pCmdStatus.getStatus().getStatusCode());
    ...
    private void updateStatus(PresRlmiInfo pRlmiInfo, PresResInfo[] pResInfo, String pPresentityURI, PresTupleInfo[] pTupleInfo , int requestID) {
        ...
        if(pRlmiInfo == null && pResInfo == null && pTupleInfo == null && pPresentityURI == null && requestID != 0)
        {
            for(int i = 0; i < AppGlobalState.requestinfo.size(); i++)
            {
                ...
                {
                    Log.d(TAG, "ListenerHandler : CMDStatus : AppGlobalState.requestinfo.get(i).requestID "+AppGlobalState.requestinfo.get(i).requestID);
                    String uriValue;
                    //ArrayList<Contact> contacts = AppGlobalState.getContacts();
                    for(int k = 0; k < AppGlobalState.requestinfo.get(i).URI.length; k++)
                    {
                        ...
                        Log.d(TAG, "ListenerHandler : CMDStatus : uriValue "+uriValue);
                        if (AppGlobalState.requestinfo.get(i).URI[k].contains("tel:")) {
                            ...
                            Log.e(TAG, " IF uriValue =" + uriValue);
                            ...
                            Log.e(TAG, "ELSE uriValue =" + uriValue);

                        }
                        int index = getIndex(contacts, uriValue);
                        Log.d(TAG, "ListenerHandler : CMDStatus : index "+index);
        ...
        String uriValue1 = c.getResUri();
            ...
            if (i < 0) {
                ...
                {
                Log.d(TAG, "ListenerHandler : updateStatus : Not VoLTE contact");
                temp.setNote("Not VoLTE contact");
                }
                else if (!c.getInstanceInfo().getReason().equals(""))
                {
                Log.d(TAG, "ListenerHandler : updateStatus : VoLTE contact");
                ...
                if(c.getInstanceInfo() != null && c.getInstanceInfo().getTupleInfo() != null && c.getInstanceInfo().getTupleInfo().length > 0)
                {
                    for (int j = 0; j < c.getInstanceInfo().getTupleInfo().length; j++) {
                        ...
                        {
                            Log.d(TAG, "ListenerHandler : updateStatus : 1111");
                        ...
                        {
                            Log.d(TAG, "ListenerHandler : updateStatus : 2222");
                            temp.setAvailability(1);
                            temp.setBasicStatus("Open");
                            temp.setAudio("True");
                            temp.setVideo("True");
                        ...
                        {
                            isChatEnabled ++;
                            Log.d(TAG, "ListenerHandler : updateStatus : isChatEnabled "+isChatEnabled);
        ...
        if(pPresentityURI != null /*pTupleInfo != null && pTupleInfo.length > 0*/)
        {
            ...
            if(pTupleInfo != null && pTupleInfo.length > 0)
            {
            ...
            {
                Log.d(TAG, "ListenerHandler : updateStatus : 7777");
                temp.setAvailability(0);
                temp.setBasicStatus("Closed");
                temp.setAudio("False");
                temp.setVideo("False");
    ...
    Handler uiThreadHandler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PRESENCE_IMS_UNPUBLISH_MSG_SENT:
                {
                    String enabler_state = (String) msg.obj;
                    Toast.makeText(mContext, "" +
                            enabler_state,
    ...
    public IOptionsListener cdServiceListener = new IOptionsListener.Stub() {
        ...
        public void getVersionCb( String pVersion)
                throws RemoteException {
            Log.d(TAG, "Options Listener ServiceUnavailable");
        }
        ...
        public void serviceAvailable( StatusCode statusCode)
                throws RemoteException {
            Log.d(TAG, "Options Listener ServiceAvailable");
        }
        ...
        public void sipResponseReceived(String URI,
            ...
            Log.d(TAG, "Options Listener CDUpdate");
            ...
            if (URI != null) {
                ...
                if(cdSipResponse != null) {
                    Log.d(TAG, "Options Listener CDUpdate : CMD-ID = " + cdSipResponse.getCmdId());
                    Log.d(TAG, "Options Listener CDUpdate : RequestID = " + cdSipResponse.getRequestId());
                    Log.d(TAG, "Options Listener CDUpdate : Response Code = " + cdSipResponse.getSipResponseCode());
                    if(cdSipResponse.getReasonPhrase() != null) {
                        Log.d(TAG, "Options Listener CDUpdate : Reason Phrase = " + cdSipResponse.getReasonPhrase());
                    }
                    Log.d(TAG, "Options Listener CDUpdate : retryAfter = " + cdSipResponse.getSipResponseCode());
                }
                if (CDCapInfo != null) {
                    Log.d(TAG, "Options Listener CDUpdate : SDP string = " + CDCapInfo.getSdp());
                    Log.d(TAG, "Options Listener CDUpdate : IM_CAPABILITY = " + CDCapInfo.getCapInfo().isImSupported());
                    Log.d(TAG, "Options Listener CDUpdate : FT_CAPABILITY = " + CDCapInfo.getCapInfo().isFtSupported());
                    Log.d(TAG, "Options Listener CDUpdate : IS_CAPABILITY = " + CDCapInfo.getCapInfo().isIsSupported());
                    Log.d(TAG, "Options Listener CDUpdate : VS_CAPABILITY = " + CDCapInfo.getCapInfo().isVsSupported());
                    Log.d(TAG, "Options Listener CDUpdate : isCDViaPresenceSupported = "
                            + CDCapInfo.getCapInfo().isCdViaPresenceSupported());
                    Log.d(TAG, "Options Listener CDUpdate : isGeoPullSupported= "+CDCapInfo.getCapInfo().isGeoPullSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isGeoPushSupported = "
                            + CDCapInfo.getCapInfo().isGeoPushSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isIPVideoSupported = "
                            + CDCapInfo.getCapInfo().isIpVideoSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isIPVoiceSupported = "
                            + CDCapInfo.getCapInfo().isIpVoiceSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isSMSupported = "
                            + CDCapInfo.getCapInfo().isSmSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isSpSupported = "
                            + CDCapInfo.getCapInfo().isSpSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isVsDuringCSSupported = "
                                    + CDCapInfo.getCapInfo().isVsDuringCSSupported());
                    Log.d(TAG, " Options Listener CDUpdate : isbFullSnFGroupChatSupported = "
                                    + CDCapInfo.getCapInfo().isFullSnFGroupChatSupported());
                    Log.d(TAG, " Options Listener CDUpdate : getCapTimestamp = "
                    ...
                    Log.d(TAG, "ListenerHandler : update CD Found CustomTags");
                    if(customStrings != null)
                    {
                        for(int x=0; x < customStrings.length ; x++)
                        {
                            Log.d(TAG, "ListenerHandler : update CD Found CustomTags [" + x + "]-["+ customStrings[x] +"]");
                        }
                    }

                } else {
                    Log.d(TAG, "ListenerHandler : update CD Status : 7777");
                    temp.setAvailability(0);
                    temp.setBasicStatus("Closed");
                    temp.setAudio("False");
                    temp.setVideo("False");
        ...
        public void incomingOptions(String sUri, OptionsCapInfo CDCapInfo,
            ...
            Log.d(TAG, "Options Listener IncomingOptionsncomingOptions");
            Log.d(TAG, "Options Listener IncomingOptionsncomingOptions: URI[" + sUri + "]");
            Log.d(TAG, "Options Listener IncomingOptionsncomingOptions: TransactionId[" + tID + "]");
            if(CDCapInfo != null)
            {
                Log.d(TAG, "Options Listener CDUpdate : SDP string = " + CDCapInfo.getSdp());
                ...
                if (tempCdInfo != null) {
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : IM_CAPABILITY = " + tempCdInfo.isImSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : FT_CAPABILITY = " + tempCdInfo.isFtSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : IS_CAPABILITY = " + tempCdInfo.isIsSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : VS_CAPABILITY = " + tempCdInfo.isVsSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isCDViaPresenceSupported = " + tempCdInfo.isCdViaPresenceSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isGeoPullSupported= "+tempCdInfo.isGeoPullSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isGeoPushSupported = "+ tempCdInfo.isGeoPushSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isIPVideoSupported = " + tempCdInfo.isIpVideoSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isIPVoiceSupported = " + tempCdInfo.isIpVoiceSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isSMSupported = " + tempCdInfo.isSmSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isSpSupported = " + tempCdInfo.isSpSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isVsDuringCSSupported = " + tempCdInfo.isVsDuringCSSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : isbFullSnFGroupChatSupported = " + tempCdInfo.isFullSnFGroupChatSupported());
                    Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : getCapTimestamp = " + tempCdInfo.getCapTimestamp());
                }
            }
            Message updateUiMesg = uiThreadHandler.obtainMessage(
            ...
            Thread thread = new Thread() {
                    ...
                    public void run() {
                        ...
                        Log.d(TAG, "Options Listener IncomingOptionsncomingOptions : getCapTimestamp = " + TempCapinfo);
                        try
                        {
        ...
        public void cmdStatus(OptionsCmdStatus CdCMDStatus )throws RemoteException {
            Log.d(TAG, "Options Listener CMDStatus");
            Log.d(TAG, "Options Listener CMDStatus: CMD_ID[" + CdCMDStatus.getCmdId().getCmdId() + "]");
            Log.d(TAG, "Options Listener CMDStatus: CMD_ID[" + CdCMDStatus.getUserData() + "]");
            Log.d(TAG, "Options Listener CMDStatus: CMD_ID[" + CdCMDStatus.getStatus().getStatusCode() + "]");
            Log.d(TAG, "Options Listener CMDStatus: CMD_ID[" + CdCMDStatus.getStatus().getStatusCode() + "]");
            ...
            case OptionsCmdId.UCE_OPTIONS_CMD_GETMYCDINFO:
                ...
                if(AppGlobalState.getOperatorMode() == AppGlobalState.ATT_MODE) {
                    Log.d(TAG, "MainActivity : updateSettingsStatusATT");
                    updateSettingsStatusATT(tempCdInfo);

                } else if(AppGlobalState.getOperatorMode() == AppGlobalState.VZW_MODE) {
                    Log.d(TAG, "MainActivity : updateSettingsStatusVZW");
            ...
            if (tempCdInfo != null) {
                    Log.d(TAG, "Options Listener CMDStatus : IM_CAPABILITY = " + tempCdInfo.isImSupported());
                    Log.d(TAG, "Options Listener CMDStatus : FT_CAPABILITY = " + tempCdInfo.isFtSupported());
                    Log.d(TAG, "Options Listener CMDStatus : IS_CAPABILITY = " + tempCdInfo.isIsSupported());
                    Log.d(TAG, "Options Listener CMDStatus : VS_CAPABILITY = " + tempCdInfo.isVsSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isCDViaPresenceSupported = " + tempCdInfo.isCdViaPresenceSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isGeoPullSupported= "+tempCdInfo.isGeoPullSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isGeoPushSupported = "+ tempCdInfo.isGeoPushSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isIPVideoSupported = " + tempCdInfo.isIpVideoSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isIPVoiceSupported = " + tempCdInfo.isIpVoiceSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isSMSupported = " + tempCdInfo.isSmSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isSpSupported = " + tempCdInfo.isSpSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isVsDuringCSSupported = " + tempCdInfo.isVsDuringCSSupported());
                    Log.d(TAG, "Options Listener CMDStatus : isbFullSnFGroupChatSupported = " + tempCdInfo.isFullSnFGroupChatSupported());
                    Log.d(TAG, "Options Listener CMDStatus : getCapTimestamp = " + tempCdInfo.getCapTimestamp());
            }
            Message updateUiMesg = uiThreadHandler.obtainMessage(
     ...
     try {
         Log.d(TAG, "MainActivity : updateSettingsStatus : After");
         if(AppGlobalState.getCdService()!= null)
         {
             ...
             myCdInfo.setFtHttpSupported(getFeatureStatus("IPME_KEY"));
    ...
    private boolean getFeatureStatus(String key) {
       ...
       SharedPreferences preferences = mContext.getSharedPreferences("presencedata", Context.MODE_PRIVATE);
       boolean featureSupported = preferences.getBoolean(key, false);
       Log.d(TAG, "Key:"+key+":featureSupported:"+featureSupported);
       return featureSupported;
    }
