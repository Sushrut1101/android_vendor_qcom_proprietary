...
**********************************************************************/
.chromatix_id = FD_HW_CHROMATIX_DETECT_TURBO_QC,
...
.speed = 3,
.input_pending_buf = 1,
.enable_facial_parts_assisted_face_filtering = 0,
...
#ifdef FD_USE_V65
.assist_tr_good_face_threshold = 700,
.assist_tr_detect_threshold = 600,
.assist_tr_tracking_threshold = 500,
.assist_tr_strict_good_face_threshold = 800,
.assist_tr_strict_detect_threshold = 620,
...
#ifdef FD_ENABLE_SW_INTERMITTENT
.sw_detect_enable = 1,
#else
.sw_detect_enable = 0,
#endif
.sw_detect_skip_if_no_orientaiton_info = 1,
.sw_detect_no_face_skip = 0,
