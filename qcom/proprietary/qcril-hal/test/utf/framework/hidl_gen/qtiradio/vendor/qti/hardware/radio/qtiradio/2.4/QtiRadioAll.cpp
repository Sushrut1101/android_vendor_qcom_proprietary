...
*/
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.4::QtiRadio"
...
const char* IQtiRadio::descriptor("vendor.qti.hardware.radio.qtiradio@2.4::IQtiRadio");
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio*>(parent.get()));

}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio*>(parent.get()));

}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio*>(parent.get()));

}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio*>(parent.get()));

}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio*>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio*>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_4::IQtiRadio>> mHidlServices;
