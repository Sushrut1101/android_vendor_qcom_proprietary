...
#define DSI_PROPERTY_PERSIST_DATA_TARGET       "persist.vendor.data.target"
...
#elif defined (DSI_NETCTRL_OFFTARGET)
#define DSI_CONFIG_FILE_PATH "/mnt/host/vendor/qcom/proprietary/data/dsi_netctrl/src/dsi_config.xml"
#elif defined (FEATURE_DS_LINUX_ANDROID)
#define DSI_CONFIG_FILE_PATH "/system/vendor/etc/data/dsi_config.xml"
#endif

/* DSI can max support 34 ifaces, 17 ifaces per modem and two modems */
#define DSI_MAX_IFACES 34
