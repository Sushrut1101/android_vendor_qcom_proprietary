...
static const JNINativeMethod gMethods[] = {
   { "registerThresholdNative",
     "(IIIFFFLcom/qualcomm/qti/sensors/core/qsensortest/QSensorEventListener;)I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorThresh_registerThresholdNative
   },
   { "unregisterThresholdNative",
     "(I)I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorThresh_unregisterThresholdNative
   }
};
...
Java_com_qualcomm_qti_sensors_core_sensortest_SensorThresh_registerThresholdNative
...
JNIEXPORT jint
JNICALL Java_com_qualcomm_qti_sensors_core_sensortest_SensorThresh_unregisterThresholdNative
...
registerMethods(JNIEnv* env)
{
  static const char* const kClassName =
    "com/qualcomm/qti/sensors/core/sensortest/SensorThresh";
  jclass class;
