...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2020 Qualcomm Technologies, Inc.
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.
  


  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/nas/api/network_access_service_v01.h#140 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define NAS_V01_IDL_MINOR_VERS 0x112
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00F1
/**
    @}
  */
...
#define NAS_CELL_SEARCH_MAX_NUM_CELL_V01 8
#define NAS_PCI_SCAN_MAX_NUM_PLMN_V01 6
#define NAS_3GPP_PREFERRED_NETWORKS_LIST_MAX_V01 85
#define NAS_3GPP_PREFERRED_NETWORKS_EXT_LIST_MAX_V01 200
...
#define NAS_NR5G_BAND_PRIORITY_LIST_MAX_V01 512
...
#define NAS_NR5G_MODULATIONS_MAX_V01 2
...
#define NAS_SIG_TYPE_MAX_V01 8
#define NAS_MMGSDI_ICCID_LEN_V01 10
/**
    @}
  */
...
typedef struct {
  ...
  /*  TX_ID */
  uint16_t tx_id;
  /**<   Transaction ID of the request to abort.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   A sequence of thresholds delimiting signal strength Var bands. 
       ...
       strength, is sent to the requesting control point. 
...
typedef struct {
  ...
  */
  ...
  /**<   RSSI delta (in dBm) at which an event report indication,
       including the current RSSI, is sent to the requesting
...
typedef struct {
  ...
  */
  ...
  /**<   ECIO delta at which an event report indication,
       ecio_delta including the current ECIO, is sent to the
...
typedef struct {
  ...
  */
  ...
  /**<   IO delta (in dBm) at which an event report indication,
       io_delta including the current IO, is sent to the
...
typedef struct {
  ...
  */
  ...
  /**<   SINR delta level at which an event report indication,
       sinr_delta including the current SINR, is sent to the
...
typedef struct {
  ...
  */
  ...
  /**<   RSRQ delta level at which an event report indication, including the
      current RSRQ, is sent to the requesting control point. 
...
typedef struct {
  ...
  */
  ...
  /**<  
   ...
   - Each threshold value is an unsigned 1 byte value \n
...
typedef struct {
  ...
  */
  ...
  /**<   LTE RSRP delta level at which an event report indication, including the
       current RSRP, is sent to the requesting control point. LTE RSRP 
...
typedef struct {
  ...
  */
  ...
  /**<   LTE SNR delta level at which an event report indication, including the
       current SNR, is sent to the requesting control point. LTE SNR delta 
...
typedef enum {
  ...
  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_86_V01 = 175, 
  ...
  NAS_ACTIVE_BAND_NR5G_BAND_12_V01 = 282, 
  NAS_ACTIVE_BAND_NR5G_BAND_25_V01 = 283, 
  NAS_ACTIVE_BAND_NR5G_BAND_34_V01 = 284, 
  NAS_ACTIVE_BAND_NR5G_BAND_39_V01 = 285, 
  NAS_ACTIVE_BAND_NR5G_BAND_40_V01 = 286, 
  NAS_ACTIVE_BAND_NR5G_BAND_65_V01 = 287, 
  NAS_ACTIVE_BAND_NR5G_BAND_86_V01 = 288, 
  NAS_ACTIVE_BAND_NR5G_BAND_48_V01 = 289, 
  NAS_ACTIVE_BAND_NR5G_BAND_14_V01 = 290, 
...
typedef enum {
  ...
  NAS_CIRCUIT_SWITCHED_V01 = 0x01, /**<  CIRCUIT_SWITCHED \n */
  NAS_PACKET_SWITCHED_V01 = 0x02, /**<  PACKET_SWITCHED \n  */
  NAS_CIRCUIT_AND_PACKET_SWITCHED_V01 = 0x03, /**<  CIRCUIT_AND_PACKET_ SWITCHED */
...
typedef struct {
  ...
  /**<   Network service domain that was rejected. Possible values: \n
      - NAS_CIRCUIT_SWITCHED (0x01) --  CIRCUIT_SWITCHED \n
      - NAS_PACKET_SWITCHED (0x02) --  PACKET_SWITCHED \n 
      - NAS_CIRCUIT_AND_PACKET_SWITCHED (0x03) --  CIRCUIT_AND_PACKET_ SWITCHED
 */

  uint16_t reject_cause;
  /**<   Reject cause values are specified in \hyperref[STD-24008]{3GPP TS 24.008},
       \hyperref[STD-24301]{3GPP TS 24.301}, and \hyperref[STD-24501]{3GPP TS 24.501}.
  */
...
typedef enum {
  ...
  NAS_SINR_LEVEL_0_V01 = 0x00, /**<  -9 dB \n   */
  NAS_SINR_LEVEL_1_V01 = 0x01, /**<  -6 dB \n */
  NAS_SINR_LEVEL_2_V01 = 0x02, /**<  -4.5 dB \n  */
  NAS_SINR_LEVEL_3_V01 = 0x03, /**<  -3 dB \n  */
  NAS_SINR_LEVEL_4_V01 = 0x04, /**<  -2 dB \n  */
  NAS_SINR_LEVEL_5_V01 = 0x05, /**<  +1 dB \n  */
  NAS_SINR_LEVEL_6_V01 = 0x06, /**<  +3 dB \n  */
  NAS_SINR_LEVEL_7_V01 = 0x07, /**<  +6 dB \n  */
  NAS_SINR_LEVEL_8_V01 = 0x08, /**<  +9 dB */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Reg MMTEL Response Indication */
  uint8_t reg_mmtel_resp_ind_valid;  /**< Must be set to true if reg_mmtel_resp_ind is being passed */
  uint8_t reg_mmtel_resp_ind;
  /**<   Controls the reporting of QMI_NAS_MMTEL_RESPONSE_IND. Values: \n
      - 0x00 -- Disable (default value) \n
      - 0x01 -- Enable
  */

  /* Optional */
  /*  Reg UAC Barring Alleviation Indication */
  uint8_t reg_uac_barring_alleviation_ind_valid;  /**< Must be set to true if reg_uac_barring_alleviation_ind is being passed */
  uint8_t reg_uac_barring_alleviation_ind;
  /**<   Controls the reporting of QMI_NAS_UAC_BARRING_ALLEVIATION_IND. Values: \n
      - 0x00 -- Disable (default value) \n
      - 0x01 -- Enable
  */

  /* Optional */
  /*  Reg Disable ICCID Indication */
  uint8_t reg_disable_iccid_ind_valid;  /**< Must be set to true if reg_disable_iccid_ind is being passed */
  uint8_t reg_disable_iccid_ind;
  /**<   Controls the reporting of QMI_NAS_DISABLE_ICCID_IND. Values: \n
      - 0x00 -- Disable (default value) \n
      - 0x01 -- Enable
  */

  /* Optional */
  /*  Reg SFN Status Indication */
  uint8_t reg_sfn_threshold_ind_valid;  /**< Must be set to true if reg_sfn_threshold_ind is being passed */
  uint8_t reg_sfn_threshold_ind;
  /**<   Controls the reporting of QMI_NAS_SFN_STATUS_IND_MSG. Values: \n
      - 0x00 -- Disable (default) \n
      - 0x01 -- Enable
  */

  /* Optional */
  /*  Reg NR5G DRX CONFIG PARAMETER Indication */
  uint8_t reg_nr5g_drx_config_param_ind_valid;  /**< Must be set to true if reg_nr5g_drx_config_param_ind is being passed */
  uint8_t reg_nr5g_drx_config_param_ind;
  /**<   Controls the reporting of QMI_NAS_NR5G_DRX_CONFIG_PARAM_IND. Values: \n
      - 0x00 -- Disable (default value) \n
      - 0x01 -- Enable
  */
...
typedef enum {
  ...
  NAS_SCAN_TYPE_CELL_SEARCH_V01 = 0x04, /**<  Cell search  */
...
typedef struct {
  ...
  /**<   Network scan type. Values: \n
      ...
      - NAS_SCAN_TYPE_CELL_SEARCH (0x04) --  Cell search 
 */
  ...
  /**<   Bitmask representing the band preference to scan.  
  ...
  */
  ...
  /**<   Bitmask representing the LTE band preference to scan. 
  ...
  */
  ...
  /**<   Bitmask representing the TD-SCDMA band preference to scan. Values: \n
 ...
 */
 ...
 mode preference. Values: \n
      - QMI_NAS_CIOT_LTE_OP_MODE_PREF_WB (0x01) --  Wideband LTE operational mode is supported \n 
      - QMI_NAS_CIOT_LTE_OP_MODE_PREF_M1 (0x02) --  LTE-M1 operational mode is supported \n 
      - QMI_NAS_CIOT_LTE_OP_MODE_PREF_NB1 (0x04) --  LTE-NB1 operational mode is supported 
 ...
 */
  ...
  /**<   \n Bitmask representing the LTE band preference to set.

       \vspace{3pt}
       If the LTE Band Preference Extended TLV is present, the modem uses this
       LTE band preference TLV.

       \vspace{3pt}
       If the LTE Band Preference Extended TLV is not present, the modem uses
       the old LTE Band Preference TLV.

       \vspace{3pt}
       If both the LTE Band Preference and LTE Band Preference Extended TLVs are not present, 
       the modem uses the value read from the NV.
  */
...
typedef enum {
  ...
  NAS_SCAN_SUCCESS_V01 = 0x00, /**<  Network scan was successful \n         */
  NAS_SCAN_AS_ABORT_V01 = 0x01, /**<  Network scan was aborted  \n */
  NAS_SCAN_REJ_IN_RLF_V01 = 0x02, /**<  Network scan did not complete due 
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_GPRS_SUPPORT_E_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_GPRS_PS_NOT_SUPPORTED_V01 = 0, /**<  GPRS PS is not supported \n  */
  NAS_GPRS_PS_SUPPORTED_V01 = 1, /**<  GPRS PS is supported \n  */
  NAS_GPRS_PS_SUPPORT_UNKNOWN_V01 = 2, /**<  GPRS support is unknown  */
  NAS_GPRS_SUPPORT_E_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_gprs_support_e_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /*  Cell barred */
  uint8_t cell_is_barred;
  /**<   TRUE if the cell is barred
       FALSE if it is not barred
  */

  /*  GPRS supported */
  nas_gprs_support_e_type_v01 gprs_is_supported;
  /**<   Informs if PS is supported
  */
  ...
  */
}nas_geran_cell_search_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t earfcn;
  /**<   Extended absolute RF channel number.
  */
  ...
  */
  ...
  uint32_t plmn_len;  /**< Must be set to # of elements in plmn */
  nas_plmn_id_ext_type_v01 plmn[NAS_PCI_SCAN_MAX_NUM_PLMN_V01];
  /**<   List of associated PLMNs
  */
}nas_lte_cell_search_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates the status of the network scan. Values: \n
      - NAS_SCAN_SUCCESS (0x00) --  Network scan was successful \n        
      - NAS_SCAN_AS_ABORT (0x01) --  Network scan was aborted  \n
      - NAS_SCAN_REJ_IN_RLF (0x02) --  Network scan did not complete due 
                 to a radio link failure recovery in progress 
 */
 ...
 */
  ...
  /* Optional */
  /*  GERAN Cell Search Information */
  uint8_t geran_cell_search_info_valid;  /**< Must be set to true if geran_cell_search_info is being passed */
  uint32_t geran_cell_search_info_len;  /**< Must be set to # of elements in geran_cell_search_info */
  nas_geran_cell_search_info_type_v01 geran_cell_search_info[NAS_CELL_SEARCH_MAX_NUM_CELL_V01];

  /* Optional */
  /*  LTE M1 Cell Search Information */
  uint8_t lte_m1_cell_search_info_valid;  /**< Must be set to true if lte_m1_cell_search_info is being passed */
  uint32_t lte_m1_cell_search_info_len;  /**< Must be set to # of elements in lte_m1_cell_search_info */
  nas_lte_cell_search_info_type_v01 lte_m1_cell_search_info[NAS_CELL_SEARCH_MAX_NUM_CELL_V01];

  /* Optional */
  /*  LTE NB1 Cell Search Information */
  uint8_t lte_nb1_cell_search_info_valid;  /**< Must be set to true if lte_nb1_cell_search_info is being passed */
  uint32_t lte_nb1_cell_search_info_len;  /**< Must be set to # of elements in lte_nb1_cell_search_info */
  nas_lte_cell_search_info_type_v01 lte_nb1_cell_search_info[NAS_CELL_SEARCH_MAX_NUM_CELL_V01];

  /* Optional */
  /*  SIB2 Upper Layer Ind Value */
  uint8_t sib2_upr_layer_ind_value_valid;  /**< Must be set to true if sib2_upr_layer_ind_value is being passed */
  uint32_t sib2_upr_layer_ind_value_len;  /**< Must be set to # of elements in sib2_upr_layer_ind_value */
  uint8_t sib2_upr_layer_ind_value[NAS_3GPP_NETWORK_INFO_LIST_MAX_V01];
  /**<    Indicates the PLMN Information r15 upper layer indication value in LTE SIB2.
        This TLV is in parallel to the 3GPP Network Scan Information TLV.
        This TLV is only valid for LTE PLMNs and 0xFF is set for non LTE PLMNs.
        This TLV is not populated if there are no LTE PLMNs. 
  */
...
typedef enum {
  ...
  NAS_AUTO_REGISTER_V01 = 0x01, /**<  Device registers according
          to its provisioning; optional TLVs supplied with the command
          are ignored \n  */
  NAS_MANUAL_REGISTER_V01 = 0x02, /**<  Device registers to a specified
...
typedef enum {
  ...
  NAS_POWER_CYCLE_V01 = 0x00, /**<  Remains active until the next device power cycle \n  */
  NAS_PERMANENT_V01 = 0x01, /**<  Remains active through power cycles until changed by the client \n
        Note: If the TLV is omitted, the device uses "0x00 -- Power cycle" as the default value. */
...
typedef struct {
  ...
  /**<   Specifies one of the following actions: \n
      - NAS_AUTO_REGISTER (0x01) --  Device registers according
          to its provisioning; optional TLVs supplied with the command
          are ignored \n 
      - NAS_MANUAL_REGISTER (0x02) --  Device registers to a specified
          network; the optional Manual Network Register Information TLV must also
          be included for the command to process successfully;
          supported only for 3GPP 
 */
  ...
  /**<   Duration of the change. Values: \n
      - NAS_POWER_CYCLE (0x00) --  Remains active until the next device power cycle \n 
      - NAS_PERMANENT (0x01) --  Remains active through power cycles until changed by the client \n
        Note: If the TLV is omitted, the device uses "0x00 -- Power cycle" as the default value.
 */
...
typedef enum {
  ...
  NAS_PS_ACTION_ATTACH_V01 = 0x01, /**<  Initiates an immediate packet domain attach action \n  */
  NAS_PS_ACTION_DETACH_V01 = 0x02, /**<  Initiates an immediate packet domain detach action  */
...
typedef struct {
  ...
  /**<   Initiates a packet domain attach or detach action. Values: \n
      - NAS_PS_ACTION_ATTACH (0x01) --  Initiates an immediate packet domain attach action \n 
      - NAS_PS_ACTION_DETACH (0x02) --  Initiates an immediate packet domain detach action  
 */
...
typedef enum {
  ...
  NAS_NOT_REGISTERED_V01 = 0x00, /**<  Not registered; mobile is not currently 
                                          searching for a new network to provide 
                                          service \n  */
  NAS_REGISTERED_V01 = 0x01, /**<  Registered with a network \n */
  NAS_NOT_REGISTERED_SEARCHING_V01 = 0x02, /**<   Not registered, but mobile is currently 
                                             searching for a new network to provide 
                                             service \n */
  NAS_REGISTRATION_DENIED_V01 = 0x03, /**<  Registration denied by the visible 
                                          network \n  */
  NAS_REGISTRATION_UNKNOWN_V01 = 0x04, /**<  Registration state is unknown */
...
typedef enum {
  ...
  NAS_CS_UNKNOWN_V01 = 0x00, /**<  Unknown or not applicable \n  */
  NAS_CS_ATTACHED_V01 = 0x01, /**<  Attached \n */
  NAS_CS_DETACHED_V01 = 0x02, /**<  Detached  */
...
typedef enum {
  ...
  NAS_PS_UNKNOWN_V01 = 0x00, /**<  Unknown or not applicable \n */
  NAS_PS_ATTACHED_V01 = 0x01, /**<  Attached \n */
  NAS_PS_DETACHED_V01 = 0x02, /**<  Detached */
...
typedef struct {
  ...
  /**<   Registration state of the mobile. Values: \n
      - NAS_NOT_REGISTERED (0x00) --  Not registered; mobile is not currently 
                                          searching for a new network to provide 
                                          service \n 
      - NAS_REGISTERED (0x01) --  Registered with a network \n
      - NAS_NOT_REGISTERED_SEARCHING (0x02) --   Not registered, but mobile is currently 
                                             searching for a new network to provide 
                                             service \n
      - NAS_REGISTRATION_DENIED (0x03) --  Registration denied by the visible 
                                          network \n 
...
typedef struct {
  ...
  /**<   Indicates whether the network name is conditionally displayed: \n
      - 0x00 -- Do not display \n
      - 0x01 -- Display \n
      - 0xFF -- Unknown \n
...
typedef struct {
  ...
  /* Optional */
  /*  3GPP Preferred Networks Extended** */
  uint8_t nas_3gpp_preferred_networks_ext_valid;  /**< Must be set to true if nas_3gpp_preferred_networks_ext is being passed */
  uint32_t nas_3gpp_preferred_networks_ext_len;  /**< Must be set to # of elements in nas_3gpp_preferred_networks_ext */
  nas_3gpp_preferred_networks_type_v01 nas_3gpp_preferred_networks_ext[NAS_3GPP_PREFERRED_NETWORKS_EXT_LIST_MAX_V01];
  /**<   \n Array containing the extended user preferred PLMNs set.

       \vspace{3pt}
       New clients should prefer this extended TLV over the old one, which is still populated 
       to capacity.

  */

  /* Optional */
  /*  3GPP Preferred Networks MNC Extended (includes PCS digit status) */
  uint8_t nas_3gpp_mnc_includes_pcs_digit_ext_valid;  /**< Must be set to true if nas_3gpp_mnc_includes_pcs_digit_ext is being passed */
  uint32_t nas_3gpp_mnc_includes_pcs_digit_ext_len;  /**< Must be set to # of elements in nas_3gpp_mnc_includes_pcs_digit_ext */
  nas_mnc_pcs_digit_include_status_type_v01 nas_3gpp_mnc_includes_pcs_digit_ext[NAS_3GPP_PREFERRED_NETWORKS_EXT_LIST_MAX_V01];
  /**<   \n Array containing the extended information on length of the corresponding MNC.
...
typedef struct {
  ...
  uint32_t nas_3gpp_preferred_networks_ext_len;  /**< Must be set to # of elements in nas_3gpp_preferred_networks_ext */
  nas_3gpp_preferred_networks_type_v01 nas_3gpp_preferred_networks_ext[NAS_3GPP_PREFERRED_NETWORKS_EXT_LIST_MAX_V01];
  /**<   \n Array containing the user preferred PLMNs to set.

       \vspace{3pt}
       If the 3GPP Preferred Networks Extended TLV is present, Modem uses this
       3GPP Preferred Networks Extended TLV to set the preferred networks.

       \vspace{3pt}
       If the 3GPP Preferred Networks Extended TLV is not present, the modem uses the
       old 3GPP Preferred Networks TLV to set the preferred networks.
  ...
  */
  ...
  uint32_t nas_3gpp_mnc_includes_pcs_digit_ext_len;  /**< Must be set to # of elements in nas_3gpp_mnc_includes_pcs_digit_ext */
  nas_mnc_pcs_digit_include_status_type_v01 nas_3gpp_mnc_includes_pcs_digit_ext[NAS_3GPP_PREFERRED_NETWORKS_EXT_LIST_MAX_V01];
  /**<   \n Array containing information on length of the corresponding MNC.

       \vspace{3pt}
       If the 3GPP Preferred Networks MNC Extended (includes PCS digit status) TLV is present, Modem 
       uses this 3GPP Preferred Networks MNC Extended TLV.

       \vspace{3pt}
       If the 3GPP Preferred Networks MNC Extended (includes PCS digit status) TLV is not present, the modem 
       uses the old 3GPP Preferred Networks MNC TLV.
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sets the codebook configuration. */
typedef struct {

  /* Mandatory */
  /*  Codebook Configuration */
  uint8_t codebook_config_index;
  /**<   Codebook configuration index.
  */
}nas_set_codebook_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sets the codebook configuration. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}nas_set_codebook_config_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Queries the codebook configuration. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_get_codebook_config_req_msg_v01;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Queries the codebook configuration. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Codebook Configuration */
  uint8_t codebook_config_index_valid;  /**< Must be set to true if codebook_config_index is being passed */
  uint8_t codebook_config_index;
  /**<   Codebook configuration index.
  */
}nas_get_codebook_config_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sets the priority for NR5G bands. */
typedef struct {

  /* Mandatory */
  /*  NR5G Band Priority List */
  uint32_t band_priority_list_len;  /**< Must be set to # of elements in band_priority_list */
  nas_active_band_enum_v01 band_priority_list[NAS_NR5G_BAND_PRIORITY_LIST_MAX_V01];
  /**<   Priority list for NR5G bands 
       (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details). 
       Values:\n
     - 250 to 289 -- NR5G band classes
  */
}nas_set_nr5g_band_priority_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sets the priority for NR5G bands. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described in
                          the error codes section of each message definition.
  */
}nas_set_nr5g_band_priority_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Gets the list of priority NR5G bands. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_get_nr5g_band_priority_list_req_msg_v01;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Gets the list of priority NR5G bands. */
typedef struct {
  ...
  */
  ...
  nas_active_band_enum_v01 configured_band_priority_list[NAS_NR5G_BAND_PRIORITY_LIST_MAX_V01];
  /**<   List of the user-configured NR5G bands set by HLOS or EFS.
       Values: \n
     - 250 to 289 -- NR5G band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */

  /* Optional */
  /*  NR5G Supported Band Priority List */
  ...
  nas_active_band_enum_v01 supported_band_priority_list[NAS_NR5G_BAND_PRIORITY_LIST_MAX_V01];
  /**<   List of the NR5G bands supported by UE, used in the order in which they are scanned. 
	   Values: \n
     - 250 to 289 -- NR5G band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
}nas_get_nr5g_band_priority_list_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef enum {
  ...
  NAS_ROAM_CONFIG_PREF_AUTO_V01 = 0x00, /**<  Acquire systems regardless of roaming status \n        */
  NAS_ROAM_CONFIG_PREF_HOME_ONLY_V01 = 0x01, /**<  Acquire home systems only \n  */
  NAS_ROAM_CONFIG_PREF_ROAM_ONLY_V01 = 0x02, /**<  Acquire nonhome systems only \n  */
  NAS_ROAM_CONFIG_PREF_HOME_AND_AFFILIATE_V01 = 0x03, /**<  Acquire home and affiliated roaming systems only */
...
typedef enum {
  ...
  NAS_HDR_REV0_PROTOCOLS_ONLY_V01 = 0x00, /**<  HDR Rev0 Protocols only /n  */
  NAS_HDR_REVA_PROTOCOLS_MFPA_V01 = 0x01, /**<  HDR RevA Protocols with MFPA \n */
  NAS_HDR_REVA_PROTOCOLS_MFPA_EMPA_V01 = 0x02, /**<  HDR RevA Protocols with MFPA and EMPA \n  */
  NAS_HDR_REVB_PROTOCOLS_MMPA_V01 = 0x03, /**<  HDR RevB Protocols with MMPA \n  */
  NAS_HDR_REVA_PROTOCOLS_EHRPD_V01 = 0x04, /**<  HDR RevA Protocols with eHRPD \n */
  NAS_HDR_REVB_PROTOCOLS_EHRPD_V01 = 0x05, /**<  HDR RevB Protocols with eHRPD */
...
typedef struct {
  ...
  */
  ...
  /**<   Roaming preference. Values: \n
      - NAS_ROAM_CONFIG_PREF_AUTO (0x00) --  Acquire systems regardless of roaming status \n       
      - NAS_ROAM_CONFIG_PREF_HOME_ONLY (0x01) --  Acquire home systems only \n 
      - NAS_ROAM_CONFIG_PREF_ROAM_ONLY (0x02) --  Acquire nonhome systems only \n 
      - NAS_ROAM_CONFIG_PREF_HOME_AND_AFFILIATE (0x03) --  Acquire home and affiliated roaming systems only
 */
  ...
  /**<        - NAS_HDR_REV0_PROTOCOLS_ONLY (0x00) --  HDR Rev0 Protocols only /n 
      - NAS_HDR_REVA_PROTOCOLS_MFPA (0x01) --  HDR RevA Protocols with MFPA \n
      - NAS_HDR_REVA_PROTOCOLS_MFPA_EMPA (0x02) --  HDR RevA Protocols with MFPA and EMPA \n 
      - NAS_HDR_REVB_PROTOCOLS_MMPA (0x03) --  HDR RevB Protocols with MMPA \n 
      - NAS_HDR_REVA_PROTOCOLS_EHRPD (0x04) --  HDR RevA Protocols with eHRPD \n
      - NAS_HDR_REVB_PROTOCOLS_EHRPD (0x05) --  HDR RevB Protocols with eHRPD
 */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  3GPP Wi-Fi Cellular Scan Timer* */
  uint8_t gpp_wifi_cellular_scan_timer_valid;  /**< Must be set to true if gpp_wifi_cellular_scan_timer is being passed */
  uint16_t gpp_wifi_cellular_scan_timer;
  /**<    Time (in seconds) for which the emergency call is attempted
        on the cellular domain when the UE is attached over a WLAN access.\n
        When the e911 3GPP scan time on the Wi-Fi timer expires, the UE considers 
        using 3GPP access to setup the emergency call a failure, and reattempts the call 
        over the available WLAN access. \n
        If this TLV is not present, the timer takes the value from NV74320 .\n
        A value of 0xFFFF disables the timer.
  */
...
typedef enum {
  ...
  NAS_RADIO_LTE_NB1_V01 = 0x0b, /**<  LTE-NB1 \n  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_NR5G_DISABLE_MODE_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_NR5G_DISABLE_MODE_NONE_V01 = 0x00, /**<  None \n  */
  NAS_NR5G_DISABLE_MODE_SA_V01 = 0x01, /**<  Disable NR5G SA mode \n  */
  NAS_NR5G_DISABLE_MODE_NSA_V01 = 0x02, /**<  Disable NR5G NSA mode   */
  NAS_NR5G_DISABLE_MODE_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_nr5g_disable_mode_enum_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t band_pref_valid;  /**< Must be set to true if band_pref is being passed */
  nas_band_pref_mask_type_v01 band_pref;
  /**<   Bitmask representing the band preference to set.  
       See Table @latexonly\ref{tbl:bandPreference}@endlatexonly 
       for details.   
  */
  ...
  /**<   PRL preference to set for band class 0 (BC0) prl_pref. Values: \n
  ...
  */
  ...
  /**<   Roaming preference to set. Values: \n
  ...
  */
  ...
  /**<    Duration of the change. Values: \n
        ...
        Note: If the TLV is omitted, the device uses "0x01 -- Permanent" as the default value. 
              .
  */
 ...
 */
  ...
  */
  ...
  uint8_t tdscdma_band_pref_valid;  /**< Must be set to true if tdscdma_band_pref is being passed */
  nas_tdscdma_band_pref_mask_type_v01 tdscdma_band_pref;
  /**<   Bitmask representing the TD-SCDMA band preference to set. Values: \n
  ...
  */
  ...
  /**<   Acquisition order preference to set. Values: \n
  ...
  */
  ...
  /**<   Modem usage preference to set. Values: \n
 ...
 */
  ...
  */
  ...
  /**<   Voice domain preference to set. Values: \n
 ...
 */
  ...
  */
  ...
  uint8_t ciot_lte_op_mode_pref_valid;  /**< Must be set to true if ciot_lte_op_mode_pref is being passed */
  ciot_lte_op_mode_pref_mask_type_v01 ciot_lte_op_mode_pref;
  /**<   Bitmask representing the CIoT LTE operational mode preference to set.
 Values: \n
      - QMI_NAS_CIOT_LTE_OP_MODE_PREF_WB (0x01) --  Wideband LTE operational mode is supported \n 
      - QMI_NAS_CIOT_LTE_OP_MODE_PREF_M1 (0x02) --  LTE-M1 operational mode is supported \n 
      - QMI_NAS_CIOT_LTE_OP_MODE_PREF_NB1 (0x04) --  LTE-NB1 operational mode is supported 
 ...
 \vspace{3pt}
 If this TLV is not present, the modem uses the value read from
 ...
 */
  ...
  uint8_t lte_m1_band_pref_valid;  /**< Must be set to true if lte_m1_band_pref is being passed */
  lte_band_pref_mask_type_v01 lte_m1_band_pref;
  /**<   Bitmask representing the LTE M1 band preference to set.
       See Table @latexonly\ref{tbl:lteBandPreference}@endlatexonly 
       for details. 

       \vspace{3pt}
       If this field is not present, the modem uses the 
  ...
  */
  ...
  uint8_t lte_nb1_band_pref_valid;  /**< Must be set to true if lte_nb1_band_pref is being passed */
  lte_band_pref_mask_type_v01 lte_nb1_band_pref;
  /**<   Bitmask representing the LTE NB1 band preference to set.
       See Table @latexonly\ref{tbl:lteBandPreference}@endlatexonly 
       for details.
 ...
 This TLV indicates the the operational mode to use during the manual
 ...
 */
  ...
  /**<   CIOT Acquisition order preference to set. Values: \n
  ...
  */
  ...
  /**<   Bitmask representing the NR5G band preference to set. 
       The preference is set to both NR5G SA band 
	   preference and NR5G NSA band preference.
  */
  ...
  */
  ...
  uint8_t nr5g_disable_mode_valid;  /**< Must be set to true if nr5g_disable_mode is being passed */
  nas_nr5g_disable_mode_enum_type_v01 nr5g_disable_mode;
  /**<   Disable NR5G SA/NSA mode setting. If this field is not present,
 it is considered as no change. Values: \n
      - NAS_NR5G_DISABLE_MODE_NONE (0x00) --  None \n 
      - NAS_NR5G_DISABLE_MODE_SA (0x01) --  Disable NR5G SA mode \n 
      - NAS_NR5G_DISABLE_MODE_NSA (0x02) --  Disable NR5G NSA mode  
 */

  /* Optional */
  /*  NR5G SA Band Preference */
  uint8_t nr5g_sa_band_pref_valid;  /**< Must be set to true if nr5g_sa_band_pref is being passed */
  nas_nr5g_band_pref_mask_type_v01 nr5g_sa_band_pref;
  /**<   \n Bitmask representing the NR5G SA band preference to set.
  */

  /* Optional */
  /*  NR5G NSA Band Preference */
  uint8_t nr5g_nsa_band_pref_valid;  /**< Must be set to true if nr5g_nsa_band_pref is being passed */
  nas_nr5g_band_pref_mask_type_v01 nr5g_nsa_band_pref;
  /**<   \n Bitmask representing the NR5G NSA band preference to set.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Bitmask representing the LTE band preference to set. Values: \n
 ...
 */
  ...
  */
  ...
  uint8_t nr5g_disable_mode_valid;  /**< Must be set to true if nr5g_disable_mode is being passed */
  nas_nr5g_disable_mode_enum_type_v01 nr5g_disable_mode;
  /**<   Disable NR5G SA/NSA mode setting. Values: \n
      - NAS_NR5G_DISABLE_MODE_NONE (0x00) --  None \n 
      - NAS_NR5G_DISABLE_MODE_SA (0x01) --  Disable NR5G SA mode \n 
      - NAS_NR5G_DISABLE_MODE_NSA (0x02) --  Disable NR5G NSA mode  
 */
  ...
  uint8_t nr5g_sa_band_pref_valid;  /**< Must be set to true if nr5g_sa_band_pref is being passed */
  nas_nr5g_band_pref_mask_type_v01 nr5g_sa_band_pref;
  /**<   Bitmask representing the NR5G SA band preference.
  */
  ...
  uint8_t nr5g_nsa_band_pref_valid;  /**< Must be set to true if nr5g_nsa_band_pref is being passed */
  nas_nr5g_band_pref_mask_type_v01 nr5g_nsa_band_pref;
  /**<   Bitmask representing the NR5G NSA band preference.
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t usage_setting_valid;  /**< Must be set to true if usage_setting is being passed */
  nas_usage_pref_enum_v01 usage_setting;
  /**<   Usage preference to set. Values: \n
      - NAS_USAGE_UNKNOWN (0) --  Unknown \n 
      - NAS_USAGE_VOICE_CENTRIC (1) --  Voice centric \n 
      - NAS_USAGE_DATA_CENTRIC (2) --  Data centric 
 */
...
typedef struct {
  ...
  */
  ...
  /**<   Action to take with the specified SO list in the SO field. Values: \n
...
typedef struct {
  ...
  /**<   MCC in ASCII string (a value of D in any of the digits used
       to indicate a "wild" value for that corresponding digit).
  */

  char mnc[NAS_MCC_MNC_MAX_V01];
  /**<   MNC in ASCII string (a value of D in any of the digits is used
       to indicate a "wild" value for that corresponding digit; digit 3 in MNC
       is optional and when not present, is set as ASCII F).
  */
...
typedef struct {
  ...
  /*  NAM ID */
  uint8_t nam_id;
  /**<   NAM ID of the information to retrieve. The index starts from 0. 
  ...
  */
  ...
  /**<   Bitmasks included in this field decide which optional TLVs are to
       include in the response message. If this TLV is not included, all 
...
typedef struct {
  ...
  /*  NAM ID */
  uint8_t nam_id;
  /**<   NAM ID of the information to write. The index starts from 0. 
...
typedef struct {
  ...
  /**<   Values: \n
       ...
       -0x02 -- Internal settings only \n
       -0x03 -- Use R-UIM if available \n
       -0x04 -- GSM on 1X (deprecated; converted to "Internal settings only" when used)
  */
...
typedef struct {
  ...
  /**<    Bitmask specifying whether a neighbor with a specific network color
    code is reported. Range: 0 to 255. Bit n set to 1 means a neighbor 
...
typedef enum {
  ...
  NAS_WCDMA_RRC_STATE_DISCONNECTED_V01 = 0x00, /**<  WCDMA RRC state is IDLE
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n  */
  NAS_WCDMA_RRC_STATE_CELL_PCH_V01 = 0x01, /**<  WCDMA RRC state is CELL_PCH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n  */
  NAS_WCDMA_RRC_STATE_URA_PCH_V01 = 0x02, /**<  WCDMA RRC state is URA_PCH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n */
  NAS_WCDMA_RRC_STATE_CELL_FACH_V01 = 0x03, /**<  WCDMA RRC state is CELL_FACH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n */
  NAS_WCDMA_RRC_STATE_CELL_DCH_V01 = 0x04, /**<  WCDMA RRC state is CELL_DCH
                defined in \hyperref[STD-25331]{3GPP TS 25.331}  */
...
typedef struct {
  ...
  /**<   WCDMA RRC states. Values: \n
      - NAS_WCDMA_RRC_STATE_DISCONNECTED (0x00) --  WCDMA RRC state is IDLE
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n 
      - NAS_WCDMA_RRC_STATE_CELL_PCH (0x01) --  WCDMA RRC state is CELL_PCH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n 
      - NAS_WCDMA_RRC_STATE_URA_PCH (0x02) --  WCDMA RRC state is URA_PCH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n
      - NAS_WCDMA_RRC_STATE_CELL_FACH (0x03) --  WCDMA RRC state is CELL_FACH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} \n
      - NAS_WCDMA_RRC_STATE_CELL_DCH (0x04) --  WCDMA RRC state is CELL_DCH
                defined in \hyperref[STD-25331]{3GPP TS 25.331} 
 */
...
typedef struct {
  ...
  */
  ...
  /**<    Indicates whether to add the country initials to the 
...
typedef enum {
  ...
  NAS_SINGLE_STANDBY_V01 = 0x01, /**<  Single standby \n     */
  NAS_DUAL_STANDBY_WITH_TUNE_AWAY_V01 = 0x02, /**<  Dual standby with tune away \n  */
  NAS_DUAL_STANDBY_WITHOUT_TUNE_AWAY_V01 = 0x04, /**<  Dual standby without tune away \n  */
  NAS_AUTOMATIC_WITH_TUNE_AWAY_V01 = 0x05, /**<  Automatic mode with tune away where applicable\n  */
  NAS_AUTOMATIC_WITHOUT_TUNE_AWAY_V01 = 0x06, /**<  Automatic mode without tune away \n  */
  NAS_TRIPLE_STANDBY_V01 = 0x07, /**<  Triple standby */
...
#define QMI_NAS_ACTIVE_SUB_PRIMARY_V01 ((nas_active_subs_mask_type_v01)0x01ull) /**<  Primary subscription \n  */
#define QMI_NAS_ACTIVE_SUB_SECONDARY_V01 ((nas_active_subs_mask_type_v01)0x02ull) /**<  Secondary subscription \n  */
#define QMI_NAS_ACTIVE_SUB_TERTIARY_V01 ((nas_active_subs_mask_type_v01)0x04ull) /**<  Tertiary subscription  */
/** @addtogroup nas_qmi_messages
    @{
  */
 ...
 */
  ...
  /**<   Bitmask representing the active subscriptions to set. If a value 
 of 0 is sent, there are no active subscriptions.
 Values: \n
      - QMI_NAS_ACTIVE_SUB_PRIMARY (0x01) --  Primary subscription \n 
      - QMI_NAS_ACTIVE_SUB_SECONDARY (0x02) --  Secondary subscription \n 
      - QMI_NAS_ACTIVE_SUB_TERTIARY (0x04) --  Tertiary subscription 
...
typedef struct {
  ...
  nas_standby_pref_enum_v01 standby_pref;
  /**<   Values: \n
      - NAS_SINGLE_STANDBY (0x01) --  Single standby \n    
      - NAS_DUAL_STANDBY_WITH_TUNE_AWAY (0x02) --  Dual standby with tune away \n 
      - NAS_DUAL_STANDBY_WITHOUT_TUNE_AWAY (0x04) --  Dual standby without tune away \n 
      - NAS_AUTOMATIC_WITH_TUNE_AWAY (0x05) --  Automatic mode with tune away where applicable\n 
      - NAS_AUTOMATIC_WITHOUT_TUNE_AWAY (0x06) --  Automatic mode without tune away \n 
      - NAS_TRIPLE_STANDBY (0x07) --  Triple standby
...
typedef enum {
  ...
  NAS_PRIORITY_SUBSCRIPTION_FALSE_V01 = 0x00, /**<  Not a priority subscription \n  */
  NAS_PRIORITY_SUBSCRIPTION_TRUE_V01 = 0x01, /**<  Priority subscription */
...
typedef enum {
  ...
  NAS_SUBSCRIPTION_NOT_ACTIVE_V01 = 0x00, /**<  Not active \n */
  NAS_SUBSCRIPTION_ACTIVE_V01 = 0x01, /**<  Active  */
...
typedef struct {
 ...
 in cases of dual standby. Values: \n
      - NAS_PRIORITY_SUBSCRIPTION_FALSE (0x00) --  Not a priority subscription \n 
      - NAS_PRIORITY_SUBSCRIPTION_TRUE (0x01) --  Priority subscription
 */
 ...
 Information on whether the subscription is active. Values: \n
      - NAS_SUBSCRIPTION_NOT_ACTIVE (0x00) --  Not active \n
      - NAS_SUBSCRIPTION_ACTIVE (0x01) --  Active 
 */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the RAT is the preferred data path: \n
       - 0x00 -- Not preferred \n
       - 0x01 -- Preferred
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether concurrent service is supported (only applicable for CDMA): \n
      - 0x00 -- Not supported \n
      - 0x01 -- Supported
...
typedef enum {
  ...
  NAS_SIM_CP_SMS_INVALID_V01 = 5, /**<  SIM has been marked by the network as invalid for SMS.  */
...
typedef enum {
  ...
  NAS_NR5G_VOICE_DOMAIN_NO_VOICE_V01 = 0, /**<  Voice is not supported over NR5G \n */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_NR5G_EMC_VAL_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_NR5G_EMC_NOT_SUPPORTED_V01 = 0, /**<  Emergency services not supported \n */
  NAS_NR5G_EMC_SUPPORTED_NR_V01 = 1, /**<  Emergency services supported in NR connected to 5GCN only\n */
  NAS_NR5G_EMC_SUPPORTED_EUTRA_V01 = 2, /**<  Emergency services supported in E-UTRA connected to 5GCN only\n */
  NAS_NR5G_EMC_SUPPORTED_NR_AND_EUTRA_V01 = 3, /**<  Emergency services supported in NR connected to 5GCN and E-UTRA connected to 5GCN */
  NAS_NR5G_EMC_VAL_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_nr5g_emc_val_enum_type_v01;
/**
    @}
  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_NR5G_EMF_VAL_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_NR5G_EMF_NOT_SUPPORTED_V01 = 0, /**<  Emergency services fallback not supported \n */
  NAS_NR5G_EMF_SUPPORTED_NR_V01 = 1, /**<  Emergency services fallback supported in NR connected to 5GCN only\n */
  NAS_NR5G_EMF_SUPPORTED_EUTRA_V01 = 2, /**<  Emergency services falback supported in E-UTRA connected to 5GCN only\n */
  NAS_NR5G_EMF_SUPPORTED_NR_AND_EUTRA_V01 = 3, /**<  Emergency services fallback supported in NR connected to 5GCN and E-UTRA connected to 5GCN */
  NAS_NR5G_EMF_VAL_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_nr5g_emf_val_enum_type_v01;
/**
    @}
  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_LTE_CS_CAPABILITY_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_LTE_CS_CAPABILITY_FULL_SERVICE_V01 = 0, /**<  FULL service on CS domain is available \n */
  NAS_LTE_CS_CAPABILITY_CSFB_NOT_PREFERRED_V01 = 1, /**<  CSFB is not preferred \n */
  NAS_LTE_CS_CAPABILITY_SMS_ONLY_V01 = 2, /**<  CS registation is for SMS only \n */
  NAS_LTE_CS_CAPABILITY_LIMITED_V01 = 3, /**<  CS registation failed for
   ** max attach or TAU attempts \n  */
  NAS_LTE_CS_CAPABILITY_BARRED_V01 = 4, /**<  CS domain not available  */
  NAS_LTE_CS_CAPABILITY_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_lte_cs_capability_enum_type_v01;
/**
    @}
  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_NR5G_FREQ_TYPE_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_NR5G_FR_TYPE_SUB6_V01 = 0, /**<  Sub6 frequency type \n */
  NAS_NR5G_FR_TYPE_MMW_V01 = 1, /**<  mmWave frequency type  */
  NAS_NR5G_FREQ_TYPE_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_nr5g_freq_type_enum_type_v01;
/**
    @}
  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_NR5G_SCS_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_NR5G_SCS_15_V01 = 0, /**<  NR5G subcarrier spacing 15 KHz \n */
  NAS_NR5G_SCS_30_V01 = 1, /**<  NR5G subcarrier spacing 30 KHz \n */
  NAS_NR5G_SCS_60_V01 = 2, /**<  NR5G subcarrier spacing 60 KHz \n */
  NAS_NR5G_SCS_120_V01 = 3, /**<  NR5G subcarrier spacing 120 KHz \n */
  NAS_NR5G_SCS_240_V01 = 4, /**<  NR5G subcarrier spacing 240 KHz  */
  NAS_NR5G_SCS_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_nr5g_scs_enum_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  nas_nr5g_emc_val_enum_type_v01 emc;
  /**<  
 Emergency service support indicator. Values: \n
      - NAS_NR5G_EMC_NOT_SUPPORTED (0) --  Emergency services not supported \n
      - NAS_NR5G_EMC_SUPPORTED_NR (1) --  Emergency services supported in NR connected to 5GCN only\n
      - NAS_NR5G_EMC_SUPPORTED_EUTRA (2) --  Emergency services supported in E-UTRA connected to 5GCN only\n
      - NAS_NR5G_EMC_SUPPORTED_NR_AND_EUTRA (3) --  Emergency services supported in NR connected to 5GCN and E-UTRA connected to 5GCN
 */

  nas_nr5g_emf_val_enum_type_v01 emf;
  /**<  
 Emergency service fallback indicator. Values: \n
      - NAS_NR5G_EMF_NOT_SUPPORTED (0) --  Emergency services fallback not supported \n
      - NAS_NR5G_EMF_SUPPORTED_NR (1) --  Emergency services fallback supported in NR connected to 5GCN only\n
      - NAS_NR5G_EMF_SUPPORTED_EUTRA (2) --  Emergency services falback supported in E-UTRA connected to 5GCN only\n
      - NAS_NR5G_EMF_SUPPORTED_NR_AND_EUTRA (3) --  Emergency services fallback supported in NR connected to 5GCN and E-UTRA connected to 5GCN
 */
}nas_nr5g_emerg_srv_ind_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Current reject state information of the SIM. Values: \n
    ...
    - 5 -- NAS_SIM_CP_SMS_INVALID -- SIM has been marked by the network as 
                                    invalid for SMS.
  */
 ...
 */
  ...
  /**<   Values: \n
      - NAS_NR5G_VOICE_DOMAIN_NO_VOICE (0) --  Voice is not supported over NR5G \n
 ...
 */
  ...
  uint8_t nr5g_ims_3gpp_voice_avail_valid;  /**< Must be set to true if nr5g_ims_3gpp_voice_avail is being passed */
  uint8_t nr5g_ims_3gpp_voice_avail;
  /**<   Indicates 3GPP NW support voice over NR5G. Values: \n
      - 0x00 -- Voice is not supported \n
      - 1x01 -- Voice is supported
  */

  /* Optional */
  /*  NR5G Emergency Service Indicators */
  uint8_t nr5g_emerg_srv_ind_valid;  /**< Must be set to true if nr5g_emerg_srv_ind is being passed */
  nas_nr5g_emerg_srv_ind_type_v01 nr5g_emerg_srv_ind;
  /**<   \n Indicates NR5G emergency service support and fallback indicators. 
  */

  /* Optional */
  /*  LTE CS Capability Indicators */
  uint8_t lte_cs_capability_valid;  /**< Must be set to true if lte_cs_capability is being passed */
  nas_lte_cs_capability_enum_type_v01 lte_cs_capability;
  /**<   Indicates CS service capabilities of the LTE network.
  */

  /* Optional */
  /*  NR5G Frequency Type  */
  uint8_t nr5g_freq_type_valid;  /**< Must be set to true if nr5g_freq_type is being passed */
  nas_nr5g_freq_type_enum_type_v01 nr5g_freq_type;
  /**<   Indicates NR5G frequency type. Values:\n
      - NAS_NR5G_FR_TYPE_SUB6 (0) --  Sub6 frequency type \n
      - NAS_NR5G_FR_TYPE_MMW (1) --  mmWave frequency type \n
 This TLV is present only when the modem is in SA or NSA mode.
 */

  /* Optional */
  /*  NR5G Subcarrier Spacing  */
  uint8_t nr5g_subcarrier_spacing_valid;  /**< Must be set to true if nr5g_subcarrier_spacing is being passed */
  nas_nr5g_scs_enum_type_v01 nr5g_subcarrier_spacing;
  /**<   Indicates NR5G subcarrier spacing of P-Scell. Values:\n
 ...
 */
  ...
  uint8_t nr5g_ims_3gpp_voice_avail_valid;  /**< Must be set to true if nr5g_ims_3gpp_voice_avail is being passed */
  uint8_t nr5g_ims_3gpp_voice_avail;
  /**<   Indicates 3GPP network support voice over NR5G. Values: \n
     - 0x00 -- Voice is not supported \n
     - 1x01 -- Voice is supported
  */
...
typedef struct {
 ...
 SINR level. SINR is only applicable for 1xEV-DO. 
 Valid levels are 0 to 8, where the maximum value for: \n
      - NAS_SINR_LEVEL_0 (0x00) --  -9 dB \n  
      - NAS_SINR_LEVEL_1 (0x01) --  -6 dB \n
      - NAS_SINR_LEVEL_2 (0x02) --  -4.5 dB \n 
      - NAS_SINR_LEVEL_3 (0x03) --  -3 dB \n 
      - NAS_SINR_LEVEL_4 (0x04) --  -2 dB \n 
      - NAS_SINR_LEVEL_5 (0x05) --  +1 dB \n 
      - NAS_SINR_LEVEL_6 (0x06) --  +3 dB \n 
      - NAS_SINR_LEVEL_7 (0x07) --  +6 dB \n 
      - NAS_SINR_LEVEL_8 (0x08) --  +9 dB
 */
 ...
 */
  ...
  uint8_t umts_rscp_valid;  /**< Must be set to true if umts_rscp is being passed */
  int16_t umts_rscp;
  /**<   Received signal code power; the received power on one code measured in 
       dBm.
  */
...
typedef struct {
  ...
  /**<  
      ...
      - 4 -- Report every 4 seconds \n
      - 5 -- Report every 5 seconds 
   */

  /*  Averaging period */
  nas_lte_sig_avg_prd_enum_type_v01 avg_period;
  /**<   Averaging period to use for the LTE signal. Values: \n
      - 0  -- Average using the default configuration \n
      - 1  -- Average over 1 second \n
      - 2  -- Average over 2 seconds \n
      - 3  -- Average over 3 seconds \n
      - 4  -- Average over 4 seconds \n
      - 5  -- Average over 5 seconds \n
      - 6  -- Average over 6 seconds \n
      - 7  -- Average over 7 seconds \n
      - 8  -- Average over 8 seconds \n
      - 9  -- Average over 9 seconds \n
...
typedef struct {
  ...
  /**<  
      ...
      forward link pilot Ec values to report as part of the rssi
      field in the TLV corresponding to the RAT in the QMI_NAS_SIG_INFO_IND
      indication.                                                 \n \vspace{-.12in}

      For GSM, this threshold setting results in the received 
      signal strength to report as part of the GSM Signal Strength Info 
...
typedef enum {
  ...
  CMAPI_LTE_API_MODULATION_256QAM_V01 = 0x04, /**<  256-QAM \n  */
  CMAPI_LTE_API_MODULATION_1024QAM_V01 = 0x05, /**<  1024-QAM \n  */
  CMAPI_LTE_API_MODULATION_UNKNOWN_V01 = 0xFF, /**<  Unknown modulation.  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_NR5G_MODULATION_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CMAPI_NR5G_API_MODULATION_BPSK_V01 = 0x00, /**<  BPSK \n  */
  CMAPI_NR5G_API_MODULATION_QPSK_V01 = 0x01, /**<  QPSK \n  */
  CMAPI_NR5G_API_MODULATION_16QAM_V01 = 0x02, /**<  16-QAM \n  */
  CMAPI_NR5G_API_MODULATION_64QAM_V01 = 0x03, /**<  64-QAM \n  */
  CMAPI_NR5G_API_MODULATION_256QAM_V01 = 0x04, /**<  256-QAM \n  */
  CMAPI_NR5G_API_MODULATION_UNKNOWN_V01 = 0xFF, /**<  Unknown modulation.  */
  NAS_NR5G_MODULATION_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_nr5g_modulation_enum_type_v01;
/**
    @}
  */
 ...
 */
  ...
  uint8_t nr5g_downlink_mod_valid;  /**< Must be set to true if nr5g_downlink_mod is being passed */
  uint32_t nr5g_downlink_mod_len;  /**< Must be set to # of elements in nr5g_downlink_mod */
  nas_nr5g_modulation_enum_type_v01 nr5g_downlink_mod[NAS_NR5G_MODULATIONS_MAX_V01];
  /**<   NR5G downlink modulation. Values: \n
 ...
 */
  ...
  uint8_t nr5g_uplink_mod_valid;  /**< Must be set to true if nr5g_uplink_mod is being passed */
  uint32_t nr5g_uplink_mod_len;  /**< Must be set to # of elements in nr5g_uplink_mod */
  nas_nr5g_modulation_enum_type_v01 nr5g_uplink_mod[NAS_NR5G_MODULATIONS_MAX_V01];
  /**<   NR5G uplink modulation. Values: \n
      - CMAPI_NR5G_API_MODULATION_BPSK (0x00) --  BPSK \n 
      - CMAPI_NR5G_API_MODULATION_QPSK (0x01) --  QPSK \n 
      - CMAPI_NR5G_API_MODULATION_16QAM (0x02) --  16-QAM \n 
      - CMAPI_NR5G_API_MODULATION_64QAM (0x03) --  64-QAM \n 
...
typedef struct {
  ...
  /*  PLMN */
  nas_plmn_id_ext_type_v01 plmn;
  /**<   Contains the PLMN to block or unblock 
  */
...
typedef struct {
  ...
  */
  ...
  /**<    Indicates whether to add the country initials to the plmn_name. 
        Values: \n
        - 0x00 -- Do not add the letters for the country's initials to the name \n
        - 0x01 -- Add the country's initials and a text string to the name \n
        - 0xFF -- Not specified \n
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  NR5G System Info - NR5G Tracking Area Code */
  uint8_t nr5g_tac_info_valid;  /**< Must be set to true if nr5g_tac_info is being passed */
  nas_nr5g_tac_info_type_v01 nr5g_tac_info;
...
typedef enum {
  ...
  NR5G_COMMON_RSSI_REPORTING_RATE_DEFAULT_V01 = 0, /**<  Reports using the default
                                                     configuration.  */
  NR5G_COMMON_RSSI_REPORTING_RATE_1_SEC_V01 = 1, /**<  Reports every 1 second  */
  NR5G_COMMON_RSSI_REPORTING_RATE_2_SEC_V01 = 2, /**<  Reports every 2 seconds  */
  NR5G_COMMON_RSSI_REPORTING_RATE_3_SEC_V01 = 3, /**<  Reports every 3 seconds  */
  NR5G_COMMON_RSSI_REPORTING_RATE_4_SEC_V01 = 4, /**<  Reports every 4 seconds  */
  NR5G_COMMON_RSSI_REPORTING_RATE_5_SEC_V01 = 5, /**<  Reports every 5 seconds  */
  NR5G_COMMON_RSSI_REPORTING_RATE_10_SEC_V01 = 10, /**<  Reports every 10 seconds  */
  NR5G_COMMON_RSSI_REPORTING_RATE_20_SEC_V01 = 20, /**<  Reports every 20 seconds  */
  NR5G_COMMON_RSSI_REPORTING_RATE_30_SEC_V01 = 30, /**<  Reports every 30 seconds  */
...
typedef enum {
  ...
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_DEFAULT_V01 = 0, /**<  Averages using the default
                                                       configuration.  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_1_SEC_V01 = 1, /**<  Averages every 1 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_2_SEC_V01 = 2, /**<  Averages every 2 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_3_SEC_V01 = 3, /**<  Averages every 3 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_4_SEC_V01 = 4, /**<  Averages every 4 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_5_SEC_V01 = 5, /**<  Averages every 5 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_6_SEC_V01 = 6, /**<  Averages every 6 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_7_SEC_V01 = 7, /**<  Averages every 7 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_8_SEC_V01 = 8, /**<  Averages every 8 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_9_SEC_V01 = 9, /**<  Averages every 9 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_10_SEC_V01 = 10, /**<  Averages every 10 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_20_SEC_V01 = 20, /**<  Averages every 20 seconds  */
  NR5G_COMMON_RSSI_AVERAGING_PERIOD_30_SEC_V01 = 30, /**<  Averages every 30 seconds  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NAS_SIG_TYPE_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_SIG_TYPE_RSSI_V01 = 0, /**<  RSSI \n  */
  NAS_SIG_TYPE_ECIO_V01 = 1, /**<  ECIO \n  */
  NAS_SIG_TYPE_SINR_V01 = 2, /**<  SINR \n  */
  NAS_SIG_TYPE_IO_V01 = 3, /**<  IO   \n  */
  NAS_SIG_TYPE_RSRQ_V01 = 4, /**<  RSRQ \n  */
  NAS_SIG_TYPE_RSRP_V01 = 5, /**<  RSRP \n  */
  NAS_SIG_TYPE_SNR_V01 = 6, /**<  SNR  \n  */
  NAS_SIG_TYPE_RSCP_V01 = 7, /**<  RSCP  */
  NAS_SIG_TYPE_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_sig_type_enum_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /**<  
	  ...
	  - 20 -- Report every 20 seconds \n
	  - 30 -- Report every 30 seconds	  
   */

  /*  Averaging period */
  nas_nr5g_common_rssi_averaging_period_enum_type_v01 avg_period;
  /**<   Averaging period to use for the NR5G signal. Values: \n
      - 0  -- Average using the default configuration \n
      - 1  -- Average over 1 second \n
      - 2  -- Average over 2 seconds \n
      - 3  -- Average over 3 seconds \n
      ...
      - 9  -- Average over 9 seconds \n
      - 10 -- Average over 10 seconds \n
	  - 20 -- Average over 20 seconds \n
	  - 30 -- Average over 30 seconds
   */
...
typedef struct {
  ...
  nas_sig_type_enum_type_v01 signal;
  /**<   Type of signal strength, e.g., RSSI, RSCP. 
   */

  /*  Hysteresis */
  uint16_t delta;
  /**<   Hysteresis value (in units of 0.1 dBm) to use for each signal. 
      For example, to set a hysteresis of 10 dBm, the value must be set 
      to 100. \n
      A value of 0 disables the hysteresis for the signal strength type. 
      The hysteresis value defines the range by which the signal
      strength indicators should cross the threshold values.
   */
}nas_hysteresis_config_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  /**<   \n Sets the signal reporting rate and averaging period information for NR5G.  */
 ...
 */
  ...
  /* Optional */
  /*  WCDMA RSCP Threshold List  */
  uint8_t wcdma_rscp_threshold_list_valid;  /**< Must be set to true if wcdma_rscp_threshold_list is being passed */
  uint32_t wcdma_rscp_threshold_list_len;  /**< Must be set to # of elements in wcdma_rscp_threshold_list */
  int16_t wcdma_rscp_threshold_list[NAS_SIG_STR_THRESHOLD_LIST_MAX2_V01];
  /**<   Array of RSCP thresholds (in units of 0.1 dBm); maximum of 32 values. 
      For example, to set thresholds at -95 dBm and -80 dBm, the threshold 
      list values would be {-950, -800}. 
 */
  ...
  /* Optional */
  /*  WCDMA RSCP Delta */
  uint8_t wcdma_rscp_delta_valid;  /**< Must be set to true if wcdma_rscp_delta is being passed */
 ...
 */
  ...
  /* Optional */
  /*  WCDMA Hysteresis */
  uint8_t wcdma_hysteresis_valid;  /**< Must be set to true if wcdma_hysteresis is being passed */
  uint32_t wcdma_hysteresis_len;  /**< Must be set to # of elements in wcdma_hysteresis */
  nas_hysteresis_config_type_v01 wcdma_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for WCDMA signal strength indicators. \n
      This TLV is used to create a hysteresis band around each threshold list value 
      (for example wcdma_ecio_threshold_list, wcdma_rssi_threshold_list etc.).
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little. \n
      So, the signal strength indicators (e.g., RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value. \n
      If hysteresis value is set to 0, 
      the signal strength notifying criteria would be just to cross the threshold 
      (for example wcdma_rscp_threshold_list and wcdma_rssi_threshold_list), 
      or vary by delta (for example, wcdma_ecio_delta and wcdma_rssi_delta).
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. 
 */

  /* Optional */
  /*  GSM Hysteresis */
  uint8_t gsm_hysteresis_valid;  /**< Must be set to true if gsm_hysteresis is being passed */
  uint32_t gsm_hysteresis_len;  /**< Must be set to # of elements in gsm_hysteresis */
  nas_hysteresis_config_type_v01 gsm_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for GSM signal strength indicators. 
      This TLV is used to create a hysteresis band around each threshold list value 
      (for example, gsm_rssi_threshold_list).
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little. \n
      The signal strength indicators (e.g., RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value. \n
      If hysteresis value is set to 0, 
      the signal strength notifying criteria would be just to cross the threshold 
      (for example, gsm_rssi_threshold_list), 
      or vary by delta (for example, gsm_rssi_delta). \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. 
 */
  ...
  /* Optional */
  /*  LTE Hysteresis */
  uint8_t lte_hysteresis_valid;  /**< Must be set to true if lte_hysteresis is being passed */
  uint32_t lte_hysteresis_len;  /**< Must be set to # of elements in lte_hysteresis */
  nas_hysteresis_config_type_v01 lte_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for LTE signal strength indicators. \n
      This TLV is used to create a hysteresis band around each threshold list value 
      (for example, lte_rsrp_threshold_list and lte_rssi_threshold_list). \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little. \n
      The signal strength indicators (e.g., RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value.\n
      If the hysteresis value is set to 0, 
      the signal strength notifying criteria would be just to cross the threshold 
      (for example, lte_rsrp_threshold_list and lte_rssi_threshold_list), 
      or vary by delta (for example lte_rsrp_delta and lte_rssi_delta). \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. 
 */
  ...
  /* Optional */
  /*  TDSCDMA Hysteresis */
  uint8_t tds_hysteresis_valid;  /**< Must be set to true if tds_hysteresis is being passed */
  uint32_t tds_hysteresis_len;  /**< Must be set to # of elements in tds_hysteresis */
  nas_hysteresis_config_type_v01 tds_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for TDSCDMA signal strength indicators. \n
      The hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for example, tdscdma_rscp_threshold_list and tdscdma_rssi_threshold_list). \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little. \n
      The signal strength indicators (e.g., RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value.\n
      If the hysteresis value is set to 0, 
      the signal strength notifying criteria would be just to cross the threshold 
      (for example tdscdma_ecio_threshold_list and tdscdma_rssi_threshold_list), 
      or vary by delta (for example, tdscdma_rscp_delta and tdscdma_rssi_delta). \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. 
 */
  ...
  /* Optional */
  /*  CDMA Hysteresis */
  uint8_t cdma_hysteresis_valid;  /**< Must be set to true if cdma_hysteresis is being passed */
  uint32_t cdma_hysteresis_len;  /**< Must be set to # of elements in cdma_hysteresis */
  nas_hysteresis_config_type_v01 cdma_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for CDMA signal strength indicators. \n
      The Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for example, cdma_ecio_threshold_list and cdma_rssi_threshold_list). \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little \n
      So, the signal strength indicators (e.g., RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value\n
      ...
      the signal strength notifying criteria would be just to cross the threshold 
      (for example, cdma_ecio_threshold_list and cdma_rssi_threshold_list), 
      or vary by delta (for example, cdma_ecio_delta and cdma_rssi_delta). \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. 
 */
  ...
  /* Optional */
  /*  HDR Hysteresis */
  uint8_t hdr_hysteresis_valid;  /**< Must be set to true if hdr_hysteresis is being passed */
  uint32_t hdr_hysteresis_len;  /**< Must be set to # of elements in hdr_hysteresis */
  nas_hysteresis_config_type_v01 hdr_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for HDR signal strength indicators. \n
      The Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for example hdr_ecio_threshold_list and hdr_rssi_threshold_list). \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little. \n
      So, the signal strength indicators (e.g., RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value.\n
      If the hysteresis value is set to 0, 
      the signal strength notifying criteria would be just to cross the threshold 
      (for example, hdr_ecio_threshold_listand hdr_rssi_threshold_list), 
      or vary by delta (for example, hdr_ecio_deltaand hdr_rssi_delta). \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again.
 */
  ...
  /**<   Hysteresis timer (in units of milliseconds). \n
      Hysteresis timer is required to prevent multiple rapid sig info indication reports towards clients, 
      even when the signal strength varies so much it crosses thresholds and hysteresis values. \n
      A value of 0 disables the hysteresis. \n
      Once configured, the hysteresis timer value is retained,
      until explicitly reconfigured to 0 again. 
 */

  /* Optional */
  /*  NR5G Hysteresis */
  uint8_t nr5g_hysteresis_valid;  /**< Must be set to true if nr5g_hysteresis is being passed */
  uint32_t nr5g_hysteresis_len;  /**< Must be set to # of elements in nr5g_hysteresis */
  nas_hysteresis_config_type_v01 nr5g_hysteresis[NAS_SIG_TYPE_MAX_V01];
  /**<   \n Hysteresis values for NR5G signal strength indicators. \n
      This TLV is used to create a hysteresis band around each threshold list value 
      (for example, nr5g_rsrp_threshold_list and nr5g_snr_threshold_list). \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little. \n
      The signal strength indicators (e.g., RSRP) should not just cross the threshold value
      but also cross by more than the hysteresis value.\n
      If the hysteresis value is set to 0, 
      the signal strength notifying criteria would be just to cross the threshold 
      (for example, nr5g_rsrp_threshold_list and nr5g_snr_threshold_list), 
      or vary by delta (for example nr5g_rsrp_delta and nr5g_snr_delta). \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. 
 */
...
/** Request Message; Sets the periodic search timer configuration for a 
              home operator-specific BPLMN search to the LTE. */
typedef struct {
 ...
 */
  ...
  nas_lte_cphy_scell_info_type_v01 scell_info;
  /**<   \n Contains the information for the Scell which has state change since last indication. \n
  ...
  */
  ...
  /* Optional */
  /*  UL Configured Carrier Aggregation ** */
  uint8_t ul_configured_valid;  /**< Must be set to true if ul_configured is being passed */
  uint8_t ul_configured;
  /**<   True when the carrier aggregation is uplink configured, false when not uplink configured.
  */

  /* Optional */
  /*  Unchanged UL Configured Carrier Aggregation Information Array ** */
  uint8_t unchanged_ul_configured_valid;  /**< Must be set to true if unchanged_ul_configured is being passed */
  uint32_t unchanged_ul_configured_len;  /**< Must be set to # of elements in unchanged_ul_configured */
  uint8_t unchanged_ul_configured[NAS_MAX_SCELL_LIST_LEN_V01];
  /**<   Unchanged uplink configured list - extended size \n
       True when the carrier aggregation is uplink configured, false when not uplink configured.
       This TLV should be used in place of the UL configured field from the unchanged 
       uplink cofigured array.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   List of the user-configured LTE bands, ordered by priority. The ordering 
       ...
       - 120 to 175 -- LTE band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
 ...
 */
  ...
  /**<   A list of WCDMA RF channel numbers to scan. If a list is not provided,
       all channels are scanned for the specified WCDMA preference.
  ...
  */
  ...
  /**<   A list of LTE RF channel numbers to scan. If a list is not provided,
       all channels are scanned for the specified LTE preference.
  ...
  */
  ...
  /**<   Search periodicity (in seconds).
       ...
       periodic search is disabled and only one scan is performed.
  ...
  */
  ...
  /**<   Maximum duration of the periodic/regular search (in seconds). \n
       ...
       - If the maximum search time is not provided, or if the value provided is longer 
	     than the modem's internal max duration value, the modem uses the internal max duration 
		 value as the maximum duration of the periodic/regular search. \n
  ...
  */
  ...
  /**<   Indicates whether the modem reports incremental results of the network scan 
       ...
       \begin{itemize}[label=\textendash, leftmargin=.3in]
         \item incremental\_results\_periodicity is provided and valid (the modem uses this) 
         \item incremental\_results\_periodicity is not provided but the periodicity NV item is valid (the modem uses the NV item value).
       \end{itemize}
       @endlatexonly
  ...
  */
  ...
  /**<   Indicates the periodicity with which the modem should report incremental 
       ...
       - If not provided, the modem uses the periodicity provided by the NV item value. \n
  ...
  */
  ...
  uint8_t nr5g_band_pref_valid;  /**< Must be set to true if nr5g_band_pref is being passed */
  nas_nr5g_band_pref_mask_type_v01 nr5g_band_pref;
  /**<   \n Bitmask representing the NR5G band preference to scan.
  */
  ...
  /**<   A list of NR5G RF channel numbers to scan. If a list is not provided,
       all channels are scanned for the specified NR5G preference.
  ...
  */
  ...
  /**<   \n Bitmask representing the LTE band preference to set.
       ...
       \vspace{3pt}
       If both the LTE Band Preference TLV and LTE Band Preference Extended TLV are not present, 
       the modem uses the value read from the NV.
  */

  /* Optional */
  /*  Search Periodicity Ext ** */
  uint8_t search_periodicity_ext_valid;  /**< Must be set to true if search_periodicity_ext is being passed */
  uint16_t search_periodicity_ext;
  /**<   Search periodicity (in seconds).

       If this TLV is not provided, or a value 0 is provided, the 
       periodic search is disabled and only one scan is performed.
       ...
       \vspace{3pt}
       If another scan type is provided, this TLV is ignored.
       If search_periodicity_ext is included, search_periodicity is ignored. 
  */
...
typedef enum {
  ...
  NAS_DRX_CN6_T32_V01 = 0x06, /**<  CN = 6, T = 32 \n  */
  NAS_DRX_CN7_T64_V01 = 0x07, /**<  CN = 7, T = 64 \n  */
  NAS_DRX_CN8_T128_V01 = 0x08, /**<  CN = 8, T = 128 \n  */
  NAS_DRX_CN9_T256_V01 = 0x09, /**<  CN = 9, T = 256  */
...
typedef struct {
  ...
  /**<   DRX setting for the device. Values: \n
      ...
      - NAS_DRX_CN6_T32 (0x06) --  CN = 6, T = 32 \n 
      - NAS_DRX_CN7_T64 (0x07) --  CN = 7, T = 64 \n 
      - NAS_DRX_CN8_T128 (0x08) --  CN = 8, T = 128 \n 
      - NAS_DRX_CN9_T256 (0x09) --  CN = 9, T = 256 
 */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  UL Configured Carrier Aggregation Information Array ** */
  uint8_t ul_configured_valid;  /**< Must be set to true if ul_configured is being passed */
  uint32_t ul_configured_len;  /**< Must be set to # of elements in ul_configured */
  uint8_t ul_configured[NAS_MAX_SCELL_LIST_LEN_V01];
  /**<   True when the carrier aggregation is uplink configured, false when not uplink configured.
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Enforce */
  uint8_t enforce_valid;  /**< Must be set to true if enforce is being passed */
  uint8_t enforce;
  /**<   Enforce cell lock param without power cycle.   */
...
typedef struct {
  ...
  /*  eDRX Setting */
  uint8_t edrx_params;
  /**<   eDRX setting for the device. Value to set per 
...
typedef struct {
  ...
  */
  ...
  /**<   eDRX cycle length. Value to set per 
       \hyperref[STD-24008]{3GPP TS 24.008 Rel-13} Section 10.5.5.32.
  */
  ...
  uint8_t edrx_ptw;
  /**<   eDRX paging time window. Value to set per 
       \hyperref[STD-24008]{3GPP TS 24.008 Rel-13} Section 10.5.5.32.
  */
 ...
 \vspace{3pt}
 Note: The device uses "0x08 -- NAS_RADIO_IF_LTE" as the default value 
...
typedef struct {
  ...
  /*  GERAN Cell Information */
  geran_grr_gcell_identifier_s_v01 uid_camped_cell;
  /**<   \n ID of the Gcell which must be barred. */

  /* Mandatory */
  /*  Bar Time */
  uint32_t bar_time;
  /**<   Time (in minutes) for which the GERAN cell is barred.
  */
...
typedef struct {
  ...
  /**<   Indicates whether ECID measurement is enabled or disabled. Values: \n
       - TRUE -- Enabled \n
       - FALSE -- Disabled
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Indicates whether the subscription is blocked. */
typedef struct {
...
typedef enum {
  ...
  QMI_NAS_LTE_B2_THRESH_ADJ_DISABLE_V01 = 0x01, /**<  Disable threshold adjust if enabled by EFS or online update. The 
          updated value is not written to the EFS file \n  */
  QMI_NAS_LTE_B2_THRESH_ADJ_IF_EFS_PRESENT_V01 = 0x02, /**<   Online updates of the threshold adjust only if the EFS file is present on the device and is read during bootup. 
          The updated value is not written to the EFS file \n */
  QMI_NAS_LTE_B2_THRESH_ADJ_DISABLE_AND_UPDATE_EFS_V01 = 0x09, /**<   Disable threshold adjust if enabled by the EFS or online update and write to the EFS file during LTE stop or power off.
          The updated value is picked on the next bootup \n */
  QMI_NAS_LTE_B2_THRESH_ADJ_UPDATE_EFS_V01 = 0x0A, /**<  Online updates of the threshold adjust only if the EFS file is present and write to the EFS file during LTE stop or power off. 
          The updated value is picked on the next bootup  */
...
typedef struct {
  ...
  int32_t rsrq_thresh;
  /**<   Threshold (in dBm) to compare against the current Pcell RSRQ. The modem only applies the  
    adjustments if Pcell RSRQ < RSRQ_THRESH   */

  int32_t rsrp_thresh;
  /**<   Threshold (in dBm) to compare against the current Pcell RSRP. The modem only applies the  
    adjustments if Pcell RSRP < RSRP_THRESH   */

  int32_t thresh1_adj;
  /**<   Adjustment (offset in dB) to apply before evaluation and when sending MRs */
...
typedef enum {
  ...
  CONFIG_ERROR_UPDATE_REJECT_NO_EFS_V01 = 1, /**<  Update rejected because no EFS is on the phone \n  */
  CONFIG_ERROR_EFS_WRITE_REJECT_NO_EFS_V01 = 2, /**<  Unable to write to the EFS file \n  */
  CONFIG_INVALID_V01 = 3, /**<  Invalid configuration */
...
typedef struct {
  ...
  */
  ...
  /**<        - CONFIG_ERROR_UPDATE_REJECT_NO_EFS (1) --  Update rejected because no EFS is on the phone \n 
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sends the small bandwidth EARFCNs to LTE to avoid reselections to the corresponding bands. */
typedef struct {
  ...
  /**<   Contains the small bandwidth EARFCNs. 
       A set message without this TLV is treated as a reset request.
   */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sends the small bandwidth EARFCNs to LTE to avoid reselections to the corresponding bands. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Gets the configured small bandwidth EARFCNs. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Gets the configured small bandwidth EARFCNs. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Forces the scan procedure to acquire the LTE. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Forces the scan procedure to acquire the LTE. */
typedef struct {
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_reset_nr5g_plmn_blocking_req_msg_v01;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Request to enable/disable ENDC. */
typedef struct {
  ...
  uint8_t immediate_scg_rel_valid;  /**< Must be set to true if immediate_scg_rel is being passed */
  uint8_t immediate_scg_rel;
  /**<   Immediate SCG Release.
        Values: \n
        0x00 - Do not release SCG immediately \n
        0x01 - Release SCG immediately \n
        If this TLV is not set, ENDC will be configured without immediate SCG release.
    */
}nas_set_endc_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Request to enable/disable ENDC. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
           ...
           - qmi_error_type  -- Error code. Possible error code values are
                                ...
                                message definition.
  */
}nas_set_endc_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Request to query the ENDC status. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_get_endc_config_req_msg_v01;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Request to query the ENDC status. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  ENDC Configuration */
  uint8_t enable_endc_valid;  /**< Must be set to true if enable_endc is being passed */
  uint8_t enable_endc;
  /**<   Get ENDC status.
        Values: \n
        - 0x00 -- ENDC is disabled \n
        - 0x01 -- ENDC is enabled
    */
  ...
  /**<   Immediate SCG Release.
        ...
        0x01 - Release SCG immediately
    */
}nas_get_endc_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sets the disabled ICCID. */
typedef struct {
  ...
  uint8_t iccid[NAS_MMGSDI_ICCID_LEN_V01];
  /**<    ICCID to disable. \n
        If this TLV is not provided, all ICCIDs are enabled.
  */
}nas_disable_iccid_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sets the disabled ICCID. */
typedef struct {
 ...
 Standard response type. Contains the following data members:
           ...
           - qmi_error_type  -- Error code. Possible error code values are
                                ...
                                message definition.
  */
}nas_disable_iccid_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Informs the control point that the disable ICCID request was
             handled by the modem. */
typedef struct {
  ...
  uint32_t iccid_len;  /**< Must be set to # of elements in iccid */
  uint8_t iccid[NAS_MMGSDI_ICCID_LEN_V01];
  /**<    ICCID that is disabled. \n
        If this TLV is not provided, all ICCIDs are enabled.
  */
}nas_disable_iccid_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Gets the next SFN. */
typedef struct {
  ...
  /**<   Radio interface technology of the signal being measured. Values: \n
       ...
       -0x08 -- RADIO_IF_LTE         -- LTE \n
       -0x0C -- RADIO_IF_NR5G        -- NR5G \n
     An error is returned for an invalid RAT.
  */
}nas_get_next_sfn_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Gets the next SFN. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  HSFN SFN NBR */
  uint8_t hsfn_sfn_nbr_valid;  /**< Must be set to true if hsfn_sfn_nbr is being passed */
  uint32_t hsfn_sfn_nbr;
  /**<   hsfn_sfn_nbr = hsfn*1024 + sfn. */
}nas_get_next_sfn_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sets the SFN configuration. */
typedef struct {
  ...
  */
  ...
  uint32_t hsfn_sfn_nbr;
  /**<   hsfn_sfn_nbr = hsfn*1024 + sfn. */
}nas_set_sfn_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sets the SFN configuration. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}nas_set_sfn_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Sets the SFN configuration. */
typedef struct {
  ...
  uint32_t hsfn_sfn_nbr;
  /**<   hsfn_sfn_nbr = hsfn*1024 + sfn. */
}nas_sfn_threshold_reached_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Indicates the DRX parameters configured by NR5G network. */
typedef struct {

  /* Optional */
  /*  DRX INACTIVITY TIMER */
  uint8_t drx_inactivity_timer_valid;  /**< Must be set to true if drx_inactivity_timer is being passed */
  uint32_t drx_inactivity_timer;
  /**<   drx inactivity timer value (in milliseconds).
       defined in \hyperref[STD-36331]{3GPP TS 36.331} section 6.2.
  */

  /* Optional */
  /*  DRX LONG CYCLE */
  uint8_t drx_long_cycle_valid;  /**< Must be set to true if drx_long_cycle is being passed */
  uint32_t drx_long_cycle;
  /**<   drx long cycle value (in milliseconds).
       defined in \hyperref[STD-36331]{3GPP TS 36.331} section 6.2.
  */

  /* Optional */
  /*  DRX SHORT CYCLE */
  uint8_t drx_short_cycle_valid;  /**< Must be set to true if drx_short_cycle is being passed */
  uint32_t drx_short_cycle;
  /**<   drx short cycle value (in milliseconds).
       defined in \hyperref[STD-36331]{3GPP TS 36.331} section 6.2.
  */
}nas_nr5g_drx_config_param_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_NAS_DISABLE_ICCID_V01
//#define REMOVE_QMI_NAS_DISABLE_ICCID_IND_V01
...
//#define REMOVE_QMI_NAS_GET_CODEBOOK_CONFIG_V01
...
//#define REMOVE_QMI_NAS_GET_ENDC_CONFIG_V01
...
//#define REMOVE_QMI_NAS_GET_NEXT_SFN_V01
//#define REMOVE_QMI_NAS_GET_NR5G_BAND_PRIORITY_LIST_V01
...
//#define REMOVE_QMI_NAS_NR5G_DRX_CONFIG_PARAM_IND_V01
...
//#define REMOVE_QMI_NAS_SET_CODEBOOK_CONFIG_V01
...
//#define REMOVE_QMI_NAS_SET_ENDC_CONFIG_V01
...
//#define REMOVE_QMI_NAS_SET_NR5G_BAND_PRIORITY_V01
...
//#define REMOVE_QMI_NAS_SET_SFN_CONFIG_V01
...
#define QMI_NAS_SET_IMS_PROC_TYPE_REQ_MSG_V01 0x00E6
#define QMI_NAS_SET_IMS_PROC_TYPE_RESP_MSG_V01 0x00E6
#define QMI_NAS_SET_ENDC_CONFIG_REQ_MSG_V01 0x00E7
#define QMI_NAS_SET_ENDC_CONFIG_RESP_MSG_V01 0x00E7
#define QMI_NAS_GET_ENDC_CONFIG_REQ_MSG_V01 0x00E8
#define QMI_NAS_GET_ENDC_CONFIG_RESP_MSG_V01 0x00E8
#define QMI_NAS_SET_CODEBOOK_CONFIG_REQ_MSG_V01 0x00E9
#define QMI_NAS_SET_CODEBOOK_CONFIG_RSP_MSG_V01 0x00E9
#define QMI_NAS_GET_CODEBOOK_CONFIG_REQ_MSG_V01 0x00EA
#define QMI_NAS_GET_CODEBOOK_CONFIG_RSP_MSG_V01 0x00EA
#define QMI_NAS_DISABLE_ICCID_REQ_MSG_V01 0x00EB
#define QMI_NAS_DISABLE_ICCID_RESP_MSG_V01 0x00EB
#define QMI_NAS_DISABLE_ICCID_IND_MSG_V01 0x00EC
#define QMI_NAS_SET_NR5G_BAND_PRIORITY_REQ_MSG_V01 0x00ED
#define QMI_NAS_SET_NR5G_BAND_PRIORITY_RESP_MSG_V01 0x00ED
#define QMI_NAS_GET_NR5G_BAND_PRIORITY_LIST_REQ_MSG_V01 0x00EE
#define QMI_NAS_GET_NR5G_BAND_PRIORITY_LIST_RESP_MSG_V01 0x00EE
#define QMI_NAS_GET_NEXT_SFN_REQ_MSG_V01 0x00EF
#define QMI_NAS_GET_NEXT_SFN_RESP_MSG_V01 0x00EF
#define QMI_NAS_SET_SFN_CONFIG_REQ_MSG_V01 0x00F0
#define QMI_NAS_SET_SFN_CONFIG_RESP_MSG_V01 0x00F0
#define QMI_NAS_SFN_THRESHOLD_REACHED_IND_MSG_V01 0x00F0
#define QMI_NAS_NR5G_DRX_CONFIG_PARAM_IND_MSG_V01 0x00F1
/**
    @}
  */
