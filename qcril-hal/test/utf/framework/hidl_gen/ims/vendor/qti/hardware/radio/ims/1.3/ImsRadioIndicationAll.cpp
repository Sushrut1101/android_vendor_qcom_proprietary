...
#define LOG_TAG "vendor.qti.hardware.radio.ims@1.3::ImsRadioIndication"
...
const char* IImsRadioIndication::descriptor("vendor.qti.hardware.radio.ims@1.3::IImsRadioIndication");
...
#if 0
// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadioIndication>& parent, bool /* emitError */) {
    return parent;
}
#endif
...
// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadioIndication>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication *>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>> IImsRadioIndication::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication>(static_cast<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioIndication *>(parent.get()));
}
