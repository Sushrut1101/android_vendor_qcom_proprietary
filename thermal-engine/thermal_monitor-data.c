...
Copyright (c) 2012-2015,2019-2020 Qualcomm Technologies, Inc.  All Rights Reserved.
...
#else
static struct setting_info tm_cfgs_sdm660_qrd_camera[] =
{
	{
...
#else
static struct setting_info tm_cfgs_sdm630_qrd_camera[] =
{
	{
		.desc = "CAMERA_SKIN_EXIT_MITIGATION",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_sdm710_qrd[] =
{
	{
		.desc = "CAMERA_SKIN_EXIT_MITIGATION",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_msmsteppe[] =
{
	{
		.desc = "HVX-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_sdmmagpie[] =
{
	{
		.desc = "CAMERA_SKIN_EXIT_MITIGATION",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_qm215[] =
{
	{
		.desc = "CAMERA_UC_MODEM_MITIGATION",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
...
static struct setting_info tm_cfgs_trinket[] =
{
	{
		.desc = "CDSP-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_trinket_qrd[] =
{
	{
		.desc = "CDSP-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_lito_qrd[] =
{
	{
...
static struct setting_info tm_cfgs_lito[] =
{
	{
		.desc = "Q6-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_kona_qrd[] =
{
	{
		.desc = "GAME_OPT_TSENS_RULE1",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
...
static struct setting_info tm_cfgs_atoll_qrd[] =
{
	{
		.desc = "Q6-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_bengal[] =
{
	{
...
static struct setting_info tm_cfgs_bengal_qrd[] =
{
	{
		.desc = "CDSP-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
	...
	switch (therm_get_msm_id()) {
		...
		case THERM_SDM_660:
			...
			case THERM_PLATFORM_MTP:
				break;
			default:
				cfg = tm_cfgs_sdm660_qrd_camera;
				arr_size =
					ARRAY_SIZE(tm_cfgs_sdm660_qrd_camera);
				break;
#endif
			}
			break;
		case THERM_SDM_630:
			...
			case THERM_PLATFORM_MTP:
				break;
			default:
				cfg = tm_cfgs_sdm630_qrd_camera;
				arr_size =
					ARRAY_SIZE(tm_cfgs_sdm630_qrd_camera);
				break;
#endif
			}
			break;
		case THERM_SDM_710:
			...
			case THERM_PLATFORM_MTP:
				break;
			default:
				cfg = tm_cfgs_sdm710_qrd;
				arr_size =
					ARRAY_SIZE(tm_cfgs_sdm710_qrd);
				break;
			}
			break;
		case THERM_SDM_632:
		...
		case THERM_MSM_8909W:
			...
			break;
#endif
		case THERM_MSMSTEPPE:
			cfg = tm_cfgs_msmsteppe;
			arr_size = ARRAY_SIZE(tm_cfgs_msmsteppe);
			break;
		case THERM_SDMMAGPIE:
			...
			case THERM_PLATFORM_IDP:
				break;
			default:
				cfg = tm_cfgs_sdmmagpie;
				arr_size = ARRAY_SIZE(tm_cfgs_sdmmagpie);
				break;
			}
			break;
		case THERM_TRINKET:
			...
			case THERM_PLATFORM_IDP:
				cfg = tm_cfgs_trinket;
				arr_size = ARRAY_SIZE(tm_cfgs_trinket);
				break;
			default:
				cfg = tm_cfgs_trinket_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_trinket_qrd);
				break;
			}
			break;
		case THERM_LITO:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_lito;
				arr_size = ARRAY_SIZE(tm_cfgs_lito);
				break;
			default:
				cfg = tm_cfgs_lito_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_lito_qrd);
				break;
			}
			break;
		case THERM_ATOLL:
			...
			case THERM_PLATFORM_ATP:
				...
				break;
			default:
				cfg = tm_cfgs_atoll_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_atoll_qrd);
				break;
			}
			break;
		case THERM_KONA:
			...
			case THERM_PLATFORM_QRD:
				cfg = tm_cfgs_kona_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_kona_qrd);
				break;
			default:
				cfg = NULL;
				arr_size = 0;
		...
		case THERM_BENGAL:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_bengal;
				arr_size = ARRAY_SIZE(tm_cfgs_bengal);
				break;
			default:
				cfg = tm_cfgs_bengal_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_bengal_qrd);
				break;
			}
			break;
#ifdef ENABLE_BW_SENSOR
		case THERM_QM_215:
			cfg = tm_cfgs_qm215;
			arr_size = ARRAY_SIZE(tm_cfgs_qm215);
			break;
#endif /* ENABLE_BW_SENSOR */
		default:
