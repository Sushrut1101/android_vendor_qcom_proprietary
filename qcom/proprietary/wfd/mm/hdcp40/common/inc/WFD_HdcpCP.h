...
typedef void (*eventHandlerType)(void *pHandle, unsigned int nStreamID,
                                 HDCP_CP_ERRORTYPE eError, void* nData);
/***************************************************************************
 *                 TYPE & DEFINEITION
 ***************************************************************************/
 ...
 *
 *  @details  WFD_HdcpCp is an wrapper on top of ARM_Hdcp_Transmitter API
...
public:
   ...
   * @param[out] pucStreamID        StreamID return from Arm_Hdcp library
   * @return     RETURN '0' if SUCCESS
   *             HDCP_CP_ERROR code in FAILURE
   */
   ...
   * @return	 None
   */
  //static void NotifyHdcpCpEvents(EArmHdcpEventType eHdcpEvent, void* pConnectionid, void* pStreamid);
...
public:
   ...
   * @param[in]  pvClientData     Client Data passed by Arm Lib
   * @return     None
   ****************************************************************************/
  static void NotifyHdcpCpEvents (ArmHdcpEvent* pEvtInfo, void* pvClientData) ;
#endif
  static HDCP_SESSION_STATUSTYPE m_eHdcpSessionStatus;
  static HDCP_SESSION_STATETYPE  m_eHdcpSessionState;
  ...
  void                     *m_hHDCPInstHandle;
  void                     *m_hHDCPSessionHandle;
  void                     *m_hHDCPConnectionHandle;
  void                     *m_hHDCPTransportHandle;
  void                     *m_hHDCPAudioStreamHandle;
  void                     *m_hHDCPVideoStreamHandle;
