...
import com.qualcomm.qti.uceservice.V2_1.IOptionsListener;
import com.qualcomm.qti.uceservice.V2_0.UceStatusCode;
import com.qualcomm.qti.uceservice.V2_0.OptionsSipResponse;
import com.qualcomm.qti.uceservice.V2_0.OptionsCmdId;
import com.qualcomm.qti.uceservice.V2_0.OptionsCmdStatus;
...
public class OptionsListener extends IOptionsListener.Stub
{
    ...
    public void sipResponseReceived(String URI,
                                     OptionsSipResponse cdSipResponse,
                                     OptionsCapabilityInfo CDCapInfo)
    ...
    public void sipResponseReceived_2_1( String URI,
                OptionsSipResponse cdSipResponse,
                com.qualcomm.qti.uceservice.V2_1.OptionsCapabilityInfo CDCapInfo)
                throws RemoteException {
        ...
        runnable.m_CDCapInfo = new com.android.ims.internal.uce.options.OptionsCapInfo();
        runnable.m_cdSipResponse = translateToAidlObj.getAidlOptionsSipResponse(cdSipResponse);
        runnable.m_CDCapInfo = translateToAidlObj.getAidlOptionsCapInfo_2_1(CDCapInfo);
        runnable.methodName = "sipResponseReceived";
    ...
    public void cmdStatus_2_1(com.qualcomm.qti.uceservice.V2_1.OptionsCmdStatus CdCMDStatus) {
        OptionsListenerRunnable runnable = new OptionsListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();

        runnable.mAidlOptionsListener = mAidlOptionsServiceListener;
        runnable.m_CdCMDStatus = new com.android.ims.internal.uce.options.OptionsCmdStatus();
        runnable.m_CdCMDStatus = translateToAidlObj.getAidlOptionsCmdStatus_2_1(CdCMDStatus);
        runnable.methodName = "cmdStatus";
    ...
    public void incomingOptions_2_1(String sUri,
                                com.qualcomm.qti.uceservice.V2_1.OptionsCapabilityInfo CDCapInfo,
                                short tID) {
        OptionsListenerRunnable runnable = new OptionsListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();
