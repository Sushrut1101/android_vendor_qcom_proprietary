...
LBSAdapterBase :: LBSAdapterBase(const LOC_API_ADAPTER_EVENT_MASK_T mask,
    ...
    LocAdapterBase(mask, context, isMaster)
{
...
bool LBSAdapterBase::reportFdclInfoEvent(FdclInfo& fdclInfo, uint8_t status, UlpLocation& location)
DEFAULT_IMPL(false)

bool LBSAdapterBase::requestCellCSDataEvent()
DEFAULT_IMPL(false)

bool LBSAdapterBase::reportCellCSInfoEvent(CellCSInfo& cellCSInfo, uint8_t status)
DEFAULT_IMPL(false)
