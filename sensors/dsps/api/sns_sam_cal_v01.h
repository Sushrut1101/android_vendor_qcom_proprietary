...
#define SNS_SAM_CAL_V01_IDL_MINOR_VERS 0x01
...
typedef struct {
  ...
  /* Optional */
  uint8_t phone_mode_valid;  /**< Must be set to true if phone_mode is being passed */
  uint8_t phone_mode;
  /**<   numeric value of the phone mode */
}sns_sam_cal_enable_req_msg_v01;  /* Message */
/**
    @}
  */
