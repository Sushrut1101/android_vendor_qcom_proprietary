...
typedef struct {
	...
	mp_attestation_feature_policy_t oem_unlock;
	mp_attestation_feature_policy_t qhee_report;
	// KV is empty
...
const mp_var_rtic_mp_t rtic_mp __attribute__ ((aligned (/* 1MB aligned*/0x100000))) = { /**/
	...
	{ /* mp_rtic_header_t header; */
		...
		{ /* // Offset table */
			...
			{ /* MP_ATTESTATION_OU */
				...
				(unsigned int)(long long unsigned int) &((mp_var_rtic_mp_t *) 0x0)->oem_unlock /**/,
				/* unsigned int size; // whole size of given structure block */
				sizeof(((mp_var_rtic_mp_t *) 0x0)->oem_unlock) /**/,},

			{ /* MP_ATTESTATION_QR */
				/* unsigned int offset; // offset from MP base */
				(unsigned int)(long long unsigned int) &((mp_var_rtic_mp_t *) 0x0)->qhee_report /**/,
				/* unsigned int size; // whole size of given structure block */
				sizeof(((mp_var_rtic_mp_t *) 0x0)->qhee_report) /**/,},
	...
	{ /* MP_ATTESTATION_OU */
		/* unsigned int const attributes; // control attributes e.g. MP_SECTION_ATTRIBUTE_NRTIC */
		123,
	}, /* MP_ATTESTATION_OU */
