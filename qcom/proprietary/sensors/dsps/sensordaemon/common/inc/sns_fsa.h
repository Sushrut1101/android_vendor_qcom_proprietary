...
/*============================================================================
  ...
  FUNCTION:   sns_fsa_realpath

  ============================================================================*/
/*!
  @brief Check real path with given path

  @param[i] pathname: A pointer to a string specifying the path name.

  @return
  SNS_ERR_FAILED if mismatch between directory paths; SNS_SUCCESS otherwise

*/
/*============================================================================*/
sns_err_code_e sns_fsa_realpath(const char* pathname);
