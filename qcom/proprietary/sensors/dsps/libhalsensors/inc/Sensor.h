...
#define ACCEL_SENSOR_NAME "BMA255 Accelerometer/Temperature/Double-tap"
#define ACCEL_MAX_FREQ  250
/*============================================================================
 * Class Sensor
 *=============================================================================*/
...
protected:
    ...
    bool is_lastsample_reset;
    float max_sample_freq_bkp;
/*============================================================================
...
/*============================================================================
  FUNCTION getResBufferedSamples
    Get the sensor Reserved buffered samples.
    Return value
        @int : The sensor Reserved buffered samples value.
============================================================================*/
    int getResBufferedSamples();
/*============================================================================
  FUNCTION getFlags
...
/*============================================================================
  FUNCTION getMaxFreqBkp
    Get the backup of sensor's maximum frequency
    Return value
        @float: The backedup maximum frequency value
=============================================================================*/
    float getMaxFreqBkp();
/*============================================================================
  FUNCTION setMaxFreqBkp
    Save maximum frequency for HAL reference
    Parameters:
        @max_sample_freq_bkp: Sensors maximum frequency saved.
=============================================================================*/
    void setMaxFreqBkp(float max_sample_freq_bkp);
/*============================================================================
...
/*============================================================================
  FUNCTION setResBufferedSamples
    Set the sensor Reserved buffered samples.
    Parameters:
        @reserved_buffered_samples: the sensor Reserved buffered samples
============================================================================*/
    void setResBufferedSamples(int reserved_buffered_samples);
/*============================================================================
  FUNCTION setFlags
...
============================================================================*/
    bool isBatchingEnable();
/*============================================================================
  FUNCTION bComplySampleRate()
    Check samples returned on par with Sample Period set in Batch function or not
============================================================================*/
    bool bComplySampleRate(int64_t prv_ts_ns, int64_t present_ts_ns);
/*============================================================================
  FUNCTION initReportTimer()
    Create timer for samples reported before report timeout elapsed
============================================================================*/
    int initReportTimer();
/*============================================================================
  FUNCTION delReportTimer()
    Delete timer for samples reported before report timeout elapsed
============================================================================*/
    int delReportTimer();
/*============================================================================
  FUNCTION setReportTimer()
    Set timer as one shot timer for samples reported before report timeout elapsed
============================================================================*/
    int setReportTimer(float report_delay_sec);
/*============================================================================
  FUNCTION unsetReportTimer()
    unset timer for samples reported before report timeout elapsed
============================================================================*/
    int unsetReportTimer();
/*============================================================================
  FUNCTION getSuid()
    Retrieve the associated SSC Sensor UID for this sensor
============================================================================*/
    virtual uint64_t getSuid(void)
    {
      return 0;
    }
};
