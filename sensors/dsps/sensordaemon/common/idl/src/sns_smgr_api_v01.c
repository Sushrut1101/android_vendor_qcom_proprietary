...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Thu Oct 20 2016 (Spin 0)
...
static const uint8_t sns_smgr_single_sensor_info_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, supported_odr_list) - QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, supported_odr_list_valid)),
  0x13,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, num_reserved_buffered_reports) - QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, num_reserved_buffered_reports_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(sns_smgr_single_sensor_info_resp_msg_v01, num_reserved_buffered_reports),
  SNS_SMGR_MAX_DATA_TYPE_PER_SENSOR_V01,
  QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, num_reserved_buffered_reports) - QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, num_reserved_buffered_reports_len)
};
...
static const uint8_t sns_smgr_report_error_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_report_error_ind_msg_v01, ReportId),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_report_error_ind_msg_v01, SensorId),

  0x03,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_report_error_ind_msg_v01, DataType),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x04,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_report_error_ind_msg_v01, ErrorCode)
};

static const uint8_t sns_smgr_sensor_cal_reset_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_req_msg_v01, usage),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_req_msg_v01, SensorId),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_req_msg_v01, DataType)
};

static const uint8_t sns_smgr_sensor_cal_reset_resp_msg_data_v01[] = {
  2,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_resp_msg_v01, Resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_resp_msg_v01, TimeStamp) - QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_resp_msg_v01, TimeStamp_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_reset_resp_msg_v01, TimeStamp)
};

static const uint8_t sns_smgr_phone_mode_switch_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_phone_mode_switch_req_msg_v01, PhoneMode)
};

static const uint8_t sns_smgr_phone_mode_switch_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 2,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sns_smgr_phone_mode_switch_resp_msg_v01, Resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry SNS_SMGR_SVC_message_table_v01[] = {
  ...
  {sizeof(sns_smgr_report_error_ind_msg_v01), sns_smgr_report_error_ind_msg_data_v01},
  {sizeof(sns_smgr_sensor_cal_reset_req_msg_v01), sns_smgr_sensor_cal_reset_req_msg_data_v01},
  {sizeof(sns_smgr_sensor_cal_reset_resp_msg_v01), sns_smgr_sensor_cal_reset_resp_msg_data_v01},
  {sizeof(sns_smgr_phone_mode_switch_req_msg_v01), sns_smgr_phone_mode_switch_req_msg_data_v01},
  {sizeof(sns_smgr_phone_mode_switch_resp_msg_v01), sns_smgr_phone_mode_switch_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_command_messages_v01[] = {
  ...
  {SNS_SMGR_CAL_RESET_REQ_V01, QMI_IDL_TYPE16(0, 28), 12},
  {SNS_SMGR_PHONE_MODE_SWITCH_REQ_V01, QMI_IDL_TYPE16(0, 30), 7}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_response_messages_v01[] = {
  ...
  {SNS_SMGR_SINGLE_SENSOR_INFO_RESP_V01, QMI_IDL_TYPE16(0, 8), 1049},
  ...
  {SNS_SMGR_CAL_RESET_RESP_V01, QMI_IDL_TYPE16(0, 29), 16},
  {SNS_SMGR_PHONE_MODE_SWITCH_RESP_V01, QMI_IDL_TYPE16(0, 31), 5}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_indication_messages_v01[] = {
  ...
  {SNS_SMGR_REPORT_ERROR_IND_V01, QMI_IDL_TYPE16(0, 27), 19}
};
