...
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_2::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError) {
    return ::android::sp<::android::hardware::radio::V1_2::IRadio>(static_cast<::android::hardware::radio::V1_2::IRadio*>(parent.get()));
}
...
static std::unordered_map<std::string, ::android::sp<::android::hardware::radio::V1_2::IRadio>> mHidlServices;
// static
...
::android::status_t IRadio::registerAsService(const std::string &serviceName) {
    ...
    ::android::hardware::radio::V1_1::IRadio::registerAsService(serviceName);
    return ::android::OK;
}
