...
/** isp_pipeline41_fill_stats_info:
 *
 ...
 **/
boolean isp_pipeline41_parser_fill_stats_info(uint32_t session_id,
  ...
  isp_parser_session_params_t *parser_session_params __unused)
{
  ...
  if (stats_mask & (1 << MSM_ISP_STATS_BE)) {
    stats_info = &iface_resource_request->isp_stats_info
      [iface_resource_request->num_stats_stream++];
    stats_info->buf_len = ALIGN32(STATS_BE_BUF_SIZE) * num_isp;
    if (iface_resource_request->ispif_split_output_info.is_split == TRUE) {
       stats_info->buf_type = ISP_SHARE_BUF;
    } else {
      stats_info->buf_type = ISP_PRIVATE_BUF;
  ...
  if (stats_mask & (1 << MSM_ISP_STATS_BHIST)) {
     stats_info = &iface_resource_request->isp_stats_info
       [iface_resource_request->num_stats_stream++];
     stats_info->buf_len = ALIGN32(STATS_BHIST_STATS_BUF_SIZE) * num_isp;
     if (iface_resource_request->ispif_split_output_info.is_split == TRUE) {
       stats_info->buf_type = ISP_SHARE_BUF;
     } else {
       stats_info->buf_type = ISP_PRIVATE_BUF;
...
boolean isp_pipeline41_parser_bf_stats(void *input_buf,
...
/** isp_pipeline41_parser_bg_stats:
 *
 *  @input_buf: input buffer
 *  @output: output params to be filled
 *  @saved_stats_params_isp0: stats params for ISP 0
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_pipeline41_parser_bg_stats(void *input_buf,
  mct_event_stats_isp_t *output,
  isp_saved_stats_params_t *saved_stats_params,
  isp_parser_session_params_t *parser_session_params)
{
...
/** isp_pipeline41_parser_be_stats:
 *
 *  @input_buf: input buffer
 *  @output: output params to be filled
 *  @stats_3a_data: stats 3a data handle
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_pipeline41_parser_be_stats(void *input_buf,
  mct_event_stats_isp_t *output,
  isp_saved_stats_params_t *saved_stats_params,
  isp_parser_session_params_t *parser_session_params)
{
...
/** isp_pipeline41_parser_rs_stats:
 *
 *  @input_buf: input buffer
 *  @output: output params to be filled
 *  @stats_3a_data: stats 3a data handle
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_pipeline41_parser_rs_stats(void *input_buf,
  mct_event_stats_isp_t *output,
...
/** isp_pipeline41_parser_cs_stats:
 *
 *  @input_buf: input buffer
 *  @output: output params to be filled
 *  @stats_3a_data: stats 3a data handle
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_pipeline41_parser_cs_stats(void *input_buf,
  mct_event_stats_isp_t *output,
  isp_saved_stats_params_t *saved_stats_params,
  isp_parser_session_params_t *parser_session_params)
{
...
/** isp_pipeline41_parser_ihist_stats:
 *
 *  @input_buf: input buffer
 *  @output: output params to be filled
 *  @stats_3a_data: stats 3a data handle
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_pipeline41_parser_ihist_stats(void *input_buf,
  mct_event_stats_isp_t *output,
  isp_saved_stats_params_t *saved_stats_params,
  isp_parser_session_params_t *parser_session_params)
{
...
/** isp_pipeline41_parser_bhist_stats:
 *
 *  @input_buf: input buffer
 *  @output: output params to be filled
 *  @stats_3a_data: stats 3a data handle
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_pipeline41_parser_bhist_stats(void *input_buf,
  mct_event_stats_isp_t *output,
  isp_saved_stats_params_t *saved_stats_params,
  isp_parser_session_params_t *parser_session_params)
{
