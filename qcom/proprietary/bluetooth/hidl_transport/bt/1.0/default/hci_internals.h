...
#define HCI_PACKET_CMD_HDR    0x04
#define HCI_PACKET_EVT_HDR    0x03
#define ACL_PACKET_HDR        0x05
...
enum HciPacketType {
  ...
  /* If trying to change this ensure to change IBS packet. */
  HCI_PACKET_TYPE_IBS_CMD = 0x15,
  HCI_PACKET_TYPE_IBS_EVENT = 0x16
};
