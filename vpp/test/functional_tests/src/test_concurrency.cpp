...
*/
        ...
        u32 = vpp_set_parameter(p1, VPP_PORT_INPUT, param);
        DVP_ASSERT_EQUAL(u32, VPP_OK);

        u32 = vpp_set_parameter(p1, VPP_PORT_OUTPUT, param);
        DVP_ASSERT_EQUAL(u32, VPP_OK);

        param.width = pFuncTestCtx->reconfig_streams[0].reconfig_pool_params.u32Width;
        param.height = pFuncTestCtx->reconfig_streams[0].reconfig_pool_params.u32Height;
