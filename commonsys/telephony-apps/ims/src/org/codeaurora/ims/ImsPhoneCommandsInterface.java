...
//  static final int CF_ACTION_UNUSED           = 2;
    ...
    void setServiceStatus(Message result,  ArrayList<CapabilityStatus> capabilityStatusList,
            int restrictCause);
    ...
    void registerForViceRefreshInfo(Handler h, int what, Object obj);

    void explicitCallTransfer(int srcCallId, int type, String number,
            int destCallId, Message result);

    void registerForRttMessage(Handler h, int what, Object obj);

    void deregisterForRttMessage(Handler h);

    void registerForVoiceInfo(Handler h, int what, Object obj);

    void deregisterForVoiceInfo(Handler h);
}
