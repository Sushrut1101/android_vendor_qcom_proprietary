...
{
  netmgr_qos_indication_data_type ind_data;
  netmgr_qos_event_report_flow_info_type *flow_info = &ind_data.event_report.flow_info;
  struct msghdr * msgh = NULL;
  netmgr_exec_cmd_t * cmd_buf = NULL;
  netmgr_tc_flow_info_t * flow_buf = NULL;
//  netmgr_tc_filter_info_t *filter_buf = NULL;
  ...
  flow_info->qos_flow_state.report_flow_state_chng = NETMGR_QOS_FLOW_ACTIVATED;
  ...
  flow_info->tx_granted_flow_data.qos_flow_granted.umts_flow_desc.param_mask = (NETMGR_QOS_UMTS_FLOW_PARAM_DATA_RATE| QMI_QOS_UMTS_FLOW_PARAM_TRAFFIC_CLASS);
  ...
  flow_info->tx_granted_flow_data.qos_flow_granted.umts_flow_desc.traffic_class = NETMGR_QOS_UMTS_TC_STREAMING;

  flow_info->tx_filter_count = 2;
  flow_info->tx_granted_filter_data[0].filter_index = 0;
  flow_info->tx_granted_filter_data[0].qos_filter.ip_version = NETMGR_QOS_IP_VERSION_4; /* IPv4 */
  flow_info->tx_granted_filter_data[0].qos_filter.filter_desc.param_mask = (NETMGR_QOS_FILTER_PARAM_SRC_ADDR |
                                                                         NETMGR_QOS_FILTER_PARAM_DEST_ADDR |
                                                                         NETMGR_QOS_FILTER_PARAM_TRANS_PROTOCOL |
                                                                         NETMGR_QOS_FILTER_PARAM_TOS |
                                                                         NETMGR_QOS_FILTER_PARAM_TCP_DEST_PORTS);
  ...
  flow_info->tx_granted_filter_data[0].qos_filter.filter_desc.protocol = NETMGR_QOS_TRANS_PROT_TCP;
  ...
  flow_info->tx_granted_filter_data[1].qos_filter.ip_version = NETMGR_QOS_IP_VERSION_4; /* IPv4 */
  flow_info->tx_granted_filter_data[1].qos_filter.filter_desc.param_mask = (NETMGR_QOS_FILTER_PARAM_SRC_ADDR |
                                                                         NETMGR_QOS_FILTER_PARAM_DEST_ADDR |
                                                                         NETMGR_QOS_FILTER_PARAM_TRANS_PROTOCOL |
                                                                         NETMGR_QOS_FILTER_PARAM_TOS |
                                                                         NETMGR_QOS_FILTER_PARAM_TCP_DEST_PORTS);
  ...
  flow_info->tx_granted_filter_data[1].qos_filter.filter_desc.protocol = NETMGR_QOS_TRANS_PROT_UDP;
  ...
  netmgr_qmi_qos_ind( INSTANCE, QMI_QOS_SERVICE, (void*)INSTANCE,
                      NETMGR_QOS_SRVC_EVENT_REPORT_IND_MSG, &ind_data );
  sleep(1);
