...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.HE.1.0.c1/Main/modem_proc/qmimsgs/pdc/src/persistent_device_configuration_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t pdc_indication_register_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_config_change) - QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_config_change_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_config_change),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_client_refresh) - QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_client_refresh_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_client_refresh)
};
...
static const uint8_t pdc_get_selected_config_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_selected_config_req_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_get_selected_config_req_msg_v01, subscription_id_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_selected_config_req_msg_v01, subscription_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_selected_config_req_msg_v01, slot_id) - QMI_IDL_OFFSET8(pdc_get_selected_config_req_msg_v01, slot_id_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_selected_config_req_msg_v01, slot_id)
};
...
static const uint8_t pdc_set_selected_config_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_selected_config_req_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_set_selected_config_req_msg_v01, subscription_id_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_selected_config_req_msg_v01, subscription_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_selected_config_req_msg_v01, slot_id) - QMI_IDL_OFFSET8(pdc_set_selected_config_req_msg_v01, slot_id_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_selected_config_req_msg_v01, slot_id)
};
...
static const uint8_t pdc_list_configs_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_list_configs_req_msg_v01, config_type) - QMI_IDL_OFFSET8(pdc_list_configs_req_msg_v01, config_type_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_list_configs_req_msg_v01, config_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_list_configs_req_msg_v01, multi_support) - QMI_IDL_OFFSET8(pdc_list_configs_req_msg_v01, multi_support_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_list_configs_req_msg_v01, multi_support)
};
...
static const uint8_t pdc_list_configs_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_list_configs_ind_msg_v01, config_list) - QMI_IDL_OFFSET8(pdc_list_configs_ind_msg_v01, config_list_valid)),
  0x11,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pdc_list_configs_ind_msg_v01, more_available) - QMI_IDL_OFFSET16RELATIVE(pdc_list_configs_ind_msg_v01, more_available_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(pdc_list_configs_ind_msg_v01, more_available)
};
...
static const uint8_t pdc_get_config_info_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pdc_get_config_info_ind_msg_v01, base_version) - QMI_IDL_OFFSET16RELATIVE(pdc_get_config_info_ind_msg_v01, base_version_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(pdc_get_config_info_ind_msg_v01, base_version),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pdc_get_config_info_ind_msg_v01, config_header) - QMI_IDL_OFFSET16RELATIVE(pdc_get_config_info_ind_msg_v01, config_header_valid)),
  0x17,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(pdc_get_config_info_ind_msg_v01, config_header),
  PDC_CONFIG_HEADER_SIZE_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(pdc_get_config_info_ind_msg_v01, config_header) - QMI_IDL_OFFSET16RELATIVE(pdc_get_config_info_ind_msg_v01, config_header_len)
};
...
static const uint8_t pdc_get_feature_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_req_msg_v01, slot_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_req_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_get_feature_req_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_req_msg_v01, ind_token)
};

static const uint8_t pdc_get_feature_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_get_feature_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t pdc_get_feature_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, error),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, ind_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, selection_mode) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, selection_mode_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, selection_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, carrier) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, carrier_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, carrier),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, flex_mapping) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, flex_mapping_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, flex_mapping),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, refresh_mode) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, refresh_mode_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, refresh_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, multisim) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, multisim_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, multisim),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, os) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, os_valid)),
  0x16,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, os),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, market) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, market_valid)),
  0x17,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, market),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, deployment) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, deployment_valid)),
  0x18,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, deployment),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, ims_feature) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, ims_feature_valid)),
  0x19,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, ims_feature),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, variant) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, variant_valid)),
  0x1A,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, variant),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, country) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, country_valid)),
  0x1B,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, country)
};

static const uint8_t pdc_set_feature_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, slot_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, ind_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, selection_mode) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, selection_mode_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, selection_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, carrier) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, carrier_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, carrier),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, flex_mapping) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, flex_mapping_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, flex_mapping),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, refresh_mode) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, refresh_mode_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, refresh_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, multisim) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, multisim_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, multisim),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, os) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, os_valid)),
  0x16,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, os),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, market) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, market_valid)),
  0x17,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, market),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, deployment) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, deployment_valid)),
  0x18,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, deployment),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, ims_feature) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, ims_feature_valid)),
  0x19,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, ims_feature),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, variant) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, variant_valid)),
  0x1A,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, variant),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, country) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, country_valid)),
  0x1B,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, country)
};

static const uint8_t pdc_set_feature_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_set_feature_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t pdc_set_feature_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(pdc_set_feature_ind_msg_v01, error),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_ind_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_set_feature_ind_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_set_feature_ind_msg_v01, ind_token)
};

static const uint8_t pdc_refresh_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, refresh_event),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, subscription_id_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, subscription_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, slot_id) - QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, slot_id_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_refresh_ind_msg_v01, slot_id)
};

static const uint8_t pdc_get_config_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, config_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, ind_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, config_id) - QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, config_id_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, config_id),
  PDC_CONFIG_ID_SIZE_MAX_V01,
  QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, config_id) - QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, config_id_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, subscription_id_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, subscription_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, frame_index) - QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, frame_index_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_req_msg_v01, frame_index)
};

static const uint8_t pdc_get_config_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_get_config_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t pdc_get_config_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, error),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, ind_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, frame_index) - QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, frame_index_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, frame_index),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, config_frame) - QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, config_frame_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, config_frame),
  ((PDC_CONFIG_FRAME_SIZE_MAX_V01) & 0xFF), ((PDC_CONFIG_FRAME_SIZE_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, config_frame) - QMI_IDL_OFFSET8(pdc_get_config_ind_msg_v01, config_frame_len)
};

static const uint8_t pdc_notification_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, client_refresh_done) - QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, client_refresh_done_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, client_refresh_done),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, subscription_id_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, subscription_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, slot_id) - QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, slot_id_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_notification_req_msg_v01, slot_id)
};

static const uint8_t pdc_notification_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_notification_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry pdc_message_table_v01[] = {
  ...
  {sizeof(pdc_get_feature_req_msg_v01), pdc_get_feature_req_msg_data_v01},
  {sizeof(pdc_get_feature_resp_msg_v01), pdc_get_feature_resp_msg_data_v01},
  {sizeof(pdc_get_feature_ind_msg_v01), pdc_get_feature_ind_msg_data_v01},
  {sizeof(pdc_set_feature_req_msg_v01), pdc_set_feature_req_msg_data_v01},
  {sizeof(pdc_set_feature_resp_msg_v01), pdc_set_feature_resp_msg_data_v01},
  {sizeof(pdc_set_feature_ind_msg_v01), pdc_set_feature_ind_msg_data_v01},
  {sizeof(pdc_refresh_ind_msg_v01), pdc_refresh_ind_msg_data_v01},
  {sizeof(pdc_get_config_req_msg_v01), pdc_get_config_req_msg_data_v01},
  {sizeof(pdc_get_config_resp_msg_v01), pdc_get_config_resp_msg_data_v01},
  {sizeof(pdc_get_config_ind_msg_v01), pdc_get_config_ind_msg_data_v01},
  {sizeof(pdc_notification_req_msg_v01), pdc_notification_req_msg_data_v01},
  {sizeof(pdc_notification_resp_msg_v01), pdc_notification_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry pdc_service_command_messages_v01[] = {
  ...
  {QMI_PDC_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 2), 8},
  {QMI_PDC_GET_SELECTED_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 5), 28},
  {QMI_PDC_SET_SELECTED_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 8), 153},
  {QMI_PDC_LIST_CONFIGS_REQ_V01, QMI_IDL_TYPE16(0, 11), 18},
  ...
  {QMI_PDC_GET_FEATURE_REQ_V01, QMI_IDL_TYPE16(0, 38), 14},
  {QMI_PDC_SET_FEATURE_REQ_V01, QMI_IDL_TYPE16(0, 41), 82},
  {QMI_PDC_GET_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 45), 156},
  {QMI_PDC_NOTIFICATION_REQ_V01, QMI_IDL_TYPE16(0, 48), 18}
};
...
static const qmi_idl_service_message_table_entry pdc_service_response_messages_v01[] = {
  ...
  {QMI_PDC_GET_FEATURE_RESP_V01, QMI_IDL_TYPE16(0, 39), 7},
  {QMI_PDC_SET_FEATURE_RESP_V01, QMI_IDL_TYPE16(0, 42), 7},
  {QMI_PDC_GET_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 46), 7},
  {QMI_PDC_NOTIFICATION_RESP_V01, QMI_IDL_TYPE16(0, 49), 7}
};
...
static const qmi_idl_service_message_table_entry pdc_service_indication_messages_v01[] = {
  ...
  {QMI_PDC_LIST_CONFIGS_IND_V01, QMI_IDL_TYPE16(0, 13), 3245},
  ...
  {QMI_PDC_GET_CONFIG_INFO_IND_V01, QMI_IDL_TYPE16(0, 25), 1071},
  ...
  {QMI_PDC_GET_FEATURE_IND_V01, QMI_IDL_TYPE16(0, 40), 80},
  {QMI_PDC_SET_FEATURE_IND_V01, QMI_IDL_TYPE16(0, 43), 12},
  {QMI_PDC_REFRESH_IND_V01, QMI_IDL_TYPE16(0, 44), 21},
  {QMI_PDC_GET_CONFIG_IND_V01, QMI_IDL_TYPE16(0, 47), 32792}
};
