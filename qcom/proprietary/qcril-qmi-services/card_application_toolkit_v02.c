...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.HE.1.0.c1/Main/modem_proc/qmimsgs/cat/src/card_application_toolkit_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t cat_contactless_state_changed_evt_type_data_v02[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_contactless_state_changed_evt_type_v02, uim_ref_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(cat_contactless_state_changed_evt_type_v02, pc_contactless_state_changed),
  ((QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02) & 0xFF), ((QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02) >> 8),
  QMI_IDL_OFFSET8(cat_contactless_state_changed_evt_type_v02, pc_contactless_state_changed) - QMI_IDL_OFFSET8(cat_contactless_state_changed_evt_type_v02, pc_contactless_state_changed_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t cat_geographical_location_evt_type_data_v02[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_geographical_location_evt_type_v02, uim_ref_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(cat_geographical_location_evt_type_v02, pc_geographical_location),
  ((QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02) & 0xFF), ((QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02) >> 8),
  QMI_IDL_OFFSET8(cat_geographical_location_evt_type_v02, pc_geographical_location) - QMI_IDL_OFFSET8(cat_geographical_location_evt_type_v02, pc_geographical_location_len),
...
static const uint8_t cat_run_at_command_event_type_data_v02[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_run_at_command_event_type_v02, uim_ref_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(cat_run_at_command_event_type_v02, pc_run_at_command),
  ((QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02) & 0xFF), ((QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02) >> 8),
  QMI_IDL_OFFSET8(cat_run_at_command_event_type_v02, pc_run_at_command) - QMI_IDL_OFFSET8(cat_run_at_command_event_type_v02, pc_run_at_command_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t cat_ims_call_disconnect_cause_type_data_v02[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_ims_call_disconnect_cause_type_v02, protocol),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(cat_ims_call_disconnect_cause_type_v02, cause),
...
static const uint8_t cat_event_report_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, refresh_alpha) - QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, refresh_alpha_valid)),
  0x6A,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, contactless_state_changed) - QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, contactless_state_changed_valid)),
  0x6B,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_event_report_ind_msg_v02, contactless_state_changed),
  QMI_IDL_TYPE88(0, 83),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, contactless_functionality_state) - QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, contactless_functionality_state_valid)),
  0x6C,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_event_report_ind_msg_v02, contactless_functionality_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, geographical_location) - QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, geographical_location_valid)),
  0x6D,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_event_report_ind_msg_v02, geographical_location),
  QMI_IDL_TYPE88(0, 84),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, media_type_valid)),
  0x6E,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_event_report_ind_msg_v02, media_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, run_at_command) - QMI_IDL_OFFSET16RELATIVE(cat_event_report_ind_msg_v02, run_at_command_valid)),
  0x6F,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_event_report_ind_msg_v02, run_at_command),
...
static const uint8_t cat_send_tr_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_tr_req_msg_v02, slot) - QMI_IDL_OFFSET16RELATIVE(cat_send_tr_req_msg_v02, slot_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_tr_req_msg_v02, slot),
  QMI_IDL_TYPE88(0, 61),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_tr_req_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_tr_req_msg_v02, indication_token_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_tr_req_msg_v02, indication_token)
};
...
static const uint8_t cat_send_tr_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_tr_resp_msg_v02, tr_response_data) - QMI_IDL_OFFSET8(cat_send_tr_resp_msg_v02, tr_response_data_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_tr_resp_msg_v02, tr_response_data),
  QMI_IDL_TYPE88(0, 88),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_tr_resp_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_tr_resp_msg_v02, indication_token_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_tr_resp_msg_v02, indication_token)
};
...
static const uint8_t cat_send_envelope_cmd_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_envelope_cmd_req_msg_v02, slot) - QMI_IDL_OFFSET16RELATIVE(cat_send_envelope_cmd_req_msg_v02, slot_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_envelope_cmd_req_msg_v02, slot),
  QMI_IDL_TYPE88(0, 61),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_envelope_cmd_req_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_envelope_cmd_req_msg_v02, indication_token_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_envelope_cmd_req_msg_v02, indication_token)
};
...
static const uint8_t cat_send_envelope_cmd_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_envelope_cmd_resp_msg_v02, env_resp_data) - QMI_IDL_OFFSET8(cat_send_envelope_cmd_resp_msg_v02, env_resp_data_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_envelope_cmd_resp_msg_v02, env_resp_data),
  QMI_IDL_TYPE88(0, 90),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_envelope_cmd_resp_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_envelope_cmd_resp_msg_v02, indication_token_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_envelope_cmd_resp_msg_v02, indication_token)
};
...
static const uint8_t cat_get_event_report_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, refresh_alpha) - QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, refresh_alpha_valid)),
  0x6A,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, contactless_state_changed) - QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, contactless_state_changed_valid)),
  0x6B,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_get_event_report_resp_msg_v02, contactless_state_changed),
  QMI_IDL_TYPE88(0, 83),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, contactless_functionality_state) - QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, contactless_functionality_state_valid)),
  0x6C,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_get_event_report_resp_msg_v02, contactless_functionality_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, geographical_location) - QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, geographical_location_valid)),
  0x6D,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_get_event_report_resp_msg_v02, geographical_location),
  QMI_IDL_TYPE88(0, 84),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, media_type_valid)),
  0x6E,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_get_event_report_resp_msg_v02, media_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, run_at_command) - QMI_IDL_OFFSET16RELATIVE(cat_get_event_report_resp_msg_v02, run_at_command_valid)),
  0x6F,
  QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_AGGREGATE,
  QMI_IDL_FLAGS_EXTENDED_OFFSET,
  QMI_IDL_OFFSET32ARRAY(cat_get_event_report_resp_msg_v02, run_at_command),
  QMI_IDL_TYPE88(0, 109)
};
...
static const uint8_t cat_send_decoded_tr_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, gst_inkey_yes_no_info) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, gst_inkey_yes_no_info_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_req_msg_v02, gst_inkey_yes_no_info),
  QMI_IDL_TYPE88(0, 95),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, battery_state) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, battery_state_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_req_msg_v02, battery_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, indication_token_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_req_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, ssid) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, ssid_valid)),
  0x18,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_req_msg_v02, ssid),
  QMI_CAT_TR_WLAN_ID_SSID_MAX_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, ssid) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, ssid_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, bssid) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, bssid_valid)),
  0x19,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_req_msg_v02, bssid),
  QMI_CAT_TR_WLAN_ID_BSSID_MAX_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, bssid) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, bssid_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, hessid) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, hessid_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_req_msg_v02, hessid),
  QMI_CAT_TR_WLAN_ID_HESSID_MAX_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, hessid) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_req_msg_v02, hessid_len)
};
...
static const uint8_t cat_send_decoded_tr_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_decoded_tr_resp_msg_v02, tr_response_data) - QMI_IDL_OFFSET8(cat_send_decoded_tr_resp_msg_v02, tr_response_data_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_decoded_tr_resp_msg_v02, tr_response_data),
  QMI_IDL_TYPE88(0, 88),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_resp_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_tr_resp_msg_v02, indication_token_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_tr_resp_msg_v02, indication_token)
};
...
static const uint8_t cat_send_decoded_envelope_cmd_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_request_uri) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_request_uri_valid)),
  0x24,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, contactless_state_request) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, contactless_state_request_valid)),
  0x25,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, contactless_state_request),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, indication_token_valid)),
  0x26,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, duration) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, duration_valid)),
  0x27,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, duration),
  QMI_IDL_TYPE88(0, 16),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_request_uri_truncated) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_request_uri_truncated_valid)),
  0x28,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, ims_request_uri_truncated),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, media_type_valid)),
  0x29,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, media_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_call_disconnect_cause) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_call_disconnect_cause_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, ims_call_disconnect_cause),
...
static const uint8_t cat_send_decoded_envelope_cmd_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, ims_request_uri) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, ims_request_uri_valid)),
  0x1D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, indication_token) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, indication_token_valid)),
  0x1E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_resp_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, poll_interval_result) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, poll_interval_result_valid)),
  0x1F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_resp_msg_v02, poll_interval_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, rsp_duration) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, rsp_duration_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_resp_msg_v02, rsp_duration),
  QMI_IDL_TYPE88(0, 16),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, media_type_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_resp_msg_v02, media_type)
};
...
static const uint8_t cat_send_tr_ind_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_tr_ind_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_send_tr_ind_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_tr_ind_msg_v02, tr_response_data) - QMI_IDL_OFFSET8(cat_send_tr_ind_msg_v02, tr_response_data_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_tr_ind_msg_v02, tr_response_data),
  QMI_IDL_TYPE88(0, 88)
};

static const uint8_t cat_send_envelope_cmd_ind_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_envelope_cmd_ind_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_send_envelope_cmd_ind_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_envelope_cmd_ind_msg_v02, env_resp_data) - QMI_IDL_OFFSET8(cat_send_envelope_cmd_ind_msg_v02, env_resp_data_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_envelope_cmd_ind_msg_v02, env_resp_data),
  QMI_IDL_TYPE88(0, 90)
};

static const uint8_t cat_send_decoded_tr_ind_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_decoded_tr_ind_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_send_decoded_tr_ind_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_decoded_tr_ind_msg_v02, tr_response_data) - QMI_IDL_OFFSET8(cat_send_decoded_tr_ind_msg_v02, tr_response_data_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_decoded_tr_ind_msg_v02, tr_response_data),
  QMI_IDL_TYPE88(0, 88)
};

static const uint8_t cat_send_decoded_envelope_cmd_ind_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, indication_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, cc_result) - QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, cc_result_valid)),
  0x10,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, cc_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, address) - QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, address_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cat_send_decoded_envelope_cmd_ind_msg_v02, address),
  QMI_IDL_TYPE88(0, 35),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, sub_address) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, sub_address_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, sub_address),
  QMI_IDL_TYPE88(0, 38),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, capability_config_param1) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, capability_config_param1_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, capability_config_param1),
  QMI_IDL_TYPE88(0, 39),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, capability_config_param2) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, capability_config_param2_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, capability_config_param2),
  QMI_IDL_TYPE88(0, 39),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, ussd_string) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, ussd_string_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, ussd_string),
  QMI_IDL_TYPE88(0, 12),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, pdp_context_act) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, pdp_context_act_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, pdp_context_act),
  QMI_IDL_TYPE88(0, 99),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, eps_pdn_connect_act) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, eps_pdn_connect_act_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, eps_pdn_connect_act),
  QMI_IDL_TYPE88(0, 100),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, alpha) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, alpha_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, alpha),
  QMI_IDL_TYPE88(0, 12),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, bc_repeat_ind) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, bc_repeat_ind_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, bc_repeat_ind),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, sms_pp_uicc_acknowledge) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, sms_pp_uicc_acknowledge_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, sms_pp_uicc_acknowledge),
  QMI_CAT_SMS_PP_UICC_ACK_MAX_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, sms_pp_uicc_acknowledge) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, sms_pp_uicc_acknowledge_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, rp_dest_address) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, rp_dest_address_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, rp_dest_address),
  QMI_IDL_TYPE88(0, 35),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, tp_dest_address) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, tp_dest_address_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, tp_dest_address),
  QMI_IDL_TYPE88(0, 35),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, ims_request_uri) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, ims_request_uri_valid)),
  0x1D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, ims_request_uri),
  QMI_CAT_IMS_URI_MAX_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, ims_request_uri) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, ims_request_uri_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, poll_interval_result) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, poll_interval_result_valid)),
  0x1E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, poll_interval_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, rsp_duration) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, rsp_duration_valid)),
  0x1F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, rsp_duration),
  QMI_IDL_TYPE88(0, 16),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, media_type_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, media_type)
};
...
static const qmi_idl_type_table_entry  cat_type_table_v02[] = {
  ...
  {sizeof(cat_contactless_state_changed_evt_type_v02), cat_contactless_state_changed_evt_type_data_v02},
  {sizeof(cat_geographical_location_evt_type_v02), cat_geographical_location_evt_type_data_v02},
  ...
  {sizeof(cat_run_at_command_event_type_v02), cat_run_at_command_event_type_data_v02},
  {sizeof(cat_ims_call_disconnect_cause_type_v02), cat_ims_call_disconnect_cause_type_data_v02}
};
...
static const qmi_idl_message_table_entry cat_message_table_v02[] = {
  ...
  {sizeof(cat_send_tr_ind_msg_v02), cat_send_tr_ind_msg_data_v02},
  {sizeof(cat_send_envelope_cmd_ind_msg_v02), cat_send_envelope_cmd_ind_msg_data_v02},
  {sizeof(cat_send_decoded_tr_ind_msg_v02), cat_send_decoded_tr_ind_msg_data_v02},
  {sizeof(cat_send_decoded_envelope_cmd_ind_msg_v02), cat_send_decoded_envelope_cmd_ind_msg_data_v02}
};
...
static const qmi_idl_service_message_table_entry cat_service_command_messages_v02[] = {
  ...
  {QMI_CAT_SEND_TR_REQ_V02, QMI_IDL_TYPE16(0, 7), 275},
  {QMI_CAT_SEND_ENVELOPE_CMD_REQ_V02, QMI_IDL_TYPE16(0, 9), 276},
  {QMI_CAT_GET_EVENT_REPORT_REQ_V02, QMI_IDL_TYPE16(0, 11), 8},
  {QMI_CAT_SEND_DECODED_TR_REQ_V02, QMI_IDL_TYPE16(0, 13), 632},
  {QMI_CAT_SEND_DECODED_ENVELOPE_CMD_REQ_V02, QMI_IDL_TYPE16(0, 15), 2825},
...
static const qmi_idl_service_message_table_entry cat_service_response_messages_v02[] = {
  ...
  {QMI_CAT_SEND_TR_RESP_V02, QMI_IDL_TYPE16(0, 8), 275},
  {QMI_CAT_SEND_EVENLOPE_CMD_RESP_V02, QMI_IDL_TYPE16(0, 10), 275},
  {QMI_CAT_GET_EVENT_REPORT_RESP_V02, QMI_IDL_TYPE16(0, 12), 65535},
  {QMI_CAT_SEND_DECODED_TR_RESP_V02, QMI_IDL_TYPE16(0, 14), 275},
  {QMI_CAT_SEND_DECODED_ENVELOPE_CMD_RESP_V02, QMI_IDL_TYPE16(0, 16), 2621},
...
static const qmi_idl_service_message_table_entry cat_service_indication_messages_v02[] = {
  ...
  {QMI_CAT_SEND_TR_IND_V02, QMI_IDL_TYPE16(0, 40), 275},
  {QMI_CAT_SEND_EVENLOPE_CMD_IND_V02, QMI_IDL_TYPE16(0, 41), 275},
  {QMI_CAT_SEND_DECODED_TR_IND_V02, QMI_IDL_TYPE16(0, 42), 275},
  {QMI_CAT_SEND_DECODED_ENVELOPE_CMD_IND_V02, QMI_IDL_TYPE16(0, 43), 2621},
