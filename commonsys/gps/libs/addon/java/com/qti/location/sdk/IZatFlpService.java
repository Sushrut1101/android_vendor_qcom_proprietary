...
/** @addtogroup IZatFlpService
    ...
    public abstract class IzatFlpRequest {
        ...
        /**
         * Sets the power mode, integer between 1 and 5.
         * This power mode is used for foreground sessions.
         *
         * This function enables applications to set the exact power mode to be used
         * for foreground tracking sessions.
         * Valid power mode values are from 1 to 5.
         * 1 being the highest power mode, 5 being the lowest.
         *
         * @param powerMode power mode to be used for the foreground request,
         *         which must be in the range [1,5], otherwise a
         *         {@link IZatIllegalArgumentException} is thrown.
         * @throws IZatIllegalArgumentException Power Mode is < 1 or > 5
         * @return
         * None.
         */
        ...
        /**
         * Gets the power mode that has been set.
         *
         * This function enables applications to get the power mode that has
         * been set in the FLP request. It returns 0 if the power mode
         * is not set.
         *
         * @return The distance of displacement in meters.
         */
        ...
        /**
         * Sets the time between measurements (tbm) interval, in milliseconds.
         *
         * This function enables applications to set the time between measurements interval
         * in the FLP request. The tbm interval is applicable only when a valid power mode is
         * specified in the FLP request.
         *
         * @param tbmMillis Time between measurements interval in milliseconds,
         *         which must be greater than zero, otherwise a
         *         {@link IZatIllegalArgumentException} is thrown.
         * @throws IZatIllegalArgumentException TBM interval is less than or equal to zero.
         * @return
         * None.
         */
        ...
        /**
         * Gets the time between measurements interval that has been set.
         *
         * This function enables applications to get the time between measurements
         * interval that has been set in the FLP request.
         * It returns 0 if the time interval is not set.
         *
         * @return The time between measurements interval in milliseconds.
         */
