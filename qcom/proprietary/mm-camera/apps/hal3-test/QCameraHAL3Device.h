...
public:
    ...
    bool IsVideoStream(int index);
    bool IsPreviewStream(int index);
    bool IsSnapShotStream(int index);
    bool IsRawStream(int index);
    bool IsJPEGSnapshotStream(int index);
