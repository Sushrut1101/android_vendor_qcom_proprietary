  ...
  */
       ...
       int mobDataEnablVal = imsConfig.getProvisionedValue(ImsConfig.ConfigConstants.MOBILE_DATA_ENABLED);
        if(mobDataEnablVal == 1)
          ...
          Settings.isMobile_data_enabled = false;
             Log.d("PRESENCE_UI", " imsconfigsettings isMobile_data_enabled " + mobDataEnablVal);
            ...
            if (AppGlobalState.getIqRcsService() != null)
            {
                ...
                if (AppGlobalState.getPresenceSerrviceHandle() != 0)
                {
                    ...
                    if (AppGlobalState.getPresenceListenerHandle() != null
                            && AppGlobalState.getPresenceService() != null
  ...
  void releaseServices() {
    ...
    if (AppGlobalState.getIqRcsService() != null) {
      ...
      // PresenceService
      if (AppGlobalState.getPresenceSerrviceHandle() != 0 && AppGlobalState.getPresenceService() != null) {
