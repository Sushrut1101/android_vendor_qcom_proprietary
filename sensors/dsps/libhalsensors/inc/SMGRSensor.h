...
#define CAL_MAG_FILTER_LENGTH (8)
#define CAL_MAG_AXES (3)
...
protected:
    ...
    bool bRawDataMode;
    /* Result of registry request */
    uint8_t  reg_value[SNS_MAX_REGISTRY_REQUEST_SIZE];
    /* Length of reg value to read */
    uint8_t  reg_req_len;
/*===========================================================================
...
/*===========================================================================
  FUNCTION:  processRegResp
    ...
    @msg_ptr : sensor1 message data
===========================================================================*/
    static void processRegResp(Sensor** mSensors, sensor1_msg_header_s *msg_hdr,
            void *msg_ptr);
/*===========================================================================
...
===========================================================================*/
    bool registryReadReq(uint16_t reg_item_id, uint8_t len );
...
void SMGRSensor_sensor1_cb (intptr_t cb_data,
                     ...
                     void *msg_ptr);
/*==========================================================================
   FUNCTION: getHandleFromInd
     get the handle from sensor periodic report data.
     Parameters
         @ReportId : sensor periodic report data report ID
         @DataType : sensor periodic report data data type
         @SensorId : sensor periodic report data sensor Id
===========================================================================*/
