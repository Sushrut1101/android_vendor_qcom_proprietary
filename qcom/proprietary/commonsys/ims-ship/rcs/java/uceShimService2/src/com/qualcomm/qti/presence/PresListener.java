...
import com.qualcomm.qti.uceservice.V2_1.IPresenceListener;
import com.qualcomm.qti.uceservice.V2_0.PresPublishTriggerType;
import com.qualcomm.qti.uceservice.V2_0.PresSubscriptionState;
...
public class PresListener extends IPresenceListener.Stub
{
    ...
    public void onPublishTrigger(int publishTrigger)
        ...
        PresListenerRunnable runnable = new PresListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();
        Log.d(logTAG,"onPublishTrigger: " + publishTrigger);
    ...
    @Override
    public void onPublishTrigger_2_1(int publishTrigger)
                throws RemoteException {

        //enums are backwards compatible, no change is needed
        onPublishTrigger(publishTrigger);
    }

    @Override
    public void cmdStatus(
            com.qualcomm.qti.uceservice.V2_0.PresCmdStatus pCmdStatus) throws RemoteException {
    ...
    public void onSipResponseReceived(
            com.qualcomm.qti.uceservice.V2_0.PresSipResponse pSipResponse) throws RemoteException {
    ...
    public void onCapInfoReceived(
            ...
            ArrayList<com.qualcomm.qti.uceservice.V2_0.PresTupleInfo> pTupleInfoArray)
            throws RemoteException {
        PresListenerRunnable runnable = new PresListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();
    ...
    public void onListCapInfoReceived(
            com.qualcomm.qti.uceservice.V2_0.PresRlmiInfo pRlmiInfo,
            ArrayList<com.qualcomm.qti.uceservice.V2_0.PresResInfo> pResInfoArray)
            throws RemoteException {
