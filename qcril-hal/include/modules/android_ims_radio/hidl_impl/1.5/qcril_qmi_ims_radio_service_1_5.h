 ...
 */
class ImsRadioImpl_1_5 : public ImsRadioImplBase,
                         public V1_5::IImsRadio,
                         public hidl_death_recipient {
 private:
  sp<V1_4::implementation::ImsRadioImpl_1_4> mBaseImsRadioImpl;
  qtimutex::QtiSharedMutex mCallbackLock;
  sp<V1_5::IImsRadioResponse> mImsRadioResponseCbV1_5;
  sp<V1_5::IImsRadioIndication> mImsRadioIndicationCbV1_5;

  sp<V1_5::IImsRadioResponse> getResponseCallbackV1_5();
  sp<V1_5::IImsRadioIndication> getIndicationCallbackV1_5();

 public:
  ImsRadioImpl_1_5(qcril_instance_id_e_type instance);
  ~ImsRadioImpl_1_5();
  ...
  void notifyOnUssdMessageFailed(
  ...
  Return<void> emergencyDial(int32_t token,
                             ...
                             bool isTesting);
  Return<void> sendImsSms(int32_t token,
                          const V1_2::ImsSmsMessage &imsSms);
 ...
 private:
  void sendSetCallForwardStatusResponse(int32_t token, uint32_t errorCode,
