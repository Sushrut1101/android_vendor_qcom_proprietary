#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_IRADIOINDICATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_IRADIOINDICATION_H
...
struct IRadioIndication : public ::android::hardware::radio::V1_2::IRadioIndication {
    ...
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_3::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadioIndication>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_3::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadioIndication>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_3::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_3::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_3::IRadioIndication>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_3::IRadioIndication>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_3::IRadioIndication>& o) {
    ...
    os += ::android::hardware::radio::V1_3::IRadioIndication::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_IRADIOINDICATION_H
