...
/*
 * Function     : icm_wal_get_radio_chan_rf_characterization_info
...
#ifdef ICM_RTR_DRIVER
        return icm_wal_rtrcfg_get_radio_chan_rf_characterization_info(picm);
#else
        /* This is not currently required for MBL config */
        return SUCCESS
#endif /* ICM_RTR_DRIVER */
    } else {
        return -1;
