IMX258_MONO_GT24C32_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_imx258_gt24c32_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(IMX258_MONO_GT24C32_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= imx258_mono_gt24c32_eeprom.c
