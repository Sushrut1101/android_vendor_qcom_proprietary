...
#endif
//To indicate if the logmask is initialized or not
#ifndef MM_MSG_MASK_INIT
#define MM_MSG_MASK_INIT (MM_PRIO_DEBUG << 1)
#endif
...
/////////////////////////////////////////////////////////////////////////////////
#ifndef ANDROID
#define LOGE(...) {printf("%s [%d]",__FUNCTION__,__LINE__);printf(__VA_ARGS__);printf("\n");}
#endif
...
#define MM_MSG_PRIO_EX(a,b,c,...)            (((b & GetLogMask(a)))?(LOGE((c),##__VA_ARGS__)), 1 : 0)
...
typedef enum CTX {OSAL_SYS_CTX, OSAL_VND_CTX} osal_ctx;
...
/**
 * Initializes the Diag Interface for logging based on file read
 *
