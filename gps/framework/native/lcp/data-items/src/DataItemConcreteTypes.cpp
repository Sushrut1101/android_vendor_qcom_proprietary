...
#define COPIER_ERROR_CHECK_AND_DOWN_CAST(T,ID) \
   ...
   T##Base * d = static_cast<T##Base *>(src);
...
DATA_ITEM_SERIALIZE(NetworkInfoDataItem) {
    ...
    do {
        ...
        BREAK_AND_DELETE_IF_NON_ZERO(
                13, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_0,
                        (d->mAllNetworkHandles[0].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                14, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_1,
                        (d->mAllNetworkHandles[1].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                15, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_2,
                        (d->mAllNetworkHandles[2].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                16, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_3,
                        (d->mAllNetworkHandles[3].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                17, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_4,
                        (d->mAllNetworkHandles[4].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                18, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_5,
                        (d->mAllNetworkHandles[5].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                19, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_6,
                        (d->mAllNetworkHandles[6].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                20, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_7,
                        (d->mAllNetworkHandles[7].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                21, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_8,
                        (d->mAllNetworkHandles[8].toString().c_str())), ic);
        BREAK_AND_DELETE_IF_NON_ZERO(
                22, card->addString(NETWORKINFO_FIELD_NETWORKHANDLE_9,
                        (d->mAllNetworkHandles[MAX_NETWORK_HANDLES - 1].toString().c_str())), ic);
        ADD_INNER_CARD();
    } while(0);
    EXIT_LOG_WITH_ERROR("%d",result);
    return result;
