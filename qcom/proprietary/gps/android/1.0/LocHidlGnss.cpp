...
Return<sp<ILocHidlAGnss>> LocHidlGnss::getExtensionLocHidlAGnss() {
...
Return<sp<ILocHidlDebugReportService>> LocHidlGnss::getExtensionLocHidlDebugReportService() {
...
Return<sp<ILocHidlFlpService>> LocHidlGnss::getExtensionLocHidlFlpService() {
...
Return<sp<ILocHidlGeofenceService>> LocHidlGnss::getExtensionLocHidlGeofenceService() {
...
Return<sp<ILocHidlIzatProvider>> LocHidlGnss::getExtensionLocHidlIzatNetworkProvider() {
...
Return<sp<ILocHidlIzatProvider>> LocHidlGnss::getExtensionLocHidlIzatFusedProvider() {
...
Return<sp<ILocHidlGnssNi>> LocHidlGnss::getExtensionLocHidlGnssNi() {
...
Return<sp<ILocHidlIzatOsNpGlue>> LocHidlGnss::getExtensionLocHidlIzatOsNpGlue() {
...
Return<sp<ILocHidlIzatSubscription>> LocHidlGnss::getExtensionLocHidlIzatSubscription() {
...
Return<sp<ILocHidlRilInfoMonitor>> LocHidlGnss::getExtensionLocHidlRilInfoMonitor() {
...
Return<sp<ILocHidlXT>> LocHidlGnss::getExtensionLocHidlXT() {
...
Return<sp<ILocHidlWiFiDBReceiver>> LocHidlGnss::getExtensionLocHidlWiFiDBReceiver() {
