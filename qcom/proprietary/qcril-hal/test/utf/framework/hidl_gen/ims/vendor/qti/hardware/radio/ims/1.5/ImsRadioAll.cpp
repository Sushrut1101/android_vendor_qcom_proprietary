...
#define LOG_TAG "vendor.qti.hardware.radio.ims@1.5::ImsRadio"
...
const char* IImsRadio::descriptor("vendor.qti.hardware.radio.ims@1.5::IImsRadio");
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadio>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadio>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadio>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadio>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
  return ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio *>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>> mHidlServices;
...
::android::status_t IImsRadio::registerAsService(const std::string &serviceName) {
    ...
    ::vendor::qti::hardware::radio::ims::V1_4::IImsRadio::registerAsService(serviceName);
    return ::android::OK;
}
