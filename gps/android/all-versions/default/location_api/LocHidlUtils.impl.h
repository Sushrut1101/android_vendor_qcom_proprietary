...
LocHidlSubscriptionDataItemId_1_1
LocHidlUtils::translateToSubscriptionDataItemId_1_1(DataItemId id) {

    LocHidlSubscriptionDataItemId_1_1 ret =
            LocHidlSubscriptionDataItemId_1_1::INVALID_DATA_ITEM_ID;
    switch (id) {
        case AIRPLANEMODE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::AIRPLANEMODE_DATA_ITEM_ID;
            break;
        case ENH_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::ENH_DATA_ITEM_ID;
            break;
        case GPSSTATE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::GPSSTATE_DATA_ITEM_ID;
            break;
        case NLPSTATUS_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::NLPSTATUS_DATA_ITEM_ID;
            break;
        case WIFIHARDWARESTATE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::WIFIHARDWARESTATE_DATA_ITEM_ID;
            break;
        case NETWORKINFO_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::NETWORKINFO_DATA_ITEM_ID;
            break;
        case RILVERSION_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::RILVERSION_DATA_ITEM_ID;
            break;
        case RILSERVICEINFO_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::RILSERVICEINFO_DATA_ITEM_ID;
            break;
        case RILCELLINFO_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::RILCELLINFO_DATA_ITEM_ID;
            break;
        case SERVICESTATUS_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::SERVICESTATUS_DATA_ITEM_ID;
            break;
        case MODEL_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::MODEL_DATA_ITEM_ID;
            break;
        case MANUFACTURER_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::MANUFACTURER_DATA_ITEM_ID;
            break;
        case VOICECALL_DATA_ITEM :
            ret = LocHidlSubscriptionDataItemId_1_1::VOICECALL_DATA_ITEM;
            break;
        case ASSISTED_GPS_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::ASSISTED_GPS_DATA_ITEM_ID;
            break;
        case SCREEN_STATE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::SCREEN_STATE_DATA_ITEM_ID;
            break;
        case POWER_CONNECTED_STATE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::POWER_CONNECTED_STATE_DATA_ITEM_ID;
            break;
        case TIMEZONE_CHANGE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::TIMEZONE_CHANGE_DATA_ITEM_ID;
            break;
        case TIME_CHANGE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::TIME_CHANGE_DATA_ITEM_ID;
            break;
        case WIFI_SUPPLICANT_STATUS_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::WIFI_SUPPLICANT_STATUS_DATA_ITEM_ID;
            break;
        case SHUTDOWN_STATE_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::SHUTDOWN_STATE_DATA_ITEM_ID;
            break;
        case TAC_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::TAC_DATA_ITEM_ID;
            break;
        case MCCMNC_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::MCCMNC_DATA_ITEM_ID;
            break;
        case BTLE_SCAN_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::BTLE_SCAN_DATA_ITEM_ID;
            break;
        case BT_SCAN_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::BT_SCAN_DATA_ITEM_ID;
            break;
        case MAX_DATA_ITEM_ID :
            ret = LocHidlSubscriptionDataItemId_1_1::MAX_DATA_ITEM_ID;
            break;
        case BATTERY_LEVEL_DATA_ITEM_ID:
            ret = LocHidlSubscriptionDataItemId_1_1::BATTERY_LEVEL_DATA_ITEM_ID;
            break;
        case MAX_DATA_ITEM_ID_1_1:
            ret = LocHidlSubscriptionDataItemId_1_1::MAX_DATA_ITEM_ID_1_1;
            break;
        default:
            break;
    }
