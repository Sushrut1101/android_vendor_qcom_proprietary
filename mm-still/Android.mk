...
ifeq ($(call is-vendor-board-platform,QCOM),true)
  ...
  CODECV1_LIST += apq8084
  CODECV1_LIST += mpq8092
  CODECV1_LIST += msm_bronze
  CODECV1_LIST += msm8952
  CODECV1_LIST += msm8909
  CODECV1_LIST += msm8994
  CODECV1_LIST += msm8996
  CODECV1_LIST += msm8992
  CODECV1_LIST += msm8952
  CODECV1_LIST += msm8937
  CODECV1_LIST += msm8953
  CODECV1_LIST += apq8098_latv
  CODECV1_LIST += msm8998
  CODECV1_LIST += sdm660
  CODECV1_LIST += $(TRINKET)
  ...
  ifeq ($(call is-board-platform-in-list,$(CODECV1_LIST)),true)
    ifeq ($(call is-board-platform-in-list,msm8974 msm8916 msm8952 msm8226 msm8610 apq8084 mpq8092 msm_bronze msm8994 msm8996 msm8992 tellurium msm8909 msm8937 msm8953 sdm660 msm8998 apq8098_latv $(TRINKET)),true)
      JPEGD_VER := jpeg10
      JPEGE_VER := jpeg10
      FACT_VER := codecB
    ...
    ifeq ($(call is-chipset-prefix-in-board-platform,msm8974 msm8952 msm8610 apq8084 mpq8092 msm_bronze msm8916 tellurium msm8909 msm8937 msm8953),true)
      USES_GEMINI := false
      USES_MERCURY := false
