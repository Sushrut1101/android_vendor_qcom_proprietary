...
public:
    ...
    TrackingOptions getUserInputTrackingOptions(std::string prompt);
    ...
    void getUserInputGnssConfigBlacklistSvId(GnssConfig& config);
    GnssSvIdSource getUserInputGnssSvIdSource(std::string prompt);
    GnssSvType getUserInputGnssSvType(std::string prompt);
    GnssSvTypesMask getUserInputGnssSvTypesMask(std::string prompt);

    // Printing utils
    void printGnssConfigBlacklistSvId(const GnssConfig& config);

    // Conversion utils
    void convertGnssSvIdMaskToList(
