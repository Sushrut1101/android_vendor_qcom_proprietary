  ...
  jpegd_engine_hw_t *p_engine)
{
  ...
  if(!buffers_initialized) {
    ...
    p_engine->in_buf.alloc_ion.heap_id_mask = 0x1 << ION_IOMMU_HEAP_ID;
    ...
    p_engine->output_buf.alloc_ion.heap_id_mask = 0x1 << ION_IOMMU_HEAP_ID;
  ...
  ********************************************************************/
  ...
  char *output_filename = QCAMERA_DUMP_FRM_LOCATION"dec.yuv";
