...
public class RCSService extends Service {
    ...
    public static com.qualcomm.qti.uceservice.V2_0.IUceService mHidlService = null;
    public static com.qualcomm.qti.uceservice.V2_1.IUceService mHidlService_2_1 = null;
    ...
    private com.qualcomm.qti.uceservice.V2_0.IUceListener iQRCSListener = null;//hidl UceListener
   ...
   private Handler mHandler;
    ...
    private IHwBinder.DeathRecipient mDeathRecipient = new IHwBinder.DeathRecipient() {
        ...
        public void serviceDied(long cookie) {
            ...
            if (cookie == mDeathBinderCookie) {
                try {
                    if (mHidlService_2_1 != null) {
                        mHidlService_2_1.unlinkToDeath(mDeathRecipient);
                    }
                    else {
                    ...
                    if(mIServiceManager != null) {
                        ...
                        if( mIServiceManager == null ) {
                            ...
                            if (!mIServiceManager.registerForNotifications(
                                UCE_SERVICE_VERSION2_1,
                                UCE_HIDL_SERVICE_NAME,
    ...
    synchronized private void startService() {
        if( !isServiceStarted ) {
            Log.i(logTAG, "Attempting to get HIDL-IUceService V2_1");
            try {
                mHidlService_2_1 = com.qualcomm.qti.uceservice.V2_1.IUceService.getService(
                                                         "com.qualcomm.qti.uceservice");
            }
            catch (java.util.NoSuchElementException nSE) {
                try {
                    mHidlService = com.qualcomm.qti.uceservice.V2_0.IUceService.getService(
                                                         "com.qualcomm.qti.uceservice");
                } catch (RemoteException e) {
                    Log.i(logTAG, "Caught Exception:", e);
                }
                catch(java.util.NoSuchElementException nSEE) {
                    Log.i(logTAG, "Caught Exception: Service not Registered yet", nSEE);
                    registerForHidlServiceNotifications();
                }
                catch (Exception e) {
                    Log.i(logTAG, "Caught Exception:", e);
            ...
            if(mHidlService_2_1 != null) {
                ...
                Log.i(logTAG, "Received HIDL-UCEService V2_1");
                if (objQRCSServiceStub != null && objQRCSServiceStub.setHidlUceSerice(mHidlService_2_1)) {
                    try {
                        mHidlService_2_1.addUceListener(mHidlUceListener);
                    ...
                    try{
                        ...
                        boolean isLinkSuccesful= mHidlService_2_1.linkToDeath(mDeathRecipient,
                                                                     mDeathBinderCookie);
                ...
                if (objQRCSServiceStub != null && objQRCSServiceStub.setHidlUceSerice(mHidlService)) {                    try {
