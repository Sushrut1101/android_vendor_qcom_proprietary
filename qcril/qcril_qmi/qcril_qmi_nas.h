...
int qcril_qmi_nas_signal_strength_con_conv_cache2ril_ncl(RIL_SignalStrength* ril_msg);
...
/*=========================================================================
  FUNCTION:  QCRIL_EVT_DATA_DDS_STATUS_FOLLOW_UP
===========================================================================*/
...
===========================================================================*/
RIL_Errno qcril_qmi_nas_set_dds_through_data_layer
(
    int dds_sub
);
