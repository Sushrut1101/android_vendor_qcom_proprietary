...
)
{
  ...
  for( i=0; i<num_flows; i++ )
  {
    ...
    QCRIL_DATA_RELEASE_STORAGE( flow_ptr )
  ...
  *tx_flow_str = *rx_flow_str = NULL;
  ...
  if( qos_info_ptr->tx_granted_flow_data_is_valid )
  {
    ...
    if( NULL == parse_ptr )
    {
      ...
      QCRIL_DATA_RELEASE_STORAGE( *tx_flow_str )
      goto err_label;
    }
  ...
  if( qos_info_ptr->rx_granted_flow_data_is_valid )
  {
    ...
    if( NULL == parse_ptr )
    {
      ...
      QCRIL_DATA_RELEASE_STORAGE( *rx_flow_str )
      goto err_label;
    }
...
)
{
  ...
  if( SUCCESS != qcril_data_parse_qos_spec( params_ptr, qos_spec_ptr, &context, records ) )
  {
    ...
    ril_req_res = RIL_E_ENCODING_ERR;
    goto err_label;
  }
...
err_label2:
  ...
  if( SUCCESS != ret )
  {
    ...
    asprintf( &response.qos_resp.setup.return_code, "%d", ril_req_res );
    qcril_data_response_success( instance_id,
                                 params_ptr->t,
                                 params_ptr->event_id,
                                 &response.qos_resp,
...
err_label:
  ...
  if( SUCCESS != ret )
  {
    ...
    asprintf( &response.qos_resp.result.return_code, "%d", ril_req_res );
    qcril_data_response_success( instance_id,
                                 params_ptr->t,
                                 params_ptr->event_id,
                                 &response.qos_resp,
...
)
{
 ...
 err_label:
  ...
  if( SUCCESS != ret )
  {
    ...
    asprintf( &response.qos_resp.get_status.return_code, "%d", ril_req_res );
    qcril_data_response_success( instance_id,
                                 params_ptr->t,
                                 params_ptr->event_id,
                                 &response.qos_resp,
