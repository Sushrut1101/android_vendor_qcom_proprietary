...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/uim/api/user_identity_module_v01.h#36 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define UIM_V01_IDL_MINOR_VERS 0x5A
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0073
/**
    @}
  */
...
#define UIM_GET_CONFIGURATION_INACTIVE_SIMLOCK_CONFIG_V01 ((uim_get_configuration_mask_v01)0x0200) /**<  Inactive SIMLOCK config  */
/** @addtogroup uim_qmi_messages
    @{
  */
...
typedef struct {
  ...
  /**<   Requested configurations:\n
      ...
      - UIM_GET_CONFIGURATION_INACTIVE_SIMLOCK_CONFIG (0x0200) --  Inactive SIMLOCK config 
 \n
...
typedef struct {
  ...
  uint8_t config_id;
  /**<   Config id for inactive simlock configuration.*/
  ...
  /**<   Config nickname for operator corresponds to inactive simlock configuration.*/
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Activates SIMLOCK categories associated with config id */
typedef struct {

  /* Mandatory */
  /*  Config Id */
  uint8_t config_id;
  /**<   SIMLOCK categories corresponds to config id to be activated */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Activates SIMLOCK categories associated with config id */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Returns token associated with enabled SIMLOCK categories. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef struct {
  ...
  /**<   Token associated with enabled SIMLOCK category.*/
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Returns token associated with enabled SIMLOCK categories. */
typedef struct {
