#define LOG_TAG "android.hardware.radio@1.1::RadioResponse"
#undef UNUSED
...
const char* IRadioResponse::descriptor("android.hardware.radio@1.1::IRadioResponse");
...
// static 
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::IRadioResponse>> IRadioResponse::castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadioResponse>& parent, bool /* emitError */) {
    return parent;
}

// static 
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::IRadioResponse>> IRadioResponse::castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadioResponse>& parent, bool emitError) {
    return ::android::sp<::android::hardware::radio::V1_1::IRadioResponse>(static_cast<::android::hardware::radio::V1_1::IRadioResponse*>(parent.get()));
}

// static 
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::IRadioResponse>> IRadioResponse::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::android::hardware::radio::V1_1::IRadioResponse>(static_cast<::android::hardware::radio::V1_1::IRadioResponse*>(parent.get()));
}
