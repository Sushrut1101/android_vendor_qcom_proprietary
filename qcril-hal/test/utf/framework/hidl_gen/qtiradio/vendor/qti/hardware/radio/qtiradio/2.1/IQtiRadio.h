...
*/
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_1_IQTIRADIO_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_1_IQTIRADIO_H
...
struct IQtiRadio : public ::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadio {
    ...
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadio>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& o);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& o) {
    ...
    os += ::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_QTIRADIO_V2_1_IQTIRADIO_H
