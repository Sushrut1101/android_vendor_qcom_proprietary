...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Fri Feb 28 2020 (Spin 0)
...
static const uint8_t wlfw_ind_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, hang_event_ind_msg) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, hang_event_ind_msg_valid)),
  0x21,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, hang_event_ind_msg)
};
...
static const uint8_t wlfw_cap_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, eeprom_caldata_read_timeout) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, eeprom_caldata_read_timeout_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
...
/*
 * wlfw_exit_power_save_req_msg is empty
 * static const uint8_t wlfw_exit_power_save_req_msg_data_v01[] = {
 * };
 */

static const uint8_t wlfw_exit_power_save_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_exit_power_save_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_hang_event_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_hang_event_ind_msg_v01, data) - QMI_IDL_OFFSET8(wlfw_hang_event_ind_msg_v01, data_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_hang_event_ind_msg_v01, data),
  ((QMI_WLFW_MAX_HANG_EVT_SIZE_V01) & 0xFF), ((QMI_WLFW_MAX_HANG_EVT_SIZE_V01) >> 8),
  QMI_IDL_OFFSET8(wlfw_hang_event_ind_msg_v01, data) - QMI_IDL_OFFSET8(wlfw_hang_event_ind_msg_v01, data_len)
};
...
static const qmi_idl_message_table_entry wlfw_message_table_v01[] = {
  ...
  {sizeof(wlfw_exit_power_save_req_msg_v01), 0},
  {sizeof(wlfw_exit_power_save_resp_msg_v01), wlfw_exit_power_save_resp_msg_data_v01},
  {sizeof(wlfw_hang_event_ind_msg_v01), wlfw_hang_event_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_command_messages_v01[] = {
  {QMI_WLFW_IND_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 0), 78},
  ...
  {QMI_WLFW_WFC_CALL_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 68), 261},
  ...
  {QMI_WLFW_EXIT_POWER_SAVE_REQ_V01, QMI_IDL_TYPE16(0, 80), 0}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_response_messages_v01[] = {
  ...
  {QMI_WLFW_CAP_RESP_V01, QMI_IDL_TYPE16(0, 10), 235},
  ...
  {QMI_WLFW_EXIT_POWER_SAVE_RESP_V01, QMI_IDL_TYPE16(0, 81), 7}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_indication_messages_v01[] = {
  ...
  {QMI_WLFW_HANG_EVENT_IND_V01, QMI_IDL_TYPE16(0, 82), 789}
};
