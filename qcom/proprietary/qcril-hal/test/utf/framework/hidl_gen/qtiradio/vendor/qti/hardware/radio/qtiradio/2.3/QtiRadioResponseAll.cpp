...
*/
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.3::QtiRadioResponse"
...
const char* IQtiRadioResponse::descriptor("vendor.qti.hardware.radio.qtiradio@2.3::IQtiRadioResponse");
...
::android::hardware::Return<void> IQtiRadioResponse::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_2::IQtiRadioResponse>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse*>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadioResponse>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse*>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadioResponse>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse*>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadioResponse>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse*>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>> IQtiRadioResponse::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_3::IQtiRadioResponse*>(parent.get()));
}
