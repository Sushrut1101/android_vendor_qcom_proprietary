...
typedef enum qdp_ril_param_idx_e
{
  ...
  QDP_RIL_AUTH = 5,
  QDP_RIL_IP_FAMILY = 6,
  QDP_RIL_IP_ROAMING = 7,
  QDP_RIL_APN_TYPE_BITMASK = 8,
  QDP_RIL_PARAM_MAX = 9
} qdp_ril_param_idx_t;
...
typedef enum qdp_calling_func_e
{
  ...
  QDP_PROFILE_LOOKUP_FOR_SETUP_EMERGENCY_DATA_CALL = 3
} qdp_calling_func_t;
...
*/
/*=========================================================================*/
int qdp_init2(const char * default_port, boolean isAPAssist);
