...
public class WigigMonitor {
    ...
    private static final String SOFTAP_DEVICE_INTERFACE = "wigig0";
   ...
   /* Network connection completed */
    ...
    public static final int AP_NON_P2P_STA_CONNECTED_EVENT       = BASE + 50;
    public static final int AP_NON_P2P_STA_DISCONNECTED_EVENT    = BASE + 51;
    ...
    public void setHostapdOverride(boolean override)
    {
        WigigMonitorSingleton.sInstance.setHostapdOverride(override);
    }
    ...
    private static class WigigMonitorSingleton {
        ...
        private boolean mHostapdOverride;
        ...
        public void setHostapdOverride(boolean override)
        {
            mHostapdOverride = override;
        }

        public boolean getHostapdOverride()
        {
            return mHostapdOverride;
        }
        ...
        private synchronized boolean dispatchEvent(String eventStr) {
            ...
            if (eventStr.startsWith("IFNAME=")) {
                ...
                // events without prefix belong to either softap or p2p-dev-wigig0 monitor
                iface = mHostapdOverride ? SOFTAP_DEVICE_INTERFACE : P2P_DEVICE_INTERFACE;
            }
    ...
    private void handleHostApEvents(String dataString) {
        ...
        if (tokens[0].equals(AP_STA_CONNECTED_STR)) {
            if (WigigMonitorSingleton.sInstance.getHostapdOverride())
                mStateMachine.sendMessage(AP_NON_P2P_STA_CONNECTED_EVENT, tokens[1]);
            else
        ...
        /* AP-STA-DISCONNECTED 42:fc:89:a8:96:09 p2p_dev_addr=02:90:4c:a0:92:54 */
            ...
            if (WigigMonitorSingleton.sInstance.getHostapdOverride())
                mStateMachine.sendMessage(AP_NON_P2P_STA_DISCONNECTED_EVENT, tokens[1]);
            else
