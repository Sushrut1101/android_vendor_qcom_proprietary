...
/*===========================================================================
  ...
  Copyright (c) 2010-2012, 2014, 2016 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#else
#define QCRIL_UIM_RIL_E_NO_MEMORY                   RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_INTERNAL_ERR                RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_SYSTEM_ERR                  RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_MODEM_ERR                   RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_NO_RESOURCES                RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_SIM_ERR                     RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_INVALID_ARGUMENTS           RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_INVALID_SIM_STATE           RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_SIM_ABSENT                  RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_PASSWORD_INCORRECT          RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_SIM_PIN2                    RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_INVALID_MODEM_STATE         RIL_E_GENERIC_FAILURE
#define QCRIL_UIM_RIL_E_OPERATION_NOT_ALLOWED       RIL_E_GENERIC_FAILURE
#endif
