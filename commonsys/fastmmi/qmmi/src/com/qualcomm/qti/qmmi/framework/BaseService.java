...
public abstract class BaseService extends Service {
    ...
    public void updateResultForCase(Bundle bundle) {
         ...
         */
        LogUtils.logi("case: " + testCase.getName() + " launchMode:" + testCase.getLaunchMode());
    ...
    private void prepareThread(Intent intent){
        ...
        //Create one new thread for each group.
        ...
        if (mServiceManager != null) {
            if (mServiceManager.getServiceHandler(groupName) == null){
                LogUtils.logi("create new thread for:" + groupName);
                HandlerThread thread = new HandlerThread(groupName);
                thread.start();
                ServiceHandler serviceHandler = new ServiceHandler(thread.getLooper());
                mServiceManager.addServiceHandler(groupName, serviceHandler);
