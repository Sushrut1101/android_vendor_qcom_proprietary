...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/uim/src/user_identity_module_v01.c#36 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue Apr 30 2019 (Spin 0)
...
static const uint8_t uim_gw_sp_ext_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_sp_ext_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_sp_ext_perso_type_v01, gid1),
  QMI_UIM_GID_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_sp_ext_perso_type_v01, gid1) - QMI_IDL_OFFSET8(uim_gw_sp_ext_perso_type_v01, gid1_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_gw_corporate_ext_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, gid1),
  QMI_UIM_GID_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, gid1) - QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, gid1_len),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, gid2),
  QMI_UIM_GID_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, gid2) - QMI_IDL_OFFSET8(uim_gw_corporate_ext_perso_type_v01, gid2_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_bsf_information_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_bsf_information_type_v01, protocol),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(uim_bsf_information_type_v01, port),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_bsf_information_type_v01, address),
  QMI_UIM_FQDN_MAX_V01,
  QMI_IDL_OFFSET8(uim_bsf_information_type_v01, address) - QMI_IDL_OFFSET8(uim_bsf_information_type_v01, address_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_perso_feature_control_key_present_type_data_v01[] = {
  QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_perso_feature_control_key_present_type_v01, feature),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_perso_feature_control_key_present_type_v01, ck_present),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_perso_control_key_present_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_perso_control_key_present_type_v01, feature_control_key_present),
  QMI_UIM_PERSO_FEATURE_MAX_V01,
  QMI_IDL_OFFSET8(uim_perso_control_key_present_type_v01, feature_control_key_present) - QMI_IDL_OFFSET8(uim_perso_control_key_present_type_v01, feature_control_key_present_len),
  QMI_IDL_TYPE88(0, 58),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_terminal_capability_tlv_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_type_v01, tag),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_type_v01, value),
  QMI_UIM_TERMINAL_CAPABILITY_VALUE_MAX_V01,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_type_v01, value) - QMI_IDL_OFFSET8(uim_terminal_capability_tlv_type_v01, value_len),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_type_v01, remove_tlv),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_terminal_capability_tlv_resp_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_resp_type_v01, tag),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_resp_type_v01, value),
  QMI_UIM_TERMINAL_CAPABILITY_VALUE_MAX_V01,
  QMI_IDL_OFFSET8(uim_terminal_capability_tlv_resp_type_v01, value) - QMI_IDL_OFFSET8(uim_terminal_capability_tlv_resp_type_v01, value_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_gw_spn_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_spn_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_spn_perso_type_v01, spn),
  QMI_UIM_GW_SPN_LEN_V01,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_gw_sp_ext2_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_sp_ext2_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_sp_ext2_perso_type_v01, gid1),
  QMI_UIM_GID_EXT_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_sp_ext2_perso_type_v01, gid1) - QMI_IDL_OFFSET8(uim_gw_sp_ext2_perso_type_v01, gid1_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_gw_corporate_ext2_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, gid1),
  QMI_UIM_GID_EXT_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, gid1) - QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, gid1_len),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, gid2),
  QMI_UIM_GID_EXT_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, gid2) - QMI_IDL_OFFSET8(uim_gw_corporate_ext2_perso_type_v01, gid2_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_gw_sp_ehplmn_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_sp_ehplmn_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_sp_ehplmn_perso_type_v01, gid1),
  QMI_UIM_GID_EXT_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_sp_ehplmn_perso_type_v01, gid1) - QMI_IDL_OFFSET8(uim_gw_sp_ehplmn_perso_type_v01, gid1_len),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_sp_ehplmn_perso_type_v01, ehplmn),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_gw_iccid_perso_type_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gw_iccid_perso_type_v01, network),
  QMI_IDL_TYPE88(0, 41),
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gw_iccid_perso_type_v01, iccid),
  QMI_UIM_ICCID_DIGIT_MAX_V01,
  QMI_IDL_OFFSET8(uim_gw_iccid_perso_type_v01, iccid) - QMI_IDL_OFFSET8(uim_gw_iccid_perso_type_v01, iccid_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t profile_policy_info_data_v01[] = {
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(profile_policy_info_v01, profile_policy_mask),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(profile_policy_info_v01, user_consent_needed),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_plmn_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_plmn_type_v01, mcc),
  QMI_UIM_MCC_LEN_V01,

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_plmn_type_v01, mnc),
  QMI_UIM_MNC_MAX_V01,
  QMI_IDL_OFFSET8(uim_plmn_type_v01, mnc) - QMI_IDL_OFFSET8(uim_plmn_type_v01, mnc_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_plmn_list_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_plmn_list_type_v01, plmn_data),
  QMI_UIM_PLMN_NUM_MAX_V01,
  QMI_IDL_OFFSET8(uim_plmn_list_type_v01, plmn_data) - QMI_IDL_OFFSET8(uim_plmn_list_type_v01, plmn_data_len),
  QMI_IDL_TYPE88(0, 68),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_imsi_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_imsi_type_v01, mcc),
  QMI_UIM_MCC_LEN_V01,

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_imsi_type_v01, mnc),
  QMI_UIM_MNC_MAX_V01,
  QMI_IDL_OFFSET8(uim_imsi_type_v01, mnc) - QMI_IDL_OFFSET8(uim_imsi_type_v01, mnc_len),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_imsi_type_v01, msin),
  QMI_UIM_MSIN_MAX_V01,
  QMI_IDL_OFFSET8(uim_imsi_type_v01, msin) - QMI_IDL_OFFSET8(uim_imsi_type_v01, msin_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_send_apdu_long_request_type_data_v01[] = {
  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(uim_send_apdu_long_request_type_v01, total_length),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_send_apdu_long_request_type_v01, token),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(uim_send_apdu_long_request_type_v01, offset),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_read_ber_tlv_result_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_result_type_v01, content),
  ((QMI_UIM_BER_TLV_CONTENT_MAX_V01) & 0xFF), ((QMI_UIM_BER_TLV_CONTENT_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(uim_read_ber_tlv_result_type_v01, content) - QMI_IDL_OFFSET8(uim_read_ber_tlv_result_type_v01, content_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_read_ber_tlv_long_response_chunk_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_long_response_chunk_type_v01, long_data_token),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_long_response_chunk_type_v01, total_length),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_long_response_chunk_type_v01, offset),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_long_response_chunk_type_v01, read_result),
  QMI_IDL_TYPE88(0, 72),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_remote_unlock_version_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_remote_unlock_version_type_v01, major_version),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_remote_unlock_version_type_v01, minor_version),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_physical_slot_information_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_physical_slot_information_type_v01, card_protocol),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_physical_slot_information_type_v01, num_app),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_physical_slot_information_type_v01, atr_value),
  QMI_UIM_ATR_MAX_V01,
  QMI_IDL_OFFSET8(uim_physical_slot_information_type_v01, atr_value) - QMI_IDL_OFFSET8(uim_physical_slot_information_type_v01, atr_value_len),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_physical_slot_information_type_v01, is_euicc),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_slot_eid_info_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_slot_eid_info_type_v01, eid),
  QMI_UIM_EID_LEN_V01,
  QMI_IDL_OFFSET8(uim_slot_eid_info_type_v01, eid) - QMI_IDL_OFFSET8(uim_slot_eid_info_type_v01, eid_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_extended_card_info_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_extended_card_info_type_v01, iccid),
  QMI_UIM_ICCID_LEN_MAX_V01,
  QMI_IDL_OFFSET8(uim_extended_card_info_type_v01, iccid) - QMI_IDL_OFFSET8(uim_extended_card_info_type_v01, iccid_len),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_extended_card_info_type_v01, atr),
  QMI_UIM_ATR_DATA_MAX_V01,
  QMI_IDL_OFFSET8(uim_extended_card_info_type_v01, atr) - QMI_IDL_OFFSET8(uim_extended_card_info_type_v01, atr_len),

  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_extended_card_info_type_v01, eid),
  QMI_UIM_EID_LEN_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_extended_card_info_type_v01, eid) - QMI_IDL_OFFSET16RELATIVE(uim_extended_card_info_type_v01, eid_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_inactive_simlock_config_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_inactive_simlock_config_type_v01, config_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_inactive_simlock_config_type_v01, config_nickname),
  QMI_UIM_CONFIG_NICKNAME_MAX_V01,
  QMI_IDL_OFFSET8(uim_inactive_simlock_config_type_v01, config_nickname) - QMI_IDL_OFFSET8(uim_inactive_simlock_config_type_v01, config_nickname_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_simlock_token_feature_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_simlock_token_feature_type_v01, token),
  QMI_UIM_TOKEN_LEN_V01,
  QMI_IDL_OFFSET8(uim_simlock_token_feature_type_v01, token) - QMI_IDL_OFFSET8(uim_simlock_token_feature_type_v01, token_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_simlock_token_slot_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_simlock_token_slot_type_v01, feature),
  QMI_UIM_PERSO_FEATURE_MAX_V01,
  QMI_IDL_OFFSET8(uim_simlock_token_slot_type_v01, feature) - QMI_IDL_OFFSET8(uim_simlock_token_slot_type_v01, feature_len),
  QMI_IDL_TYPE88(0, 79),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t uim_extended_card_state_type_data_v01[] = {
  QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_extended_card_state_type_v01, card_state),

  QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_extended_card_state_type_v01, error_code),
...
static const uint8_t uim_read_transparent_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_resp_msg_v01, read_result_ext) - QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_resp_msg_v01, read_result_ext_valid)),
  0x16,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_resp_msg_v01, parsed_plmn_list) - QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_resp_msg_v01, parsed_plmn_list_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_read_transparent_resp_msg_v01, parsed_plmn_list),
  QMI_IDL_TYPE88(0, 69),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_resp_msg_v01, parsed_imsi) - QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_resp_msg_v01, parsed_imsi_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_read_transparent_resp_msg_v01, parsed_imsi),
  QMI_IDL_TYPE88(0, 70)
};
...
static const uint8_t uim_read_transparent_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_ind_msg_v01, read_result_ext) - QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_ind_msg_v01, read_result_ext_valid)),
  0x15,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_ind_msg_v01, parsed_plmn_list) - QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_ind_msg_v01, parsed_plmn_list_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_read_transparent_ind_msg_v01, parsed_plmn_list),
  QMI_IDL_TYPE88(0, 69),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_ind_msg_v01, parsed_imsi) - QMI_IDL_OFFSET16RELATIVE(uim_read_transparent_ind_msg_v01, parsed_imsi_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_read_transparent_ind_msg_v01, parsed_imsi),
  QMI_IDL_TYPE88(0, 70)
};
...
static const uint8_t uim_refresh_get_last_event_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_refresh_get_last_event_resp_msg_v01, refresh_event) - QMI_IDL_OFFSET8(uim_refresh_get_last_event_resp_msg_v01, refresh_event_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_refresh_get_last_event_resp_msg_v01, refresh_event),
  QMI_IDL_TYPE88(0, 13),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_refresh_get_last_event_resp_msg_v01, refresh_enforcement_policy_mask) - QMI_IDL_OFFSET16RELATIVE(uim_refresh_get_last_event_resp_msg_v01, refresh_enforcement_policy_mask_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_refresh_get_last_event_resp_msg_v01, refresh_enforcement_policy_mask)
};
...
static const uint8_t uim_power_up_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_power_up_req_msg_v01, ignore_hotswap_switch) - QMI_IDL_OFFSET8(uim_power_up_req_msg_v01, ignore_hotswap_switch_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_power_up_req_msg_v01, ignore_hotswap_switch),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_power_up_req_msg_v01, card_mode) - QMI_IDL_OFFSET8(uim_power_up_req_msg_v01, card_mode_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_power_up_req_msg_v01, card_mode)
};
...
static const uint8_t uim_get_card_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, sim_busy_status) - QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, sim_busy_status_valid)),
  0x15,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, card_mode) - QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, card_mode_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_card_status_resp_msg_v01, card_mode),
  QMI_UIM_EXTENDED_CARDS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, card_mode) - QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, card_mode_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, extended_card_info) - QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, extended_card_info_valid)),
  0x17,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_get_card_status_resp_msg_v01, extended_card_info),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, extended_card_info) - QMI_IDL_OFFSET16RELATIVE(uim_get_card_status_resp_msg_v01, extended_card_info_len),
  QMI_IDL_TYPE88(0, 77)
};
...
static const uint8_t uim_status_change_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, extended_card_status) - QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, extended_card_status_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_status_change_ind_msg_v01, extended_card_status),
  QMI_IDL_TYPE88(0, 27),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, card_mode) - QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, card_mode_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_status_change_ind_msg_v01, card_mode),
  QMI_UIM_EXTENDED_CARDS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, card_mode) - QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, card_mode_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, extended_card_info) - QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, extended_card_info_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_status_change_ind_msg_v01, extended_card_info),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, extended_card_info) - QMI_IDL_OFFSET16RELATIVE(uim_status_change_ind_msg_v01, extended_card_info_len),
  QMI_IDL_TYPE88(0, 77)
};

static const uint8_t uim_refresh_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_refresh_ind_msg_v01, refresh_event) - QMI_IDL_OFFSET8(uim_refresh_ind_msg_v01, refresh_event_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_refresh_ind_msg_v01, refresh_event),
  QMI_IDL_TYPE88(0, 13),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_refresh_ind_msg_v01, refresh_enforcement_policy_mask) - QMI_IDL_OFFSET16RELATIVE(uim_refresh_ind_msg_v01, refresh_enforcement_policy_mask_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_refresh_ind_msg_v01, refresh_enforcement_policy_mask)
};
...
static const uint8_t uim_get_configuration_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, perso_reactivation_status) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, perso_reactivation_status_valid)),
  0x17,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, perso_control_key_present) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, perso_control_key_present_valid)),
  0x18,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_get_configuration_resp_msg_v01, perso_control_key_present),
  QMI_UIM_EXTENDED_CARDS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, perso_control_key_present) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, perso_control_key_present_len),
  QMI_IDL_TYPE88(0, 59),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, remote_simlock_storage) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, remote_simlock_storage_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_configuration_resp_msg_v01, remote_simlock_storage),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, emergency_only_mode) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, emergency_only_mode_valid)),
  0x1A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_configuration_resp_msg_v01, emergency_only_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, extended_apdu) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, extended_apdu_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_configuration_resp_msg_v01, extended_apdu),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, inactive_simlock_config) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, inactive_simlock_config_valid)),
  0x1C,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_get_configuration_resp_msg_v01, inactive_simlock_config),
  QMI_UIM_INACTIVE_SIMLOCK_CONFIG_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, inactive_simlock_config) - QMI_IDL_OFFSET16RELATIVE(uim_get_configuration_resp_msg_v01, inactive_simlock_config_len),
  QMI_IDL_TYPE88(0, 78)
};
...
static const uint8_t uim_send_apdu_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_send_apdu_req_msg_v01, procedure_bytes) - QMI_IDL_OFFSET16RELATIVE(uim_send_apdu_req_msg_v01, procedure_bytes_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(uim_send_apdu_req_msg_v01, procedure_bytes),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_send_apdu_req_msg_v01, long_request) - QMI_IDL_OFFSET16RELATIVE(uim_send_apdu_req_msg_v01, long_request_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_send_apdu_req_msg_v01, long_request),
  QMI_IDL_TYPE88(0, 71)
};
...
static const uint8_t uim_logical_channel_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_logical_channel_resp_msg_v01, select_response) - QMI_IDL_OFFSET8(uim_logical_channel_resp_msg_v01, select_response_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_logical_channel_resp_msg_v01, long_select_response) - QMI_IDL_OFFSET16RELATIVE(uim_logical_channel_resp_msg_v01, long_select_response_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_logical_channel_resp_msg_v01, long_select_response),
  ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) & 0xFF), ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_logical_channel_resp_msg_v01, long_select_response) - QMI_IDL_OFFSET16RELATIVE(uim_logical_channel_resp_msg_v01, long_select_response_len)
};
...
static const uint8_t uim_get_atr_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_atr_resp_msg_v01, atr_value) - QMI_IDL_OFFSET8(uim_get_atr_resp_msg_v01, atr_value_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_atr_resp_msg_v01, euicc_supported) - QMI_IDL_OFFSET8(uim_get_atr_resp_msg_v01, euicc_supported_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_get_atr_resp_msg_v01, euicc_supported)
};
...
static const uint8_t uim_open_logical_channel_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_open_logical_channel_resp_msg_v01, select_response) - QMI_IDL_OFFSET8(uim_open_logical_channel_resp_msg_v01, select_response_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_open_logical_channel_resp_msg_v01, long_select_response) - QMI_IDL_OFFSET16RELATIVE(uim_open_logical_channel_resp_msg_v01, long_select_response_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_open_logical_channel_resp_msg_v01, long_select_response),
  ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) & 0xFF), ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_open_logical_channel_resp_msg_v01, long_select_response) - QMI_IDL_OFFSET16RELATIVE(uim_open_logical_channel_resp_msg_v01, long_select_response_len)
};
...
static const uint8_t uim_get_slots_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_status) - QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_status_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_information) - QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_information_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_information),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_information) - QMI_IDL_OFFSET8(uim_get_slots_status_resp_msg_v01, physical_slot_information_len),
  QMI_IDL_TYPE88(0, 75),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, slot_eid_info) - QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, slot_eid_info_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_get_slots_status_resp_msg_v01, slot_eid_info),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, slot_eid_info) - QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, slot_eid_info_len),
  QMI_IDL_TYPE88(0, 76),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, extended_card_state) - QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, extended_card_state_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_get_slots_status_resp_msg_v01, extended_card_state),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, extended_card_state) - QMI_IDL_OFFSET16RELATIVE(uim_get_slots_status_resp_msg_v01, extended_card_state_len),
  QMI_IDL_TYPE88(0, 81)
};

static const uint8_t uim_slot_status_change_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_status) - QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_status_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_information) - QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_information_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_information),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_information) - QMI_IDL_OFFSET8(uim_slot_status_change_ind_msg_v01, physical_slot_information_len),
  QMI_IDL_TYPE88(0, 75),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, slot_eid_info) - QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, slot_eid_info_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_slot_status_change_ind_msg_v01, slot_eid_info),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, slot_eid_info) - QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, slot_eid_info_len),
  QMI_IDL_TYPE88(0, 76),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, extended_card_state) - QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, extended_card_state_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_slot_status_change_ind_msg_v01, extended_card_state),
  QMI_UIM_PHYSICAL_SLOTS_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, extended_card_state) - QMI_IDL_OFFSET16RELATIVE(uim_slot_status_change_ind_msg_v01, extended_card_state_len),
  QMI_IDL_TYPE88(0, 81)
};
...
static const uint8_t uim_personalization_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, reactivate_feature) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, reactivate_feature_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, reactivate_feature),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, reuse_code_for_feature) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, reuse_code_for_feature_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, reuse_code_for_feature),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_perso_valid)),
  0x1D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_sp_ext_perso),
  QMI_UIM_PERSO_NUM_GW_SP_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_perso_len),
  QMI_IDL_TYPE88(0, 55),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_perso_valid)),
  0x1E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_corporate_ext_perso),
  QMI_UIM_PERSO_NUM_GW_CP_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_perso_len),
  QMI_IDL_TYPE88(0, 56),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_spn_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_spn_perso_valid)),
  0x1F,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_spn_perso),
  QMI_UIM_PERSO_NUM_GW_SPN_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_spn_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_spn_perso_len),
  QMI_IDL_TYPE88(0, 62),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_v4_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_v4_perso_valid)),
  0x20,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_sp_ext_v4_perso),
  QMI_UIM_PERSO_NUM_GW_SP_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_v4_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ext_v4_perso_len),
  QMI_IDL_TYPE88(0, 63),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_v4_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_v4_perso_valid)),
  0x21,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_corporate_ext_v4_perso),
  QMI_UIM_PERSO_NUM_GW_CP_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_v4_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_corporate_ext_v4_perso_len),
  QMI_IDL_TYPE88(0, 64),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ehplmn_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ehplmn_perso_valid)),
  0x22,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_sp_ehplmn_perso),
  QMI_UIM_PERSO_NUM_GW_SP_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ehplmn_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_sp_ehplmn_perso_len),
  QMI_IDL_TYPE88(0, 65),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_iccid_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_iccid_perso_valid)),
  0x23,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_personalization_req_msg_v01, feature_gw_iccid_perso),
  QMI_UIM_PERSO_NUM_GW_ICCID_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_iccid_perso) - QMI_IDL_OFFSET16RELATIVE(uim_personalization_req_msg_v01, feature_gw_iccid_perso_len),
  QMI_IDL_TYPE88(0, 66)
};
...
static const uint8_t uim_reselect_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_reselect_resp_msg_v01, select_response) - QMI_IDL_OFFSET8(uim_reselect_resp_msg_v01, select_response_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_reselect_resp_msg_v01, long_select_response) - QMI_IDL_OFFSET16RELATIVE(uim_reselect_resp_msg_v01, long_select_response_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_reselect_resp_msg_v01, long_select_response),
  ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) & 0xFF), ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_reselect_resp_msg_v01, long_select_response) - QMI_IDL_OFFSET16RELATIVE(uim_reselect_resp_msg_v01, long_select_response_len)
};
...
static const uint8_t uim_send_status_cmd_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_send_status_cmd_resp_msg_v01, card_result) - QMI_IDL_OFFSET16RELATIVE(uim_send_status_cmd_resp_msg_v01, card_result_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_send_status_cmd_resp_msg_v01, card_result),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_send_status_cmd_resp_msg_v01, long_status_response) - QMI_IDL_OFFSET16RELATIVE(uim_send_status_cmd_resp_msg_v01, long_status_response_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_send_status_cmd_resp_msg_v01, long_status_response),
  ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) & 0xFF), ((QMI_UIM_LONG_SELECT_RESPONSE_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_send_status_cmd_resp_msg_v01, long_status_response) - QMI_IDL_OFFSET16RELATIVE(uim_send_status_cmd_resp_msg_v01, long_status_response_len)
};
...
static const uint8_t uim_set_sim_profile_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_set_sim_profile_req_msg_v01, enable_profile) - QMI_IDL_OFFSET8(uim_set_sim_profile_req_msg_v01, enable_profile_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_set_sim_profile_req_msg_v01, enable_profile)
};
...
static const uint8_t uim_gba_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_gba_req_msg_v01, apn_name) - QMI_IDL_OFFSET16RELATIVE(uim_gba_req_msg_v01, apn_name_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_gba_req_msg_v01, bsf_information) - QMI_IDL_OFFSET16RELATIVE(uim_gba_req_msg_v01, bsf_information_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_gba_req_msg_v01, bsf_information),
  QMI_IDL_TYPE88(0, 57),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_gba_req_msg_v01, key_status_ind_reg) - QMI_IDL_OFFSET16RELATIVE(uim_gba_req_msg_v01, key_status_ind_reg_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_gba_req_msg_v01, key_status_ind_reg)
};
...
static const uint8_t uim_remote_unlock_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_unlock_req_msg_v01, simlock_data) - QMI_IDL_OFFSET8(uim_remote_unlock_req_msg_v01, simlock_data_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, operation) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, operation_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_req_msg_v01, operation),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, simlock_data_ext) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, simlock_data_ext_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_req_msg_v01, simlock_data_ext),
  ((QMI_UIM_SIMLOCK_DATA_EXT_MAX_V01) & 0xFF), ((QMI_UIM_SIMLOCK_DATA_EXT_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, simlock_data_ext) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, simlock_data_ext_len)
};
...
static const uint8_t uim_remote_unlock_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_remote_unlock_resp_msg_v01, encrypted_key) - QMI_IDL_OFFSET8(uim_remote_unlock_resp_msg_v01, encrypted_key_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, simlock_data) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, simlock_data_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_resp_msg_v01, simlock_data),
  ((QMI_UIM_SIMLOCK_DATA_MAX_V01) & 0xFF), ((QMI_UIM_SIMLOCK_DATA_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, simlock_data) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, simlock_data_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, hmac_data) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, hmac_data_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_resp_msg_v01, hmac_data),
  QMI_UIM_HMAC_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, hmac_data) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, hmac_data_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, maximum_version) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, maximum_version_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_resp_msg_v01, maximum_version),
  QMI_IDL_TYPE88(0, 74),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, blob_request) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, blob_request_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_resp_msg_v01, blob_request),
  ((QMI_UIM_SIMLOCK_DATA_MAX_V01) & 0xFF), ((QMI_UIM_SIMLOCK_DATA_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, blob_request) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, blob_request_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, delay_timer_value) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, delay_timer_value_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_remote_unlock_resp_msg_v01, delay_timer_value)
};
...
static const uint8_t uim_gba_key_status_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_gba_key_status_ind_msg_v01, session_information),
  QMI_IDL_TYPE88(0, 0),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_gba_key_status_ind_msg_v01, key_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_gba_key_status_ind_msg_v01, btid),
  QMI_UIM_BTID_MAX_V01,
  QMI_IDL_OFFSET8(uim_gba_key_status_ind_msg_v01, btid) - QMI_IDL_OFFSET8(uim_gba_key_status_ind_msg_v01, btid_len)
};

static const uint8_t uim_purge_temporary_identity_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_purge_temporary_identity_req_msg_v01, session_information),
  QMI_IDL_TYPE88(0, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_purge_temporary_identity_req_msg_v01, purge_temporary_identity_req_mask)
};

static const uint8_t uim_purge_temporary_identity_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_purge_temporary_identity_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_purge_temporary_identity_ind_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_purge_temporary_identity_ind_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_purge_temporary_identity_ind_msg_v01, session_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_purge_temporary_identity_ind_msg_v01, purge_temporary_identity_req_mask)
};

static const uint8_t uim_switch_slot_ext_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_switch_slot_ext_req_msg_v01, logical_slot),
  QMI_UIM_EXTENDED_CARDS_MAX_V01,
  QMI_IDL_OFFSET8(uim_switch_slot_ext_req_msg_v01, logical_slot) - QMI_IDL_OFFSET8(uim_switch_slot_ext_req_msg_v01, logical_slot_len)
};

static const uint8_t uim_switch_slot_ext_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_switch_slot_ext_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * uim_get_physical_slot_mapping_req_msg is empty
 * static const uint8_t uim_get_physical_slot_mapping_req_msg_data_v01[] = {
 * };
 */

static const uint8_t uim_get_physical_slot_mapping_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_get_physical_slot_mapping_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_physical_slot_mapping_resp_msg_v01, logical_slot) - QMI_IDL_OFFSET8(uim_get_physical_slot_mapping_resp_msg_v01, logical_slot_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_get_physical_slot_mapping_resp_msg_v01, logical_slot),
  QMI_UIM_EXTENDED_CARDS_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_physical_slot_mapping_resp_msg_v01, logical_slot) - QMI_IDL_OFFSET8(uim_get_physical_slot_mapping_resp_msg_v01, logical_slot_len)
};

static const uint8_t uim_get_profile_info_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_get_profile_info_req_msg_v01, slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_req_msg_v01, profile_id)
};

static const uint8_t uim_get_profile_info_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_iccid) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_iccid_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_iccid),
  QMI_UIM_ICCID_LEN_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_iccid) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_iccid_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_state) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_state_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_nickname) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_nickname_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_nickname),
  QMI_UIM_EUICC_NICKNAME_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_nickname) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_nickname_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_spn) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_spn_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_spn),
  QMI_UIM_EUICC_SPN_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_spn) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_spn_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_name) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_name_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_name),
  QMI_UIM_EUICC_PROFILE_NAME_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_name) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_name_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_icon_type) - QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_icon_type_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_get_profile_info_resp_msg_v01, profile_icon_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_icon_data) - QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_icon_data_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_profile_info_resp_msg_v01, profile_icon_data),
  ((QMI_UIM_EUICC_ICON_MAX_V01) & 0xFF), ((QMI_UIM_EUICC_ICON_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_icon_data) - QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_icon_data_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_class) - QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_class_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_profile_info_resp_msg_v01, profile_class),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_policy_rules) - QMI_IDL_OFFSET16RELATIVE(uim_get_profile_info_resp_msg_v01, profile_policy_rules_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_get_profile_info_resp_msg_v01, profile_policy_rules)
};

static const uint8_t uim_get_eid_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_get_eid_req_msg_v01, slot)
};

static const uint8_t uim_get_eid_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_get_eid_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_eid_resp_msg_v01, eid_value) - QMI_IDL_OFFSET8(uim_get_eid_resp_msg_v01, eid_value_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_get_eid_resp_msg_v01, eid_value),
  QMI_UIM_EID_LEN_V01,
  QMI_IDL_OFFSET8(uim_get_eid_resp_msg_v01, eid_value) - QMI_IDL_OFFSET8(uim_get_eid_resp_msg_v01, eid_value_len)
};

static const uint8_t uim_delete_profile_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_delete_profile_req_msg_v01, slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_delete_profile_req_msg_v01, profile_id)
};

static const uint8_t uim_delete_profile_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_delete_profile_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_euicc_memory_reset_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_euicc_memory_reset_req_msg_v01, slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_euicc_memory_reset_req_msg_v01, reset_option) - QMI_IDL_OFFSET8(uim_euicc_memory_reset_req_msg_v01, reset_option_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(uim_euicc_memory_reset_req_msg_v01, reset_option)
};

static const uint8_t uim_euicc_memory_reset_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_euicc_memory_reset_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_add_profile_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_add_profile_req_msg_v01, slot),

  0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_add_profile_req_msg_v01, activation_code),
  ((QMI_UIM_EUICC_DOWNLOAD_CODE_MAX_V01) & 0xFF), ((QMI_UIM_EUICC_DOWNLOAD_CODE_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(uim_add_profile_req_msg_v01, activation_code) - QMI_IDL_OFFSET8(uim_add_profile_req_msg_v01, activation_code_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_add_profile_req_msg_v01, confirmation_code) - QMI_IDL_OFFSET16RELATIVE(uim_add_profile_req_msg_v01, confirmation_code_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_add_profile_req_msg_v01, confirmation_code),
  ((QMI_UIM_EUICC_DOWNLOAD_CODE_MAX_V01) & 0xFF), ((QMI_UIM_EUICC_DOWNLOAD_CODE_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(uim_add_profile_req_msg_v01, confirmation_code) - QMI_IDL_OFFSET16RELATIVE(uim_add_profile_req_msg_v01, confirmation_code_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_add_profile_req_msg_v01, user_consent_supported) - QMI_IDL_OFFSET16RELATIVE(uim_add_profile_req_msg_v01, user_consent_supported_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_add_profile_req_msg_v01, user_consent_supported)
};

static const uint8_t uim_add_profile_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_add_profile_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_add_profile_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, slot),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, profile_download_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, error_cause) - QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, error_cause_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, error_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, percentage) - QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, percentage_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, percentage),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, profile_policy_rules) - QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, profile_policy_rules_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_add_profile_ind_msg_v01, profile_policy_rules),
  QMI_IDL_TYPE88(0, 67)
};

static const uint8_t uim_update_profile_nickname_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, slot),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, profile_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, nickname) - QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, nickname_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, nickname),
  QMI_UIM_EUICC_NICKNAME_MAX_V01,
  QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, nickname) - QMI_IDL_OFFSET8(uim_update_profile_nickname_req_msg_v01, nickname_len)
};

static const uint8_t uim_update_profile_nickname_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_update_profile_nickname_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_terminal_capability_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_terminal_capability_req_msg_v01, slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_terminal_capability_req_msg_v01, terminal_capability_tlv) - QMI_IDL_OFFSET8(uim_terminal_capability_req_msg_v01, terminal_capability_tlv_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_terminal_capability_req_msg_v01, terminal_capability_tlv),
  QMI_UIM_TERMINAL_CAPABILITY_TLVS_MAX_V01,
  QMI_IDL_OFFSET8(uim_terminal_capability_req_msg_v01, terminal_capability_tlv) - QMI_IDL_OFFSET8(uim_terminal_capability_req_msg_v01, terminal_capability_tlv_len),
  QMI_IDL_TYPE88(0, 60)
};

static const uint8_t uim_terminal_capability_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_terminal_capability_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_terminal_capability_resp_msg_v01, terminal_capability_tlv) - QMI_IDL_OFFSET8(uim_terminal_capability_resp_msg_v01, terminal_capability_tlv_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_terminal_capability_resp_msg_v01, terminal_capability_tlv),
  QMI_UIM_TERMINAL_CAPABILITY_TLVS_MAX_V01,
  QMI_IDL_OFFSET8(uim_terminal_capability_resp_msg_v01, terminal_capability_tlv) - QMI_IDL_OFFSET8(uim_terminal_capability_resp_msg_v01, terminal_capability_tlv_len),
  QMI_IDL_TYPE88(0, 61)
};

static const uint8_t uim_set_apdu_behavior_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_set_apdu_behavior_req_msg_v01, slot),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_set_apdu_behavior_req_msg_v01, channel_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_set_apdu_behavior_req_msg_v01, apdu_behavior) - QMI_IDL_OFFSET8(uim_set_apdu_behavior_req_msg_v01, apdu_behavior_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_set_apdu_behavior_req_msg_v01, apdu_behavior)
};

static const uint8_t uim_set_apdu_behavior_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_set_apdu_behavior_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_profile_user_consent_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_profile_user_consent_req_msg_v01, slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_profile_user_consent_req_msg_v01, user_ok)
};

static const uint8_t uim_profile_user_consent_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_profile_user_consent_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_euicc_default_server_address_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_euicc_default_server_address_req_msg_v01, slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_euicc_default_server_address_req_msg_v01, default_smdp_address) - QMI_IDL_OFFSET8(uim_euicc_default_server_address_req_msg_v01, default_smdp_address_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_euicc_default_server_address_req_msg_v01, default_smdp_address),
  QMI_UIM_FQDN_MAX_V01,
  QMI_IDL_OFFSET8(uim_euicc_default_server_address_req_msg_v01, default_smdp_address) - QMI_IDL_OFFSET8(uim_euicc_default_server_address_req_msg_v01, default_smdp_address_len)
};

static const uint8_t uim_euicc_default_server_address_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_euicc_default_server_address_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_euicc_default_server_address_resp_msg_v01, default_smds_address) - QMI_IDL_OFFSET8(uim_euicc_default_server_address_resp_msg_v01, default_smds_address_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_euicc_default_server_address_resp_msg_v01, default_smds_address),
  QMI_UIM_FQDN_MAX_V01,
  QMI_IDL_OFFSET8(uim_euicc_default_server_address_resp_msg_v01, default_smds_address) - QMI_IDL_OFFSET8(uim_euicc_default_server_address_resp_msg_v01, default_smds_address_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_euicc_default_server_address_resp_msg_v01, default_smdp_address) - QMI_IDL_OFFSET16RELATIVE(uim_euicc_default_server_address_resp_msg_v01, default_smdp_address_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_euicc_default_server_address_resp_msg_v01, default_smdp_address),
  QMI_UIM_FQDN_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(uim_euicc_default_server_address_resp_msg_v01, default_smdp_address) - QMI_IDL_OFFSET16RELATIVE(uim_euicc_default_server_address_resp_msg_v01, default_smdp_address_len)
};

static const uint8_t uim_map_provisioning_sessions_to_slots_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, primary_slot) - QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, primary_slot_valid)),
  0x10,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, primary_slot),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, secondary_slot) - QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, secondary_slot_valid)),
  0x11,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, secondary_slot),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, tertiary_slot) - QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, tertiary_slot_valid)),
  0x12,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, tertiary_slot),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, quaternary_slot) - QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, quaternary_slot_valid)),
  0x13,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, quaternary_slot),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, quinary_slot) - QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, quinary_slot_valid)),
  0x14,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_req_msg_v01, quinary_slot)
};

static const uint8_t uim_map_provisioning_sessions_to_slots_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_map_provisioning_sessions_to_slots_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_read_ber_tlv_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_req_msg_v01, session_information),
  QMI_IDL_TYPE88(0, 0),

  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_req_msg_v01, file_id),
  QMI_IDL_TYPE88(0, 1),

  0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_req_msg_v01, tag),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_read_ber_tlv_req_msg_v01, indication_token) - QMI_IDL_OFFSET8(uim_read_ber_tlv_req_msg_v01, indication_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_req_msg_v01, indication_token)
};

static const uint8_t uim_read_ber_tlv_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, card_result) - QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, card_result_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, card_result),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, read_result) - QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, read_result_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_resp_msg_v01, read_result),
  QMI_IDL_TYPE88(0, 72),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_resp_msg_v01, indication_token) - QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_resp_msg_v01, indication_token_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_read_ber_tlv_resp_msg_v01, indication_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_resp_msg_v01, file_length) - QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_resp_msg_v01, file_length_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_read_ber_tlv_resp_msg_v01, file_length),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_resp_msg_v01, long_data_token) - QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_resp_msg_v01, long_data_token_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_read_ber_tlv_resp_msg_v01, long_data_token)
};

static const uint8_t uim_read_ber_tlv_ind_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, indication_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, card_result) - QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, card_result_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, card_result),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, read_result) - QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, read_result_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_ind_msg_v01, read_result),
  QMI_IDL_TYPE88(0, 72),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_ind_msg_v01, file_length) - QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_ind_msg_v01, file_length_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_read_ber_tlv_ind_msg_v01, file_length),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_ind_msg_v01, long_data_token) - QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_ind_msg_v01, long_data_token_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(uim_read_ber_tlv_ind_msg_v01, long_data_token)
};

static const uint8_t uim_read_ber_tlv_long_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_read_ber_tlv_long_ind_msg_v01, long_response_chunk),
  QMI_IDL_TYPE88(0, 73),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_long_ind_msg_v01, card_result) - QMI_IDL_OFFSET16RELATIVE(uim_read_ber_tlv_long_ind_msg_v01, card_result_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(uim_read_ber_tlv_long_ind_msg_v01, card_result),
  QMI_IDL_TYPE88(0, 3)
};

static const uint8_t uim_sim_profile_switch_lock_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(uim_sim_profile_switch_lock_req_msg_v01, lock),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(uim_sim_profile_switch_lock_req_msg_v01, slot)
};

static const uint8_t uim_sim_profile_switch_lock_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_sim_profile_switch_lock_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t uim_activate_simlock_config_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(uim_activate_simlock_config_req_msg_v01, config_id)
};

static const uint8_t uim_activate_simlock_config_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_activate_simlock_config_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * uim_get_simlock_token_req_msg is empty
 * static const uint8_t uim_get_simlock_token_req_msg_data_v01[] = {
 * };
 */

static const uint8_t uim_get_simlock_token_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_get_simlock_token_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(uim_get_simlock_token_resp_msg_v01, slot) - QMI_IDL_OFFSET8(uim_get_simlock_token_resp_msg_v01, slot_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(uim_get_simlock_token_resp_msg_v01, slot),
  QMI_UIM_EXTENDED_CARDS_MAX_V01,
  QMI_IDL_OFFSET8(uim_get_simlock_token_resp_msg_v01, slot) - QMI_IDL_OFFSET8(uim_get_simlock_token_resp_msg_v01, slot_len),
  QMI_IDL_TYPE88(0, 80)
};
...
static const qmi_idl_type_table_entry  uim_type_table_v01[] = {
  ...
  {sizeof(uim_gw_sp_ext_perso_type_v01), uim_gw_sp_ext_perso_type_data_v01},
  {sizeof(uim_gw_corporate_ext_perso_type_v01), uim_gw_corporate_ext_perso_type_data_v01},
  {sizeof(uim_bsf_information_type_v01), uim_bsf_information_type_data_v01},
  {sizeof(uim_perso_feature_control_key_present_type_v01), uim_perso_feature_control_key_present_type_data_v01},
  {sizeof(uim_perso_control_key_present_type_v01), uim_perso_control_key_present_type_data_v01},
  {sizeof(uim_terminal_capability_tlv_type_v01), uim_terminal_capability_tlv_type_data_v01},
  {sizeof(uim_terminal_capability_tlv_resp_type_v01), uim_terminal_capability_tlv_resp_type_data_v01},
  {sizeof(uim_gw_spn_perso_type_v01), uim_gw_spn_perso_type_data_v01},
  {sizeof(uim_gw_sp_ext2_perso_type_v01), uim_gw_sp_ext2_perso_type_data_v01},
  {sizeof(uim_gw_corporate_ext2_perso_type_v01), uim_gw_corporate_ext2_perso_type_data_v01},
  {sizeof(uim_gw_sp_ehplmn_perso_type_v01), uim_gw_sp_ehplmn_perso_type_data_v01},
  {sizeof(uim_gw_iccid_perso_type_v01), uim_gw_iccid_perso_type_data_v01},
  {sizeof(profile_policy_info_v01), profile_policy_info_data_v01},
  {sizeof(uim_plmn_type_v01), uim_plmn_type_data_v01},
  {sizeof(uim_plmn_list_type_v01), uim_plmn_list_type_data_v01},
  {sizeof(uim_imsi_type_v01), uim_imsi_type_data_v01},
  {sizeof(uim_send_apdu_long_request_type_v01), uim_send_apdu_long_request_type_data_v01},
  {sizeof(uim_read_ber_tlv_result_type_v01), uim_read_ber_tlv_result_type_data_v01},
  {sizeof(uim_read_ber_tlv_long_response_chunk_type_v01), uim_read_ber_tlv_long_response_chunk_type_data_v01},
  {sizeof(uim_remote_unlock_version_type_v01), uim_remote_unlock_version_type_data_v01},
  {sizeof(uim_physical_slot_information_type_v01), uim_physical_slot_information_type_data_v01},
  {sizeof(uim_slot_eid_info_type_v01), uim_slot_eid_info_type_data_v01},
  {sizeof(uim_extended_card_info_type_v01), uim_extended_card_info_type_data_v01},
  {sizeof(uim_inactive_simlock_config_type_v01), uim_inactive_simlock_config_type_data_v01},
  {sizeof(uim_simlock_token_feature_type_v01), uim_simlock_token_feature_type_data_v01},
  {sizeof(uim_simlock_token_slot_type_v01), uim_simlock_token_slot_type_data_v01},
  {sizeof(uim_extended_card_state_type_v01), uim_extended_card_state_type_data_v01}
};
...
static const qmi_idl_message_table_entry uim_message_table_v01[] = {
  ...
  {sizeof(uim_gba_key_status_ind_msg_v01), uim_gba_key_status_ind_msg_data_v01},
  {sizeof(uim_purge_temporary_identity_req_msg_v01), uim_purge_temporary_identity_req_msg_data_v01},
  {sizeof(uim_purge_temporary_identity_resp_msg_v01), uim_purge_temporary_identity_resp_msg_data_v01},
  {sizeof(uim_purge_temporary_identity_ind_msg_v01), uim_purge_temporary_identity_ind_msg_data_v01},
  {sizeof(uim_switch_slot_ext_req_msg_v01), uim_switch_slot_ext_req_msg_data_v01},
  {sizeof(uim_switch_slot_ext_resp_msg_v01), uim_switch_slot_ext_resp_msg_data_v01},
  {sizeof(uim_get_physical_slot_mapping_req_msg_v01), 0},
  {sizeof(uim_get_physical_slot_mapping_resp_msg_v01), uim_get_physical_slot_mapping_resp_msg_data_v01},
  {sizeof(uim_get_profile_info_req_msg_v01), uim_get_profile_info_req_msg_data_v01},
  {sizeof(uim_get_profile_info_resp_msg_v01), uim_get_profile_info_resp_msg_data_v01},
  {sizeof(uim_get_eid_req_msg_v01), uim_get_eid_req_msg_data_v01},
  {sizeof(uim_get_eid_resp_msg_v01), uim_get_eid_resp_msg_data_v01},
  {sizeof(uim_delete_profile_req_msg_v01), uim_delete_profile_req_msg_data_v01},
  {sizeof(uim_delete_profile_resp_msg_v01), uim_delete_profile_resp_msg_data_v01},
  {sizeof(uim_euicc_memory_reset_req_msg_v01), uim_euicc_memory_reset_req_msg_data_v01},
  {sizeof(uim_euicc_memory_reset_resp_msg_v01), uim_euicc_memory_reset_resp_msg_data_v01},
  {sizeof(uim_add_profile_req_msg_v01), uim_add_profile_req_msg_data_v01},
  {sizeof(uim_add_profile_resp_msg_v01), uim_add_profile_resp_msg_data_v01},
  {sizeof(uim_add_profile_ind_msg_v01), uim_add_profile_ind_msg_data_v01},
  {sizeof(uim_update_profile_nickname_req_msg_v01), uim_update_profile_nickname_req_msg_data_v01},
  {sizeof(uim_update_profile_nickname_resp_msg_v01), uim_update_profile_nickname_resp_msg_data_v01},
  {sizeof(uim_terminal_capability_req_msg_v01), uim_terminal_capability_req_msg_data_v01},
  {sizeof(uim_terminal_capability_resp_msg_v01), uim_terminal_capability_resp_msg_data_v01},
  {sizeof(uim_set_apdu_behavior_req_msg_v01), uim_set_apdu_behavior_req_msg_data_v01},
  {sizeof(uim_set_apdu_behavior_resp_msg_v01), uim_set_apdu_behavior_resp_msg_data_v01},
  {sizeof(uim_profile_user_consent_req_msg_v01), uim_profile_user_consent_req_msg_data_v01},
  {sizeof(uim_profile_user_consent_resp_msg_v01), uim_profile_user_consent_resp_msg_data_v01},
  {sizeof(uim_euicc_default_server_address_req_msg_v01), uim_euicc_default_server_address_req_msg_data_v01},
  {sizeof(uim_euicc_default_server_address_resp_msg_v01), uim_euicc_default_server_address_resp_msg_data_v01},
  {sizeof(uim_map_provisioning_sessions_to_slots_req_msg_v01), uim_map_provisioning_sessions_to_slots_req_msg_data_v01},
  {sizeof(uim_map_provisioning_sessions_to_slots_resp_msg_v01), uim_map_provisioning_sessions_to_slots_resp_msg_data_v01},
  {sizeof(uim_read_ber_tlv_req_msg_v01), uim_read_ber_tlv_req_msg_data_v01},
  {sizeof(uim_read_ber_tlv_resp_msg_v01), uim_read_ber_tlv_resp_msg_data_v01},
  {sizeof(uim_read_ber_tlv_ind_msg_v01), uim_read_ber_tlv_ind_msg_data_v01},
  {sizeof(uim_read_ber_tlv_long_ind_msg_v01), uim_read_ber_tlv_long_ind_msg_data_v01},
  {sizeof(uim_sim_profile_switch_lock_req_msg_v01), uim_sim_profile_switch_lock_req_msg_data_v01},
  {sizeof(uim_sim_profile_switch_lock_resp_msg_v01), uim_sim_profile_switch_lock_resp_msg_data_v01},
  {sizeof(uim_activate_simlock_config_req_msg_v01), uim_activate_simlock_config_req_msg_data_v01},
  {sizeof(uim_activate_simlock_config_resp_msg_v01), uim_activate_simlock_config_resp_msg_data_v01},
  {sizeof(uim_get_simlock_token_req_msg_v01), 0},
  {sizeof(uim_get_simlock_token_resp_msg_v01), uim_get_simlock_token_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry uim_service_command_messages_v01[] = {
  ...
  {QMI_UIM_POWER_UP_REQ_V01, QMI_IDL_TYPE16(0, 41), 15},
  ...
  {QMI_UIM_SEND_APDU_REQ_V01, QMI_IDL_TYPE16(0, 64), 1052},
  ...
  {QMI_UIM_PERSONALIZATION_REQ_V01, QMI_IDL_TYPE16(0, 94), 11711},
  ...
  {QMI_UIM_SET_SIM_PROFILE_REQ_V01, QMI_IDL_TYPE16(0, 108), 15},
  ...
  {QMI_UIM_GBA_REQ_V01, QMI_IDL_TYPE16(0, 123), 685},
  {QMI_UIM_GET_GBA_IMPI_REQ_V01, QMI_IDL_TYPE16(0, 126), 41},
  {QMI_UIM_SEARCH_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 128), 327},
  {QMI_UIM_REMOTE_UNLOCK_REQ_V01, QMI_IDL_TYPE16(0, 131), 5137},
  {QMI_UIM_VERIFY_IMSI_REQ_V01, QMI_IDL_TYPE16(0, 133), 14},
  {QMI_UIM_PURGE_TEMPORARY_IDENTITY_REQ_V01, QMI_IDL_TYPE16(0, 137), 44},
  {QMI_UIM_SWITCH_SLOT_EXT_REQ_V01, QMI_IDL_TYPE16(0, 140), 24},
  {QMI_UIM_GET_PHYSICAL_SLOT_MAPPING_REQ_V01, QMI_IDL_TYPE16(0, 142), 0},
  {QMI_UIM_GET_PROFILE_INFO_REQ_V01, QMI_IDL_TYPE16(0, 144), 11},
  {QMI_UIM_GET_EID_REQ_V01, QMI_IDL_TYPE16(0, 146), 4},
  {QMI_UIM_DELETE_PROFILE_REQ_V01, QMI_IDL_TYPE16(0, 148), 11},
  {QMI_UIM_EUICC_MEMORY_RESET_REQ_V01, QMI_IDL_TYPE16(0, 150), 15},
  {QMI_UIM_ADD_PROFILE_REQ_V01, QMI_IDL_TYPE16(0, 152), 530},
  {QMI_UIM_UPDATE_PROFILE_NICKNAME_REQ_V01, QMI_IDL_TYPE16(0, 155), 79},
  {QMI_UIM_TERMINAL_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 157), 568},
  {QMI_UIM_SET_APDU_BEHAVIOR_REQ_V01, QMI_IDL_TYPE16(0, 159), 15},
  {QMI_UIM_PROFILE_USER_CONSENT_REQ_V01, QMI_IDL_TYPE16(0, 161), 8},
  {QMI_UIM_EUICC_DEFAULT_SERVER_ADDRESS_REQ_V01, QMI_IDL_TYPE16(0, 163), 263},
  {QMI_UIM_MAP_PROVISIONING_SESSIONS_TO_SLOTS_REQ_V01, QMI_IDL_TYPE16(0, 165), 20},
  {QMI_UIM_READ_BER_TLV_REQ_V01, QMI_IDL_TYPE16(0, 167), 67},
  {QMI_UIM_SIM_PROFILE_SWITCH_LOCK_REQ_V01, QMI_IDL_TYPE16(0, 171), 11},
  {QMI_UIM_ACTIVATE_SIMLOCK_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 173), 4},
  {QMI_UIM_GET_SIMLOCK_TOKEN_REQ_V01, QMI_IDL_TYPE16(0, 175), 0}
};
...
static const qmi_idl_service_message_table_entry uim_service_response_messages_v01[] = {
  ...
  {QMI_UIM_READ_TRANSPARENT_RESP_V01, QMI_IDL_TYPE16(0, 3), 5785},
  ...
  {QMI_UIM_REFRESH_GET_LAST_EVENT_RESP_V01, QMI_IDL_TYPE16(0, 24), 1359},
  {QMI_UIM_EVENT_REG_RESP_V01, QMI_IDL_TYPE16(0, 46), 14},
  {QMI_UIM_GET_CARD_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 44), 6901},
  ...
  {QMI_UIM_GET_CONFIGURATION_RESP_V01, QMI_IDL_TYPE16(0, 63), 3710},
  ...
  {QMI_UIM_LOGICAL_CHANNEL_RESP_V01, QMI_IDL_TYPE16(0, 73), 1304},
  {QMI_UIM_SUBSCRIPTION_OK_RESP_V01, QMI_IDL_TYPE16(0, 75), 7},
  {QMI_UIM_GET_ATR_RESP_V01, QMI_IDL_TYPE16(0, 77), 48},
  {QMI_UIM_OPEN_LOGICAL_CHANNEL_RESP_V01, QMI_IDL_TYPE16(0, 79), 1304},
  ...
  {QMI_UIM_GET_SLOTS_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 88), 418},
  ...
  {QMI_UIM_RESELECT_RESP_V01, QMI_IDL_TYPE16(0, 102), 1300},
  {QMI_UIM_SEND_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 105), 1300},
  ...
  {QMI_UIM_REMOTE_UNLOCK_RESP_V01, QMI_IDL_TYPE16(0, 132), 2724},
  {QMI_UIM_VERIFY_IMSI_RESP_V01, QMI_IDL_TYPE16(0, 134), 7},
  {QMI_UIM_PURGE_TEMPORARY_IDENTITY_RESP_V01, QMI_IDL_TYPE16(0, 138), 7},
  {QMI_UIM_SWITCH_SLOT_EXT_RESP_V01, QMI_IDL_TYPE16(0, 141), 7},
  {QMI_UIM_GET_PHYSICAL_SLOT_MAPPING_RESP_V01, QMI_IDL_TYPE16(0, 143), 31},
  {QMI_UIM_GET_PROFILE_INFO_RESP_V01, QMI_IDL_TYPE16(0, 145), 1254},
  {QMI_UIM_GET_EID_RESP_V01, QMI_IDL_TYPE16(0, 147), 27},
  {QMI_UIM_DELETE_PROFILE_RESP_V01, QMI_IDL_TYPE16(0, 149), 7},
  {QMI_UIM_EUICC_MEMORY_RESET_RESP_V01, QMI_IDL_TYPE16(0, 151), 7},
  {QMI_UIM_ADD_PROFILE_RESP_V01, QMI_IDL_TYPE16(0, 153), 7},
  {QMI_UIM_UPDATE_PROFILE_NICKNAME_RESP_V01, QMI_IDL_TYPE16(0, 156), 7},
  {QMI_UIM_TERMINAL_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 158), 555},
  {QMI_UIM_SET_APDU_BEHAVIOR_RESP_V01, QMI_IDL_TYPE16(0, 160), 7},
  {QMI_UIM_PROFILE_USER_CONSENT_RESP_V01, QMI_IDL_TYPE16(0, 162), 7},
  {QMI_UIM_EUICC_DEFAULT_SERVER_ADDRESS_RESP_V01, QMI_IDL_TYPE16(0, 164), 525},
  {QMI_UIM_MAP_PROVISIONING_SESSIONS_TO_SLOTS_RESP_V01, QMI_IDL_TYPE16(0, 166), 7},
  {QMI_UIM_READ_BER_TLV_RESP_V01, QMI_IDL_TYPE16(0, 168), 4134},
  {QMI_UIM_SIM_PROFILE_SWITCH_LOCK_RESP_V01, QMI_IDL_TYPE16(0, 172), 7},
  {QMI_UIM_ACTIVATE_SIMLOCK_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 174), 7},
  {QMI_UIM_GET_SIMLOCK_TOKEN_RESP_V01, QMI_IDL_TYPE16(0, 176), 3316}
};

static const qmi_idl_service_message_table_entry uim_service_indication_messages_v01[] = {
  {QMI_UIM_READ_TRANSPARENT_IND_V01, QMI_IDL_TYPE16(0, 4), 5785},
  ...
  {QMI_UIM_STATUS_CHANGE_IND_V01, QMI_IDL_TYPE16(0, 47), 6870},
  {QMI_UIM_REFRESH_IND_V01, QMI_IDL_TYPE16(0, 48), 1352},
  ...
  {QMI_UIM_SLOT_STATUS_CHANGE_IND_V01, QMI_IDL_TYPE16(0, 89), 411},
  ...
  {QMI_UIM_GBA_KEY_STATUS_IND_V01, QMI_IDL_TYPE16(0, 136), 303},
  {QMI_UIM_PURGE_TEMPORARY_IDENTITY_IND_V01, QMI_IDL_TYPE16(0, 139), 18},
  {QMI_UIM_ADD_PROFILE_IND_V01, QMI_IDL_TYPE16(0, 154), 34},
  {QMI_UIM_READ_BER_TLV_IND_V01, QMI_IDL_TYPE16(0, 169), 4132},
  {QMI_UIM_READ_BER_TLV_LONG_IND_V01, QMI_IDL_TYPE16(0, 170), 4114}
};
