#======================================================================
#makefile for libmmcamera2_isp2_bpc48.so form mm-camera2
#======================================================================
...
LOCAL_SRC_FILES        := module_bpc48.c \
                          bpc48.c
ifeq ($(OEM_CHROMATIX), true)
LOCAL_C_INCLUDES += $(LOCAL_EXTEN_ISP_INCLUDES)
LOCAL_SRC_FILES  += ../../../../../../../../mm-camera-ext/mm-camera2/media-controller/modules/isp2/bpc48_ext.c
