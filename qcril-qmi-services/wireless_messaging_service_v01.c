...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/wms/src/wireless_messaging_service_v01.c#12 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t wms_mwi_summary_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wms_mwi_summary_type_v01, message_type),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wms_mwi_summary_type_v01, new_msg),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wms_mwi_summary_type_v01, old_msg),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wms_mwi_summary_type_v01, new_urgent),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wms_mwi_summary_type_v01, old_urgent),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wms_mwi_detail_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wms_mwi_detail_type_v01, message_type),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET8(wms_mwi_detail_type_v01, to_address),
  WMS_TRANSPORT_MWI_ADDR_LENGTH_MAX_V01,

  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wms_mwi_detail_type_v01, from_address),
  WMS_TRANSPORT_MWI_ADDR_LENGTH_MAX_V01,

  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wms_mwi_detail_type_v01, subject),
  WMS_TRANSPORT_MWI_ADDR_LENGTH_MAX_V01,

  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wms_mwi_detail_type_v01, date_time),
  WMS_TRANSPORT_MWI_DATE_LENGTH_MAX_V01,

  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_mwi_detail_type_v01, priority),

  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wms_mwi_detail_type_v01, message_id),
  WMS_TRANSPORT_MWI_ADDR_LENGTH_MAX_V01,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wms_reject_cause_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wms_reject_cause_type_v01, reject_type),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_reject_cause_type_v01, reject_value),
...
static const uint8_t wms_set_event_report_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_mwi_message) - QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_mwi_message_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_mwi_message),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_ll_err_codes) - QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_ll_err_codes_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_ll_err_codes)
};
...
static const uint8_t wms_event_report_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, call_control_info) - QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, call_control_info_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wms_event_report_ind_msg_v01, call_control_info),
  QMI_IDL_TYPE88(0, 5),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, bc_sms_rat_info) - QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, bc_sms_rat_info_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_event_report_ind_msg_v01, bc_sms_rat_info),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, verstat_status_info) - QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, verstat_status_info_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_event_report_ind_msg_v01, verstat_status_info),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, warning_area) - QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, warning_area_valid)),
  0x1A,
  ...
  QMI_IDL_OFFSET16ARRAY(wms_event_report_ind_msg_v01, warning_area),
  ((WMS_BC_WARNING_AREA_COORDINATE_LENGTH_MAX_V01) & 0xFF), ((WMS_BC_WARNING_AREA_COORDINATE_LENGTH_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, warning_area) - QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, warning_area_len)
};
...
static const uint8_t wms_raw_send_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, link_enable_mode) - QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, link_enable_mode_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_raw_send_req_msg_v01, link_enable_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, link_control_mode) - QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, link_control_mode_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_raw_send_req_msg_v01, link_control_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, sms_is_command_tpdu) - QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, sms_is_command_tpdu_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_raw_send_req_msg_v01, sms_is_command_tpdu)
};
...
static const uint8_t wms_raw_send_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_raw_send_resp_msg_v01, call_control_modified_info) - QMI_IDL_OFFSET8(wms_raw_send_resp_msg_v01, call_control_modified_info_valid)),
  0x15,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wms_raw_send_resp_msg_v01, call_control_modified_info),
  QMI_IDL_TYPE88(0, 9),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_raw_send_resp_msg_v01, rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_raw_send_resp_msg_v01, rej_cause_info_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wms_raw_send_resp_msg_v01, rej_cause_info),
  QMI_IDL_TYPE88(0, 32),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_raw_send_resp_msg_v01, sms_ims_rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_raw_send_resp_msg_v01, sms_ims_rej_cause_info_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_raw_send_resp_msg_v01, sms_ims_rej_cause_info)
};
...
static const uint8_t wms_get_smsc_address_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_smsc_address_req_msg_v01, index) - QMI_IDL_OFFSET8(wms_get_smsc_address_req_msg_v01, index_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_smsc_address_req_msg_v01, index)
};
...
static const uint8_t wms_send_from_mem_store_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, message_delivery_failure_type) - QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, message_delivery_failure_type_valid)),
  0x14,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, message_delivery_failure_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, rej_cause_info) - QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, rej_cause_info_valid)),
  0x15,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, rej_cause_info),
  QMI_IDL_TYPE88(0, 32),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, message_delivery_failure_cause) - QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, message_delivery_failure_cause_valid)),
  0x16,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, message_delivery_failure_cause),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, call_control_modified_info) - QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, call_control_modified_info_valid)),
  0x17,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wms_send_from_mem_store_resp_msg_v01, call_control_modified_info),
  QMI_IDL_TYPE88(0, 9),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_send_from_mem_store_resp_msg_v01, sms_ims_rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_send_from_mem_store_resp_msg_v01, sms_ims_rej_cause_info_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_send_from_mem_store_resp_msg_v01, sms_ims_rej_cause_info)
};
...
static const uint8_t wms_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_broadcast_config_events) - QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_broadcast_config_events_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_broadcast_config_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_transport_layer_mwi_info_events) - QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_transport_layer_mwi_info_events_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_transport_layer_mwi_info_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_sim_ready_info_events) - QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_sim_ready_info_events_valid)),
  0x16,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_sim_ready_info_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_smsc_addr_info_events) - QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_smsc_addr_info_events_valid)),
  0x17,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_smsc_addr_info_events),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, mem_full_ind_events) - QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, mem_full_ind_events_valid)),
  0x18,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, mem_full_ind_events)
};
...
static const uint8_t wms_get_indication_register_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_broadcast_config_events) - QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_broadcast_config_events_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_broadcast_config_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_transport_layer_mwi_info_events) - QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_transport_layer_mwi_info_events_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_transport_layer_mwi_info_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_sim_ready_events) - QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_sim_ready_events_valid)),
  0x16,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_sim_ready_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_smsc_addr_info_events) - QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_smsc_addr_info_events_valid)),
  0x17,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_smsc_addr_info_events),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, mem_full_ind_events) - QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, mem_full_ind_events_valid)),
  0x18,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, mem_full_ind_events)
};
...
static const uint8_t wms_async_raw_send_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, link_enable_mode) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, link_enable_mode_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_raw_send_req_msg_v01, link_enable_mode),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, link_control_mode) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, link_control_mode_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_raw_send_req_msg_v01, link_control_mode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, sms_is_command_tpdu) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, sms_is_command_tpdu_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_raw_send_req_msg_v01, sms_is_command_tpdu)
};
...
static const uint8_t wms_async_raw_send_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_ind_msg_v01, user_data) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_ind_msg_v01, user_data_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_raw_send_ind_msg_v01, user_data),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_ind_msg_v01, rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_ind_msg_v01, rej_cause_info_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wms_async_raw_send_ind_msg_v01, rej_cause_info),
  QMI_IDL_TYPE88(0, 32),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_ind_msg_v01, sms_ims_rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_ind_msg_v01, sms_ims_rej_cause_info_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_raw_send_ind_msg_v01, sms_ims_rej_cause_info)
};
...
static const uint8_t wms_async_send_from_mem_store_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_send_from_mem_store_ind_msg_v01, user_data) - QMI_IDL_OFFSET16RELATIVE(wms_async_send_from_mem_store_ind_msg_v01, user_data_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_send_from_mem_store_ind_msg_v01, user_data),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_send_from_mem_store_ind_msg_v01, rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_async_send_from_mem_store_ind_msg_v01, rej_cause_info_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wms_async_send_from_mem_store_ind_msg_v01, rej_cause_info),
  QMI_IDL_TYPE88(0, 32),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_send_from_mem_store_ind_msg_v01, sms_ims_rej_cause_info) - QMI_IDL_OFFSET16RELATIVE(wms_async_send_from_mem_store_ind_msg_v01, sms_ims_rej_cause_info_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wms_async_send_from_mem_store_ind_msg_v01, sms_ims_rej_cause_info)
};
...
static const uint8_t wms_get_service_ready_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, ready_status) - QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, ready_status_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, ready_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, sim_ready_registered_ind) - QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, sim_ready_registered_ind_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, sim_ready_registered_ind),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, sim_ready_status) - QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, sim_ready_status_valid)),
  0x13,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wms_get_service_ready_status_resp_msg_v01, sim_ready_status)
};
...
static const uint8_t wms_service_ready_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_service_ready_ind_msg_v01, sim_ready_status) - QMI_IDL_OFFSET8(wms_service_ready_ind_msg_v01, sim_ready_status_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wms_service_ready_ind_msg_v01, sim_ready_status)
};
...
static const uint8_t wms_transport_layer_mwi_ind_msg_data_v01[] = {
  0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wms_transport_layer_mwi_ind_msg_v01, message_waiting_summary_info),
  WMS_MESSAGE_TUPLE_MAX_V01,
  QMI_IDL_OFFSET8(wms_transport_layer_mwi_ind_msg_v01, message_waiting_summary_info) - QMI_IDL_OFFSET8(wms_transport_layer_mwi_ind_msg_v01, message_waiting_summary_info_len),
  QMI_IDL_TYPE88(0, 30),

  0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wms_transport_layer_mwi_ind_msg_v01, UE_address),
  WMS_TRANSPORT_MWI_ADDR_LENGTH_MAX_V01,

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_transport_layer_mwi_ind_msg_v01, message_waiting_detail_info) - QMI_IDL_OFFSET16RELATIVE(wms_transport_layer_mwi_ind_msg_v01, message_waiting_detail_info_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wms_transport_layer_mwi_ind_msg_v01, message_waiting_detail_info),
  ((WMS_TRANSPORT_MWI_TUPLE_MAX_V01) & 0xFF), ((WMS_TRANSPORT_MWI_TUPLE_MAX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(wms_transport_layer_mwi_ind_msg_v01, message_waiting_detail_info) - QMI_IDL_OFFSET16RELATIVE(wms_transport_layer_mwi_ind_msg_v01, message_waiting_detail_info_len),
  QMI_IDL_TYPE88(0, 31)
};
...
static const qmi_idl_type_table_entry  wms_type_table_v01[] = {
  ...
  {sizeof(wms_mwi_summary_type_v01), wms_mwi_summary_type_data_v01},
  {sizeof(wms_mwi_detail_type_v01), wms_mwi_detail_type_data_v01},
  {sizeof(wms_reject_cause_type_v01), wms_reject_cause_type_data_v01}
};
...
static const qmi_idl_message_table_entry wms_message_table_v01[] = {
  ...
  {sizeof(wms_get_smsc_address_req_msg_v01), wms_get_smsc_address_req_msg_data_v01},
  ...
  {sizeof(wms_transport_layer_mwi_ind_msg_v01), wms_transport_layer_mwi_ind_msg_data_v01}
};
...
{&wms_qmi_idl_type_table_object_v01, &common_qmi_idl_type_table_object_v01, &voice_service_common_qmi_idl_type_table_object_v02};
...
static const qmi_idl_service_message_table_entry wms_service_command_messages_v01[] = {
  ...
  {QMI_WMS_GET_SMSC_ADDRESS_REQ_V01, QMI_IDL_TYPE16(0, 23), 4},
  ...
  {QMI_WMS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 58), 36},
  ...
  {QMI_WMS_ASYNC_RAW_SEND_REQ_V01, QMI_IDL_TYPE16(0, 91), 311},
...
static const qmi_idl_service_message_table_entry wms_service_response_messages_v01[] = {
  ...
  {QMI_WMS_RAW_SEND_RESP_V01, QMI_IDL_TYPE16(0, 6), 307},
  ...
  {QMI_WMS_SEND_FROM_MEM_STORE_RESP_V01, QMI_IDL_TYPE16(0, 51), 307},
  ...
  {QMI_WMS_GET_INDICATION_REGISTER_RESP_V01, QMI_IDL_TYPE16(0, 69), 43},
  ...
  {QMI_WMS_GET_SERVICE_READY_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 101), 33},
...
static const qmi_idl_service_message_table_entry wms_service_indication_messages_v01[] = {
  {QMI_WMS_EVENT_REPORT_IND_V01, QMI_IDL_TYPE16(0, 4), 3244},
  ...
  {QMI_WMS_ASYNC_RAW_SEND_IND_V01, QMI_IDL_TYPE16(0, 93), 312},
  {QMI_WMS_ASYNC_SEND_ACK_IND_V01, QMI_IDL_TYPE16(0, 96), 16},
  {QMI_WMS_ASYNC_SEND_FROM_MEM_STORE_IND_V01, QMI_IDL_TYPE16(0, 99), 312},
  {QMI_WMS_SERVICE_READY_IND_V01, QMI_IDL_TYPE16(0, 102), 18},
  {QMI_WMS_BROADCAST_CONFIG_IND_V01, QMI_IDL_TYPE16(0, 103), 516},
  {QMI_WMS_TRANSPORT_LAYER_MWI_IND_V01, QMI_IDL_TYPE16(0, 106), 46422}
};
