...
/*==============================================================================
  ...
  DEPENDENCIES: Logging
                ...
                Copyright (c) 2011-2014, 2016, 2019 Qualcomm Technologies, Inc.
                All Rights Reserved.
...
#include <vendor/qti/hardware/slmadapter/1.0/ISlmAdapterCallback.h>
using ::vendor::qti::hardware::slmadapter::V1_0::ISlmAdapterCallback;

using ::android::sp;
using ::android::hidl::base::V1_0::IBase;
using ::android::hardware::hidl_string;

using vendor::qti::hardware::slmadapter::V1_0::SlmIpTableCmd;
using vendor::qti::hardware::slmadapter::V1_0::SlmIpTableInfo;
...
public:
  ...
  void setSlmAdapterCb(const sp<ISlmAdapterCallback> SlmAdapterCb);
  void clearServerCb(const sp<IServiceCallback> serverCb);
  void resetServerCb();
  void resetSlmAdapterCb();
...
private:
  ...
  static sp<ISlmAdapterCallback> mSlmAdapterCb;
  ...
  static void transposeSlmRatInfo(SlmIfaceInfo_t &slmIfaceInfo,SlmIpTableInfo &slmIpTableInfo);
};
