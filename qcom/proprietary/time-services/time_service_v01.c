...
static const uint8_t qmi_time_qtimer_delta_from_hlos_apps_req_msg_data_v01[] = {
  0x01,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_time_qtimer_delta_from_hlos_apps_req_msg_v01, hlos_apps_timetick),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_time_qtimer_delta_from_hlos_apps_req_msg_v01, sdx_timetick)
};

static const uint8_t qmi_time_get_qtimer_delta_from_hlos_apps_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_time_qtimer_delta_from_hlos_apps_resp_msg_v01, resp),
  0, 1
};

static const uint8_t qtimer_delta_update_indication_message_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qtimer_delta_update_indication_message_msg_v01, qtimer_delta)
};
...
static const qmi_idl_message_table_entry time_message_table_v01[] = {
  ...
  {sizeof(qmi_time_qtimer_delta_from_hlos_apps_req_msg_v01), qmi_time_qtimer_delta_from_hlos_apps_req_msg_data_v01},
  {sizeof(qmi_time_qtimer_delta_from_hlos_apps_resp_msg_v01), qmi_time_get_qtimer_delta_from_hlos_apps_resp_msg_data_v01},
  {sizeof(qtimer_delta_update_indication_message_msg_v01), qtimer_delta_update_indication_message_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry time_service_command_messages_v01[] = {
  ...
  {QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_REQ_MSG_V01, TYPE16(0, 13), 22}
};
...
static const qmi_idl_service_message_table_entry time_service_response_messages_v01[] = {
  ...
  {QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_RESP_MSG_V01, TYPE16(0, 14), 7}
};
...
static const qmi_idl_service_message_table_entry time_service_indication_messages_v01[] = {
  ...
  {QMI_TIME_ATS_5G_UPDATE_IND_MSG_V01, TYPE16(0, 12), 18},
  {QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_IND_MSG_V01, TYPE16(0, 15), 11}
};
