...
#define COEX_V01_IDL_MINOR_VERS 0x1E
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define COEX_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define COEX_V01_MAX_MESSAGE_ID 0x004B
/**
    @}
  */
...
#define COEX_MAX_TX_ANTENNA_V01 8
#define COEX_MAX_BANDS_TO_TIME_SHARE_V01 16
/**
    @}
  */
...
typedef enum {
  ...
  COEX_CARRIER_SECONDARY_2_V01 = 3, /**<  Component carrier ID for third secondary carrier  */
  COEX_CARRIER_SECONDARY_3_V01 = 4, /**<  Component carrier ID for fourth secondary carrier  */
  COEX_CARRIER_SECONDARY_4_V01 = 5, /**<  Component carrier ID for fifth secondary carrier  */
  COEX_CARRIER_SECONDARY_5_V01 = 6, /**<  Component carrier ID for sixth secondary carrier  */
  COEX_CARRIER_SECONDARY_6_V01 = 7, /**<  Component carrier ID for seventh secondary carrier  */
  COEX_CARRIER_SECONDARY_7_V01 = 8, /**<  Component carrier ID for eighth secondary carrier  */
  COEX_CARRIER_SECONDARY_8_V01 = 9, /**<  Component carrier ID for ninth secondary carrier  */
  COEX_CARRIER_SECONDARY_9_V01 = 10, /**<  Component carrier ID for tenth secondary carrier  */
  COEX_CARRIER_SECONDARY_10_V01 = 11, /**<  Component carrier ID for eleventh secondary carrier  */
...
#define COEX_PCM_LTE_5GHZ_CHANNEL_AVOIDANCE_V01 ((coex_policy_config_mask_v01)0x0000000000002000ull) /**<  Avoid LTE 5 GHz channels  */
#define COEX_PCM_RESERVED_FOR_CONTROLLER_2_V01 ((coex_policy_config_mask_v01)0x0000000000004000ull) /**<  Policy bitmask reserved for use by the controller (second instance)  */
#define COEX_PCM_RESERVED_FOR_CONTROLLER_3_V01 ((coex_policy_config_mask_v01)0x0000000000008000ull) /**<  Policy bitmask reserved for use by the controller (third instance)  */
#define COEX_PCM_NR_SUB6_HI_CHANNEL_AVOIDANCE_V01 ((coex_policy_config_mask_v01)0x0000000000010000ull) /**<  Policy bitmask for declaring vRLF for NR SUB6 High Channel Avoidance  */
...
#define COEX_PCM_ENFORCE_STATIC_WLAN_POWER_BACKOFF_V01 ((coex_wcn_policy_config_mask_v01)0x0000000000000080ull) /**<  Update Static Power Backoff  */
...
typedef uint64_t coex_antenna_mask_v01;
#define COEX_ANTENNA_BAND_2GHZ_CHAIN0_V01 ((coex_antenna_mask_v01)0x0000000000000001ull) /**<  Chain 0 antenna for 2 GHz channels   */
#define COEX_ANTENNA_BAND_2GHZ_CHAIN1_V01 ((coex_antenna_mask_v01)0x0000000000000002ull) /**<  Chain 1 antenna for 2 GHz channels  */
#define COEX_ANTENNA_BAND_5GHZ_CHAIN0_V01 ((coex_antenna_mask_v01)0x0000000000000004ull) /**<  Chain 0 antenna for 5 GHz channels  */
#define COEX_ANTENNA_BAND_5GHZ_CHAIN1_V01 ((coex_antenna_mask_v01)0x0000000000000008ull) /**<  Chain 1 antenna for 5 GHz channels  */
typedef uint64_t coex_call_type_mask_v01;
#define COEX_CALL_TYPE_DATA_V01 ((coex_call_type_mask_v01)0x0000000000000001ull) /**<  Data call   */
#define COEX_CALL_TYPE_VOICE_V01 ((coex_call_type_mask_v01)0x0000000000000002ull) /**<  Voice call  */
/** @addtogroup coex_qmi_enums
    @{
  */
typedef enum {
...
typedef enum {
  ...
  COEX_LTE2_TECH_V01 = 9, /**<  LTE (Instance 2)\n  */
  COEX_NR5G_TECH_V01 = 10, /**<  NR5G  */
 ...
 */
  ...
  /**<   Specifies the technology to which this range refers. Values:\n
      ...
      - COEX_LTE2_TECH (9) --  LTE (Instance 2)\n 
      - COEX_NR5G_TECH (10) --  NR5G  
 */
...
typedef struct {
  ...
  uint8_t old_state;
  /**<   Previous switch state of the antenna. */

  uint8_t new_state;
  /**<   Current switch state of the antenna.   */
}coex_tx_antenna_state_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_METRICS_SUBCODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_METRICS_CODE_NONE_V01 = 0, /**<  No metrics requested  */
  COEX_METRICS_SCAN_DUR_HISTO_V01 = 1, /**<  Log type-4 scan duration histogram over DIAG and reset data  */
  COEX_METRICS_SUBCODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_metrics_subcode_v01;
/**
    @}
  */
...
typedef struct {
  ...
  int32_t band_number;
  /**<   Band number from MMCP band enum. The coex_band_type_and_direction below
       contains information on this particular band.
  */

  coex_band_type_and_direction_v01 band;
  /**<   WWAN frequency, bandwidth, and direction for the band number above.
  */
}coex_band_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_LTE_INSTANCE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_LTE_INSTANCE1_V01 = 0, /**<  LTE instance 1 \n  */
  COEX_LTE_INSTANCE2_V01 = 1, /**<  LTE instance 2  */
  COEX_LTE_INSTANCE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_lte_instance_enum_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_TECH_INSTANCE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_TECH_INSTANCE1_V01 = 0, /**<  Technology instance 1 \n  */
  COEX_TECH_INSTANCE2_V01 = 1, /**<  Technology instance 2  */
  COEX_TECH_INSTANCE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_tech_instance_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Action to be taken by MDM when this conflict is found. Values:\n
      ...
      - COEX_PCM_LTE_5GHZ_CHANNEL_AVOIDANCE (0x0000000000002000) --  Avoid LTE 5 GHz channels 
      - COEX_PCM_RESERVED_FOR_CONTROLLER_2 (0x0000000000004000) --  Policy bitmask reserved for use by the controller (second instance) 
      - COEX_PCM_RESERVED_FOR_CONTROLLER_3 (0x0000000000008000) --  Policy bitmask reserved for use by the controller (third instance) 
      - COEX_PCM_NR_SUB6_HI_CHANNEL_AVOIDANCE (0x0000000000010000) --  Policy bitmask for declaring vRLF for NR SUB6 High Channel Avoidance 
 */
  ...
  /**<   Action to be taken by WCN when this conflict is found. Values:\n
      ...
      - COEX_PCM_ENFORCE_TDM_STICKY (0x0000000000000040) --  Run sticky TDM, which is similar to COEX_PCM_ENFORCE_TDM except after TDM
       is triggered, it stays triggered when the WLAN RX rate is recovered to high. 
      - COEX_PCM_ENFORCE_STATIC_WLAN_POWER_BACKOFF (0x0000000000000080) --  Update Static Power Backoff 
 */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Control for LTE 5 GHz State Indication */
  uint8_t lte_5ghz_state_valid;  /**< Must be set to true if lte_5ghz_state is being passed */
  uint8_t lte_5ghz_state;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  Control for Tx Antenna State Update */
  uint8_t tx_antenna_state_valid;  /**< Must be set to true if tx_antenna_state is being passed */
  uint8_t tx_antenna_state;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  Control for NR State Indication */
  uint8_t nr_state_valid;  /**< Must be set to true if nr_state is being passed */
  uint8_t nr_state;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  Control for WCI-2 Tx Antenna Map Indication */
  uint8_t wci2_tx_ant_map_valid;  /**< Must be set to true if wci2_tx_ant_map is being passed */
  uint8_t wci2_tx_ant_map;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  LTE2 Band Information */
  uint8_t lte2_band_info_valid;  /**< Must be set to true if lte2_band_info is being passed */
  coex_xsver_band_type_v01 lte2_band_info;
  /**<   \n Contains a set of center frequency and bandwidth
     for each uplink and downlink.
     Valid bandwidths are 2 (represents 1.4), 3, 5, 10, 15, 20 MHz.
  */
  ...
  /* Optional */
  /*  LTE2 TDD Information */
  uint8_t lte2_tdd_info_valid;  /**< Must be set to true if lte2_tdd_info is being passed */
  coex_lte_tdd_info_type_v01 lte2_tdd_info;
  /**<   \n  If LTE2 is operating with carrier aggregation, this TLV
           reflects the configuration of the primary carrier.
  */

  /* Optional */
  /*  LTE2 Off Period */
  uint8_t lte2_off_period_valid;  /**< Must be set to true if lte2_off_period is being passed */
  uint32_t lte2_off_period;
  /**<   Indicates the duration (in milliseconds) for which
     LTE2 is going to sleep. A value of 0xFFFFFFFF indicates either LTE2 is off
     indefinitely or is going out of the system.
  */

  /* Optional */
  /*  LTE2 Band Information Set */
  uint8_t lte2_band_info_set_valid;  /**< Must be set to true if lte2_band_info_set is being passed */
  uint32_t lte2_band_info_set_len;  /**< Must be set to # of elements in lte2_band_info_set */
  coex_band_type_and_direction_v01 lte2_band_info_set[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   \n Contains all LTE2 center frequencies and bandwidths
     for uplink and downlink. A band is specified as both uplink 
     and downlink by combining the mask values of uplink and downlink.
  */

  /* Optional */
  /*  LTE2 Component Carrier Information */
  uint8_t lte2_carrier_info_set_valid;  /**< Must be set to true if lte2_carrier_info_set is being passed */
  uint32_t lte2_carrier_info_set_len;  /**< Must be set to # of elements in lte2_carrier_info_set */
  coex_lte_carrier_info_type_v01 lte2_carrier_info_set[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   \n Contains information specific to each active LTE2 component carrier.
     To match this TLV to the LTE Band Information Set TLV, use the same 
     index for both arrays.\n
     Note: A carrier must contain one downlink band and can contain up to one uplink 
           band. In other words, a carrier ID can be shared by one uplink and one
  ...
  */
  ...
  /* Optional */
  /*  NR5G Band Information Set */
  uint8_t nr5g_band_info_set_valid;  /**< Must be set to true if nr5g_band_info_set is being passed */
  uint32_t nr5g_band_info_set_len;  /**< Must be set to # of elements in nr5g_band_info_set */
  coex_band_type_and_direction_v01 nr5g_band_info_set[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   \n Contains all NR5G center frequencies and bandwidths
     for uplink and downlink. A band is specified as both uplink 
     and downlink by combining the mask values of uplink and downlink.
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  LTE Instance */
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the policy is set for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 indicating LTE instance 1.
 */
  ...
  coex_wwan_tech_v01 tech;
  /**<   WWAN technology the policy is set for. Values: \n
      - COEX_LTE_TECH (0) --  LTE 
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n 
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n 
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n 
      ...
      - COEX_NR5G_TECH (10) --  NR5G 
 \n
 Note: If technology information is not passed as part of the message, the policy
 is set for LTE.
 */

  /* Optional */
  /*  Technology Instance */
  uint8_t tech_instance_valid;  /**< Must be set to true if tech_instance is being passed */
  coex_tech_instance_enum_v01 tech_instance;
  /**<   WWAN technology instance the policy is set for. Values: \n
      - COEX_TECH_INSTANCE1 (0) --  Technology instance 1 \n 
      - COEX_TECH_INSTANCE2 (1) --  Technology instance 2 
 \n
 Note: At startup the default value for the technology instance is zero,
 indicating instance 1 of the technology.
 */
  ...
  /**<   Specifies the technology component carrier for which to set the policy,
 if technology is doing carrier aggregation. If this field is not present, 
 COEX_CARRIER_PRIMARY is assumed. Values:\n
      ...
      - COEX_CARRIER_SECONDARY_2 (3) --  Component carrier ID for third secondary carrier 
      - COEX_CARRIER_SECONDARY_3 (4) --  Component carrier ID for fourth secondary carrier 
      - COEX_CARRIER_SECONDARY_4 (5) --  Component carrier ID for fifth secondary carrier 
      - COEX_CARRIER_SECONDARY_5 (6) --  Component carrier ID for sixth secondary carrier 
      - COEX_CARRIER_SECONDARY_6 (7) --  Component carrier ID for seventh secondary carrier 
      - COEX_CARRIER_SECONDARY_7 (8) --  Component carrier ID for eighth secondary carrier 
      - COEX_CARRIER_SECONDARY_8 (9) --  Component carrier ID for ninth secondary carrier 
      - COEX_CARRIER_SECONDARY_9 (10) --  Component carrier ID for tenth secondary carrier 
      - COEX_CARRIER_SECONDARY_10 (11) --  Component carrier ID for eleventh secondary carrier 
 */
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the policy has been set for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the policy is requested for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t tech_valid;  /**< Must be set to true if tech is being passed */
  coex_wwan_tech_v01 tech;
  /**<   WWAN technology the policy is requested for. Values: \n
      - COEX_LTE_TECH (0) --  LTE 
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n 
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n 
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n 
 ...
 */
  ...
  uint8_t tech_instance_valid;  /**< Must be set to true if tech_instance is being passed */
  coex_tech_instance_enum_v01 tech_instance;
  /**<   WWAN technology instance the policy is requested for. Values: \n
      - COEX_TECH_INSTANCE1 (0) --  Technology instance 1 \n 
      - COEX_TECH_INSTANCE2 (1) --  Technology instance 2 
 \n
 Note: At startup the default value for the technology instance is zero,
 ...
 */
  ...
  uint8_t carrier_valid;  /**< Must be set to true if carrier is being passed */
  coex_carrier_v01 carrier;
  /**<   Specifies the technology component carrier for which to get the policy,
 if technology is doing carrier aggregation. If this field is not present, 
 COEX_CARRIER_PRIMARY is assumed. Values:\n
      - COEX_CARRIER_PRIMARY (0) --  Primary component carrier ID 
      - COEX_CARRIER_SECONDARY_0 (1) --  Component carrier ID for first secondary carrier 
      ...
      - COEX_CARRIER_SECONDARY_10 (11) --  Component carrier ID for eleventh secondary carrier 
 */
}coex_get_policy_req_msg_v01;  /* Message */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the policy is for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t tech_valid;  /**< Must be set to true if tech is being passed */
  coex_wwan_tech_v01 tech;
  /**<   WWAN technology the policy is for. Values: \n
      - COEX_LTE_TECH (0) --  LTE 
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n 
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n 
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n 
      ...
      - COEX_NR5G_TECH (10) --  NR5G 
 \n
 Note: If technology information is not passed as part of the message,
 the policy is for LTE.
 */
  ...
  uint8_t tech_instance_valid;  /**< Must be set to true if tech_instance is being passed */
  coex_tech_instance_enum_v01 tech_instance;
  /**<   WWAN technology instance the policy is for. Values: \n
      - COEX_TECH_INSTANCE1 (0) --  Technology instance 1 \n 
      - COEX_TECH_INSTANCE2 (1) --  Technology instance 2 
 \n
 Note: At startup the default value for the technology instance is zero,
 ...
 */
  ...
  uint8_t carrier_valid;  /**< Must be set to true if carrier is being passed */
  coex_carrier_v01 carrier;
  /**<   Specifies the technology component carrier for which the policy is being sent,
 if technology is doing carrier aggregation. If this field is not present, 
 COEX_CARRIER_PRIMARY is assumed. Values:\n
      - COEX_CARRIER_PRIMARY (0) --  Primary component carrier ID 
      - COEX_CARRIER_SECONDARY_0 (1) --  Component carrier ID for first secondary carrier 
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the BLER Start request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the BLER Start response msg is for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the BLER Indication is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the BLER Stop request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 indicating LTE instance 1.
 */
}coex_metrics_lte_bler_stop_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the BLER Stop response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the SINR Start request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the SINR Start response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the SINR Read request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the SINR Read response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the SINR Stop request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 ...
 */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the SINR Stop response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Set Band Filter request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Set Band Filter response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Get Band Filter request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 indicating LTE instance 1.
 */
}coex_get_band_filter_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Get Band Filter response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Set Scan Freq Band Filter request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Set Scan Freq Band Filter response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
typedef struct {
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Get Scan Freq Band Filter request is made for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
 indicating LTE instance 1.
 */
}coex_get_scan_freq_band_filter_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t lte_instance_valid;  /**< Must be set to true if lte_instance is being passed */
  coex_lte_instance_enum_v01 lte_instance;
  /**<   LTE Instance the Get Scan Freq Band Filter response is sent for. Values: \n
      - COEX_LTE_INSTANCE1 (0) --  LTE instance 1 \n 
      - COEX_LTE_INSTANCE2 (1) --  LTE instance 2 
 \n
 Note: At startup the default value for the LTE instance is zero,
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables LTE-U. */
typedef struct {

  /* Mandatory */
  /*  LTE-U Configure */
  uint8_t enable;
  /**<   Set to TRUE to enable LTE-U. Otherwise LTE-U is disabled.
  */
}coex_configure_lte_5ghz_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables LTE-U. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_configure_lte_5ghz_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the 5 GHz LTE state. */
typedef struct {

  /* Optional */
  /*  LTE 5 GHz State */
  uint8_t lte_5ghz_active_valid;  /**< Must be set to true if lte_5ghz_active is being passed */
  uint8_t lte_5ghz_active;
  /**<   Provides the 5 GHz LTE state.
  */

  /* Optional */
  /*  LTE 5 GHz Frequency Set */
  uint8_t frequency_valid;  /**< Must be set to true if frequency is being passed */
  uint32_t frequency_len;  /**< Must be set to # of elements in frequency */
  uint32_t frequency[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   Contains all 5 GHz LTE center frequencies in KHz. 
  */
}coex_lte_5ghz_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Requests the antennas for a cold boot calibration. */
typedef struct {

  /* Mandatory */
  /*  Antennas to Switch */
  coex_antenna_mask_v01 antenna;
  /**<   Switches the antennas to WLAN. 
 Values: \n
      - COEX_ANTENNA_BAND_2GHZ_CHAIN0 (0x0000000000000001) --  Chain 0 antenna for 2 GHz channels  
      - COEX_ANTENNA_BAND_2GHZ_CHAIN1 (0x0000000000000002) --  Chain 1 antenna for 2 GHz channels 
      - COEX_ANTENNA_BAND_5GHZ_CHAIN0 (0x0000000000000004) --  Chain 0 antenna for 5 GHz channels 
      - COEX_ANTENNA_BAND_5GHZ_CHAIN1 (0x0000000000000008) --  Chain 1 antenna for 5 GHz channels 
 */
}coex_antenna_switch_to_wlan_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Requests the antennas for a cold boot calibration. */
typedef struct {
 ...
 Values: \n
      ...
      - COEX_ANTENNA_BAND_5GHZ_CHAIN1 (0x0000000000000008) --  Chain 1 antenna for 5 GHz channels 
 */
}coex_antenna_switch_to_wlan_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Releases the antennas after a cold boot calibration. */
typedef struct {

  /* Mandatory */
  /*  Antennas to Switch */
  coex_antenna_mask_v01 antenna;
  /**<   Switches the antennas back to MDM. 
 Values: \n
      - COEX_ANTENNA_BAND_2GHZ_CHAIN0 (0x0000000000000001) --  Chain 0 antenna for 2 GHz channels  
      - COEX_ANTENNA_BAND_2GHZ_CHAIN1 (0x0000000000000002) --  Chain 1 antenna for 2 GHz channels 
      - COEX_ANTENNA_BAND_5GHZ_CHAIN0 (0x0000000000000004) --  Chain 0 antenna for 5 GHz channels 
      - COEX_ANTENNA_BAND_5GHZ_CHAIN1 (0x0000000000000008) --  Chain 1 antenna for 5 GHz channels 
 */
}coex_antenna_switch_to_mdm_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Releases the antennas after a cold boot calibration. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_antenna_switch_to_mdm_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the antenna state. */
typedef struct {

  /* Optional */
  /*  Antenna Client Switch Position */
  uint8_t tx_antenna_state_valid;  /**< Must be set to true if tx_antenna_state is being passed */
  uint32_t tx_antenna_state_len;  /**< Must be set to # of elements in tx_antenna_state */
  coex_tx_antenna_state_type_v01 tx_antenna_state[COEX_MAX_TX_ANTENNA_V01];
  /**<   \n Contains switch positions of Tx antennas. 
  */
}coex_tx_antenna_state_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Requests coexistence-specific metrics. */
typedef struct {

  /* Optional */
  /*  Specific Metric Request */
  uint8_t subcode_valid;  /**< Must be set to true if subcode is being passed */
  coex_metrics_subcode_v01 subcode;
  /**<   Subcode associated with the specific metric requested.
 Values: \n
      - COEX_METRICS_CODE_NONE (0) --  No metrics requested 
      - COEX_METRICS_SCAN_DUR_HISTO (1) --  Log type-4 scan duration histogram over DIAG and reset data 
 */
}coex_metrics_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Requests coexistence-specific metrics. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_metrics_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables NR on requested band. */
typedef struct {

  /* Mandatory */
  /*  Set NR Configuration */
  uint8_t enable;
  /**<   Set to TRUE to enable NR on requested band. Otherwise NR is disabled
       on this band.
  */

  /* Optional */
  /*  Band Number for Set NR Request  */
  uint8_t band_number_valid;  /**< Must be set to true if band_number is being passed */
  int32_t band_number;
  /**<   Band number from MMCP band enum. Request to enable/disable on this
       band is sent.
  */
}coex_configure_nr_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables NR on requested band. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Band Number Set NR Response */
  uint8_t band_number_valid;  /**< Must be set to true if band_number is being passed */
  int32_t band_number;
  /**<   Band number from MMCP band enum. NR is enabled/disabled on this
       band.
  */
}coex_configure_nr_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the NR state on the band indicated. */
typedef struct {

  /* Optional */
  /*  NR State */
  uint8_t nr_active_valid;  /**< Must be set to true if nr_active is being passed */
  uint8_t nr_active;
  /**<   Provides the NR state.
  */

  /* Optional */
  /*  Current Active NR Band Information */
  uint8_t band_info_valid;  /**< Must be set to true if band_info is being passed */
  uint32_t band_info_len;  /**< Must be set to # of elements in band_info */
  coex_band_info_type_v01 band_info[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   Contains the following fields for the bands on which NR is active: \n
       - Band number from MMCP band enum \n
       - Frequency in KHz \n
       - Bandwidth in Hz \n
       - Direction (UL, DL, or both)
  */
}coex_nr_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables Wi-Fi time sharing feature on
              a specific WWAN technology. */
typedef struct {

  /* Mandatory */
  /*  Set Time Share Configuration */
  uint8_t enable;
  /**<   Set to TRUE to enable time sharing feature. Otherwise the feature
       is disabled.
  */
  ...
  uint8_t tech_valid;  /**< Must be set to true if tech is being passed */
  coex_wwan_tech_v01 tech;
  /**<   WWAN technology for which time sharing needs to be set for. Values: \n
      - COEX_LTE_TECH (0) --  LTE 
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n 
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n 
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n 
      ...
      - COEX_NR5G_TECH (10) --  NR5G 
 \n
 Note: If technology is not passed as part of the message, the feature
 is set for LTE.
 */
  ...
  uint8_t bands_valid;  /**< Must be set to true if bands is being passed */
  uint32_t bands_len;  /**< Must be set to # of elements in bands */
  coex_band_type_v01 bands[COEX_MAX_BANDS_TO_TIME_SHARE_V01];
  /**<   \n WWAN bands on which time sharing needs to be enabled.
       \n
       Note: If bands are not passed as part of the message, the feature
             is enabled for all bands of this particular technology.
  */

  /* Optional */
  /*  WWAN Call Type */
  uint8_t call_type_valid;  /**< Must be set to true if call_type is being passed */
  coex_call_type_mask_v01 call_type;
  /**<   WWAN call types for which time sharing needs to be enabled. Values: \n
      - COEX_CALL_TYPE_DATA (0x0000000000000001) --  Data call  
      - COEX_CALL_TYPE_VOICE (0x0000000000000002) --  Voice call 
 \n
 Note: If call type is not passed as part of the message, the feature
 is enabled for all call types of this particular technology.
 */

  /* Optional */
  /*  Long DRx Cycle */
  uint8_t long_drx_cycle_valid;  /**< Must be set to true if long_drx_cycle is being passed */
  uint16_t long_drx_cycle;
  /**<   Value of long DRx cycle in milliseconds. Time sharing is enabled if 
       technology has a DRx cycle larger than this value.
       \n
       Note: If a long DRx cycle is not passed as part of the message, the
             feature is enabled for long DRx cycle of more than 40 ms.
  */

  /* Optional */
  /*  Short DRx Timer */
  uint8_t short_drx_timer_valid;  /**< Must be set to true if short_drx_timer is being passed */
  uint16_t short_drx_timer;
  /**<   Value of short DRx timer in milliseconds. Time sharing is enabled if 
       technology has short DRX timer larger than this value.
       \n
       Note: If a short DRx timer is not passed as part of the message, the
             feature is disabled for any value of the short DRx timer.
  */

  /* Optional */
  /*  Granularity of the Sleep/Wakeup Duration WCI2 Message */
  uint8_t sleep_wakeup_dur_scale_valid;  /**< Must be set to true if sleep_wakeup_dur_scale is being passed */
  uint8_t sleep_wakeup_dur_scale;
  /**<   The multiplication factor for determining the inactivity duration
       in the sleep/wakeup WCI2 message in milliseconds.
       \n
       Note: By default the factor is 5 ms.
  */
}coex_config_time_share_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables Wi-Fi time sharing feature on
              a specific WWAN technology. */
typedef struct {
  ...
  */
  ...
  uint8_t tech_valid;  /**< Must be set to true if tech is being passed */
  coex_wwan_tech_v01 tech;
  /**<   WWAN technology for which time sharing has been enabled. Values: \n
      - COEX_LTE_TECH (0) --  LTE 
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n 
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n 
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n 
      ...
      - COEX_NR5G_TECH (10) --  NR5G 
 \n
 Note: If tech is not passed as part of the message, the feature
 is enabled for LTE.
 */
}coex_config_time_share_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the antenna number map for the WCI-2 Type-7 message 
              indices. */
typedef struct {

  /* Optional */
  /*  Antenna Map Information */
  uint8_t wci2_ant_map_valid;  /**< Must be set to true if wci2_ant_map is being passed */
  uint32_t wci2_ant_map_len;  /**< Must be set to # of elements in wci2_ant_map */
  uint8_t wci2_ant_map[COEX_MAX_TX_ANTENNA_V01];
  /**<   Map indicating antenna numbers for different indices in WCI-2
          Type-7 message. \n
       Note: The indices in the Type-7 message can be 0 to 7. The numbers in
             this array maps to different antennae for these indices.
  */

  /* Optional */
  /*  Default Index in a WCI2 Type-7 Message */
  uint8_t wci2_default_idx_valid;  /**< Must be set to true if wci2_default_idx is being passed */
  uint8_t wci2_default_idx;
  /**<   Contains the index that will be used for a default Type-7 message. \n
       Note: This is the default index passed as a part of Type-7 message
             if there is no Tx active.
  */
}coex_wci2_tx_ant_map_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Request for the WCI-2 Type-7 message indices to Tx antennae
              mapping. */
typedef struct {
  ...
  uint8_t enable;
  /**<   Set to FALSE to disable Tx antenna configuration. If this field is not 
       present, the Tx antenna map reporting remains enabled and the current map
       is sent to host via a Response message.
  */
}coex_get_wci2_tx_ant_map_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Request for the WCI-2 Type-7 message indices to Tx antennae
              mapping. */
typedef struct {
  ...
  */
  ...
  /**<   Contains the index that will be used for a default Type-7 message. \n
       Note: This is the default index passed as a part of Type-7 message
             if there is no Tx active.
  */
}coex_get_wci2_tx_ant_map_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables critical carrier for a WWAN technology. */
typedef struct {

  /* Mandatory */
  /*  Set Critical Carrier Configuration */
  uint8_t enable;
  /**<   Set to TRUE to enable critical carrier. Otherwise the critical carrier
       defaults to the LTE primary carrier.
  */
  ...
  uint8_t tech_valid;  /**< Must be set to true if tech is being passed */
  coex_wwan_tech_v01 tech;
  /**<   WWAN technology for which critical carrier needs to be set. Values: \n
      - COEX_LTE_TECH (0) --  LTE 
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n 
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n 
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n 
      ...
      - COEX_NR5G_TECH (10) --  NR5G 
 \n
 Note: If technology is not passed as part of the message, the critical
 carrier is set for LTE.
 */
  ...
  uint8_t tech_instance_valid;  /**< Must be set to true if tech_instance is being passed */
  coex_tech_instance_enum_v01 tech_instance;
  /**<   WWAN technology instance for which critical carrier needs to be set. Values: \n
      - COEX_TECH_INSTANCE1 (0) --  Technology instance 1 \n 
      - COEX_TECH_INSTANCE2 (1) --  Technology instance 2 
 \n
 Note: When this field is not present, the default value for the technology
 instance is zero, indicating instance 1 of the technology.
 */
  ...
  uint8_t carrier_valid;  /**< Must be set to true if carrier is being passed */
  coex_carrier_v01 carrier;
  /**<   Specifies the critical component carrier for which to report the 
 Tx antenna information for this particular WWAN technology. Values:\n
      - COEX_CARRIER_PRIMARY (0) --  Primary component carrier ID 
      - COEX_CARRIER_SECONDARY_0 (1) --  Component carrier ID for first secondary carrier 
      - COEX_CARRIER_SECONDARY_1 (2) --  Component carrier ID for second secondary carrier 
      - COEX_CARRIER_SECONDARY_2 (3) --  Component carrier ID for third secondary carrier 
      ...
      - COEX_CARRIER_SECONDARY_10 (11) --  Component carrier ID for eleventh secondary carrier 
 \n
 Note: If this field is not present, COEX_CARRIER_PRIMARY is assumed.
 */

  /* Optional */
  /*  WWAN Band Information */
  uint8_t band_info_valid;  /**< Must be set to true if band_info is being passed */
  coex_band_type_v01 band_info;
  /**<   \n WWAN band on which critical carrier needs to be set. \n
       Notes: \begin{itemize1}
        \item If coex_carrier is valid then that will supersede this
          field. The carrier passed there will be the critical carrier.
        \item If coex_carrier is not valid and band_info is valid then
          band_info will be used for critical carrier.
        \item If both band_info and coex_carrier are invalid then
          COEX_CARRIER_PRIMARY is the critical carrier.
        \vspace{-.18in}	
        \end{itemize1}
  */
}coex_set_crit_carrier_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables critical carrier for a WWAN technology. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_crit_carrier_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_COEX_CONFIGURE_LTE_5GHZ_V01 
//#define REMOVE_QMI_COEX_CONFIGURE_NR_V01 
//#define REMOVE_QMI_COEX_CONFIG_TIME_SHARE_V01 
...
//#define REMOVE_QMI_COEX_GET_WCI2_TX_ANT_MAP_V01 
...
//#define REMOVE_QMI_COEX_LTE_5GHZ_STATUS_IND_V01 
//#define REMOVE_QMI_COEX_METRICS_INFO_V01 
...
//#define REMOVE_QMI_COEX_NR_STATUS_IND_V01 
//#define REMOVE_QMI_COEX_RESET_V01 
//#define REMOVE_QMI_COEX_SET_BAND_FILTER_INFO_V01 
//#define REMOVE_QMI_COEX_SET_CRIT_CARRIER_V01 
...
//#define REMOVE_QMI_COEX_SWITCH_ANTENNA_TO_MDM_V01 
//#define REMOVE_QMI_COEX_SWITCH_ANTENNA_TO_WLAN_V01 
//#define REMOVE_QMI_COEX_TX_ANTENNA_STATE_IND_V01 
//#define REMOVE_QMI_COEX_WAKEUP_IND_V01 
//#define REMOVE_QMI_COEX_WCI2_TX_ANT_MAP_IND_V01 
...
#define QMI_COEX_CONFIGURE_LTE_5GHZ_REQ_V01 0x0040
#define QMI_COEX_CONFIGURE_LTE_5GHZ_RESP_V01 0x0040
#define QMI_COEX_LTE_5GHZ_STATUS_IND_V01 0x0041
#define QMI_COEX_SWITCH_ANTENNA_TO_WLAN_REQ_V01 0x0042
#define QMI_COEX_SWITCH_ANTENNA_TO_WLAN_RESP_V01 0x0042
#define QMI_COEX_SWITCH_ANTENNA_TO_MDM_REQ_V01 0x0043
#define QMI_COEX_SWITCH_ANTENNA_TO_MDM_RESP_V01 0x0043
#define QMI_COEX_TX_ANTENNA_STATE_IND_V01 0x0044
#define QMI_COEX_METRICS_INFO_REQ_V01 0x0045
#define QMI_COEX_METRICS_INFO_RESP_V01 0x0045
#define QMI_COEX_CONFIGURE_NR_REQ_V01 0x0046
#define QMI_COEX_CONFIGURE_NR_RESP_V01 0x0046
#define QMI_COEX_NR_STATUS_IND_V01 0x0047
#define QMI_COEX_CONFIG_TIME_SHARE_REQ_V01 0x0048
#define QMI_COEX_CONFIG_TIME_SHARE_RESP_V01 0x0048
#define QMI_COEX_WCI2_TX_ANT_MAP_IND_V01 0x0049
#define QMI_COEX_GET_WCI2_TX_ANT_MAP_REQ_V01 0x004A
#define QMI_COEX_GET_WCI2_TX_ANT_MAP_RESP_V01 0x004A
#define QMI_COEX_SET_CRIT_CARRIER_REQ_V01 0x004B
#define QMI_COEX_SET_CRIT_CARRIER_RESP_V01 0x004B
/**
    @}
  */
