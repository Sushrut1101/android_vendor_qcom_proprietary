...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/voice/api/voice_service_common_v02.h#14 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define VOICE_SERVICE_COMMON_V02_IDL_MINOR_VERS 0x17
...
typedef enum {
  ...
  CALL_STATE_PRE_ALERTING_V02 = 0x0B, /**<  MT call is in Pre alerting state (applicable to IMS Call Composer) \n  */
...
typedef enum {
  ...
  CALL_END_CAUSE_PDN_DISCONNECTED_V02 = 0x17F,
  CALL_END_CAUSE_REJECTED_ELSEWHERE_V02 = 0x180,
  CALL_END_CAUSE_CALL_PULLED_V02 = 0x181,
  CALL_END_CAUSE_CALL_PULL_OUT_OF_SYNC_V02 = 0x182,
  CALL_END_CAUSE_HOLD_RESUME_FAILED_V02 = 0x183,
  CALL_END_CAUSE_HOLD_RESUME_CANCELED_V02 = 0x184,
  CALL_END_CAUSE_REINVITE_COLLISION_V02 = 0x185,
  CALL_END_CAUSE_PROTOCOL_Q850_ERROR_V02 = 0x186,
  CALL_END_CAUSE_CSFB_NOT_FEASIBLE_IN_ROAM_CS_NW_V02 = 0x187,
  CALL_END_CAUSE_SIP_503_SERVER_UNAVAILABLE_V02 = 0x188,
  CALL_END_CAUSE_INCOMING_REJ_CAUSE_CALL_ONGOING_CW_DISABLED_V02 = 0x189,
  CALL_END_CAUSE_INCOMING_REJ_CAUSE_CALL_ON_OTHER_SUB_V02 = 0x18A,
  CALL_END_CAUSE_INCOMING_REJ_CAUSE_1X_COLLISION_V02 = 0x18B,
  CALL_END_CAUSE_SRV_NOT_REGISTERED_V02 = 0x18C,
  CALL_END_CAUSE_CALL_TYPE_NOT_ALLOWED_V02 = 0x18D,
  CALL_END_CAUSE_EMRG_CALL_ONGOING_V02 = 0x18E,
  CALL_END_CAUSE_CALL_SETUP_ONGOING_V02 = 0x18F,
  CALL_END_CAUSE_MAX_CALL_LIMIT_REACHED_V02 = 0x190,
  CALL_END_CAUSE_UNSUPPORTED_SIP_HDRS_V02 = 0x191,
  CALL_END_CAUSE_CALL_TRANSFER_ONGOING_V02 = 0x192,
  CALL_END_CAUSE_PRACK_TIMEOUT_V02 = 0x193,
  CALL_END_CAUSE_QOS_FAILURE_V02 = 0x194,
  CALL_END_CAUSE_ONGOING_HANDOVER_V02 = 0x195,
  CALL_END_CAUSE_VT_WITH_TTY_NOT_ALLOWED_V02 = 0x196,
  CALL_END_CAUSE_CALL_UPGRADE_ONGOING_V02 = 0x197,
  CALL_END_CAUSE_CONFERENCE_WITH_TTY_NOT_ALLOWED_V02 = 0x198,
  CALL_END_CAUSE_CALL_CONFERENCE_ONGOING_V02 = 0x199,
  CALL_END_CAUSE_VT_WITH_AVPF_NOT_ALLOWED_V02 = 0x19A,
  CALL_END_CAUSE_ENCRYPTION_CALL_ONGOING_V02 = 0x19B,
  CALL_END_CAUSE_INCOM_REJ_CAUSE_UI_NOT_READY_V02 = 0x19C,
  CALL_END_CAUSE_CS_CALL_ONGOING_V02 = 0x19D,
  CALL_END_CAUSE_UNWANTED_CALL_V02 = 0x25F,
  CALL_END_CAUSE_INCOMING_REJ_CAUSE_CALL_ONGOING_CB_ENABLED_V02 = 0x260,
  ...
  CALL_END_CAUSE_CALL_COMPLETED_ELSEWHERE_V02 = 0x25D,
  CALL_END_CAUSE_RETRY_ON_IMS_WITHOUT_RTT_V02 = 0x25E,
  CALL_END_CAUSE_NOT_ACCEPTABLE_GLOBAL_V02 = 0x261,
...
/** @addtogroup voice_service_common_qmi_enums
  ...
  */
typedef enum {
  MT_IMS_VERSTAT_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MT_IMS_TN_VALIDATION_NONE_V02 = 0, /**<  No telephone number validation obtained from the network \n  */
  MT_IMS_TN_VALIDATION_PASS_V02 = 1, /**<  Telephone number validation from the network PASSED \n  */
  MT_IMS_TN_VALIDATION_FAIL_V02 = 2, /**<  Telephone number validation from the network FAILED \n  */
  MT_IMS_VERSTAT_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mt_ims_verstat_enum_v02;
/**
    @}
  */
