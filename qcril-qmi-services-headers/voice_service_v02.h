...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/voice/api/voice_service_v02.h#51 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define VOICE_V02_IDL_MINOR_VERS 0x76
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x007A
/**
    @}
  */
...
#define QMI_VOICE_IP_CALLER_INFO_CONTENT_TYPE_LENGTH_V02 25
#define QMI_VOICE_IP_CALLER_INFO_LENGTH_V02 140
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  IP Caller Info Status Events */
  uint8_t ip_caller_info_status_events_valid;  /**< Must be set to true if ip_caller_info_status_events is being passed */
  uint8_t ip_caller_info_status_events;
  /**<   Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  eCall HLAP Timer Status Events */
  uint8_t ecall_hlap_timer_status_events_valid;  /**< Must be set to true if ecall_hlap_timer_status_events is being passed */
  uint8_t ecall_hlap_timer_status_events;
  /**<   Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  eCall Era Glonass Enabled Status Events */
  uint8_t ecall_era_glonass_enabled_status_events_valid;  /**< Must be set to true if ecall_era_glonass_enabled_status_events is being passed */
  uint8_t ecall_era_glonass_enabled_status_events;
  /**<   Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  SUPS_MODE_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SUPS_MODE_TEMPORARY_V02 = 0x00, /**<  Temporary TIR mode
   */
  SUPS_MODE_PERMANENT_V02 = 0x01, /**<  Permanent TIR mode
   */
  SUPS_MODE_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sups_mode_enum_v02;
/**
    @}
  */
...
typedef enum {
  ...
  VOICE_DIAL_CALL_SRV_TYPE_PS_ONLY_V02 = 0x0A,
  VOICE_DIAL_CALL_SRV_TYPE_NR5G_V02 = 0x0B,
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the call is a secure call; boolean value.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Service type. Values: \n
       ...
       - 0x0A -- VOICE_DIAL_CALL_SRV_TYPE_ PS_ONLY -- Packet-switched domain \n
       - 0x0B -- VOICE_DIAL_CALL_SRV_TYPE_ NR5G -- NR5G
  */
 ...
 */
  ...
  */
  ...
  /**<   Indicates whether the current call is an RTT call. Values: \n
 ...
 */
  ...
  */
  ...
  /**<   Indicates whether the call is being originated on a secondary line. \n
  ...
  */
  ...
  /**<   Indicates whether the temporary reference number (TRN) is avaialble for the secondary line. \n
       Set to FALSE by default.
  */

  /* Optional */
  /*  IP Caller Info Content Type */
  uint8_t ip_caller_info_content_type_valid;  /**< Must be set to true if ip_caller_info_content_type is being passed */
  uint32_t ip_caller_info_content_type_len;  /**< Must be set to # of elements in ip_caller_info_content_type */
  uint8_t ip_caller_info_content_type[QMI_VOICE_IP_CALLER_INFO_CONTENT_TYPE_LENGTH_V02];
  /**<   Content type of the IP caller information.
       Range: 1 to 25.
  */

  /* Optional */
  /*  IP Caller Info */
  uint8_t ip_caller_info_valid;  /**< Must be set to true if ip_caller_info is being passed */
  uint32_t ip_caller_info_len;  /**< Must be set to # of elements in ip_caller_info */
  uint8_t ip_caller_info[QMI_VOICE_IP_CALLER_INFO_LENGTH_V02];
  /**<   IP caller information sent over the SIP header. It is
       ASN.1 PER encoded data. Range: 1 to 140.
  */

  /* Optional */
  /*  Mode on which previous call failed  */
  uint8_t call_failure_mode_valid;  /**< Must be set to true if call_failure_mode is being passed */
  call_mode_enum_v02 call_failure_mode;
  /**<   Indicates the mode on which previous call failed. \n
       If this TLV is set as WLAN, the call is originated on WLAN \n
       If this TLV is set as Cellular RATs, the call is originated on Cellular Networks \n
       This TLV needs to be configured along with call_failure_reason to capture complete
       call failure info \n
       If this TLV is not configured, this msg will be treated as Legacy Dial Call command \n
  */

  /* Optional */
  /*  Reason for which previous call failed  */
  uint8_t call_failure_reason_valid;  /**< Must be set to true if call_failure_reason is being passed */
  call_end_reason_enum_v02 call_failure_reason;
  /**<   Indicates the reason with which previous call failed. \n
       This TLV specifies the reason for which call is dialed on the call_failure_mode \n
       This TLV needs to be configured along with call_failure_mode to capture complete
       call failure info \n
       If this TLV is not configured, this msg will be treated as Legacy Dial Call command \n
  */
 ...
 */
  ...
  /**<   SIP URI number as an ASCII string. Range: 1 to 128.
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_srvcc_call;
  /**<   Indicates whether the call is an SRVCC call; boolean value.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the call has additional information; boolean value.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Number as an ASCII string. Range: 1 to 128.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Connected number in ASCII characters. Range: 1 to 128.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the connected number occurred as a result of an ECT. Values: \n
...
typedef struct {
  ...
  */
  ...
  /**<   An emergency service category received from IMS.
   */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_nw_end_unwanted_call;
  /**<   Value that indicates nw ended the unwanted robocall with SIP 607.
  */
}voice_nw_end_unwanted_call_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   TIR Mode. Values: \n
      - SUPS_MODE_TEMPORARY (0x00) --  Temporary TIR mode

      - SUPS_MODE_PERMANENT (0x01) --  Permanent TIR mode

 */
}voice_tir_mode_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_secondary_valid;  /**< Must be set to true if is_secondary is being passed */
  uint8_t is_secondary;
  /**<   Indicates whether the call is on a secondary line. \n
       Set to FALSE by default.
  */
  ...
  */
  ...
  /**<   \n An emergency service category received from IMS when a call ends with cause code 380;
        see \hyperref[STD-24008]{3GPP TS 24.008} Table 10.5.135 for valid
data. */

  /* Optional */
  /*  Array of MT Display Unwanted Missed Call Info** */
  uint8_t is_nw_end_unwanted_call_valid;  /**< Must be set to true if is_nw_end_unwanted_call is being passed */
  uint32_t is_nw_end_unwanted_call_len;  /**< Must be set to # of elements in is_nw_end_unwanted_call */
  voice_nw_end_unwanted_call_type_v02 is_nw_end_unwanted_call[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   \n When the nw ends the MT call with SIP 607, the value of the
          is_unwanted_call flag is received and determines the
          value of the is_nw_end_unwanted_call flag. */

  /* Optional */
  /*  Mode Associated with TIR */
  uint8_t tir_mode_valid;  /**< Must be set to true if tir_mode is being passed */
  uint32_t tir_mode_len;  /**< Must be set to # of elements in tir_mode */
  voice_tir_mode_type_v02 tir_mode[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   \n The value of TIR mode of the MT call, it can be Temporary or Permanent mode.
  */
...
typedef enum {
  ...
  VOICE_SERVICE_ACTIVATE_V02 = 0x01, /**<  Activate \n  */
  VOICE_SERVICE_DEACTIVATE_V02 = 0x02, /**<  Dectivate \n  */
  VOICE_SERVICE_REGISTER_V02 = 0x03, /**<  Register \n  */
  VOICE_SERVICE_ERASE_V02 = 0x04, /**<  Erase  */
...
typedef enum {
  ...
  VOICE_REASON_FWD_UNCONDITIONAL_V02 = 0x01, /**<  Unconditional call forwarding \n  */
  VOICE_REASON_FWD_MOBILEBUSY_V02 = 0x02, /**<  Forward when the mobile is busy \n  */
  VOICE_REASON_FWD_NOREPLY_V02 = 0x03, /**<  Forward when there is no reply \n  */
  VOICE_REASON_FWD_UNREACHABLE_V02 = 0x04, /**<  Forward when the call is unreachable \n  */
  VOICE_REASON_FWD_ALLFORWARDING_V02 = 0x05, /**<  All forwarding \n  */
  VOICE_REASON_FWD_ALLCONDITIONAL_V02 = 0x06, /**<  All conditional forwarding \n  */
  VOICE_REASON_BARR_ALLOUTGOING_V02 = 0x07, /**<  All outgoing \n  */
  VOICE_REASON_BARR_OUTGOINGINT_V02 = 0x08, /**<  Outgoing internal \n  */
  VOICE_REASON_BARR_OUTGOINGINTEXTOHOME_V02 = 0x09, /**<  Outgoing external to home \n  */
  VOICE_REASON_BARR_ALLINCOMING_V02 = 0x0A, /**<  All incoming \n  */
  VOICE_REASON_BARR_INCOMINGROAMING_V02 = 0x0B, /**<  Roaming incoming \n  */
  VOICE_REASON_BARR_ALLBARRING_V02 = 0x0C, /**<  All calls are barred \n  */
  VOICE_REASON_BARR_ALLOUTGOINGBARRING_V02 = 0x0D, /**<  All outgoing calls are barred \n  */
  VOICE_REASON_BARR_ALLINCOMINGBARRING_V02 = 0x0E, /**<  All incoming calls are barred \n  */
  VOICE_REASON_CALLWAITING_V02 = 0x0F, /**<  Call waiting \n  */
  VOICE_REASON_CLIP_V02 = 0x10, /**<  Calling line identification presentation \n  */
  VOICE_REASON_CLIR_V02 = 0x11, /**<  Calling line identification restriction \n  */
  VOICE_REASON_COLP_V02 = 0x12, /**<  Connected line identification presentation \n  */
  VOICE_REASON_COLR_V02 = 0x13, /**<  Connected line identification restriction \n  */
  VOICE_REASON_CNAP_V02 = 0x14, /**<  Calling name presentation \n  */
  VOICE_REASON_BARR_INCOMING_NUMBER_V02 = 0x15, /**<  Incoming calls from registered and activated numbers are barred \n  */
  VOICE_REASON_BARR_INCOMING_ANONYMOUS_V02 = 0x16, /**<  Incoming calls from anonymous numbers are barred  */
...
typedef struct {
  ...
  /**<   Combination (sum) of information class constants
...
typedef struct {
  ...
  */
  ...
  uint8_t is_secondary_valid;  /**< Must be set to true if is_secondary is being passed */
  uint8_t is_secondary;
  /**<   Indicates whether the USSD is originated on a secondary line. \n
       Set to FALSE by default.
   */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  USSD Error Cause Description  */
  uint8_t ussd_error_description_valid;  /**< Must be set to true if ussd_error_description is being passed */
  uint16_t ussd_error_description[QMI_VOICE_USS_DATA_MAX_V02 + 1];
  /**<   USSD error cause description received from the network. This text
       contains up to 256 UTF-16 characters and it is not guaranteed to be
       NULL terminated. Range: 0 to 256.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   eCall MSD can contain up to 140-byte
       ASN.1 unaligned PER data as described in
       \hyperref[CEN-EN-15722]{CEN EN 15722}.
       Range: 0 to 140. Set the length to 0 to disable this feature.
  */
  ...
  /**<   Indicates whether the secure call feature is enabled. Values: \n
       - 0x00 -- Not enabled \n
       - 0x01 -- Enabled
  */
 ...
 */
  ...
  */
  ...
  /**<   Distinguishes between the supplementary service data sent to the
 ...
 */
  ...
  */
  ...
  uint8_t sip_uri_valid;  /**< Must be set to true if sip_uri is being passed */
  char sip_uri[QMI_VOICE_SIP_URI_MAX_V02 + 1];
  /**<   SIP URI number in ASCII string. Range: 1 to 128.
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Speech Codec Type (Deprecated: Use Speech Codec Mask Type place of this.) */
 ...
 */
  ...
  */
  ...
  /**<   Speech codec mask consisting of all speech codec values in the request.
 Use either the speech_codec or the speech_codec_mask TLV, but not both.
 If both are included, an error is thrown.
 Values: \n
 ...
 */
  ...
  /**<   Specifies the highest priority speech codec. If not given
 and the speech_codec is present, speech_codec is the highest priority.
 If the speech_codec_mask is present, the least significant bit
 ...
 */
  ...
  uint8_t rtt_mode_valid;  /**< Must be set to true if rtt_mode is being passed */
  rtt_mode_type_v02 rtt_mode;
  /**<   Indicates whether the current call the current call is an RTT call. Values: \n
      - RTT_MODE_DISABLED (0) --  non-RTT call \n
      - RTT_MODE_FULL (1) --  RTT call with RTT being used from both sides
 */
  ...
  uint8_t is_secure_call_valid;  /**< Must be set to true if is_secure_call is being passed */
  uint8_t is_secure_call;
  /**<   Indicates whether the current call is a secure call.
  */
...
typedef enum {
  ...
  VOICE_NETWORK_MODE_NR5G_V02 = 0x07, /**<  NR5G \n  */
...
typedef struct {
  ...
  /**<   Network mode. Values: \n
      ...
      - VOICE_NETWORK_MODE_NR5G (0x07) --  NR5G \n
 */
...
typedef struct {
  ...
  /**<   URI of the participant. This is unique to each user
       ...
       to be NULL terminated. Range in bytes: 0 to 128.
  */
 ...
 */
  ...
  /**<   Disconnection information.
       ...
       to be NULL terminated. Range in bytes: 0 to 64.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Additional call information is a part of the complete update and is
       ...
       up to 2048 UTF-8 characters. Range: 1 to 2048.
  */
 ...
 */
  ...
  /* Optional */
  /*  RAT Information (Deprecated; use QMI_VOICE_ALL_CALL_STATUS_IND to determine the RAT) */
...
typedef struct {
  ...
  */
  ...
  /**<   Boolean value indicating whether this is an Explicit Call Transfer.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the secure call context is established. Values: \n
...
typedef struct {
  ...
  /**<   WWAN-911 Timer value in seconds. Range: 0 to 1024.
  */
...
typedef enum {
  ...
  VOICE_ECALL_MSD_START_RECEIVED_V02 = 0x05, /**<  Start Recieved and SYNC is Locked  */
  VOICE_ECALL_MSD_LL_ACK_RECEIVED_V02 = 0x06, /**<  LL ACKS are recieved  */
  VOICE_ECALL_MSD_TX_USER_DEFINED_1_V02 = 0x07, /**<  Customer defined MSD TX Status  */
  VOICE_ECALL_MSD_TX_USER_DEFINED_2_V02 = 0x08, /**<  Customer defined MSD TX Status  */
  VOICE_ECALL_MSD_TX_USER_DEFINED_3_V02 = 0x09,
...
typedef struct {
  ...
  */
  ...
  /**<   Minimum set of data transmission status. Values: \n
      ...
      - VOICE_ECALL_MSD_START_RECEIVED (0x05) --  Start Recieved and SYNC is Locked
      - VOICE_ECALL_MSD_LL_ACK_RECEIVED (0x06) --  LL ACKS are recieved
      - VOICE_ECALL_MSD_TX_USER_DEFINED_1 (0x07) --  Customer defined MSD TX Status
      - VOICE_ECALL_MSD_TX_USER_DEFINED_2 (0x08) --  Customer defined MSD TX Status
      - VOICE_ECALL_MSD_TX_USER_DEFINED_3 (0x09) --
 */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  ECALL_HLAP_TIMER_STATUS_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_ECALL_TIMER_STATUS_INACTIVE_V02 = 0x00, /**<  eCall Timer status Inactive \n  */
  VOICE_ECALL_TIMER_STATUS_ACTIVE_V02 = 0x01, /**<  eCall Timer Status Active  */
  VOICE_ECALL_TIMER_STATUS_STARTED_V02 = 0x02, /**<  eCall Timer status started \n  */
  VOICE_ECALL_TIMER_STATUS_STOPPED_V02 = 0x03, /**<  eCall Timer Status stopped  */
  VOICE_ECALL_TIMER_STATUS_EXPIRED_V02 = 0x04, /**<  eCall Timer status expired \n  */
  ECALL_HLAP_TIMER_STATUS_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}ecall_hlap_timer_status_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about eCall HLAP Timer Status. */
typedef struct {

  /* Optional */
  /*  eCall t2_timer_status */
  uint8_t t2_timer_status_valid;  /**< Must be set to true if t2_timer_status is being passed */
  ecall_hlap_timer_status_enum_v02 t2_timer_status;
  /**<   eCall HLAP timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall Timer status Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall Timer Status Active
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall Timer status started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  eCall Timer Status stopped
      - VOICE_ECALL_TIMER_STATUS_EXPIRED (0x04) --  eCall Timer status expired \n
 */

  /* Optional */
  /*  eCall t5_timer_status */
  uint8_t t5_timer_status_valid;  /**< Must be set to true if t5_timer_status is being passed */
  ecall_hlap_timer_status_enum_v02 t5_timer_status;
  /**<   eCall HLAP timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall Timer status Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall Timer Status Active
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall Timer status started \n
 ...
 */
  ...
  /* Optional */
  /*  eCall t6_timer_status */
  uint8_t t6_timer_status_valid;  /**< Must be set to true if t6_timer_status is being passed */
  ecall_hlap_timer_status_enum_v02 t6_timer_status;
  /**<   eCall HLAP timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall Timer status Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall Timer Status Active
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall Timer status started \n
 ...
 */
  ...
  /* Optional */
  /*  eCall t7_timer_status */
  uint8_t t7_timer_status_valid;  /**< Must be set to true if t7_timer_status is being passed */
  ecall_hlap_timer_status_enum_v02 t7_timer_status;
  /**<   eCall HLAP timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall Timer status Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall Timer Status Active
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall Timer status started \n
 ...
 */
  ...
  /* Optional */
  /*  eCall t9_timer_status */
  uint8_t t9_timer_status_valid;  /**< Must be set to true if t9_timer_status is being passed */
  ecall_hlap_timer_status_enum_v02 t9_timer_status;
  /**<   eCall HLAP timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall Timer status Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall Timer Status Active
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall Timer status started \n
      ...
      - VOICE_ECALL_TIMER_STATUS_EXPIRED (0x04) --  eCall Timer status expired \n
 */
}voice_ecall_hlap_timer_status_ind_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Queries the eCall HLAP Timer status */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}voice_get_ecall_hlap_timer_status_req_msg_v02;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Queries the eCall HLAP Timer status */
typedef struct {
 ...
 */
  ...
  /**<   eCall HLAP timer status. Values: \n
      ...
      - VOICE_ECALL_TIMER_STATUS_EXPIRED (0x04) --  eCall Timer status expired \n
 */
}voice_get_ecall_hlap_timer_status_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about eCall Era Glonass enabled Status. */
typedef struct {

  /* Mandatory */
  /*  eCall is_era_glonass_enabled  */
  uint8_t is_era_glonass_enabled;
  /**<   eCall era glonass enabled status. Values: \n
         @BOOLEAN()
  */
}voice_ecall_era_glonass_enabled_status_ind_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Queries the eCall era glonass enabled status */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}voice_get_ecall_era_glonass_enabled_status_req_msg_v02;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Queries the eCall era glonass enabled status */
typedef struct {
  ...
  /* Optional */
  /*  eCall is_era_glonass_enabled */
  uint8_t is_era_glonass_enabled_valid;  /**< Must be set to true if is_era_glonass_enabled is being passed */
  uint8_t is_era_glonass_enabled;
  /**<   eCall is_era_glonasss_enabled status. Values: \n
         @BOOLEAN()
  */
}voice_get_ecall_era_glonass_enabled_status_resp_msg_v02;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Verstat Info */
  uint8_t mt_call_verstat_info_valid;  /**< Must be set to true if mt_call_verstat_info is being passed */
  mt_ims_verstat_enum_v02 mt_call_verstat_info;
  /**<   Verstat info for the rejected call. \n
      - MT_IMS_TN_VALIDATION_NONE (0) --  No telephone number validation obtained from the network \n
      - MT_IMS_TN_VALIDATION_PASS (1) --  Telephone number validation from the network PASSED \n
      - MT_IMS_TN_VALIDATION_FAIL (2) --  Telephone number validation from the network FAILED \n
 */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about the IP caller information status. */
typedef struct {

  /* Mandatory */
  /*  Call ID */
  uint8_t call_id;
  /**<   Call ID for the IP Call.
  */

  /* Optional */
  /*  IP Caller Info Transmission Status */
  uint8_t caller_info_tx_succeeded_valid;  /**< Must be set to true if caller_info_tx_succeeded is being passed */
  uint8_t caller_info_tx_succeeded;
  /**<   Caller information transmission status. Values: \n
       - 0 -- FAILURE \n
	   - 1 -- SUCCESS
  */
}voice_ip_caller_info_status_ind_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Manages all call-independent supplementary services for
             call forwarding activation, deactivation, registration, and
             erasure.  */
typedef struct {
  ...
  /*  Supplementary Service Information */
  voice_service_enum_v02 voice_service;
  /**<   Supplementary service information. Values: \n
      - VOICE_SERVICE_ACTIVATE (0x01) --  Activate \n
      - VOICE_SERVICE_DEACTIVATE (0x02) --  Dectivate \n
      - VOICE_SERVICE_REGISTER (0x03) --  Register \n
      - VOICE_SERVICE_ERASE (0x04) --  Erase
 */
  ...
  /*  Service Class */
  uint8_t service_class_valid;  /**< Must be set to true if service_class is being passed */
  voice_service_class_enum_v02 service_class;
  /**<   Service class; see Table
       @latexonly\ref{tbl:extServiceClass}@endlatexonly for more
       information. If this TLV is not present, then voice service is one
       of the following: \n
       - ACTIVATE -- Activation request applies to all subscribed
         basic service groups against which all call forward is
         registered. \n
         - ERASURE -- Erasure request applies for all basic
           service groups for which all call forward operation is
           registered. \n
         - REGISTER -- Registration is performed for all subscribed basic
           service groups. \n
         - DEACTIVATE -- Deactivation request applies to all basic
           services for which all call forward is active. */

  /* Optional */
  /*  Call Forwarding No Reply Timer */
  uint8_t timer_value_valid;  /**< Must be set to true if timer_value is being passed */
  uint32_t timer_value;
  /**<   Timer value in seconds. If this TLV is not present, then previous
       value set by the client or the network operator value applies.
   */
  ...
  uint8_t num_type_plan_valid;  /**< Must be set to true if num_type_plan is being passed */
  voice_num_type_plan_type_v02 num_type_plan;
  /**<   \n If this TLV is not present, the modem derives the number type
        and plan from the "number" TLV.
   */
  ...
  uint8_t call_fwd_start_time_valid;  /**< Must be set to true if call_fwd_start_time is being passed */
  voice_time_type_v02 call_fwd_start_time;
  /**<   \n If this TLV is not present, then UE uses the fwd_start and fwd_end
       timers received from NW during bootup.
   */
  ...
  /* Optional */
  /*  Call Forward SUPS Reason */
  uint8_t reason_valid;  /**< Must be set to true if reason is being passed */
  voice_reason_enum_v02 reason;
  /**<   If this TLV is not present, then SUPS operation is executed for
 voice reason. Value: \n
      - VOICE_REASON_FWD_UNCONDITIONAL (0x01) --  Unconditional call forwarding \n
      - VOICE_REASON_FWD_MOBILEBUSY (0x02) --  Forward when the mobile is busy \n
      - VOICE_REASON_FWD_NOREPLY (0x03) --  Forward when there is no reply \n
      - VOICE_REASON_FWD_UNREACHABLE (0x04) --  Forward when the call is unreachable \n
      - VOICE_REASON_FWD_ALLFORWARDING (0x05) --  All forwarding \n
      - VOICE_REASON_FWD_ALLCONDITIONAL (0x06) --  All conditional forwarding \n
      - VOICE_REASON_BARR_ALLOUTGOING (0x07) --  All outgoing \n
      - VOICE_REASON_BARR_OUTGOINGINT (0x08) --  Outgoing internal \n
      - VOICE_REASON_BARR_OUTGOINGINTEXTOHOME (0x09) --  Outgoing external to home \n
      - VOICE_REASON_BARR_ALLINCOMING (0x0A) --  All incoming \n
      - VOICE_REASON_BARR_INCOMINGROAMING (0x0B) --  Roaming incoming \n
      - VOICE_REASON_BARR_ALLBARRING (0x0C) --  All calls are barred \n
      - VOICE_REASON_BARR_ALLOUTGOINGBARRING (0x0D) --  All outgoing calls are barred \n
      - VOICE_REASON_BARR_ALLINCOMINGBARRING (0x0E) --  All incoming calls are barred \n
      - VOICE_REASON_CALLWAITING (0x0F) --  Call waiting \n
      - VOICE_REASON_CLIP (0x10) --  Calling line identification presentation \n
      - VOICE_REASON_CLIR (0x11) --  Calling line identification restriction \n
      - VOICE_REASON_COLP (0x12) --  Connected line identification presentation \n
      - VOICE_REASON_COLR (0x13) --  Connected line identification restriction \n
      - VOICE_REASON_CNAP (0x14) --  Calling name presentation \n
      - VOICE_REASON_BARR_INCOMING_NUMBER (0x15) --  Incoming calls from registered and activated numbers are barred \n
      - VOICE_REASON_BARR_INCOMING_ANONYMOUS (0x16) --  Incoming calls from anonymous numbers are barred

 */
}voice_set_all_call_fwd_sups_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Manages all call-independent supplementary services for
             call forwarding activation, deactivation, registration, and
             erasure.  */
typedef struct {
  ...
  uint8_t failure_cause_valid;  /**< Must be set to true if failure_cause is being passed */
  qmi_sups_errors_enum_v02 failure_cause;
  /**<   This TLV is sent only if the results of the sub-operations are not
       available; if they are available, this will not be sent and the
       individual sub-operation result TLVs will be sent.
           Supplementary services failure cause;
       see @latexonly Table~\ref{tbl:endReasons}@endlatexonly for more information.
  */
  ...
  /**<   Failure cause description received from the network. This text contains
       UTF-16 characters. This TLV is sent only if the results of the
       sub-operations are not available; if they are available, this is
       not sent and the individual sub-operation result TLVs are sent. */

  /* Optional */
  /*  SIP Error Code */
  uint8_t sip_error_code_valid;  /**< Must be set to true if sip_error_code is being passed */
  uint16_t sip_error_code;
  /**<   SIP error code for supplementary service failure.This TLV will be sent only
       if the results of the sub-operations are not available; if they are available,
       this will not be sent and the individual sub-operation result TLVs will be sent.
  */

  /* Optional */
  /*  Call Forward Unconditional Status */
  uint8_t cfu_result_valid;  /**< Must be set to true if cfu_result is being passed */
  qmi_result_type_v01 cfu_result;
  /**<   Indicates success or failure of call forward unconditional operation.
       If all sub operations (CFB, CFU, CFNRY, CFNRC) of all call forwards
       are success, then this TLV is not present and only "resp" TLV is
       present. \n
       - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE  */

  /* Optional */
  /*  Call Forward Unconditional Failure Cause  */
  uint8_t cfu_failure_cause_valid;  /**< Must be set to true if cfu_failure_cause is being passed */
  qmi_sups_errors_enum_v02 cfu_failure_cause;
  /**<   Supplementary services failure cause;
       see @latexonly Table~\ref{tbl:endReasons}@endlatexonly for more information.
   */

  /* Optional */
  /*  Call Forward Unconditional Failure Cause Description  */
  uint8_t cfu_failure_cause_description_valid;  /**< Must be set to true if cfu_failure_cause_description is being passed */
  uint16_t cfu_failure_cause_description[QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02 + 1];
  /**<   Failure cause description received from the network. This text contains
       UTF-16 characters.
  */

  /* Optional */
  /*  Call Forward Unconditional Retry Duration */
  uint8_t cfu_retry_duration_valid;  /**< Must be set to true if cfu_retry_duration is being passed */
  uint16_t cfu_retry_duration;
  /**<   Retry duration in seconds.
  */

  /* Optional */
  /*  Call Forward Unconditional SIP Error Code */
  uint8_t cfu_sip_error_code_valid;  /**< Must be set to true if cfu_sip_error_code is being passed */
  uint16_t cfu_sip_error_code;
  /**<   Call forward unconditional SIP error code.
  */

  /* Optional */
  /*  Call Forward Busy Status */
  uint8_t cfb_result_valid;  /**< Must be set to true if cfb_result is being passed */
  qmi_result_type_v01 cfb_result;
  /**<   Indicates succes or failure of call forward busy operation. If all
       sub operations (CFB, CFU, CFNRY, CFNRC) of all call forwards
       are success, then this TLV is not present and only "resp" TLV
       is present. \n
       - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE
    */

  /* Optional */
  /*  Call Forward Busy Failure Cause  */
  uint8_t cfb_failure_cause_valid;  /**< Must be set to true if cfb_failure_cause is being passed */
  qmi_sups_errors_enum_v02 cfb_failure_cause;
  /**<   Supplementary services failure cause;
       see @latexonly Table~\ref{tbl:endReasons}@endlatexonly for more information.
  */

  /* Optional */
  /*  Call Forward Busy Failure Cause Description  */
  uint8_t cfb_failure_cause_description_valid;  /**< Must be set to true if cfb_failure_cause_description is being passed */
  uint16_t cfb_failure_cause_description[QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02 + 1];
  /**<   Failure cause description received from the network. This text contains
       UTF-16 characters.
  */

  /* Optional */
  /*  Call Forward Busy Retry Duration */
  uint8_t cfb_retry_duration_valid;  /**< Must be set to true if cfb_retry_duration is being passed */
  uint16_t cfb_retry_duration;
  /**<   Retry duration in seconds.
  */

  /* Optional */
  /*  Call Forward Busy SIP Error Code */
  uint8_t cfb_sip_error_code_valid;  /**< Must be set to true if cfb_sip_error_code is being passed */
  uint16_t cfb_sip_error_code;
  /**<   Call forward busy SIP error code.
  */

  /* Optional */
  /*  Call Forward No Reply Status */
  uint8_t cfnry_result_valid;  /**< Must be set to true if cfnry_result is being passed */
  qmi_result_type_v01 cfnry_result;
  /**<   Indicates success or failure of call forward no reply operation.
       If all sub operations (CFB, CFU, CFNRY, CFNRC) of all call forwards
       are success, then this TLV is not present and only "resp" TLV is
       present. \n
       - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE
  ...
  /* Optional */
  /*  Call Forward No Reply Failure Cause  */
  uint8_t cfnry_failure_cause_valid;  /**< Must be set to true if cfnry_failure_cause is being passed */
  qmi_sups_errors_enum_v02 cfnry_failure_cause;
  /**<   Supplementary services failure cause;
       see @latexonly Table~\ref{tbl:endReasons}@endlatexonly for more information.
  */

  /* Optional */
  /*  Call Forward No Reply  Failure Cause Description  */
  uint8_t cfnry_failure_cause_description_valid;  /**< Must be set to true if cfnry_failure_cause_description is being passed */
  uint16_t cfnry_failure_cause_description[QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02 + 1];
  /**<   Failure cause description received from the network. This text contains
       UTF-16 characters.
  */

  /* Optional */
  /*  Call Forward No Reply Retry Duration */
  uint8_t cfnry_retry_duration_valid;  /**< Must be set to true if cfnry_retry_duration is being passed */
  uint16_t cfnry_retry_duration;
  /**<   Retry duration in seconds.
  */

  /* Optional */
  /*  Call Forward No Reply SIP Error Code */
  uint8_t cfnry_sip_error_code_valid;  /**< Must be set to true if cfnry_sip_error_code is being passed */
  uint16_t cfnry_sip_error_code;
  /**<   Call forward no reply SIP error code.
  */

  /* Optional */
  /*  Call Forward Not Reachable Status */
  uint8_t cfnrc_result_valid;  /**< Must be set to true if cfnrc_result is being passed */
  qmi_result_type_v01 cfnrc_result;
  /**<   Indicates success or failure of call forward not reachable operation.
       If all sub operations (CFB, CFU, CFNRY, CFNRC) of all call forwards
       are success, then this TLV is not present and only "resp" TLV is
       present. \n
       - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE
  ...
  /* Optional */
  /*  Call Forward Not Reachable Failure Cause  */
  uint8_t cfnrc_failure_cause_valid;  /**< Must be set to true if cfnrc_failure_cause is being passed */
  qmi_sups_errors_enum_v02 cfnrc_failure_cause;
  /**<   Supplementary services failure cause;
       see @latexonly Table~\ref{tbl:endReasons}@endlatexonly for more information.
  */

  /* Optional */
  /*  Call Forward Not Reachable Failure Cause Description  */
  uint8_t cfnrc_failure_cause_description_valid;  /**< Must be set to true if cfnrc_failure_cause_description is being passed */
  uint16_t cfnrc_failure_cause_description[QMI_VOICE_FAILURE_CAUSE_DESC_MAX_LEN_V02 + 1];
  /**<   Failure cause description received from the network. This text contains
       UTF-16 characters.
  */

  /* Optional */
  /*  Call Forward Not Reachable Retry Duration */
  uint8_t cfnrc_retry_duration_valid;  /**< Must be set to true if cfnrc_retry_duration is being passed */
  uint16_t cfnrc_retry_duration;
  /**<   Retry duration in seconds.
  */

  /* Optional */
  /*  Call Forward Not Reachable SIP Error Code */
  uint8_t cfnrc_sip_error_code_valid;  /**< Must be set to true if cfnrc_sip_error_code is being passed */
  uint16_t cfnrc_sip_error_code;
  /**<   Call forward not reachable SIP error code.
  */
 ...
 */
  ...
  */
  ...
  voice_cc_sups_result_type_v02 cc_sups_result;
  /**<   Supplementary service data that resulted from call control;
       data is present when cc_result_type is present and is other than
       voice. */
}voice_set_all_call_fwd_sups_resp_msg_v02;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_VOICE_ECALL_ERA_GLONASS_ENABLED_STATUS_IND_V02
//#define REMOVE_QMI_VOICE_ECALL_HLAP_TIMER_STATUS_IND_V02
...
//#define REMOVE_QMI_VOICE_GET_ECALL_ERA_GLONASS_ENABLED_STATUS_V02
//#define REMOVE_QMI_VOICE_GET_ECALL_HLAP_TIMER_STATUS_V02
...
//#define REMOVE_QMI_VOICE_IP_CALLER_INFO_STATUS_IND_V02
...
//#define REMOVE_QMI_VOICE_SET_ALL_CALL_FWD_SUPS_V02
...
#define QMI_VOICE_IP_CALLER_INFO_STATUS_IND_V02 0x0075
#define QMI_VOICE_SET_ALL_CALL_FWD_SUPS_REQ_V02 0x0076
#define QMI_VOICE_SET_ALL_CALL_FWD_SUPS_RESP_V02 0x0076
#define QMI_VOICE_GET_ECALL_HLAP_TIMER_STATUS_REQ_V02 0x0077
#define QMI_VOICE_GET_ECALL_HLAP_TIMER_STATUS_RESP_V02 0x0077
#define QMI_VOICE_ECALL_HLAP_TIMER_STATUS_IND_V02 0x0078
#define QMI_VOICE_GET_ECALL_ERA_GLONASS_ENABLED_STATUS_REQ_V02 0x0079
#define QMI_VOICE_GET_ECALL_ERA_GLONASS_ENABLED_STATUS_RESP_V02 0x0079
#define QMI_VOICE_ECALL_ERA_GLONASS_ENABLED_STATUS_IND_V02 0x007A
/**
    @}
  */
