...
STATIC_LIBS=( qcrilAndroidAudioModule qcrilQmiModule qcrilVoiceModule qcrilSampleModule qcrilLpaModule qcrilAmModule qcrilImsModule qcrilDataModule qcrilCellInfoModule qcrilUimModule qcrilNasModule qcrilPbmModule qcrilMbnModule qcrilOemHookModule)
