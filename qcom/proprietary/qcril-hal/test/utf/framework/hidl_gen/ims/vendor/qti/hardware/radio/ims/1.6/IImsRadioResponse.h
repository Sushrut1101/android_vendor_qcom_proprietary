...
#ifndef HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_6_IIMSRADIORESPONSE_H
#define HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_6_IIMSRADIORESPONSE_H
...
struct IImsRadioResponse : public ::vendor::qti::hardware::radio::ims::V1_5::IImsRadioResponse {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.qti.hardware.radio.ims@1.6::IImsRadioResponse"
     */
     ...
     *
     */
    virtual ::android::hardware::Return<void> queryServiceStatusResponse_1_6(int32_t token, uint32_t errorCode, const ::android::hardware::hidl_vec<::vendor::qti::hardware::radio::ims::V1_6::ServiceStatusInfo>& srvStatusList) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> setConfigResponse_1_6(int32_t token, uint32_t errorCode, const ::vendor::qti::hardware::radio::ims::V1_6::ConfigInfo& config) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> getRegistrationResponse_1_6(int32_t token, uint32_t errorCode, const ::vendor::qti::hardware::radio::ims::V1_6::RegistrationInfo& registration) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadioResponse>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse>& o) {
    std::string os = "[class or subclass of ";
    os += ::vendor::qti::hardware::radio::ims::V1_6::IImsRadioResponse::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_QTI_HARDWARE_RADIO_IMS_V1_6_IIMSRADIORESPONSE_H
