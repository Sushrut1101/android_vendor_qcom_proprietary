...
#define DMS_V01_IDL_MINOR_VERS 0x48
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DMS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DMS_V01_MAX_MESSAGE_ID 0x0074
/**
    @}
  */
...
#define QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01 512
#define QMI_DMS_TX_MODEM_LEVEL_MAX_V01 100
#define QMI_DMS_AP_OS_VERSION_MAX_V01 60
#define QMI_DMS_AP_SW_VERSION_MAX_V01 60
#define QMI_DMS_AP_WLAN_MACID_MAX_V01 48
#define QMI_DMS_SENSOR_TYPE_MAX_V01 10
#define QMI_DMS_NUM_RAT_TECH_V01 64
#define QMI_DMS_SENSOR_CONFIG_MAX_V01 10
#define QMI_DMS_MAX_BATCH_SUPPORTED_V01 25
#define QMI_DMS_MAX_BATTERY_LIST_LEN_V01 50
/**
    @}
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_PSM_VERSION_CAPABILITY_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_PSM_NOT_SUPPORTED_V01 = 0, /**<  PSM is not supported on device  */
  DMS_PSM_VERSION_1_V01 = 1, /**<  Version1: AP decides the time that the modem goes into PSM \n */
  DMS_PSM_VERSION_2_V01 = 2, /**<  Version 2: Modem calculates and decides the time that it goes into PSM \n */
  DMS_PSM_VERSION_UNSPEC_V01 = 0xFF, /**<  PSM version unspecified, e.g., the modem either does not support the PSM feature or version 1 is 
           supported on an older modem that does not support negotiating PSM version (default value). */
  DMS_PSM_VERSION_CAPABILITY_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_psm_version_capability_v01;
/**
    @}
  */
...
typedef enum {
  ...
  DMS_OP_MODE_CAMP_ONLY_V01 = 0x09, /**<  Camp only  */
...
#define DMS_SUBS_CAPABILITY_NR5G_V01 ((dms_subs_capability_mask_type_v01)0x00000080ull) /**<  NR5G  */
/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
  DMS_SENSOR_TYPE_ID_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_SENSOR_TYPE_ALS_V01 = 1, /**<  Sensor information about ambient light sensor \n   */
  DMS_SENSOR_TYPE_PRESSURE_V01 = 2, /**<  Sensor information about pressure \n   */
  DMS_SENSOR_TYPE_HUMIDITY_V01 = 3, /**<  Sensor information about humidity \n   */
  DMS_SENSOR_TYPE_TEMPERATURE_V01 = 4, /**<  Sensor information about temperature \n   */
  DMS_SENSOR_TYPE_AMD_V01 = 5, /**<  Sensor information about motion \n   */
  DMS_SENSOR_TYPE_SMD_V01 = 6, /**<  Sensor information about motion\n   */
  DMS_SENSOR_TYPE_ALL_V01 = 255, /**<  Sensor information about multiple sensors   */
  DMS_SENSOR_TYPE_ID_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_sensor_type_id_v01;
/**
    @}
  */
...
}dms_sensor_policy_cond_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  dms_sensor_type_id_v01 sensor_id;
  /**<   Values: \n
      - DMS_SENSOR_TYPE_ALS (1) --  Sensor information about ambient light sensor \n
      - DMS_SENSOR_TYPE_PRESSURE (2) --  Sensor information about pressure \n
      - DMS_SENSOR_TYPE_HUMIDITY (3) --  Sensor information about humidity \n
      - DMS_SENSOR_TYPE_TEMPERATURE (4) --  Sensor information about temperature \n
      - DMS_SENSOR_TYPE_AMD (5) --  Sensor information about motion \n
      - DMS_SENSOR_TYPE_SMD (6) --  Sensor information about motion\n
      - DMS_SENSOR_TYPE_ALL (255) --  Sensor information about multiple sensors   */

  uint32_t sensor_policy_len;  /**< Must be set to # of elements in sensor_policy */
  dms_sensor_policy_cond_v01 sensor_policy[QMI_DMS_SENSOR_CONFIG_MAX_V01];
  ...
  */
}dms_sensor_policy_config_v01;  /* Type */
/**
    @}
  */

typedef uint16_t dms_sensor_id_mask_v01;
#define DMS_MASK_SENSOR_ID_ALS_V01 ((dms_sensor_id_mask_v01)0x0001) /**<  ALS \n  */
#define DMS_MASK_SENSOR_ID_PRESSURE_V01 ((dms_sensor_id_mask_v01)0x0002) /**<  Pressure \n */
#define DMS_MASK_SENSOR_ID_HUMIDITY_V01 ((dms_sensor_id_mask_v01)0x0004) /**<  Humidity \n */
#define DMS_MASK_SENSOR_ID_TEMPERATURE_V01 ((dms_sensor_id_mask_v01)0x0008) /**<  Temperature \n */
#define DMS_MASK_SENSOR_ID_AMD_V01 ((dms_sensor_id_mask_v01)0x0010) /**<  AMD \n */
#define DMS_MASK_SENSOR_ID_SMD_V01 ((dms_sensor_id_mask_v01)0x0020) /**<  SMD  */
/** @addtogroup dms_qmi_aggregates
    @{
  */
typedef struct {
  ...
  float sensor_dimension_data[QMI_DMS_SENSOR_CONFIG_MAX_V01];
  ...
  uint64_t timestamp;
  /**<   Time stamp. */
}dms_sensor_sample_data_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  dms_sensor_sample_data_v01 sample_list[QMI_DMS_MAX_BATCH_SUPPORTED_V01];
}dms_sensor_info_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Report Power Configuration Requests */
  uint8_t report_power_cfg_reqs_valid;  /**< Must be set to true if report_power_cfg_reqs is being passed */
  uint8_t report_power_cfg_reqs;
  /**<   Values: \n
  - 0 -- Do not report \n
  - 1 -- Report power configuration requests from the modem
  */

  /* Optional */
  /*  Report Device Interactive State Requests */
  uint8_t report_interactive_state_reqs_valid;  /**< Must be set to true if report_interactive_state_reqs is being passed */
  uint8_t report_interactive_state_reqs;
  /**<   Values: \n
    - 0 -- Do not report \n
    - 1 -- Report device interactive state requests from the modem
  */
...
typedef enum {
  ...
  DMS_RADIO_IF_NR5G_V01 = 0x0A, /**<  NR5G  */
 ...
 */
  ...
  /**<   The highest supported release information for the GERAN RAT 
       by the device.
  */

  dms_device_wcdma_rel_info_v01 wcdma_rel_info;
  /**<   The highest supported release information for the WCDMA RAT
       by the device.
  */

  dms_device_lte_rat_rel_info_v01 lte_rel_info;
  /**<   The highest supported release information for the LTE RAT
       by the device.
  */

  dms_device_hdr_rat_rel_info_v01 hdrcp_rel_info;
  /**<   The highest supported release information for the HDR RAT
       by the device.
  */

  dms_device_cdma_1x_rel_info_v01 cdma1x_rel_info;
  /**<   The highest supported release information for the CDMA2000 RAT
       by the device.
  */

  dms_device_tdscdma_rel_info_v01 tdscdma_rel_info;
  /**<   The highest supported release information for the TDSCDMA RAT
       by the device.
  */
 ...
 */
  ...
  */
  ...
  /**<   \n Indicates the highest RAT release information of various RATs supported in the 
...
typedef struct {
  ...
  */
  ...
  uint8_t supported_nr5g_bands_valid;  /**< Must be set to true if supported_nr5g_bands is being passed */
  uint32_t supported_nr5g_bands_len;  /**< Must be set to # of elements in supported_nr5g_bands */
  uint16_t supported_nr5g_bands[QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01];
  /**<   Array of supported NR5G bands where each entry is a 
       decimal representation of the NR5G band number supported. 
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Secondary Software Version Information */
  uint8_t secondary_sw_version_valid;  /**< Must be set to true if secondary_sw_version is being passed */
  char secondary_sw_version[QMI_DMS_SW_VERSION_MAX_EXT_V01 + 1];
  /**<   String representing the secondary software version information.
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_MODEM_POWER_TECH_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_MODEM_POWER_1X_TECH_V01 = 0, /**<  1X technology definition \n */
  DMS_MODEM_POWER_DO_TECH_V01 = 1, /**<  DO technology definition \n */
  DMS_MODEM_POWER_WCDMA1_TECH_V01 = 2, /**<  WCDMA technology definition for SUB1\n */
  DMS_MODEM_POWER_WCDMA2_TECH_V01 = 3, /**<  WCDMA technology definition for SUB2 \n */
  DMS_MODEM_POWER_LTE1_TECH_V01 = 4, /**<  LTE technology definition for SUB1 \n */
  DMS_MODEM_POWER_LTE2_TECH_V01 = 5, /**<  LTE technology definition for SUB2 \n */
  DMS_MODEM_POWER_TDSCDMA_TECH_V01 = 6, /**<  TDSCDMA technology definition \n */
  DMS_MODEM_POWER_GERAN1_TECH_V01 = 7, /**<  GERAN technology definition for SUB1 \n */
  DMS_MODEM_POWER_GERAN2_TECH_V01 = 8, /**<  GERAN technology definition for SUB2  */
  DMS_MODEM_POWER_TECH_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_modem_power_tech_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  dms_modem_power_tech_enum_v01 modem_power_tech;
 ...
 */
  ...
  uint32_t modem_tech_active_time;
  /**<   Duration that the modem technology was active since last query
       (in milliseconds).
  */
}modem_tech_active_time_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Modem Technology Active Time */
  uint8_t modem_tech_active_time_valid;  /**< Must be set to true if modem_tech_active_time is being passed */
  uint32_t modem_tech_active_time_len;  /**< Must be set to # of elements in modem_tech_active_time */
  modem_tech_active_time_type_v01 modem_tech_active_time[QMI_DMS_NUM_RAT_TECH_V01];
  /**<    Duration that the modem was active in milliseconds per tech
        since the last query.
  */

  /* Optional */
  /*  WLAN Technology Active Time */
  uint8_t wlan_active_time_valid;  /**< Must be set to true if wlan_active_time is being passed */
  uint32_t wlan_active_time;
  /**<    Duration that the WLAN was active in milliseconds since the last query.
  */

  /* Optional */
  /*  GPS Technology Active Time */
  uint8_t gps_active_time_valid;  /**< Must be set to true if gps_active_time is being passed */
  uint32_t gps_active_time;
  /**<    Duration that the GPS was active in milliseconds since the last query.
  */

  /* Optional */
  /*  Modem Active Vote Status */
  uint8_t modem_active_vote_status_valid;  /**< Must be set to true if modem_active_vote_status is being passed */
  uint8_t modem_active_vote_status;
  /**<    This boolean gives the active status of the modem RAT/TECH based on NPA vote.
        TRUE means that modem RAT/TECH is active as per vote.
  */

  /* Optional */
  /*  WLAN Active Vote Status */
  uint8_t wlan_active_vote_status_valid;  /**< Must be set to true if wlan_active_vote_status is being passed */
  uint8_t wlan_active_vote_status;
  /**<    This boolean gives active status of WLAN based on NPA vote.
        TRUE means that WLAN is active as per vote.
  */

  /* Optional */
  /*  GPS Active Vote Status */
  uint8_t gps_active_vote_status_valid;  /**< Must be set to true if gps_active_vote_status is being passed */
  uint8_t gps_active_vote_status;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Requests to get the DMS capability. */
typedef struct {

  /* Optional */
  /*  TE PSM Version */
  uint8_t te_psm_capability_valid;  /**< Must be set to true if te_psm_capability is being passed */
  dms_psm_version_capability_v01 te_psm_capability;
  /**<   PSM version that the control point supports Values : \n
      - DMS_PSM_NOT_SUPPORTED (0) --  PSM is not supported on device 
      - DMS_PSM_VERSION_1 (1) --  Version1: AP decides the time that the modem goes into PSM \n
      - DMS_PSM_VERSION_2 (2) --  Version 2: Modem calculates and decides the time that it goes into PSM \n
      - DMS_PSM_VERSION_UNSPEC (0xFF) --  PSM version unspecified, e.g., the modem either does not support the PSM feature or version 1 is 
           supported on an older modem that does not support negotiating PSM version (default value).
 */
}dms_get_capability_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Requests to get the DMS capability. */
typedef struct {
  ...
  dms_psm_version_capability_v01 psm_capability;
  /**<   PSM version honored by the modem Values : \n
      ...
      - DMS_PSM_VERSION_UNSPEC (0xFF) --  PSM version unspecified, e.g., the modem either does not support the PSM feature or version 1 is 
           supported on an older modem that does not support negotiating PSM version (default value).
 */
}dms_get_capability_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_DEVICE_IMAGE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_DEVICE_IMAGE_UNSPECIFIED_V01 = 0, /**<  Default \n   */
  DMS_DEVICE_IMAGE_PERF_V01 = 1, /**<  Performance Image \n   */
  DMS_DEVICE_IMAGE_NON_PERF_V01 = 2, /**<  Non Performance Image \n   */
  DMS_DEVICE_IMAGE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_device_image_type_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Sets the AP version information on the modem. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  AP WLAN MAC ID */
  uint8_t ap_wlan_macid_valid;  /**< Must be set to true if ap_wlan_macid is being passed */
  char ap_wlan_macid[QMI_DMS_AP_WLAN_MACID_MAX_V01 + 1];
  /**<   String representing the AP WLAN MAC address.
  */

  /* Optional */
  /*  Software Image Type  */
  uint8_t sw_image_type_valid;  /**< Must be set to true if sw_image_type is being passed */
  dms_device_image_type_v01 sw_image_type;
  /**<   Software image type . Values:\n
      - DMS_DEVICE_IMAGE_UNSPECIFIED (0) --  Default \n
      - DMS_DEVICE_IMAGE_PERF (1) --  Performance Image \n
      - DMS_DEVICE_IMAGE_NON_PERF (2) --  Non Performance Image \n
 */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Sets the AP version information on the modem. */
typedef struct {
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_MARB_CLIENT_GROUP_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_MARB_CLI_GROUP_GNSS_V01 = 0, /**<  To be used by all GNSS clients \n   */
  DMS_MARB_CLI_GROUP_WWAN_V01 = 1, /**<  To be used by all WWAN clients   */
  DMS_MARB_CLIENT_GROUP_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_marb_client_group_type_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Notifies the modem about the application 
              that must be prioritized for modem operations.  */
typedef struct {

  /* Mandatory */
  /*  Prioritized Application   */
  dms_marb_client_group_type_v01 prioritized_app;
  /**<   Application that must be prioritized on the modem
      - DMS_MARB_CLI_GROUP_GNSS (0) --  To be used by all GNSS clients \n
      - DMS_MARB_CLI_GROUP_WWAN (1) --  To be used by all WWAN clients
 */
}dms_set_app_priority_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Notifies the modem about the application 
              that must be prioritized for modem operations.  */
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_set_app_priority_resp_msg_v01;  /* Message */
/**
    @}
  */
 ...
 */
  ...
  /* Optional */
  /*   Sensor Policy (Deprecated) */
  uint8_t sensor_policy_valid;  /**< Must be set to true if sensor_policy is being passed */
  uint32_t sensor_policy_len;  /**< Must be set to # of elements in sensor_policy */
  dms_sensor_policy_cond_v01 sensor_policy[QMI_DMS_SENSOR_CONFIG_MAX_V01];
  /**<   \n Sensor policy data to be configured.
        */

  /* Optional */
  /*   Batch Count (Deprecated) */
  uint8_t sensor_batch_cnt_valid;  /**< Must be set to true if sensor_batch_cnt is being passed */
  uint8_t sensor_batch_cnt;
  /**<   Number of sample collections after which the modem must report to the control point.
        */

  /* Optional */
  /*   Reporting interval (Deprecated) */
  uint8_t reporting_interval_valid;  /**< Must be set to true if reporting_interval is being passed */
  uint32_t reporting_interval;
  /**<   Interval in seconds after which the modem must report to the control point.
        */
  ...
  dms_sensor_policy_config_v01 sensor_config_list[QMI_DMS_SENSOR_CONFIG_MAX_V01];
  /**<   \n Sensor configuration for multiple sensors.
        */
}dms_set_sensor_configuration_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_set_sensor_configuration_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Sensor ID Mask  */
  dms_sensor_id_mask_v01 sensor_id_mask;
  /**<   Values: \n
      - DMS_MASK_SENSOR_ID_ALS (0x0001) --  ALS \n
      - DMS_MASK_SENSOR_ID_PRESSURE (0x0002) --  Pressure \n
      - DMS_MASK_SENSOR_ID_HUMIDITY (0x0004) --  Humidity \n
      - DMS_MASK_SENSOR_ID_TEMPERATURE (0x0008) --  Temperature \n
      - DMS_MASK_SENSOR_ID_AMD (0x0010) --  AMD \n
      - DMS_MASK_SENSOR_ID_SMD (0x0020) --  SMD
 */
}dms_get_sensor_data_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  dms_sensor_info_v01 sensor_info[QMI_DMS_SENSOR_TYPE_MAX_V01];
}dms_get_sensor_data_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_reset_sensor_config_data_req_msg_v01;
...
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_reset_sensor_config_data_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_last_policy_met_info_req_msg_v01;
...
typedef struct {
  ...
  dms_sensor_id_mask_v01 policy_met_sensor_mask;
  /**<   Values: \n
      - DMS_MASK_SENSOR_ID_ALS (0x0001) --  ALS \n
      - DMS_MASK_SENSOR_ID_PRESSURE (0x0002) --  Pressure \n
      - DMS_MASK_SENSOR_ID_HUMIDITY (0x0004) --  Humidity \n
 ...
 */
  ...
  dms_sensor_id_mask_v01 batch_full_sensor_mask;
  /**<   Values: \n
      - DMS_MASK_SENSOR_ID_ALS (0x0001) --  ALS \n
      - DMS_MASK_SENSOR_ID_PRESSURE (0x0002) --  Pressure \n
      - DMS_MASK_SENSOR_ID_HUMIDITY (0x0004) --  Humidity \n
      ...
      - DMS_MASK_SENSOR_ID_AMD (0x0010) --  AMD \n
      - DMS_MASK_SENSOR_ID_SMD (0x0020) --  SMD */
}dms_get_last_policy_met_info_resp_msg_v01;  /* Message */
/**
    @}
  */
 ...
 */
  ...
  /**<   Values: \n
      ...
      - DMS_MASK_SENSOR_ID_SMD (0x0020) --  SMD
 */
}dms_sensor_policy_met_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Indicates the request from the modem to report the device
            power information. */
typedef struct {

  /* Optional */
  /*  Report Power Status */
  uint8_t report_power_status_valid;  /**< Must be set to true if report_power_status is being passed */
  uint8_t report_power_status;
  /**<   Report power status. Values:\n
       -0 -- Do not report\n
       -1 -- Report power status
  */

  /* Optional */
  /*  Battery Threshold List */
  uint8_t battery_threshold_list_valid;  /**< Must be set to true if battery_threshold_list is being passed */
  uint32_t battery_threshold_list_len;  /**< Must be set to # of elements in battery_threshold_list */
  uint8_t battery_threshold_list[QMI_DMS_MAX_BATTERY_LIST_LEN_V01];
  /**<   List of threshold values ranging from 0 to 100 in % that 
       triggers battery reporting. Only applicable when the Report Power Status
       TLV is set to TRUE.
  */
}dms_device_power_info_request_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Report Device Interactive State */
  uint8_t report_device_interactive_state_valid;  /**< Must be set to true if report_device_interactive_state is being passed */
  uint8_t report_device_interactive_state;
  /**<   Report device interactive state. Values:\n
       -0 -- Do not report\n
       -1 -- Report device interactive state
  */
}dms_device_interactive_state_request_ind_msg_v01;  /* Message */
/**
    @}
  */

typedef uint64_t dms_battery_charging_mask_v01;
#define DMS_MASK_BATTERY_CHARGING_OFF_V01 ((dms_battery_charging_mask_v01)0x00ull) /**<  Battery not charging \n   */
#define DMS_MASK_BATTERY_CHARGING_BY_AC_V01 ((dms_battery_charging_mask_v01)0x01ull) /**<  AC charging  \n  */
#define DMS_MASK_BATTERY_CHARGING_BY_USB_V01 ((dms_battery_charging_mask_v01)0x02ull) /**<  USB charging  \n   */
#define DMS_MASK_BATTERY_CHARGING_BY_WIRELESS_V01 ((dms_battery_charging_mask_v01)0x04ull) /**<  Wireless charging   */
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Notifies the modem about the power information on the UE.  */
typedef struct {

  /* Optional */
  /*  Power Save Mode Status   */
  uint8_t power_save_mode_status_valid;  /**< Must be set to true if power_save_mode_status is being passed */
  uint8_t power_save_mode_status;
  /**<   Power Save mode status. Values:\n
       -0 -- Power Save mode off \n
       -1 -- Power Save mode on
  */

  /* Optional */
  /*  Battery Charging State   */
  uint8_t battery_charge_state_valid;  /**< Must be set to true if battery_charge_state is being passed */
  dms_battery_charging_mask_v01 battery_charge_state;
  /**<   Battery charge state.
      - DMS_MASK_BATTERY_CHARGING_OFF (0x00) --  Battery not charging \n
      - DMS_MASK_BATTERY_CHARGING_BY_AC (0x01) --  AC charging  \n
      - DMS_MASK_BATTERY_CHARGING_BY_USB (0x02) --  USB charging  \n
      - DMS_MASK_BATTERY_CHARGING_BY_WIRELESS (0x04) --  Wireless charging
 */

  /* Optional */
  /*  Battery Capacity   */
  uint8_t battery_capacity_valid;  /**< Must be set to true if battery_capacity is being passed */
  ...
  uint8_t battery_level_valid;  /**< Must be set to true if battery_level is being passed */
  ...
  /* Optional */
  /*  Battery Level index */
  uint8_t battery_level_index_valid;  /**< Must be set to true if battery_level_index is being passed */
  uint8_t battery_level_index;
  /**<   Battery index, calculated based on Battery Threshold List and
      Battery level percentage, range starts from 0.
      */
}dms_device_power_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Notifies the modem about the power information on the UE.  */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_device_power_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_INTERACTIVE_STATE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_INTERACTIVE_STATE_INVALID_V01 = 0, /**<  Interactive state invalid \n   */
  DMS_INTERACTIVE_STATE_ON_V01 = 1, /**<  Interactive on \n   */
  DMS_INTERACTIVE_STATE_OFF_V01 = 2, /**<  Interactive off     */
  DMS_INTERACTIVE_STATE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_interactive_state_type_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Notifies the modem about the device interactive state.  */
typedef struct {

  /* Mandatory */
  /*  Device Interactive State  */
  dms_interactive_state_type_v01 interactive_state;
  /**<   Device interactive state. Values:\n
      - DMS_INTERACTIVE_STATE_INVALID (0) --  Interactive state invalid \n
      - DMS_INTERACTIVE_STATE_ON (1) --  Interactive on \n
      - DMS_INTERACTIVE_STATE_OFF (2) --  Interactive off
 */
}dms_device_interactive_state_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Notifies the modem about the device interactive state.  */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_device_interactive_state_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_DMS_DEVICE_INTERACTIVE_STATE_V01
//#define REMOVE_QMI_DMS_DEVICE_INTERACTIVE_STATE_REQUEST_IND_V01
//#define REMOVE_QMI_DMS_DEVICE_POWER_INFO_V01
//#define REMOVE_QMI_DMS_DEVICE_POWER_INFO_REQUEST_IND_V01
...
//#define REMOVE_QMI_DMS_GET_CAPABILITY_V01
...
//#define REMOVE_QMI_DMS_GET_LAST_POLICY_MET_INFO_V01
...
//#define REMOVE_QMI_DMS_GET_SENSOR_DATA_V01
...
//#define REMOVE_QMI_DMS_RESET_SENSOR_CONFIG_DATA_V01
//#define REMOVE_QMI_DMS_RESTORE_FACTORY_DEFAULTS_V01
//#define REMOVE_QMI_DMS_SENSOR_POLICY_MET_IND_V01
//#define REMOVE_QMI_DMS_SET_ALT_NET_CONFIG_V01
//#define REMOVE_QMI_DMS_SET_APP_PRIORITY_V01
...
//#define REMOVE_QMI_DMS_SET_SENSOR_CONFIGURATION_V01
...
#define QMI_DMS_GET_CAPABILITY_REQ_V01 0x006A
#define QMI_DMS_GET_CAPABILITY_RESP_V01 0x006A
#define QMI_DMS_SET_APP_PRIORITY_REQ_V01 0x006B
#define QMI_DMS_SET_APP_PRIORITY_RESP_V01 0x006B
#define QMI_DMS_SET_SENSOR_CONFIGURATION_REQ_V01 0x006C
#define QMI_DMS_SET_SENSOR_CONFIGURATION_RESP_V01 0x006C
#define QMI_DMS_GET_SENSOR_DATA_REQ_V01 0x006D
#define QMI_DMS_GET_SENSOR_DATA_RESP_V01 0x006D
#define QMI_DMS_RESET_SENSOR_CONFIG_DATA_REQ_V01 0x006E
#define QMI_DMS_RESET_SENSOR_CONFIG_DATA_RESP_V01 0x006E
#define QMI_DMS_GET_LAST_POLICY_MET_INFO_REQ_V01 0x006F
#define QMI_DMS_GET_LAST_POLICY_MET_INFO_RESP_V01 0x006F
#define QMI_DMS_SENSOR_POLICY_MET_IND_V01 0x0070
#define QMI_DMS_DEVICE_POWER_INFO_REQUEST_IND_V01 0x0071
#define QMI_DMS_DEVICE_INTERACTIVE_STATE_REQUEST_IND_V01 0x0072
#define QMI_DMS_DEVICE_POWER_INFO_REQ_V01 0x0073
#define QMI_DMS_DEVICE_POWER_INFO_RESP_V01 0x0073
#define QMI_DMS_DEVICE_INTERACTIVE_STATE_REQ_V01 0x0074
#define QMI_DMS_DEVICE_INTERACTIVE_STATE_RESP_V01 0x0074
/**
    @}
  */
