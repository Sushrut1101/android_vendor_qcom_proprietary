...
---------------------------------------------------------------------------*/
#define QMI_CAT_NO_ERR                0       /* No Error */
#define QMI_CAT_INTERNAL_ERR               -1      /* Linux/System Error */
#define QMI_CAT_SERVICE_ERR               -2      /* QMI error, check QMI error code */
#define QMI_CAT_TIMEOUT_ERR           -3      /* Transaction timeout error code */
#define QMI_CAT_EXTENDED_ERR           -4      /* SubSystem specific error codes(example: ds_profile) */
#define QMI_CAT_ORT_NOT_OPEN_ERR      -5     /* QMI control port is not open */
#define QMI_CAT_QMUXD_NOT_SUPPORTED_ERR -6     /* SHIM layer supported by modem. */

/* Encode/Decode library specific error codes */
#define QMI_CAT_IDL_BUFFER_TOO_SMALL                -6
#define QMI_CAT_IDL_ARRAY_TOO_BIG                   -7
#define QMI_CAT_IDL_MESSAGE_ID_NOT_FOUND            -8
#define QMI_CAT_IDL_TLV_DUPLICATED                  -9
#define QMI_CAT_IDL_LENGTH_INCONSISTENCY            -10
#define QMI_CAT_IDL_MISSING_TLV                     -11
#define QMI_CAT_IDL_PARAMETER_ERROR                 -12
#define QMI_CAT_IDL_UNRECOGNIZED_SERVICE_VERSION    -13

/* Additional error codes */
#define QMI_CAT_MEMCOPY_ERROR                       -14
#define QMI_CAT_INVALID_TXN                         -15
#define QMI_CAT_CLIENT_ALLOC_FAILURE                -16
#define QMI_CAT_IDL_UNKNOWN_MANDATORY_TLV           -17
#define QMI_CAT_SERVICE_NOT_PRESENT_ON_MODEM        -18
#define QMI_CAT_IDL_TLV_RESP_ERROR                  -19

/* QMI Error codes.  The value in the qmi error code should be set
** to one these when QMI_CAT_SERVICE_ERR is returned
*/
#define QMI_CAT_SERVICE_ERR_NONE                          0
#define QMI_CAT_SERVICE_ERR_MALFORMED_MSG                 1
#define QMI_CAT_SERVICE_ERR_NO_MEMORY                     2
#define QMI_CAT_SERVICE_ERR_INTERNAL                      3
#define QMI_CAT_SERVICE_ERR_ABORTED                       4
#define QMI_CAT_SERVICE_ERR_CLIENT_IDS_EXHAUSTED          5

#define QMI_CAT_ENVELOPE_DATA_MAX_LENGTH      258
#define QMI_CAT_TERMINAL_RESPONSE_MIN_LENGTH  12
