...
--------   ---     ----------------------------------------------------------
02/27/19   llg     (Tech Pubs) Edited/added Doxygen comments and markup.
...
typedef enum {
    TUI_SI_SUCCESS                        = 0,   /**< Operation was successful. */
    TUI_SI_ERROR                          = -1,  /**< General error. */
...
/**
  ...
  @sideeffects
  On success, the image is deleted from the FS. @newpage
*/
