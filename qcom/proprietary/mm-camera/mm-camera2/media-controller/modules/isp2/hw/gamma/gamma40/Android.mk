#======================================================================
#makefile for libmmcamera2_isp2_gamma40.so form mm-camera2
#======================================================================
ifeq ($(call is-vendor-board-platform,QCOM),true)
ifeq ($(call is-board-platform-in-list,msm8974 msm8916 msm8226 msm8952 msm8937 msm8953),true)
...
LOCAL_SRC_FILES        := module_gamma40.c gamma40.c \
                          ../adrc/gamma_algo.c
ifeq ($(OEM_CHROMATIX), true)
LOCAL_SRC_FILES        += gamma40_ext.c
