...
public:
  ...
  virtual ~FileSource();
#ifdef FEATURE_FILESOURCE_FILE_PLAYBACK
  /*!
  @brief  Open a File.
...
#endif
#ifdef FEATURE_FILESOURCE_BUFFER_PLAYBACK
  /*!
  ...
  */
  FileSourceStatus GetStreamParameter(uint32 ulTrackId, uint32 ulParamIndex,
                                      void* pParamStruct);
  /*!
  @brief      Method to Set Stream specific parameters.
  ...
  @note   It is expected that user has received the successul callback for
          OpenFile() earlier.
  */
  FileSourceStatus SetStreamParameter(uint32 ulTrackId, uint32 ulParamIndex,
                                      void* pParamStruct);
  ...
  */
  ...
  @param[in]      type       Type of decoder specific data to fetch
