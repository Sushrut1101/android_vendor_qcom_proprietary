...
import com.qualcomm.qti.simsettings.SimSettingsActivity;
import com.qualcomm.qti.simsettings.SimDialogActivity;
...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        final int numSlots = telephonyManager.getPhoneCount();
        ...
        // TODO (b/129634560): this method no longer exists
        //subscriptionManager.clearDefaultsForInactiveSubIds();

        boolean dataSelected = SubscriptionManager.isUsableSubscriptionId(
                SubscriptionManager.getDefaultDataSubscriptionId());
        boolean smsSelected = SubscriptionManager.isUsableSubscriptionId(
