...
public class SignalDrawable extends Drawable {
    ...
    public SignalDrawable(Context context) {
        ...
        list = context.getResources().
                getColorStateList(R.color.dark_mode_icon_color_dual_tone_background,
                context.getTheme());
        mDarkModeBackgroundColor = list.getDefaultColor();

        list = context.getResources().
                getColorStateList(R.color.dark_mode_icon_color_dual_tone_fill,
                context.getTheme());
        mDarkModeFillColor = list.getDefaultColor();

        list = context.getResources().
                getColorStateList(R.color.light_mode_icon_color_dual_tone_background,
                context.getTheme());
        mLightModeBackgroundColor = list.getDefaultColor();

        list = context.getResources().
                getColorStateList(R.color.light_mode_icon_color_dual_tone_fill,
                context.getTheme());
        mLightModeFillColor = list.getDefaultColor();
    ...
    private int getFillColor(float darkIntensity) {
        /* TODO: Temporarily returning mDarkModeFillColor since mLightModeFillColor is being read
         * as -1, and bars don't get shown
         */
        /*
        return getColorForDarkIntensity(
                darkIntensity, mLightModeFillColor, mDarkModeFillColor);
        */
        return mDarkModeFillColor;
    }

    private int getBackgroundColor(float darkIntensity) {
        /* TODO: Temporarily returning mDarkModeBackgroundColor since mLightModeFillColor is
         * being read as -1, and bars don't get shown
         */
        /*
        return getColorForDarkIntensity(
                darkIntensity, mLightModeBackgroundColor, mDarkModeBackgroundColor);
        */
        return mDarkModeBackgroundColor;
    }
