...
public class DefaultReceiver extends BroadcastReceiver {
    ...
    private static final String HOST_CODE_MCONFIG = "6266344";
    private static final String HOST_CODE_DECONFIG = "33266344";
    private static final String HOST_CODE_DCONFIG = "3266344";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_BOOT_COMPLETED.equals(action)) {
            ...
            if (HOST_CODE_MCONFIG.equals(host)) {
                //*#*#mconfig#*#*
                log("In Sw Mbn config mode");
                setMbnAppState(context, true);
                MbnTestUtils.setSwMbnMode(true);
                context.startActivity(new Intent(context, MbnModeSelect.class)
                        .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
            } else if (HOST_CODE_DECONFIG.equals(host)) {
                // *#*#deconfig#*#*
                log("setMbnAppState: false");
                setMbnAppState(context, false);
            } else if (HOST_CODE_DCONFIG.equals(host)) {
                // *#*#dconfig#*#*
