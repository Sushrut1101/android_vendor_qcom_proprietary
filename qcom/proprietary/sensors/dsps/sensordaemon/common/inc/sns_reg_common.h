...
/*============================================================================
  ...
  Copyright (c) 2011-2016, 2018 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#define SNS_REG_DEF_ITEM_SSI_VDD_RAIL_CFG    0xff
#define SNS_REG_DEF_ITEM_SSI_VDDIO_RAIL_CFG  0xff
...
#define SNS_REG_CMC_DEF_SENSOR_VERTICAL_MIN_SPPED      0.1f
#define SNS_REG_CMC_DEF_SENSOR_VERTICAL_MIN_SPPED_Q16 (FX_CONV_Q16(SNS_REG_CMC_DEF_SENSOR_VERTICAL_MIN_SPPED, 0))
...
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_VERSION             02
...
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM1              0
...
/**
 * Default values for items in group SNS_REG_SAM_GROUP_FAST_AMD_V02
 */
#define SNS_REG_FAST_AMD_MIN_NUM_SAMPLE        10
#define SNS_REG_FAST_AMD_MAX_NUM_SAMPLE        45
#define SNS_REG_FAST_AMD_DEF_DETECT_THRESH     80

/**
 * Default values for items in group SNS_REG_DRIVER_GROUP_UV_V02
 */
#define SNS_REG_DEFAULT_UV_DS                  0
#define SNS_REG_DEFAULT_UV_BIAS                0
#define SNS_REG_DEFAULT_UV_SCALE               100

/**
 * Default values for items in group SNS_REG_DRIVER_GROUP_OBJECT_TEMP_V02
 */
#define SNS_REG_DEFAULT_OBJECT_TEMP_BIAS       0
#define SNS_REG_DEFAULT_OBJECT_TEMP_SCALE      100

/**
 * Default values for items in group SNS_REG_SAM_GROUP_IOD
 */
#define SNS_REG_IOD_AUTOCAL_DEF_VERSION                     1
#define SNS_REG_IOD_AUTOCAL_DEF_CONVERGENCE_STATUS          0     // Autocal convergence status
#define SNS_REG_IOD_AUTOCAL_DEF_AUTOCAL_COEFF               0.0f  // Autocal coefficient
#define SNS_REG_IOD_AUTOCAL_DEF_CUMULATIVE_NUM_SAMPLES      0
#define SNS_REG_IOD_AUTOCAL_DEF_FIRST_MOMENT                0.0f
#define SNS_REG_IOD_AUTOCAL_DEF_SECOND_MOMENT               0.0f
#define SNS_REG_IOD_AUTOCAL_DEF_DISCRETE_VALS               0.0f
#define SNS_REG_IOD_AUTOCAL_DEF_IS_DISCRETE                 1

/**
 * Default values for items in group SNS_REG_DRIVER_GROUP_AMBIENT_TEMP_HUMIDITY_V02
 */
#define SNS_REG_DEFAULT_AMBIENT_TEMP_DS        0
#define SNS_REG_DEFAULT_AMBIENT_TEMP_BIAS      0
#define SNS_REG_DEFAULT_AMBIENT_TEMP_SCALE     100

/**
 * Default values for items in group SNS_REG_SMGR_GROUP_HUMIDITY_V02
 */
#define SNS_REG_DEFAULT_HUMIDITY_DS            0
#define SNS_REG_DEFAULT_HUMIDITY_BIAS          0
#define SNS_REG_DEFAULT_HUMIDITY_SCALE         100

/**
 * Default values for items in group SNS_REG_DRIVER_GROUP_PRESSURE_V02
 */
#define SNS_REG_DEFAULT_PRESSURE_DS            0
#define SNS_REG_DEFAULT_PRESSURE_BIAS          0
#define SNS_REG_DEFAULT_PRESSURE_SCALE         100

/**
 * Default values for items in group SNS_REG_SAM_GROUP_MULTISHAKE
 */
#define SNS_REG_MULTISHAKE_VERSION_DEF                      1
#define SNS_REG_MULTISHAKE_SHAKE_THRESH_DEF                 (FX_FLTTOFIX_Q16(1.5*G))   // m/s/s, Q16
#define SNS_REG_MULTISHAKE_DEF_SAMPLE_RATE                  (FX_FLTTOFIX_Q16(100.0))   // Hz, Q16
#define SNS_REG_MULTISHAKE_SLEEP_DEF                        (FX_FLTTOFIX_Q16(0.06))    // seconds, Q16
#define SNS_REG_MULTISHAKE_MIN_SHAKE_PERIOD_SECONDS_Q16_DEF (FX_FLTTOFIX_Q16(0.22))    // seconds, Q16
#define SNS_REG_MULTISHAKE_MAX_SHAKE_PERIOD_SECONDS_Q16_DEF (FX_FLTTOFIX_Q16(0.7))     // seconds, Q16

/**
 * Default values for items in group SNS_REG_SAM_GROUP_DEV_ORI_V02
 */
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM0         (4)
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM1_Q16     (FX_FLTTOFIX_Q16(20.0f))
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM2         (0.25f)
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM2_Q16     (FX_FLTTOFIX_Q16(SNS_REG_DEV_ORI_DEF_CFG_PARAM2))
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM3         (70.0f)
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM3_Q16     (FX_FLTTOFIX_Q16(SNS_REG_DEV_ORI_DEF_CFG_PARAM3))
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM4         (45.0f)
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM4_Q16     (FX_FLTTOFIX_Q16(SNS_REG_DEV_ORI_DEF_CFG_PARAM4))
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM5         (3.0f)
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM5_Q16     (FX_FLTTOFIX_Q16(SNS_REG_DEV_ORI_DEF_CFG_PARAM5))
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM6         (15.0f)
#define SNS_REG_DEV_ORI_DEF_CFG_PARAM6_Q16     (FX_FLTTOFIX_Q16(SNS_REG_DEV_ORI_DEF_CFG_PARAM6))

/**
 * eew registry value defaults
 */
#define SNS_REG_DEF_EEW_SUBJECT_HEIGHT_CM_Q16               FX_FLTTOFIX_Q16(175.0f)
#define SNS_REG_DEF_EEW_SUBJECT_WEIGHT_KG_Q16               FX_FLTTOFIX_Q16(77.27f)
#define SNS_REG_DEF_EEW_SUBJECT_AGE_YRS                     45
#define SNS_REG_DEF_EEW_SUJECT_GENDER_IS_MALE               1
...
typedef PACK(struct)
{
  ...
  uint16_t i2c_bus;               //buscfg bus_addr/bus_id - populated by smgr to ssi
  uint16_t reg_group_id;
  uint16_t cal_pri_group_id;
  uint16_t gpio1;
  uint16_t gpio2;
  uint8_t  sensor_id;
  uint8_t  i2c_address;           //buscfg slave_bus_addr/slave_bus_id
  int8_t   data_type1;
  int8_t   data_type2;
  ...
  uint8_t  vdd_rail;             // Vdd and vddio rails for sensor - populated to smgr sensor cfg
  uint8_t  vddio_rail;
  int32_t  reserved3;
...
/**
 *  Registry Data Group for Fast-AMD algorithm
 */
typedef PACK(struct)
{
   uint32_t min_num_of_samples;      /* Minimum number of samples required to generate a motion event */
   uint32_t max_num_of_samples;      /* Maximum number of samples needed to generate a motion event */
   uint32_t def_state_detect_thresh; /* Default motion detection threshold. In unit of percentage */
} sns_reg_fast_amd_data_group_s;

/**
 * Registry Data Group for IOD autocalibration
 */
#define SNS_REG_IOD_MAX_DISCRETE_VALUES 16
typedef PACK(struct)
{
  uint32_t version;
  uint8_t  convergence_status;   /* Convergence status */
  float    auto_cal_coeff;       /* Autocalibration coefficient */
  uint64_t cumulative_num_samples;
  float first_moment;              // mean of log_mean_xi
  float second_moment;             // mean of log_mean_xi_squared
  float als_discrete_vals[SNS_REG_IOD_MAX_DISCRETE_VALUES];
  uint8_t  is_discrete;
} sns_reg_iod_data_group_s;
...
typedef enum
{
  ...
  SNS_REG_SSI_DATA_TYPE_ULTRA_VIOLET,
  SNS_REG_SSI_DATA_TYPE_HEART_RATE,
  SNS_REG_SSI_DATA_TYPE_HEART_RATE_RAW,
  SNS_REG_SSI_DATA_TYPE_OBJECT_TEMP,
  /**<Add new types here */
...
/**
 * Flag true if the device & driver is configured for S4S.
 * S4S & SELF_SCHED are mutually exclusive */
#define SNS_REG_SSI_FLAG_S4S                     0x04

/**
 * Flag true if latency measurement is enabled for particular sensor*/
...
typedef PACK(struct)
{
  ...
  uint16_t reg_group_id;
  uint16_t cal_pri_group_id;
  uint16_t i2c_bus;         //buscfg bus_addr/bus_id - populated to ddf and dd_init by smgr
  uint8_t i2c_address;      //buscfg slave_bus_addr/slave_bus_id
  uint8_t sensitivity_default;
  uint8_t flags;
  uint8_t vdd_rail;        //vdd, vddio rail info
  uint8_t vddio_rail;
  uint8_t reserved1;
  uint32_t reserved2;
...
#define SNS_REG_UUID_DAF_PLAYBACK_ACCEL \
  {0x1f,0xc2,0x96,0x87,0xa4,0x97,0x46,0x6a,0xb8,0x24,0x2a,0x27,0x35,0x39,0xf2,0xb4}
...
#define SNS_REG_UUID_LSM303D \
  {0x2b,0x5f,0xfe,0x66,0x9b,0x62,0x4d,0x35,0xbb,0x58,0xd3,0x9e,0x9b,0x91,0xaf,0x7c}
...
#define SNS_REG_UUID_ZPA2326 \
  {0xf3,0x8f,0x85,0x32,0xbd,0xaa,0x49,0x87,0x9f,0xfb,0xcd,0x33,0x4f,0xbe,0x67,0x52}
#define SNS_REG_UUID_BMI160 \
  {0xa5,0xd5,0x0c,0xec,0x83,0xcb,0x46,0xd6,0xb5,0xea,0xc7,0x54,0xd6,0x0f,0x4d,0x0f}
#define SNS_REG_UUID_AKM099xx_FIFO \
  {0xf6,0xae,0x80,0xfe,0x94,0x2b,0x4d,0x56,0x8f,0x16,0x61,0xd5,0x98,0x1b,0x61,0x90}
#define SNS_REG_UUID_APDS9960 \
  {0xf8,0x39,0x74,0x7a,0x04,0x7c,0x49,0x6f,0xb6,0x79,0x96,0xe1,0xcf,0x87,0x02,0x0f}
#define SNS_REG_UUID_BMP280 \
  {0x72,0xb0,0x06,0xa8,0x90,0x39,0x47,0x5c,0xbd,0x0a,0x1c,0x7f,0xc1,0x1e,0xc3,0x32}
#define SNS_REG_UUID_LSM6DS3 \
  {0xaa,0x2b,0xa9,0x09,0xcb,0xe1,0x46,0x12,0x8e,0x50,0x6c,0x95,0xd5,0xd9,0x0b,0x1a}
#define SNS_REG_UUID_LSM6DS3_DB \
  {0x3f,0xf0,0x8b,0xb4,0xa7,0xbf,0x40,0xe5,0x95,0xe3,0x27,0xa2,0x0b,0x3b,0x3e,0x7d}
#define SNS_REG_UUID_HTS221 \
  {0xa8,0x6f,0xf7,0xee,0xd6,0xe9,0x45,0x5b,0xa7,0x35,0x9a,0x6a,0x65,0x80,0x0f,0x59}
#define SNS_REG_UUID_LIS3MDL \
  {0x35,0x36,0xb1,0xc2,0x4a,0x92,0x4f,0x38,0xa7,0x71,0x83,0x39,0xde,0x02,0x91,0xda}
#define SNS_REG_UUID_MMC3530 \
  {0x72,0xb0,0x06,0xa8,0x90,0x39,0x47,0x5c,0xbd,0x0a,0x1c,0x7f,0xc1,0x1e,0xc3,0x7f}
#define SNS_REG_UUID_LIS2HH \
  {0x18,0x72,0x32,0x7c,0x8e,0x9d,0x4b,0x22,0xb8,0xb6,0xd0,0x4a,0x27,0xc5,0x32,0x8b}
#define SNS_REG_UUID_LIS2MDL \
  {0x2f,0x13,0xcb,0xb8,0xdd,0x35,0x4b,0x59,0xbe,0xd5,0x50,0xd3,0xa8,0xbe,0x65,0xca}
#define SNS_REG_UUID_HSVDDD002A \
  {0xfc,0x33,0xe8,0xc5,0xfb,0x6d,0x47,0x77,0xa3,0x5e,0x45,0xa5,0x1d,0x40,0x49,0xe9}
#define SNS_REG_UUID_ADPD142 \
  {0x17,0xc1,0xf3,0x7f,0xc7,0xcc,0x42,0x34,0x80,0x5c,0xf2,0x9a,0x80,0x2a,0xba,0xa8}
#define SNS_REG_UUID_DTS201A \
  {0x76,0x3a,0xf3,0x02,0xb3,0x23,0x41,0x6a,0x9c,0x59,0x3d,0x18,0xc4,0x28,0x23,0xd8}
#define SNS_REG_UUID_LSM6DSM \
  {0x3c,0xfd,0x26,0xe8,0x52,0xaf,0x48,0xbe,0xac,0xc2,0x1d,0x40,0xfc,0x4c,0x53,0x68}
#define SNS_REG_UUID_CM3526 \
  {0x59,0x49,0x8e,0xf3,0x46,0x3b,0x4e,0xbe,0xad,0xb1,0x69,0x7b,0x93,0x95,0x3c,0x45}
#define SNS_REG_UUID_TMG490x \
  {0xaa,0x50,0x3b,0xd7,0xc0,0xda,0x4f,0xd2,0xad,0xd5,0xf2,0x79,0x7c,0x58,0x83,0x3a}
...
typedef PACK(struct)
{
   ...
   int32_t   param1;  // Opaque configuration parameter used by the QMagCal algorithm
   int32_t   param2;
}sns_reg_qmag_cal_algo_data_group_s;

#define PHONE_MODE_NUM 2
#define MAG_CAL_MAT_ROW 3
#define MAG_CAL_MAT_COL 3
...
typedef PACK(struct)
{
   ...
   int32_t   y_dyn_bias;
   int32_t   z_dyn_bias;
   int32_t   compensation_matrix[MAG_CAL_MAT_ROW][MAG_CAL_MAT_COL];
   int32_t   accuracy;
   uint32_t  time_stamp;
   uint8_t   active;
}sns_reg_mag_cal_params_mode_s;
#else
typedef PACK(struct)
{
   uint32_t  version_no;
...
typedef PACK(struct)
{
  sns_reg_mag_cal_params_mode_s mode[PHONE_MODE_NUM];
}sns_reg_mag_cal_params_data_group_s;
...
/**
 *  Registry Data Group for Object Temperature
 */
typedef PACK(struct)
{
...
}sns_reg_object_temp_group_s;

/**
 *  Registry Data Group for ambient temperature and relative humidity
 */
typedef PACK(struct)
{
...
}sns_reg_ambient_temp_humidity_group_s;

/**
 *  Registry Data Group for pressure sensor
 */
typedef PACK(struct)
{
   uint32_t  pressure_bias;
   uint32_t  pressure_scale;
   uint32_t  pressure_temp_bias;
   uint32_t  pressure_temp_scale;
   uint32_t  pressure_ds1;
   uint32_t  pressure_ds2;
}sns_reg_pressure_group_s;

#define SNS_REG_GROUP_SSC_GPIO_CONFIG_MAX    30
#define SNS_REG_SSC_GPIO_CFG_DEFAULT_VERSION 0
#define SNS_REG_SMGR_HW_INVALID_GPIO        (0xFFFF)

typedef PACK(struct)
{
  uint32_t version;  // If version is 0, then ignore this group
  uint16_t gpio_num; // If the gpio_num is invalid (0xFFFF), then ignore this group
  uint8_t  active_func_sel;
  uint8_t  active_dir;
  uint8_t  active_pull;
  uint8_t  active_drive;
  uint8_t  inactive_func_sel;
  uint8_t  inactive_dir;
  uint8_t  inactive_pull;
  uint8_t  inactive_drive;
} sns_reg_group_ssc_gpio_config_group_s;

typedef PACK(struct)
{
  uint32_t version;
  int32_t sample_rate;
  int32_t shake_thresh;
  int32_t sleep;
  int32_t max_shake_period;
} sns_reg_group_multishake_s;

/**
 *  Registry Data Group for Device Orientation algorithm
 */
typedef PACK(struct)
{
  uint32_t cfg_param0;
  ...
  int32_t  cfg_param5;
  int32_t  cfg_param6;
} sns_reg_dev_ori_data_group_s;

#define SNS_REG_DEF_EEW_TUNING_ENTRIES  55
typedef PACK(struct)
{
  int32_t subject_height_cm_q16;  // can be overridden by enable pkt
  int32_t subject_weight_kg_q16;  // can be overridden by enable pkt
  uint32_t subject_age_yrs; // can be overridden by enable pkt
  uint8_t  subject_gender_is_male; // can be overridden by enable pkt
  uint32_t tuning[SNS_REG_DEF_EEW_TUNING_ENTRIES];
}sns_reg_eew_data_group_s;

/**
 * arw registry data
 */
#define SNS_REG_DEF_ARW_TUNING_ENTRIES  30
typedef PACK(struct)
{
  uint32_t enabled_motion_states;
  uint32_t tuning[SNS_REG_DEF_ARW_TUNING_ENTRIES];
}sns_reg_arw_data_group_s;
