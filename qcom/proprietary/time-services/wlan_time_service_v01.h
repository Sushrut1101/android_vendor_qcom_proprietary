...
#define WLAN_TIME_V01_MAX_MESSAGE_ID 0x0029
/**
    @}
  */
...
typedef enum {
  ...
  QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_IND_V01 = 0, /**<  Indication message for qtimer delta update. */
  QMI_WLAN_GET_RTC_FROM_APPS_IND_V01 = 1, /**<  Indication message to get rtc update. */
...
/** @addtogroup wlan_time_qmi_enums
  ...
  */
typedef enum {
  TIME_SERVICE_INDICATIONS_OPR_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QMI_WLAN_TIME_IND_ON_V01 = 0x10, /**<  Indication turn on . */
  QMI_WLAN_TIME_IND_OFF_V01 = 0x20, /**<  Indication turn off. */
  TIME_SERVICE_INDICATIONS_OPR_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}time_service_indications_opr_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  uint64_t apps_timetick; /**qtimer timetick value at APSS*/

  uint64_t wlan_timetick; /**qtimer timetick value at WLAN*/

}qmi_wlan_get_qtimer_delta_from_apps_req_v01;  /* Message */
...
}qmi_wlan_get_qtimer_delta_from_apps_resp_v01;  /* Message */
...
}qmi_wlan_get_qtimer_delta_from_apps_ind_v01;  /* Message */
...
}qmi_wlan_get_rtc_from_apps_ind_v01;  /* Message */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Indication To Turn on or Off */
  time_service_indications_enum_v01 msg_id;
  /**<   Specifies the indication to be turned off.\n
      - QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_IND (0) --  Indication message for qtimer delta update.
      - QMI_WLAN_GET_RTC_FROM_APPS_IND (1) --  Indication message to get rtc update.
 */

  /* Mandatory */
  /*  operation to turn on or off */
  time_service_indications_opr_enum_v01 opr;
  /**<   Specifies the indication to be turned off.\n
      - QMI_WLAN_TIME_IND_ON (0x10) --  Indication turn on .
      - QMI_WLAN_TIME_IND_OFF (0x20) --  Indication turn off.
 */
}time_turn_on_or_off_ind_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
 ...
 Standard response type. Contains the following data members:
       ...
       qmi_error_type  - Error code. Possible error code values are described in
                         the error codes section of each message definition.
  */
}time_turn_on_or_off_ind_resp_msg_v01;  /* Message */
/**
    @}
  */
...
#define QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_REQ_V01 0x0027
#define QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_RESP_V01 0x0027
#define QMI_WLAN_GET_QTIMER_DELTA_FROM_APPS_IND_V01 0x0027
#define QMI_WLAN_GET_RTC_FROM_APPS_IND_V01 0x0028
#define QMI_WLAN_TIME_TURN_ON_OR_OFF_IND_REQ_MSG_V01 0x0029
#define QMI_WLAN_TIME_TURN_ON_OR_OFF_IND_RESP_MSG_V01 0x0029
/**
    @}
  */
