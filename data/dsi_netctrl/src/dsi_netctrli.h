...
#define DSI_LOCAL_MODEM_IFACE_END    (16)
#define DSI_REMOTE_MODEM_IFACE_START (17)
#define DSI_REMOTE_MODEM_IFACE_END   (33)
...
#define DSI_QMI_PORT_RMNET_8  QMI_PORT_RMNET_8
#define DSI_QMI_PORT_RMNET_9  QMI_PORT_RMNET_9
#define DSI_QMI_PORT_RMNET_10 QMI_PORT_RMNET_10
#define DSI_QMI_PORT_RMNET_11 QMI_PORT_RMNET_11
#define DSI_QMI_PORT_RMNET_12 QMI_PORT_RMNET_12
#define DSI_QMI_PORT_RMNET_13 QMI_PORT_RMNET_13
#define DSI_QMI_PORT_RMNET_14 QMI_PORT_RMNET_14
#define DSI_QMI_PORT_RMNET_15 QMI_PORT_RMNET_15
#define DSI_QMI_PORT_RMNET_16 QMI_PORT_RMNET_16
/* sdio ports */
...
#define DSI_QMI_PORT_RMNET_SDIO_8  QMI_PORT_RMNET_SDIO_8
#define DSI_QMI_PORT_RMNET_SDIO_9  QMI_PORT_RMNET_SDIO_9
#define DSI_QMI_PORT_RMNET_SDIO_10 QMI_PORT_RMNET_SDIO_10
#define DSI_QMI_PORT_RMNET_SDIO_11 QMI_PORT_RMNET_SDIO_11
#define DSI_QMI_PORT_RMNET_SDIO_12 QMI_PORT_RMNET_SDIO_12
#define DSI_QMI_PORT_RMNET_SDIO_13 QMI_PORT_RMNET_SDIO_13
#define DSI_QMI_PORT_RMNET_SDIO_14 QMI_PORT_RMNET_SDIO_14
#define DSI_QMI_PORT_RMNET_SDIO_15 QMI_PORT_RMNET_SDIO_15
#define DSI_QMI_PORT_RMNET_SDIO_16 QMI_PORT_RMNET_SDIO_16
/* usb ports */
...
#define DSI_SET_SUBS_ID(i,x) \
  ( dsi_iface_tbl[i].dsi_modem_subs_id = x )

#define DSI_GET_SUBS_ID(i) \
  ( dsi_iface_tbl[i].dsi_modem_subs_id )
...
typedef struct dsi_store_s
{
  ...
  int dsi_tech; /* if user provided specific technology
                ...
                * to store it */
  int dsi_modem_subs_id; /*subscription ID for handle */
...
extern boolean is_default_handle_inited[DSI_MAX_MODEMS];
...
extern void dsi_attach_dsi_iface(int dsi_iface_index,
                                            dsi_store_t * st);

extern void dsi_detach_dsi_iface(dsi_store_t * st);
...
extern int dsi_get_modem_subs_id( dsi_store_t * st_hndl);

extern int dsi_link_release(int link);
