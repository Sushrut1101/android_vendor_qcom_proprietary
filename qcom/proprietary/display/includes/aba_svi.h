...
#define ABA_SVI_VERSION_MAJOR           0x00000001
#define ABA_SVI_VERSION_MINOR           0x00000005
#define ABA_SVI_VERSION_REVISION        0x00000001
#define ABA_SVI_VERSION                 (ABA_SVI_VERSION_MAJOR << 24 | ABA_SVI_VERSION_MINOR << 16 | ABA_SVI_VERSION_REVISION)
...
#include <stdint.h>
  ...
  */
  typedef struct
  {
    ...
    uint32_t   uMaxBacklightLevel;                   // Max backlight level
    ...
    uint32_t  *pLutUpdateSpeedTableInput;            // LUT update speed table - input axis
    uint32_t  *pLutUpdateSpeedTableOutput;           // LUT update speed table - output axis
    uint32_t   uLutUpdateSpeedTableLength;           // LUT update speed table length
  } SVIConfigParametersType;
