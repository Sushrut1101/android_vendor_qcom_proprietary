...
#define SNS_SMGR_SVC_V01_IDL_MINOR_VERS 0x1B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SNS_SMGR_SVC_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SNS_SMGR_SVC_V01_MAX_MESSAGE_ID 0x0027
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_SVC_qmi_enums
  ...
  */
typedef enum {
  SNS_SMGR_PHONE_MODE_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SMGR_PHONE_MODE_0_V01 = 0, 
  SNS_SMGR_PHONE_MODE_1_V01 = 1, /**<  refer to SNS_REG_SCM_GROUP_MAG_FAC_CAL_PARAMS  */
  SNS_SMGR_PHONE_MODE_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_smgr_phone_mode_e_v01;
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Request Message; This command sends all sensor info request and get all sensor IDs and
           short sensor names. */
typedef struct {
...
typedef struct {
  ...
  /* Optional */
  uint8_t num_reserved_buffered_reports_valid;  /**< Must be set to true if num_reserved_buffered_reports is being passed */
  uint32_t num_reserved_buffered_reports_len;  /**< Must be set to # of elements in num_reserved_buffered_reports */
  uint32_t num_reserved_buffered_reports[SNS_SMGR_MAX_DATA_TYPE_PER_SENSOR_V01];
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Request Message; This command requests all-sensor test.
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Indication Message; Asynchronous error indication for a sensor report */
typedef struct {
  ...
  /* Mandatory */
  sns_smgr_report_error_e_v01 ErrorCode;
  /**<   error code  */
}sns_smgr_report_error_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Request Message; This command resets the calibration parameters of a sensor. */
typedef struct {
  ...
  */
  ...
  /**<   Defines sensor data type which classifies if the data type is primary
    ...
    - All other values defined as SNS_SMGR_DATA_TYPE_XXXX style are reserved
      ...
      This parameter identifies the sensor data type.
   */
}sns_smgr_sensor_cal_reset_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Response Message; This command resets the calibration parameters of a sensor. */
typedef struct {
...
}sns_smgr_sensor_cal_reset_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Request Message; This command update the phone mode */
typedef struct {

  /* Mandatory */
  sns_smgr_phone_mode_e_v01 PhoneMode;
  /**<   Defines the new phone mode
    ...
    - All other values defined as SNS_SMGR_PHONE_MODE_XXX style are reserved for
      future use 
  */
}sns_smgr_phone_mode_switch_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_SVC_qmi_messages
    @{
  */
/** Response Message; This command update the phone mode */
typedef struct {

  /* Mandatory */
  sns_common_resp_s_v01 Resp;
}sns_smgr_phone_mode_switch_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_SNS_SMGR_CAL_RESET_V01 
//#define REMOVE_SNS_SMGR_PHONE_MODE_SWITCH_V01 
//#define REMOVE_SNS_SMGR_REPORT_V01 
//#define REMOVE_SNS_SMGR_REPORT_ERROR_IND_V01 
...
#define SNS_SMGR_REPORT_ERROR_IND_V01 0x0025
#define SNS_SMGR_CAL_RESET_REQ_V01 0x0026
#define SNS_SMGR_CAL_RESET_RESP_V01 0x0026
#define SNS_SMGR_PHONE_MODE_SWITCH_REQ_V01 0x0027
#define SNS_SMGR_PHONE_MODE_SWITCH_RESP_V01 0x0027
/**
    @}
  */
