...
/*==============================================================================
  ...
  DEPENDENCIES: Logging, sockets
                ...
                Copyright (c) 2011-2013, 2015, 2019 Qualcomm Technologies, Inc.
                All Rights Reserved.
...
private:
  ...
  static void slmEventHandler(SlmSvcEventType  event,const void *eventData, void *cbData);
  void handleDsdUp();
  ...
  static void handleSlmEvent(Cne *cne, SlmSvcEventInfo_t* eventInfo);
