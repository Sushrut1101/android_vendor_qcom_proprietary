...
int qmi_simple_ril_show_call_waiting_info_callback (qmi_util_service_message_info* callback_msg_info,qmi_simple_ril_cmd_completion_info* uplink_message)
{
    if (uplink_message->error_code == QMI_NO_ERR || uplink_message->error_code == QMI_IDL_LIB_MISSING_TLV)
        ...
        {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] ERROR in sending the Get_Call_Waiting Request, ERROR CODE:%d\n",uplink_message->error_code);
...
static void ss_print_get_call_waiting_info_resp(voice_get_call_waiting_resp_msg_v02* ss_arg_resp_msg,qmi_simple_ril_cmd_completion_info* uplink_message)
{
    ...
    {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Call Waiting Info : \n");
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        if(TRUE == ss_arg_resp_msg->service_class_valid)
        {
            if(0 != ss_arg_resp_msg->service_class)
            {
                for(iter1 = 0; iter1 < NUMBER_OF_INFORMATION_CLASSES; iter1++)
                {
                    ...
                    {
                        case 0x01:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] VOICE Information Class has Call Waiting active\n");
                            break;
                        case 0x02:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Data Information Class has Call Waiting active\n");
                            break;
                        case 0x04:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] FAX Information Class has Call Waiting active\n");
                            break;
                        case 0x08:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] SMS Information Class has Call Waiting active\n");
                            break;
                        case 0x10:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] DATACIRCUITSYNC Information Class has Call Waiting active\n");
                            break;
                        case 0x20:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] DATACIRCUITASYNC Information Class has Call Waiting active\n");
                            break;
                        case 0x40:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] PACKETACCESS Information Class has Call Waiting active\n");
                            break;
                        case 0x80:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] PADACCESS Information Class has Call Waiting active\n");
                            break;
                        default:                            
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "");
                            break;
            ...
            {
                snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] None of the Information Classes have Call Waiting active\n");
                qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
            }      
        }
        else
        {
           snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] no information provided\n");
           qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    }
    else
    {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] ERROR in Get_Call_Waiting Response, ERROR CODE:%d\n\n",ss_arg_resp_msg->resp.error);
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        if(TRUE == ss_arg_resp_msg->failure_cause_valid)
        {
           snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Failure Cause : %d\n",ss_arg_resp_msg->failure_cause); 
           qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
        else
        {
            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] QMI ERROR : Unknown Error\n");
            qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    }
}
...
int qmi_simple_ril_show_call_barring_info_callback (qmi_util_service_message_info* callback_msg_info,qmi_simple_ril_cmd_completion_info* uplink_message)
{
    if (uplink_message->error_code == QMI_NO_ERR || uplink_message->error_code == QMI_IDL_LIB_MISSING_TLV)
        ...
        {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] ERROR in sending the Get_Call_Barring Request, ERROR CODE:%d\n",uplink_message->error_code);
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    return 0;
}
...
static void ss_print_get_call_barring_info_resp(voice_get_call_barring_resp_msg_v02* ss_arg_resp_msg,qmi_simple_ril_cmd_completion_info* uplink_message)
{
    ...
    if(QMI_RESULT_SUCCESS_V01 == ss_arg_resp_msg->resp.result)
    {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Call Barring Info : \n");
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        if(TRUE == ss_arg_resp_msg->service_class_valid)
        {
            if(0 != ss_arg_resp_msg->service_class)
            {
                for(iter1 = 0; iter1 < NUMBER_OF_INFORMATION_CLASSES; iter1++)
                {
                    ...
                    {
                        case 0x01:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] VOICE Information Class has Call Barring active\n");
                            break;
                        case 0x02:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Data Information Class has Call Barring active\n");
                            break;
                        case 0x04:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] FAX Information Class has Call Barring active\n");
                            break;
                        case 0x08:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] SMS Information Class has Call Barring active\n");
                            break;
                        case 0x10:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] DATACIRCUITSYNC Information Class has Call Barring active\n");
                            break;
                        case 0x20:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] DATACIRCUITASYNC Information Class has Call Barring active\n");
                            break;
                        case 0x40:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] PACKETACCESS Information Class has Call Barring active\n");
                            break;
                        case 0x80:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] PADACCESS Information Class has Call Barring active\n");
                            break;
                        default:
                            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "");
                            break;
            ...
            {
                snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] None of the Information Classes have Call Barring active\n");
                qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
            }      
        }
        else
        {
           snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] no service class info provided \n");
           qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    }
    else
    {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] ERROR in Get_Call_Barring Response, ERROR CODE:%d\n",ss_arg_resp_msg->resp.error);
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        if(TRUE == ss_arg_resp_msg->failure_cause_valid)
        {
           snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Failure Cause : %d\n",ss_arg_resp_msg->failure_cause); 
        ...
        {
            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] no failure cause provided\n");
            qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    }
}
...
int qmi_simple_ril_show_call_forwarding_info_callback (qmi_util_service_message_info* callback_msg_info,qmi_simple_ril_cmd_completion_info* uplink_message)
{
    if (uplink_message->error_code == QMI_NO_ERR || uplink_message->error_code == QMI_IDL_LIB_MISSING_TLV)
        ...
        {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] ERROR in sending the Get_Call_Forwarding Request, ERROR CODE:%d\n",uplink_message->error_code);
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    return 0;
}
...
static void ss_print_get_call_forwarding_info_resp(voice_get_call_forwarding_resp_msg_v02* ss_arg_resp_msg,qmi_simple_ril_cmd_completion_info* uplink_message)
{
    ...
    if(QMI_RESULT_SUCCESS_V01 == ss_arg_resp_msg->resp.result)
    {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Call Forwarding Info : \n");
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        if(TRUE == ss_arg_resp_msg->get_call_forwarding_info_valid)
        {
            if(GET_CALL_FORWARDING_INFO_MAX_V02 >= ss_arg_resp_msg->get_call_forwarding_info_len)
            {
                ...
                {
                    class_info_helper=1;
                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Call Forwarding Info for number-%s : \n",ss_arg_resp_msg->get_call_forwarding_info[iter1].number);
                    qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
                    if(TRUE == ss_arg_resp_msg->get_call_forwarding_info[iter1].service_status)
                    {
                        for(iter2 = 0; iter2 < NUMBER_OF_INFORMATION_CLASSES; iter2++)
                        {
                            ...
                            {
                                case 0x01:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] VOICE Information Class has Call Forwarding active\n");
                                    break;
                                case 0x02:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Data Information Class has Call Forwarding active\n");
                                    break;
                                case 0x04:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] FAX Information Class has Call Forwarding active\n");
                                    break;
                                case 0x08:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] SMS Information Class has Call Forwarding active\n");
                                    break;
                                case 0x10:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] DATACIRCUITSYNC Information Class has Call Forwarding active\n");
                                    break;
                                case 0x20:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] DATACIRCUITASYNC Information Class has Call Forwarding active\n");
                                    break;
                                case 0x40:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] PACKETACCESS Information Class has Call Forwarding active\n");
                                    break;
                                case 0x80:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] PADACCESS Information Class has Call Forwarding active\n");
                                    break;
                                default:
                                    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "");
                                    break;
                    ...
                    {
                        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] None of the Information Classes have Call Forwarding active for number-%s\n",ss_arg_resp_msg->get_call_forwarding_info[iter1].number);
                        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
                    }
                }
            }
            ...
            {
                snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] QMI ERROR : Invalid Length\n");
                qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
            }
        }
        else
        {
           snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] no information provided for SS status\n");
           qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    }
    else
    {
        snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] ERROR in Get_Call_Forwarding Response, ERROR CODE:%d\n",ss_arg_resp_msg->resp.error);
        qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        if(TRUE == ss_arg_resp_msg->failure_cause_valid)
        {
           snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] Failure Cause : %d\n",ss_arg_resp_msg->failure_cause); 
        ...
        {
            snprintf(temp_char_array, TEMP_ARRAY_SIZE, "[SS_TEST] no faulire cause provided \n");
            qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
        }
    }
}
...
{
    snprintf(temp_char_array, TEMP_ARRAY_SIZE, "******************Received SS Indication****************\n");
    qmi_simple_ril_util_add_entry_to_info_set(uplink_message->info_set, temp_char_array);
    return 0;
}
#endif
