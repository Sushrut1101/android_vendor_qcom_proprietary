 ...
 */
class QcRilRequestImsModifyCallConfirmMessage
    : public QcRilRequestMessage,
      public add_message_id<QcRilRequestImsModifyCallConfirmMessage> {
 private:
 ...
 public:
  static constexpr const char *MESSAGE_NAME = "QcRilRequestImsModifyCallConfirmMessage";

  QcRilRequestImsModifyCallConfirmMessage() = delete;

  ~QcRilRequestImsModifyCallConfirmMessage() {}

  inline QcRilRequestImsModifyCallConfirmMessage(std::shared_ptr<MessageContext> context)
