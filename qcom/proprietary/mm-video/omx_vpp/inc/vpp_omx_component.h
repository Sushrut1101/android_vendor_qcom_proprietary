...
private:
    ...
    bool allocate_client_extradata_buffer();
...
private:
    ...
    int32_t                 mClientExtradataFd;
    bool                    mDebugExtradata;
    ...
    /* Number of buffers to be run in turbo to yield some savings to catch up with av sync. */
    uint32_t                mBuffersInTurbo;
    int64_t                 mSumFrameIntervals;
    int64_t                 mPreviousTimestamp;
    bool                    mFrameRateFinalized;
