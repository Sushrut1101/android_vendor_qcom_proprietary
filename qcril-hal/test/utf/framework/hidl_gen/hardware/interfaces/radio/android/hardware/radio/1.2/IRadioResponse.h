#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_2_IRADIORESPONSE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_2_IRADIORESPONSE_H
...
struct IRadioResponse : public ::android::hardware::radio::V1_1::IRadioResponse {
    ...
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_2::IRadioResponse>> castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_2::IRadioResponse>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_2::IRadioResponse>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadioResponse>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_2::IRadioResponse>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<::android::hardware::radio::V1_2::IRadioResponse>& o);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_2_IRADIORESPONSE_H
