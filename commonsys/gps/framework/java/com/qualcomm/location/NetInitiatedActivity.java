...
public class NetInitiatedActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HandlerThread t = new HandlerThread(NetInitiatedActivity.class.getSimpleName());
        t.start();
        ...
        if (GpsNetInitiatedHandler.obj == null) {
            ...
            mNetInitiatedListener = GpsNetInitiatedHandler.obj.getNetInitiatedListener();
        }
    ...
    private void sendUserResponse(int response) {
        ...
        try {
            if (mNetInitiatedListener == null) {
                ...
                mNetInitiatedListener.sendNiResponse(notificationId, response);
            }
