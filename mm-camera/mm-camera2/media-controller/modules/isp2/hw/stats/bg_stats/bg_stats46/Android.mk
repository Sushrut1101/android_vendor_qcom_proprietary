#======================================================================
#makefile for libmmcamera2_isp2_bg_stats46.so form mm-camera2
#======================================================================
...
LOCAL_SRC_FILES        := module_bg_stats46.c bg_stats46.c
ifeq ($(call is-board-platform-in-list, sdm660 msm8998 apq8098_latv $(TRINKET)),true)
LOCAL_SRC_FILES        += include48/bg_stats_ext48.c
else
LOCAL_SRC_FILES        += bg_stats_ext46.c
endif
LOCAL_C_INCLUDES += $(LOCAL_PATH)/include48
