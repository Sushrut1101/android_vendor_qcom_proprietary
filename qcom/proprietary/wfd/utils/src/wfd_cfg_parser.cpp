...
void  parseUIBCSupport(string uibcBuffer)
{
   ...
   if(bValid)
   {
      ...
      if(bGeneric)
      {
         ...
         {
            pReadCfgCapabilities->uibcCapability.config.generic_input_type |= UIBC_CAMERA;
         }
...
void parseExtendedVideoCodec(string videoBuffer, int index)
{
   ...
   /* Limit FPS based on chipset capability */
   switch(mnHW_ID)
   {
      /*--1--*/
      case 206:
      ...
      case 363:
      case 364:
           if(wfdDevice != SOURCE && (uMaxHRes >= 1920 || uMaxVRes >= 1080) && fpsSupported > 30)
           {
              fpsSupported = 30;
              break;
           }
      /*--4--*/
      case 385:
           if((uMaxHRes >= 1920 || uMaxVRes >= 1080) && fpsSupported > 30)
           {
              fpsSupported = 30;
           }
        break;
...
void parseHWVer()
{
    ...
    switch(mnHW_ID)
    {
        ...
        case 337:
        case 360:
            property_get("media.sdm710.version", value, "0");
