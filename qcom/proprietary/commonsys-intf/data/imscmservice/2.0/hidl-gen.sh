...
HIDL_ROOT_DIR="$QCPATH/ims-ship/rcs/interfaces/imscmservice"
LIBHIDL_COMPONENT='-r android.hidl:system/libhidl/transport'

IMS_CM_INTERFACE_LIB='com.qualcomm.qti.imscmservice@2.0'

LOC="$QCPATH/ims-ship/rcs/interfaces/imscmservice/2.0/default"

hidl-gen -Landroidbp -r com.qualcomm.qti.imscmservice:$HIDL_ROOT_DIR $LIBHIDL_COMPONENT $IMS_CM_INTERFACE_LIB
