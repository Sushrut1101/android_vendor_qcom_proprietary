/******************************************************************************
#  Copyright (c) 2008-1010, 2017 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
{
  const char *mmi_sc;       /* MMI value of Service Code */
...
{
  const char *mmi_bsg;           /* MMI value of Basic Service Group */
...
{
  const char *sups_mode_str;                /* Sups operation type string */
...
uint8  qcril_cm_ss_get_cfw_ss_code( int reason, const char **cf_reason_name );
...
size_t qcril_cm_ss_ascii_to_utf8(const unsigned char* ascii_str, size_t ascii_len, char* utf8_str, size_t utf8_sz );
