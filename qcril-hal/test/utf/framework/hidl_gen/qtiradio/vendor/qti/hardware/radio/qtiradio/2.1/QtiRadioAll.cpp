...
#define LOG_TAG "vendor.qti.hardware.radio.qtiradio@2.1::QtiRadio"
...
const char* IQtiRadio::descriptor("vendor.qti.hardware.radio.qtiradio@2.1::IQtiRadio");
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_0::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio*>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> IQtiRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::qtiradio::V1_0::IQtiRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>(static_cast<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio*>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::qtiradio::V2_1::IQtiRadio>> mHidlServices;
