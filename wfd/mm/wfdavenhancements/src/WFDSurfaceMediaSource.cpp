...
void WFDSurfaceMediaSource::passMetadataBuffer_l(MediaBufferBase **buffer,
...
buffer_handle_t
WFDSurfaceMediaSource::getMediaBufferHandle(MediaBufferBase *buffer) {
...
void WFDSurfaceMediaSource::signalBufferReturned(MediaBufferBase *buffer) {
