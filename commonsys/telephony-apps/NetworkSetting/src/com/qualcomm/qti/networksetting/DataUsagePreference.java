...
public class DataUsagePreference extends Preference {
    ...
    private NetworkTemplate getNetworkTemplate(Activity activity, int subId) {
        TelephonyManager defaultSubTelephonyManager = (TelephonyManager) activity
                .getSystemService(Context.TELEPHONY_SERVICE);
        TelephonyManager telephonyManagerForSubId =
                defaultSubTelephonyManager.createForSubscriptionId(subId);
        NetworkTemplate mobileAll = NetworkTemplate
                .buildTemplateMobileAll(telephonyManagerForSubId.getSubscriberId());
        return NetworkTemplate.normalize(mobileAll,
                defaultSubTelephonyManager.getMergedSubscriberIds());
    }
}
