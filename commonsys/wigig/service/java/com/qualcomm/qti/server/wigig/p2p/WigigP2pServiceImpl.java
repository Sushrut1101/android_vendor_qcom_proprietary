...
public class WigigP2pServiceImpl extends IWigigP2pManager.Stub {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case BLOCK_DISCOVERY:
                    ...
                    break;
                case WigigP2pManager.DISCOVER_PEERS:
                    replyToMessage(message, WigigP2pManager.DISCOVER_PEERS_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.STOP_DISCOVERY:
                    replyToMessage(message, WigigP2pManager.STOP_DISCOVERY_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.DISCOVER_SERVICES:
                    replyToMessage(message, WigigP2pManager.DISCOVER_SERVICES_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.CONNECT:
                    replyToMessage(message, WigigP2pManager.CONNECT_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.CANCEL_CONNECT:
                    replyToMessage(message, WigigP2pManager.CANCEL_CONNECT_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.CREATE_GROUP:
                    replyToMessage(message, WigigP2pManager.CREATE_GROUP_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.REMOVE_GROUP:
                    replyToMessage(message, WigigP2pManager.REMOVE_GROUP_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.ADD_LOCAL_SERVICE:
                    replyToMessage(message, WigigP2pManager.ADD_LOCAL_SERVICE_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.REMOVE_LOCAL_SERVICE:
                    replyToMessage(message, WigigP2pManager.REMOVE_LOCAL_SERVICE_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.CLEAR_LOCAL_SERVICES:
                    replyToMessage(message, WigigP2pManager.CLEAR_LOCAL_SERVICES_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.ADD_SERVICE_REQUEST:
                    replyToMessage(message, WigigP2pManager.ADD_SERVICE_REQUEST_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.REMOVE_SERVICE_REQUEST:
                    replyToMessage(message,
                            WigigP2pManager.REMOVE_SERVICE_REQUEST_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.CLEAR_SERVICE_REQUESTS:
                    replyToMessage(message,
                            WigigP2pManager.CLEAR_SERVICE_REQUESTS_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.SET_DEVICE_NAME:
                    replyToMessage(message, WigigP2pManager.SET_DEVICE_NAME_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.DELETE_PERSISTENT_GROUP:
                    replyToMessage(message, WigigP2pManager.DELETE_PERSISTENT_GROUP,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.SET_WFD_INFO:
                    replyToMessage(message, WigigP2pManager.SET_WFD_INFO_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.REQUEST_PEERS:
                    replyToMessage(message, WigigP2pManager.RESPONSE_PEERS,
                            new WifiP2pDeviceList(mPeers));
                    break;
                case WigigP2pManager.REQUEST_CONNECTION_INFO:
                    replyToMessage(message, WigigP2pManager.RESPONSE_CONNECTION_INFO,
                            new WifiP2pInfo(mWifiP2pInfo));
                    break;
                case WigigP2pManager.REQUEST_GROUP_INFO:
                    replyToMessage(message, WigigP2pManager.RESPONSE_GROUP_INFO,
                            mGroup != null ? new WifiP2pGroup(mGroup) : null);
                    break;
                case WigigP2pManager.REQUEST_PERSISTENT_GROUP_INFO:
                    replyToMessage(message, WigigP2pManager.RESPONSE_PERSISTENT_GROUP_INFO,
                            new WifiP2pGroupList(mGroups, null));
                    break;
                case WigigP2pManager.START_WPS:
                    replyToMessage(message, WigigP2pManager.START_WPS_FAILED,
                        WigigP2pManager.BUSY);
                    break;
                case WigigP2pManager.GET_HANDOVER_REQUEST:
                case WigigP2pManager.GET_HANDOVER_SELECT:
                    replyToMessage(message, WigigP2pManager.RESPONSE_GET_HANDOVER_MESSAGE, null);
                    break;
                case WigigP2pManager.INITIATOR_REPORT_NFC_HANDOVER:
                case WigigP2pManager.RESPONDER_REPORT_NFC_HANDOVER:
                    replyToMessage(message, WigigP2pManager.REPORT_NFC_HANDOVER_FAILED,
                            WigigP2pManager.BUSY);
                    break;
                    // Ignore
    ...
    class P2pNotSupportedState extends State {
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
               case WigigP2pManager.DISCOVER_PEERS:
                    replyToMessage(message, WigigP2pManager.DISCOVER_PEERS_FAILED,
                            WigigP2pManager.P2P_UNSUPPORTED);
                    break;
                case WigigP2pManager.STOP_DISCOVERY:
                    replyToMessage(message, WigigP2pManager.STOP_DISCOVERY_FAILED,
                            WigigP2pManager.P2P_UNSUPPORTED);
               ...
               case WigigP2pManager.CREATE_GROUP:
                ...
                case WigigP2pManager.START_WPS:
                    ...
                    break;
                case WigigP2pManager.START_LISTEN:
                    replyToMessage(message, WigigP2pManager.START_LISTEN_FAILED,
                            WigigP2pManager.P2P_UNSUPPORTED);
                    break;
                case WigigP2pManager.STOP_LISTEN:
                    replyToMessage(message, WigigP2pManager.STOP_LISTEN_FAILED,
                            WigigP2pManager.P2P_UNSUPPORTED);
                    break;
            ...
            switch (message.what) {
                ...
                case WigigP2pManager.SET_DEVICE_NAME:
                {
                    ...
                    if (d != null && setAndPersistDeviceName(d.deviceName)) {
                        ...
                        replyToMessage(message, WigigP2pManager.SET_DEVICE_NAME_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.SET_DEVICE_NAME_FAILED,
                                WigigP2pManager.ERROR);
                    }
                    break;
                }
                case WigigP2pManager.SET_WFD_INFO:
                {
                    ...
                    if (d != null && setWfdInfo(d)) {
                        replyToMessage(message, WigigP2pManager.SET_WFD_INFO_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.SET_WFD_INFO_FAILED,
                                WigigP2pManager.ERROR);
                    }
                ...
                case WigigP2pManager.DISCOVER_PEERS:
                    ...
                    if (mWigigNative.p2pFind(DISCOVER_TIMEOUT_S)) {
                        replyToMessage(message, WigigP2pManager.DISCOVER_PEERS_SUCCEEDED);
                ...
                case WigigP2pManager.STOP_DISCOVERY:
                    if (mWigigNative.p2pStopFind()) {
                        replyToMessage(message, WigigP2pManager.STOP_DISCOVERY_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.STOP_DISCOVERY_FAILED,
                                WigigP2pManager.ERROR);
                    }
                ...
                case WigigP2pManager.DISCOVER_SERVICES:
                    ...
                    if (!updateSupplicantServiceRequest()) {
                        replyToMessage(message, WigigP2pManager.DISCOVER_SERVICES_FAILED,
                                WigigP2pManager.NO_SERVICE_REQUESTS);
                        break;
                    }
                    if (mWigigNative.p2pFind(DISCOVER_TIMEOUT_S)) {
                        replyToMessage(message, WigigP2pManager.DISCOVER_SERVICES_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.DISCOVER_SERVICES_FAILED,
                                WigigP2pManager.ERROR);
                    }
                ...
                case WigigP2pManager.ADD_LOCAL_SERVICE:
                    ...
                    if (addLocalService(message.replyTo, servInfo)) {
                        replyToMessage(message, WigigP2pManager.ADD_LOCAL_SERVICE_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.ADD_LOCAL_SERVICE_FAILED);
                    }
                    break;
                case WigigP2pManager.REMOVE_LOCAL_SERVICE:
                    ...
                    replyToMessage(message, WigigP2pManager.REMOVE_LOCAL_SERVICE_SUCCEEDED);
                    break;
                case WigigP2pManager.CLEAR_LOCAL_SERVICES:
                    if (DBG) logd(getName() + " clear service");
                    clearLocalServices(message.replyTo);
                    replyToMessage(message, WigigP2pManager.CLEAR_LOCAL_SERVICES_SUCCEEDED);
                    break;
                case WigigP2pManager.ADD_SERVICE_REQUEST:
                    ...
                    replyToMessage(message, WigigP2pManager.ADD_SERVICE_REQUEST_SUCCEEDED);
                    break;
                case WigigP2pManager.REMOVE_SERVICE_REQUEST:
                    if (DBG) logd(getName() + " remove service request");
                    removeServiceRequest(message.replyTo, (WifiP2pServiceRequest)message.obj);
                    replyToMessage(message, WigigP2pManager.REMOVE_SERVICE_REQUEST_SUCCEEDED);
                    break;
                case WigigP2pManager.CLEAR_SERVICE_REQUESTS:
                    if (DBG) logd(getName() + " clear service request");
                    clearServiceRequests(message.replyTo);
                    replyToMessage(message, WigigP2pManager.CLEAR_SERVICE_REQUESTS_SUCCEEDED);
                    break;
                case WigigMonitor.P2P_SERV_DISC_RESP_EVENT:
                ...
                case WigigP2pManager.DELETE_PERSISTENT_GROUP:
                   ...
                   replyToMessage(message, WigigP2pManager.DELETE_PERSISTENT_GROUP_SUCCEEDED);
                   break;
                case SET_MIRACAST_MODE:
                ...
                case WigigP2pManager.START_LISTEN:
                    ...
                    if (mWigigNative.p2pExtListen(true, 500, 500)) {
                        replyToMessage(message, WigigP2pManager.START_LISTEN_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.START_LISTEN_FAILED);
                    }
                    break;
                case WigigP2pManager.STOP_LISTEN:
                    ...
                    if (mWigigNative.p2pExtListen(false, 0, 0)) {
                        replyToMessage(message, WigigP2pManager.STOP_LISTEN_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.STOP_LISTEN_FAILED);
                    }
                    mWigigNative.p2pFlush();
                ...
                case WigigP2pManager.SET_CHANNEL:
                    ...
                    if (mWigigNative.p2pSetChannel(lc, oc)) {
                        replyToMessage(message, WigigP2pManager.SET_CHANNEL_SUCCEEDED);
                    } else {
                        replyToMessage(message, WigigP2pManager.SET_CHANNEL_FAILED);
                    }
                    break;
                case WigigP2pManager.GET_HANDOVER_REQUEST:
                    Bundle requestBundle = new Bundle();
                    requestBundle.putString(WigigP2pManager.EXTRA_HANDOVER_MESSAGE,
                            mWigigNative.getNfcHandoverRequest());
                    replyToMessage(message, WigigP2pManager.RESPONSE_GET_HANDOVER_MESSAGE,
                            requestBundle);
                    break;
                case WigigP2pManager.GET_HANDOVER_SELECT:
                    Bundle selectBundle = new Bundle();
                    selectBundle.putString(WigigP2pManager.EXTRA_HANDOVER_MESSAGE,
                            mWigigNative.getNfcHandoverSelect());
                    replyToMessage(message, WigigP2pManager.RESPONSE_GET_HANDOVER_MESSAGE,
                            selectBundle);
                    break;
                default:
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case WigigP2pManager.CONNECT:
                    ...
                    sendPeersChangedBroadcast();
                    replyToMessage(message, WigigP2pManager.CONNECT_SUCCEEDED);
                    break;
                case WigigP2pManager.STOP_DISCOVERY:
                    if (mWigigNative.p2pStopFind()) {
                ...
                case WigigP2pManager.CREATE_GROUP:
                    ...
                    if (ret) {
                        replyToMessage(message, WigigP2pManager.CREATE_GROUP_SUCCEEDED);
                        transitionTo(mGroupNegotiationState);
                    } else {
                        replyToMessage(message, WigigP2pManager.CREATE_GROUP_FAILED,
                                WigigP2pManager.ERROR);
                ...
                case WigigP2pManager.INITIATOR_REPORT_NFC_HANDOVER:
                    ...
                    if (handoverSelect != null
                        ...
                        replyToMessage(message, WigigP2pManager.REPORT_NFC_HANDOVER_SUCCEEDED);
            ...
            switch (message.what) {
               case GROUP_CREATING_TIMED_OUT:
                ...
                case WigigP2pManager.CANCEL_CONNECT:
                    ...
                    handleGroupCreationFailure();
                    transitionTo(mIdleState);
                    replyToMessage(message, WigigP2pManager.CANCEL_CONNECT_SUCCEEDED);
                    break;
    ...
    class FrequencyConflictState extends State {
        ...
        private void notifyFrequencyConflict() {
            ...
            // TODO flag was renamed to SYSTEM_FLAG_SHOW_FOR_ALL_USERS but need to branch
            // the component to fix. Temporarily comment
            ...
            switch (message.what) {
                ...
                case WigigP2pManager.REMOVE_GROUP:
                    ...
                    if (mWigigNative.p2pGroupRemove(mGroup.getInterface())) {
                        ...
                        replyToMessage(message, WigigP2pManager.REMOVE_GROUP_SUCCEEDED);
                    } else {
                        handleGroupRemoved();
                        transitionTo(mIdleState);
                        replyToMessage(message, WigigP2pManager.REMOVE_GROUP_FAILED,
                ...
                case WigigP2pManager.START_WPS:
                    ...
                    replyToMessage(message, ret ? WigigP2pManager.START_WPS_SUCCEEDED :
                            WigigP2pManager.START_WPS_FAILED);
                    break;
                case WigigP2pManager.CONNECT:
                    WifiP2pConfig config = (WifiP2pConfig) message.obj;
                    if (isConfigInvalid(config)) {
    ...
    private void sendServiceResponse(WifiP2pServiceResponse resp) {
        for (ClientInfo c : mClientInfoList.values()) {
            ...
            if (req != null) {
                Message msg = Message.obtain();
                msg.what = WigigP2pManager.RESPONSE_SERVICE;
                msg.arg1 = 0;
                msg.arg2 = 0;
                msg.obj = resp;
                try {
