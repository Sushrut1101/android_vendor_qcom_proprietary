...
#define LOG_TAG "vendor.qti.hardware.radio.ims@1.6::ImsRadio"
...
const char* IImsRadio::descriptor("vendor.qti.hardware.radio.ims@1.6::IImsRadio");
...
// Methods from ::vendor::qti::hardware::radio::ims::V1_5::IImsRadio follow.
// no default implementation for: ::android::hardware::Return<void> IImsRadio::setConfig_1_5(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_5::ConfigInfo& config)
// no default implementation for: ::android::hardware::Return<void> IImsRadio::emergencyDial(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_4::DialRequest& dialRequest, ::android::hardware::hidl_bitfield<::vendor::qti::hardware::radio::ims::V1_5::EmergencyServiceCategory> categories, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& urns, ::vendor::qti::hardware::radio::ims::V1_5::EmergencyCallRoute route, bool hasKnownUserIntentEmergency, bool isTesting)
// no default implementation for: ::android::hardware::Return<void> IImsRadio::acknowledgeSms_1_5(int32_t token, uint32_t messageRef, ::vendor::qti::hardware::radio::ims::V1_5::ImsSmsDeliverStatusResult smsResult)

// Methods from ::vendor::qti::hardware::radio::ims::V1_6::IImsRadio follow.
// no default implementation for: ::android::hardware::Return<void> IImsRadio::setConfig_1_6(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_6::ConfigInfo& config)
// no default implementation for: ::android::hardware::Return<void> IImsRadio::setServiceStatus_1_6(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_6::ServiceStatusInfo& srvStatusInfo)
// no default implementation for: ::android::hardware::Return<void> IImsRadio::suppServiceStatus_1_6(int32_t token, int32_t operationType, ::vendor::qti::hardware::radio::ims::V1_0::FacilityType facilityType, const ::vendor::qti::hardware::radio::ims::V1_0::CbNumListInfo& cbNumListInfo, const ::android::hardware::hidl_string& password)
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_5::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_4::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_3::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_2::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_1::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::vendor::qti::hardware::radio::ims::V1_0::IImsRadio>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> IImsRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>(static_cast<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio *>(parent.get()));
}

static std::unordered_map<std::string, ::android::sp<::vendor::qti::hardware::radio::ims::V1_6::IImsRadio>> mHidlServices;
...
::android::status_t IImsRadio::registerAsService(const std::string &serviceName) {
    ...
    ::vendor::qti::hardware::radio::ims::V1_5::IImsRadio::registerAsService(serviceName);
    return ::android::OK;
}
