...
/*==============================================================
FUNCTION:  bt_nv_is_random_addr
==============================================================*/
/**
* Used to check the existing address is randomly genarated or
* not.
*
* @return  bool - TRUE incase of random addr FALSE otherwise.
*
*/
bool bt_nv_is_random_addr(void)
{
  ...
  {
    if( NV_BD_ADDR_I == params_temp[i].item)
    {
      item = i;
  ...
  return (params_temp[item].writeprotect == NV_WRITE_ONCE_DISABLE);
}
