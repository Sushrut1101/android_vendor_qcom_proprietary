...
public class Camera2APIActivity extends CameraActivity {
    ...
    private static final Integer previewFormat_ = ImageFormat.PRIVATE;
    ...
    private class EndTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            /** Tear down camera resources in the same thread to serialize
             *  and avoid race condition with preview resources */
            try {
                if (previewCamera_ != null) {
                    previewCamera_.stop();
                    previewCamera_ = null;
