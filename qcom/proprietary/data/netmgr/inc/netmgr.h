...
#endif /* defined(NETMGR_OFFTARGET) */
...
typedef enum netmgr_link_id_e {
  ...
  NETMGR_LINK_RMNET_22,
  NETMGR_LINK_RMNET_23,
  NETMGR_LINK_RMNET_24,
  NETMGR_LINK_RMNET_25,
  NETMGR_LINK_RMNET_26,
  NETMGR_LINK_RMNET_27,
  NETMGR_LINK_RMNET_28,
  NETMGR_LINK_RMNET_29,
  NETMGR_LINK_RMNET_30,
  NETMGR_LINK_RMNET_31,
  NETMGR_LINK_RMNET_32,
  NETMGR_LINK_RMNET_33,
  ...
  NETMGR_LINK_REV_RMNET_18,
  NETMGR_LINK_REV_RMNET_19,
  NETMGR_LINK_REV_RMNET_20,
  NETMGR_LINK_REV_RMNET_21,
  NETMGR_LINK_REV_RMNET_22,
  NETMGR_LINK_REV_RMNET_23,
  NETMGR_LINK_REV_RMNET_24,
  NETMGR_LINK_REV_RMNET_25,
  NETMGR_LINK_REV_RMNET_26,
  NETMGR_LINK_REV_RMNET_27,
  NETMGR_LINK_REV_RMNET_28,
  NETMGR_LINK_REV_RMNET_29,
  NETMGR_LINK_REV_RMNET_30,
  NETMGR_LINK_REV_RMNET_31,
...
#define NETMGR_USER_CMD_QUERY_NETWORK_HANDLE    7
...
#define NETMGR_BEARER_ID_DEFAULT      (0)
